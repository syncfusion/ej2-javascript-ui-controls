 ...
 */
import { Toolbar, BeforeCreateArgs } from '../../src/toolbar/index';

    let toolbarObj: Toolbar = new Toolbar({
           beforeCreate: beforecreat,
           created: created,
        items: [
            {
            ...
            {
                text: 'Charts', tooltipText: 'Clear' },
            {
                 text: 'Rewind', tooltipText: 'Reload' },
            {
                text: 'Forward', tooltipText: 'Export'
            },{
                type: 'Separator' },
            {
                 text: 'Pause', tooltipText: 'Clear' },
            {
                text: 'Play', tooltipText: 'Reload' },
            {
                 text: 'next', tooltipText: 'Export'
            },{
                type: 'Separator' },
            {
                text: 'prev', tooltipText: 'Clear' },
            {
                 text: 'SubTitle', tooltipText: 'Reload' },
            {
                text: 'Charts', tooltipText: 'Clear' },
            {
                 text: 'Rewind', tooltipText: 'Reload' },
                ...
                text: 'prev', tooltipText: 'Clear' },
            {
                 text: 'SubTitle', tooltipText: 'Reload' },
            {
                text: 'Donut-chart', tooltipText: 'Clear' },
            {
                 text: 'PieChart', tooltipText: 'Reload' }]
    });
    toolbarObj.appendTo('#ej2Toolbar');
    let startTime: number;
    function beforecreat (e: BeforeCreateArgs): void{
