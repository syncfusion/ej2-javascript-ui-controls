...
describe('TimePicker', () => {
    ...
    describe('EJ2-53323', function () {
        ...
        it('clear the full selected value on input',function(){
            let timepicker: any= new TimePicker({
            });
            timepicker.appendTo('#date');
            timepicker.show();
            expect(timepicker.inputWrapper.container.classList.contains('e-input-focus')).toBe(true);
            ...
            expect(timepicker.inputElement.value === "").toBe(false);
            timepicker.inputElement.value="";
            expect(timepicker.liCollections[0].classList.contains('e-active')).toBe(true);
            timepicker.liCollections[0].click();
            expect(timepicker.inputElement.value === "12:00 AM").toBe(true);
        });
        it('clear the selected value partially on input',function(){
            let timepicker: any= new TimePicker({
            });
            timepicker.appendTo('#date');
            timepicker.show();
            ...
            expect(timepicker.liCollections[0].classList.contains('e-active')).toBe(true);
            expect(timepicker.inputElement.value === "").toBe(false);
            timepicker.inputElement.value='12.00 A';
            expect(timepicker.liCollections[0].classList.contains('e-active')).toBe(true);
            timepicker.liCollections[0].click();
            expect(timepicker.inputElement.value === "12:00 AM").toBe(true);
        });
