...
window.onload = () => {
    let circulargauge: CircularGauge = new CircularGauge({
        axes: [{
            ...
            startAngle: 210, endAngle: 150, minimum: 50, maximum: 150, radius: '80%',
            ranges: [{ start: 0, end: 40, color: '#30B32D' }, { start: 60, end: 70, color: '#FFDD00' }],
            pointers: [{
                animation: { enable: false },
                value: 70, radius: '60%', color: '#757575', pointerWidth: 10,
