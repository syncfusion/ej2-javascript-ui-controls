...
describe('Linear gauge control', () => {
    ...
    describe('Checking axis properties', () => {
        ...
        it('Tailwind3 theme', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_MajorTicksLine_0');
                expect(svg.getAttribute('fill')).toBe('#D1D5DB');
                let minorTicks : HTMLElement = document.getElementById('container_MinorTicksLine_0');
                expect(minorTicks.getAttribute('fill')).toBe('#D1D5DB');
                let line : HTMLElement = document.getElementById('container_AxisLine_0');
                expect(line.getAttribute('fill')).toBe('#E5E7EB');
                let pointerColor : HTMLElement = document.getElementById('container_AxisIndex_0_MarkerPointer_0');
                expect(pointerColor.getAttribute('fill')).toBe('#1F2937');
            };
            gauge.theme = 'Tailwind3'
            gauge.refresh();
        });
        it('Tailwind3Dark theme', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_MajorTicksLine_0');
                expect(svg.getAttribute('fill')).toBe('#374151');
                let minorTicks : HTMLElement = document.getElementById('container_MinorTicksLine_0');
                expect(minorTicks.getAttribute('fill')).toBe('#374151');
                let line : HTMLElement = document.getElementById('container_AxisLine_0');
                expect(line.getAttribute('fill')).toBe('#282F3C');
                let pointerColor : HTMLElement = document.getElementById('container_AxisIndex_0_MarkerPointer_0');
                expect(pointerColor.getAttribute('fill')).toBe('#6B7280');
            };
            gauge.theme = 'Tailwind3Dark'
            gauge.refresh();
        });
