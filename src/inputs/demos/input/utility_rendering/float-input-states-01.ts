...
Input.setEnabled(false, element3, "Auto");
...
Input.setEnabled(false, element4, "Auto");
...
Input.setEnabled(false, element8, "Auto");
...
Input.appendSpan('e-input-group-icon e-input-down', inputObj9.container);
Input.setEnabled(false, element9, "Auto");
...
Input.setEnabled(false, element13, "Auto");
...
Input.setEnabled(false, element14, "Auto");
...
Input.setEnabled(false, element18, "Auto");
...
Input.setEnabled(false, element19, "Auto");
