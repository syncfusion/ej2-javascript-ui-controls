                ...
                "blocks": [
                    ...
                    },
                    {
                        ...
                        "inlines": [
                            ...
                            {
                                "text": "us company on which the AdventureWorks sample ",
                                "characterFormat": {
                                    "baselineAlignment": "Subscript",
                                    "fontSize": 12
                                }
...
describe('insert Hyperlink validation in multiple cases in forward', () => {
    let editor: DocumentEditor;
    let dialog: HyperlinkDialog;
    beforeAll((): void => {
        editor = undefined;
...
console.log('insert Hyperlink in single paragraph');
        ...
        urlTextBox.value = 'https://syncfusion.com';
        editor.hyperlinkDialogModule.onInsertHyperlink();
...
describe('insert Hyperlink validation in multiple cases in backward direction', () => {
    let editor: DocumentEditor;
    let dialog: HyperlinkDialog;
    beforeAll((): void => {
        editor = undefined;
...
console.log('insert Hyperlink in single paragraph');
        ...
        let urlTextBox: HTMLInputElement = (editor.hyperlinkDialogModule as any).urlTextBox;
        urlTextBox.value = 'https://syncfusion.com';
        (editor.hyperlinkDialogModule as any).onInsertHyperlink();
        editor.selection.handleLeftKey();
        editor.selection.handleLeftKey();
        let fieldBegin = editor.selection.getHyperlinkField();
        expect(fieldBegin).not.toBeUndefined();
