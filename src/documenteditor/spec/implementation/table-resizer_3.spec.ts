...
console.log('Resize Table Cell in Final Row Drag Value Testing ');
        ...
        let event: any = { offsetX: 735, offsetY: 143, preventDefault: function () { }, ctrlKey: false, button: 0 };
        editor.documentHelper.onMouseDownInternal(event);
        event = { offsetX: 779, offsetY: 143, preventDefault: function () { }, ctrlKey: false };
        editor.documentHelper.onMouseMoveInternal(event);
        editor.documentHelper.onMouseUpInternal(event);
        event = { offsetX: 799, offsetY: 143, preventDefault: function () { }, ctrlKey: false, button: 0 };
        editor.documentHelper.onMouseDownInternal(event);
...
console.log('Resize Table Cell With Selection table cell Spacing Resizing Testing ');
        ...
        editor.selection.selectRange(startPosition, endPosition);
        let event: any = { offsetX: 321, offsetY: 141, preventDefault: function () { }, ctrlKey: false, button: 0 };
        editor.documentHelper.onMouseDownInternal(event);
        event = { offsetX: 381, offsetY: 141, preventDefault: function () { }, ctrlKey: false };
        editor.documentHelper.onMouseMoveInternal(event);
        editor.documentHelper.onMouseUpInternal(event);
        event = { offsetX: 391, offsetY: 141, preventDefault: function () { }, ctrlKey: false, button: 0 };
        editor.documentHelper.onMouseDownInternal(event);
    });
});
...
console.log('Resize Table Without Selection on Zero index Testing');
        editor.editor.insertTable(2, 3);
        let event: any = { offsetX: 320, offsetY: 126, preventDefault: function () { }, ctrlKey: false, button: 0 };
        editor.documentHelper.onMouseDownInternal(event);
        event = { offsetX: 360, offsetY: 126, preventDefault: function () { }, ctrlKey: false };
        editor.documentHelper.onMouseMoveInternal(event);
        editor.documentHelper.onMouseUpInternal(event);
        event = { offsetX: 370, offsetY: 126, preventDefault: function () { }, ctrlKey: false, button: 0 };
        editor.documentHelper.onMouseDownInternal(event);
...
console.log('Resize table without selection on middle index testing');
        editor.editor.insertTable(3, 3);
        let event: any = { offsetX: 736, offsetY: 145, preventDefault: function () { }, ctrlKey: false, button: 0 };
        editor.documentHelper.onMouseDownInternal(event);
        event = { offsetX: 766, offsetY: 145, preventDefault: function () { }, ctrlKey: false };
        editor.documentHelper.onMouseMoveInternal(event);
        editor.documentHelper.onMouseUpInternal(event);
        event = { offsetX: 776, offsetY: 145, preventDefault: function () { }, ctrlKey: false, button: 0 };
        editor.documentHelper.onMouseDownInternal(event);
        editor.editorHistory.undo();
        editor.editorHistory.redo();
    });
