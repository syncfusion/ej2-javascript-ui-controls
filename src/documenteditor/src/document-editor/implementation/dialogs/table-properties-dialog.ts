...
export class TablePropertiesDialog {
    ...
    public onTableWidthTypeChange(): void {
        ...
        if (this.tableWidthType.value === 'Percent' && this.documentHelper.selection.tableFormat.preferredWidthType !== 'Percent') {
            ...
            this.formatNumericTextBox(this.tableWidthBox, (this.tableWidthType.value === 'Points') ? 'Point' : this.tableWidthType.value as WidthType, value);
        }

        this.tableFormat.preferredWidthType = (this.tableWidthType.value === 'Points') ? 'Point' : this.tableWidthType.value as WidthType;
    }
    /**
     * @private
     * @returns {void}
    ...
    public onCellWidthTypeChange(): void {
        ...
        if (this.cellWidthType.value === 'Percent' && this.documentHelper.selection.cellFormat.preferredWidthType !== 'Percent') {
            ...
            this.formatNumericTextBox(this.cellWidthBox, (this.cellWidthType.value === 'Points') ? 'Point' : this.cellWidthType.value as WidthType, value);
        }
        this.cellFormat.preferredWidthType = (this.cellWidthType.value === 'Points') ? 'Point' : this.cellWidthType.value as WidthType;
    }
    /**
     * @private
     * @param {Event} event - Specified the event
