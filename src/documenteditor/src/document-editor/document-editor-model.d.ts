...
export interface DocumentEditorSettingsModel {
     ...
     *
     */
    defaultCheckBoxOption?: CheckboxSymbolOptions;
...
/**
 * Interface for a class RevisionSettings
 */
export interface RevisionSettingsModel {
...
export interface DocumentEditorModel extends ComponentModel{
     ...
     */
    unsupportedBorderStyleClick?: EmitType<UnsupportedBorderStyleClickEventArgs>;
