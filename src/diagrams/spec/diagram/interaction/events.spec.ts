...
import { DiagramTools, ConnectorConstraints, PortConstraints, DiagramConstraints, NodeConstraints } from '../../../src/diagram/enum/enum';
...
describe('Code coverage test cases', () => {
    let diagram: Diagram;
    let ele: HTMLElement;
    let mouseEvents: MouseEvents = new MouseEvents();
    beforeAll((): void => {
        ...
        let nodes: NodeModel[] = [
            ...
            {id:'ch1',width:50,offsetX: 100, offsetY: 300,tooltip:{content:'ch1Tooltip'},
            constraints:NodeConstraints.Default|NodeConstraints.Tooltip},
            {id:'ch2',width:50,offsetX: 200, offsetY: 200,tooltip:{content:'ch2Tooltip'},
            constraints:NodeConstraints.Default|NodeConstraints.Tooltip},
            {id:'group',children:['ch1','ch2'],}
        ]
    
 diagram = new Diagram({
    width: '1000px', height: 700, nodes: nodes,
...
diagram.appendTo('#diagram46');
    ...
    it('Mouse events code coverage', (done: Function) => {
        let diagramCanvas: HTMLElement = document.getElementById(diagram.element.id + 'content');
        ...
        mouseEvents.mouseMoveEvent(diagramCanvas,550,150);
        mouseEvents.mouseUpEvent(diagramCanvas, 550, 150);
        mouseEvents.dblclickEvent(diagramCanvas, 550, 150);
        mouseEvents.mouseMoveEvent(diagramCanvas,200,200);
