...
describe('Diagram Control', () => {
    ...
    describe('Simple canvas panel without children', () => {
        ...
        beforeAll((): void => {
            ...
            diagram = new Diagram({ width: 1000, height: 600, basicElements: [container] } as DiagramModel);
    ...
    describe('Simple container with two child', () => {
        ...
        beforeAll((): void => {
            ...
            diagram = new Diagram({ width: 600, height: 300, basicElements: [container] } as DiagramModel);
    ...
    describe('Simple container with rotateangle', () => {
        ...
        beforeAll((): void => {
            ...
            element1.style = { fill: 'yellow' };
            container.children = [element, element1];
            diagram = new Diagram({ width: 1000, height: 700, basicElements: [container] } as DiagramModel);
    ...
    describe('Simple container with rotateangle and rotatedchild', () => {
        ...
        beforeAll((): void => {
            ...
            element1.style = { fill: 'yellow' };
            container.children = [element, element1];
            diagram = new Diagram({ width: '600px', height: '500px', basicElements: [container] } as DiagramModel);
