...
let node11: NodeModel = { id: 'node11', width: 100, height: 100, offsetX: 100, offsetY: 500, shape: shape11 };
let shape12: BasicShapeModel = { type: 'Basic', shape: 'Decagon' };
let node12: NodeModel = { id: 'node12', width: 100, height: 100, offsetX: 300, offsetY: 500, shape: shape12 };
let shape13: BasicShapeModel = { type: 'Basic', shape: 'RightTriangle' };
let node13: NodeModel = { id: 'node13', width: 100, height: 100, offsetX: 600, offsetY: 500, shape: shape13 };
let shape14: BasicShapeModel = { type: 'Basic', shape: 'Cylinder' };
let node14: NodeModel = { id: 'node14', width: 100, height: 100, offsetX: 900, offsetY: 500, shape: shape14 };
let shape15: BasicShapeModel = { type: 'Basic', shape: 'Diamond' };
let node15: NodeModel = { id: 'node15', width: 100, height: 100, offsetX: 1200, offsetY: 500, shape: shape15 };
