 ...
 * area series
 */
import { Chart, SplineSeries, Tooltip, DateTime, Crosshair, Legend } from '../../../../src/chart/index';
import '../../../../node_modules/es6-promise/dist/es6-promise';
Chart.Inject(SplineSeries, DateTime, Tooltip, Crosshair, Legend);
...
let chart: Chart = new Chart({
        ...
        series: [
            ...
            },
            {
                ...
                marker: { visible: true },
                type: 'Spline', width: 2,
                yName: 'y1', animation: { enable: false }
            },
            {
                dataSource: trackData, name: 'Thomas', xName: 'x',
                marker: { visible: true },
                type: 'Spline', width: 2,
                yName: 'y2', animation: { enable: false }
            },
            {
                dataSource: trackData, name: 'Mark', xName: 'x',
                marker: { visible: true },
                type: 'Spline', width: 2,
                yName: 'y3', animation: { enable: false }
            },
            {
                dataSource: trackData, name: 'William', xName: 'x',
                marker: { visible: true },
                type: 'Spline', width: 2,
                yName: 'y4', animation: { enable: false }
            }
        ],
        // trackball for chart
