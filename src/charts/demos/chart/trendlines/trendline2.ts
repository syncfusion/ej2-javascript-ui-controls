    ...
    series: [
        {
            ...
            trendlines: [{ type: 'MovingAverage', enableTooltip: true, animation: { enable: false}, marker: { visible: true } }]
        },
        {
            dataSource: series2, xName: 'x', yName: 'y', name: 'BackwardForecast 5', type: 'Line', animation: { enable: false},
            trendlines: [{ type: 'MovingAverage', marker: { visible: true }, animation: { enable: false}, backwardForecast: 5 }]
        },
        {
...
let power: Chart = new Chart({
    ...
    series: [
        {
            dataSource: series1, xName: 'x', yName: 'y', name: 'Default', type: 'Scatter', animation: { enable: false},
            trendlines: [{ type: 'Power', enableTooltip: true,  animation: { enable: false}, marker: { visible: true } }]
        },
        {
            dataSource: series2, xName: 'x', yName: 'y', name: 'BackwardForecast 5', type: 'Line', animation: { enable: false},
            trendlines: [{ type: 'Power', marker: { visible: true }, animation: { enable: false}, backwardForecast: 5 }]
        },
        {
            dataSource: series3, xName: 'x', yName: 'y', name: 'ForwardwardForecast 10', type: 'Scatter', animation: { enable: false},
            trendlines: [{ type: 'Power', marker: { visible: true }, animation: { enable: false}, backwardForecast: 5 }]
