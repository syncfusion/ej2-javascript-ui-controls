    ...
    describe('Polynomial Trendlines', () => {
        ...
        it('Polynomial Trendlines with tooltip', (done: Function) => {
            loaded = (args: Object): void => {
                ...
                expect(tooltip.childNodes[0].childNodes[0].childNodes[1].textContent.replace(/\u200E/g, '')).toEqual('Polynomial1978 : 7.019');
            ...
            chartObj = new Chart(
                {
                    ...
                    series: [{
                        ...
                        name: 'Polynomial_trend', fill: 'red', enableTooltip: true, marker: { visible: true } }],
                    }],
                    title: 'Online trading'
                });
            chartObj.appendTo('#container');
