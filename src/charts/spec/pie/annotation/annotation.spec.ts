...
describe('Accumumation Control', () => {
    ...
    describe('Annotation for Chart', () => {
        ...
        it('Checking annotaiton in series region', (done: Function) => {
            const template1: Element = getElement('template1');
            template1.innerHTML = '<div>${chart.title}</div>';
            chartObj.loaded = (args: Object): void => {
                element = getElement('container_Secondary_Element');
                expect(element.children[0].childElementCount).toBe(2);
                element = getElement('container_Annotation_0');
                expect((element as HTMLElement).style.left == '715px' || ((element as HTMLElement) as HTMLElement).style.left == '339px'
                    || (element as HTMLElement).style.left == '329px' || ((element as HTMLElement) as HTMLElement).style.left == '320px' || (element as HTMLElement).style.left == '56px').toBe(true);
                expect((element as HTMLElement).style.top == '218px' || (element as HTMLElement).style.top == '217px' || (element as HTMLElement).style.top == '160.25px').toBe(true);
                ...
                expect((element as HTMLElement).style.left == '690.888px' || (element as HTMLElement).style.left == '314.891px'
                    || (element as HTMLElement).style.left == '304.891px' || (element as HTMLElement).style.left == '295.891px' || (element as HTMLElement).style.left == '31.8906px').toBe(true);
                expect((element as HTMLElement).style.top == '226px' || (element as HTMLElement).style.top == '225px' || (element as HTMLElement).style.top == '168.25px').toBe(true);
                done();
            };
            chartObj.annotations[0].region = 'Series';
            chartObj.refresh();
        ...
        it('Checking annotaiton in point units', (done: Function) => {
            ...
            chartObj.loaded = (args: Object): void => {
                element = getElement('container_Annotation_0');
                expect((element as HTMLElement).style.left == '34.0572px' || (element as HTMLElement).style.left == '722.281px' || (element as HTMLElement).style.left == '346.317px'
                || (element as HTMLElement).style.left == '336.317px' || (element as HTMLElement).style.left == '58.1666px' || (element as HTMLElement).style.left == '327.317px').toBe(true);
                expect((element as HTMLElement).style.top == '143.946px' || (element as HTMLElement).style.top == '136.324px' || (element as HTMLElement).style.top == '134.925px').toBe(true);
                element = getElement('container_Annotation_1');
                expect((element as HTMLElement).style.top == '34.0572px' || (element as HTMLElement).style.left == '698.169px' || (element as HTMLElement).style.left == '322.207px'
                || (element as HTMLElement).style.left == '312.207px' || (element as HTMLElement).style.left == '303.207px').toBe(true);
                expect((element as HTMLElement).style.top == '143.946px' || (element as HTMLElement).style.top == '144.324px' || (element as HTMLElement).style.top == '142.925px').toBe(true);
                done();
            };
            chartObj.annotations[0].coordinateUnits = 'Point';
        ...
        it('Checking annotaiton in point units with yAxis out of x axis label', (done: Function) => {
            ...
            chartObj.loaded = (args: Object): void => {
                ...
                expect(element).toBe(null);
                element = getElement('container_Annotation_1');
                expect((element as HTMLElement).style.left == '34.0572px' || (element as HTMLElement).style.left == '698.169px' || (element as HTMLElement).style.left == '322.207px'
                || (element as HTMLElement).style.left == '312.207px' || (element as HTMLElement).style.left == '303.207px').toBe(true);
                expect((element as HTMLElement).style.top == '143.946px' || (element as HTMLElement).style.top == '144.324px' || (element as HTMLElement).style.top == '142.925px').toBe(true);
                done();
            };
