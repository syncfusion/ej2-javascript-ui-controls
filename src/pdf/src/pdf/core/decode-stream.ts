...
/**
 * Decode stream wrapper that incrementally decodes compressed data from an underlying stream.
 *
 * @private
 */
export class _PdfDecodeStream extends _PdfBaseStream {
    ...
    /**
     * Internal minimum buffer length requested for decoding operations.
     *
     * @private
     */
