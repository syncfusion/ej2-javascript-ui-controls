...
export class PdfAppearance {
    /**
     * Holds the annotation associated with this appearance.
     *
     * @private
     */
    _annotations: PdfAnnotation;
    /**
     * Defines the bounding rectangle of the appearance.
     *
     * @private
     */
    _bounds: Rectangle;
    /**
     * Indicates whether the normal appearance key is used.
     *
     * @private
     */
    ...
    /**
     * Initializes the appearance template for the annotation using its bounds and cross reference.
     *
     * @private
