 ...
 * Grid Column spec
 */
TreeGrid.Inject(ColumnChooser, Filter, Toolbar);
...
describe('Stacked Header', () => {
    ...
    it('column Checking after stacked header added dynamically', () => {
        ...
        const cols: ColumnModel = {headerText: 'Price Details', columns: [{ field: 'unitPrice' }, { field: 'price'}]};
...
describe('Columns refresh issue with getColumnByUid method - EJ2-51804', () => {
    ...
    it('column width checking ', () => {
        ...
        gridObj.grid.actionComplete = actionComplete;
        const column: any = gridObj.getColumnByUid('taskName');
        column.width = 500;
        gridObj.refreshColumns();
    });
    afterAll(() => {
