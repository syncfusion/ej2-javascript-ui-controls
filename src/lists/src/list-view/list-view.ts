...
export class ListView extends Component<HTMLElement> implements INotifyPropertyChanged {
    ...
    private header(text?: string, showBack?: boolean, prop?: string): void {
        if (this.headerEle === undefined && this.showHeader) {
            ...
            const curOpt: ListBaseOptions = this.listBaseOption || {
            ...
            (innerHeaderEle as any)[ListBase.getDomSetter(curOpt)] = ListBase.getSanitizedText(this.headerTitle, curOpt);
            ...
            if (this.showHeader) {
                ...
                const curOpt: ListBaseOptions = this.listBaseOption || {
                    enableHtmlSanitizer: this.enableHtmlSanitizer, disableHtmlEncode: this.disableHtmlEncode };
                (textEle as any)[ListBase.getDomSetter(curOpt)] = ListBase.getSanitizedText(text, curOpt);
