        ...
        var dropDown = new DropDownButton({
            ...
            beforeOpen: function (args) {
                ...
                if (Browser.isDevice && !args.element.parentElement.classList.contains(CLS_QUICK_DROPDOWN)) {
                    var popupInst = getInstance(args.element.parentElement, Popup);
                    popupInst.relateTo = document.body;
                    popupInst.position = { X: 0, Y: 0 };
                    popupInst.targetType = 'container';
                    popupInst.collision = { X: 'none', Y: 'none' };
                    popupInst.offsetY = 4;
                    _this.setIsModel(args.element.parentElement);
                }
            },
        ...
        var dropDown = new DropDownButton({
            ...
            beforeOpen: function (dropDownArgs) {
                ...
                if (dropDownArgs.event && dropDownArgs.event.type === 'click' && (element.classList.contains(CLS_COLOR_CONTENT)
                    ...
                    if (Browser.isDevice) {
                        var popupInst = getInstance(dropDownArgs.element.parentElement, Popup);
                        popupInst.relateTo = document.body;
                        popupInst.position = { X: 0, Y: 0 };
                        popupInst.targetType = 'container';
                        popupInst.collision = { X: 'fit', Y: 'fit' };
                        popupInst.offsetY = 4;
                        _this.setIsModel(dropDownArgs.element.parentElement);
                    }
                    var ele = dropDownArgs.element.querySelector('.e-control.e-colorpicker');
...
var DropDownButtons = /** @__PURE__ @class */ (function () {
    ...
    DropDownButtons.prototype.beforeRender = function (args) {
        var item = args.item;
        if (item.class) {
            addClass([args.element], item.class);
        }
                ...
                switch (item) {
                    ...
                    case 'fontsize':
                        ...
                        _this.fontSizeDropDown = _this.toolbarRenderer.renderDropDownButton({
                            content: _this.dropdownContent(_this.parent.fontSize.width, type, getFormattedFontSize(getDropDownValue(fontsize, _this.parent.fontSize.default, 'text', 'value'))),
...
var Toolbar$1 = /** @__PURE__ @class */ (function () {
    ...
    Toolbar$$1.prototype.updateItem = function (args) {
        var item = tools[args.updateItem.toLocaleLowerCase()];
        var trgItem = tools[args.targetItem.toLocaleLowerCase()];
    ...
    Toolbar$$1.prototype.enableTBarItems = function (baseToolbar, items, isEnable) {
    ...
    Toolbar$$1.prototype.removeTBarItems = function (items) {
        ...
        this.tbItems = selectAll('.' + CLS_TB_ITEM, this.parent.element);
        for (var i = 0; i < trgItems.length; i++) {
...
var Count = /** @__PURE__ @class */ (function () {
    ...
    Count.prototype.appendCount = function () {
        var htmlText = this.editPanel.textContent.trim();
    ...
    Lists.prototype.keyDownHandler = function (e) {
        if (e.event.which === 9) {
            ...
            for (var i = 0; i < blockNodes.length; i++) {
                ...
                else if (blockNodes[i].parentNode.tagName === 'LI') {
        ...
        for (var i = 0; i < elements.length; i++) {
            ...
            if (prevSibling) {
                ...
                if (firstNode) {
                    ...
                    siblingList = prevSibling.querySelectorAll('ul, ol');
                    firstNode = siblingList[0];
                    if (firstNode) {
                        append([elements[i]], firstNode);
                    }
                    else {
...
var TableCommand = /** @__PURE__ @class */ (function () {
    ...
    TableCommand.prototype.insertRow = function (e) {
        ...
        var newRow = closest(selectedCell, 'tr').cloneNode(true);
    ...
    TableCommand.prototype.tableHeader = function (e) {
        ...
        if (table && 0 === table.querySelectorAll('thead').length) {
            var cellCount = table.querySelectorAll('tr:first-child td').length;
...
var HtmlEditor = /** @__PURE__ @class */ (function () {
    ...
    HtmlEditor.prototype.selectAll = function () {
        this.parent.formatter.editorManager.nodeSelection.setSelectionText(this.parent.contentModule.getDocument(), this.parent.contentModule.getEditPanel(), this.parent.contentModule.getEditPanel(), 0, this.parent.contentModule.getEditPanel().childNodes.length);
    };
    /**
     * For selecting all content in RTE
     * @private
...
var Image = /** @__PURE__ @class */ (function () {
    ...
    Image.prototype.undoStack = function (args) {
        if (args.subCommand.toLowerCase() === 'undo' || args.subCommand.toLowerCase() === 'redo') {
            for (var i = 0; i < this.parent.formatter.getUndoRedoStack().length; i++) {
                ...
                var contentElem = document.createRange().createContextualFragment(this.parent.formatter.getUndoRedoStack()[i].text);
    ...
    Image.prototype.insertAltText = function (e) {
        ...
        if (!isNullOrUndefined(this.dialogObj)) {
            ...
            var altArgs_1 = { selfImage: this, selection: e.selection, selectNode: e.selectNode, alt: inputAlt };
            this.dialogObj.setProperties({
    ...
    Image.prototype.imageSize = function (e) {
        ...
        if (!isNullOrUndefined(this.dialogObj)) {
            ...
            var selectObj = { selfImage: this, selection: e.selection, selectNode: e.selectNode };
            this.dialogObj.setProperties({
    ...
    Image.prototype.imagDialog = function (e) {
        ...
        var selection = e.selection;
        var selectObj = { selfImage: this, selection: e.selection, args: e.args };
        this.dialogObj = new Dialog({
            header: imgHeader,
            cssClass: CLS_RTE_ELEMENTS,
            enableRtl: this.parent.enableRtl,
...
var Table = /** @__PURE__ @class */ (function () {
    ...
    Table.prototype.createDialog = function (args) {
        ...
        var tableDialog = this.parent.createElement('div', { className: 'e-rte-edit-table', id: this.rteID + '_image' });
...
function setAttributes(htmlAttributes, rte, isFrame) {
    var target;
    if (isFrame) {
        ...
        for (var _i = 0, _a = Object.keys(newProp); _i < _a.length; _i++) {
            ...
            switch (prop) {
                ...
                case 'locale':
                    ...
                    break;
                case 'inlineMode':
                    this.notify(modelChanged, { module: 'quickToolbar' });
                    this.setContentHeight();
                    break;
                case 'toolbarSettings':
                    this.notify(modelChanged, { module: 'toolbar' });
                    this.setContentHeight();
                    break;
                case 'showCharCount':
    ...
    RichTextEditor.prototype.updateReadOnly = function () {
        if (this.editorMode !== 'Markdown') {
            if (this.readonly) {
                ...
                addClass([this.element], CLS_RTE_READONLY);
            }
            else {
