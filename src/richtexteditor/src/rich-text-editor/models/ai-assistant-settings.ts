...
import { IAIAssistantToolbarItem, AICommands } from '../base/interface';
import { DEFAULT_AI_COMMANDS } from './items';
import { AssistantPromptToolbarItems, AssistantResponseToolbarItems, AssitantHeaderToolbarItems } from '../base/types';
 ...
 */
export class AIAssistantSettings extends ChildProperty<AIAssistantSettings> {
    /**
     ...
     */
    @Property('400px')
    public popupMaxHeight: string | number;
    ...
    public headerToolbarSettings: (AssitantHeaderToolbarItems | IAIAssistantToolbarItem)[];
     ...
     */
    @Property(['Edit', 'Copy'])
    public promptToolbarSettings: (AssistantPromptToolbarItems | IAIAssistantToolbarItem)[];
    ...
    public responseToolbarSettings: (AssistantResponseToolbarItems | IAIAssistantToolbarItem)[];
     ...
     */
    @Property(20)
    public maxPromptHistory: number;
