...
xdescribe('DropDownTree control remote datasource', () => {
    ...
    describe('Pre-selected Value', function () {
        let ddtreeObj: any;
        let ele: HTMLElement = createElement('input', { id: 'tree1' });
        ...
        it('Testing with pre-selected value in remote-data', function () {
            expect(ddtreeObj.inputEle.value).toBe('Vins et alcools Chevalier');
        });
    });
});
