...
let listObj: MultiSelect = new MultiSelect({ dataSource: datasource, mode: 'Default', popupHeight: 200, value: ['JAVA', 'C#', 'C++'] });
listObj.appendTo(<HTMLElement>document.querySelector("#component"));
let listObj1: MultiSelect = new MultiSelect({ closePopupOnSelect: true, dataSource: datasource, mode: 'Box', value: ['JAVA', 'C#', '.NET'] });
