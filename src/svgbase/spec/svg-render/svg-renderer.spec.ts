...
describe('SVG Rendering', () => {
    ...
    describe('Text', () => {
        ...
        it('Content of the text element test', function (): void {
            ...
            let element: Element = this.render.createText(options, null, 5, 5, null, true);
    ...
    describe('DrawCircularClipPath', () => {
        ...
        it('PathAttributes method test', function (): void {
            let options: PathAttributes = {
                'cx': 10,
                'cy': 10,
                'd': 'M 0 4 Q 0 0 4 0  L 96 0 Q 100 0 100 4 L 100 28 Q 100 32 96 32 L 57 32 L 50 39 L 43 32 L 4 32 Q 0 32 0 28 z'
            };
            let element: Element = this.render.createCanvas(options);
            expect(true).toBe(true);
        });
        it('PathAttributes method test', function (): void {
            ...
            let element: Element = this.render.createText(options, 'Label', 20, 15);
            expect(true).toBe(true);
        });
        it('calling method test', function (): void {
            let options: PathAttributes = {
                'cx': 10,
                'cy': 10,
                'd': 'M 0 4 Q 0 0 4 0  L 96 0 Q 100 0 100 4 L 100 28 Q 100 32 96 32 L 57 32 L 50 39 L 43 32 L 4 32 Q 0 32 0 28 z'
            ...
            let element1 = render.drawClipPath();
            let element2 = render.drawCircularClipPath();
            let element5 = render.drawPolygon();
            let element6 = render.createDefs();
            let element7 = render.createClipPath();
            let element8 = render.createSvg();
            expect(true).toBe(true);
        });
    });
});
