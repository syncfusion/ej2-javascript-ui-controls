                    ...
                    for (let i: number = 0; i < shapeAnnotations.length; i++) {
                        ...
                        if (annotation.ShapeAnnotationType) {
                            ...
                            if (nameTableAnnot && nameTableAnnot.wrapper && nameTableAnnot.wrapper.bounds &&
                                (annot.shapeAnnotationType === 'Line' || annot.shapeAnnotationType === 'Polygon' ||
                                    annot.shapeAnnotationType === 'LineWidthArrowHead')) {
                    ...
                    if (property === 'bounds') {
                        ...
                        if (this.pdfViewerBase.isBounds) {
                            if (pageAnnotations[parseInt(i.toString(), 10)].shapeAnnotationType === 'Line') {
                                ...
                                pageAnnotations[parseInt(i.toString(), 10)].vertexPoints = annotationBase.vertexPoints;
                                pageAnnotations[parseInt(i.toString(), 10)].bounds = {
                                    left: annotationBase.wrapper.bounds.x,
                                    top: annotationBase.wrapper.bounds.y, width: annotationBase.wrapper.bounds.width,
                                    height: annotationBase.wrapper.bounds.height, right: annotationBase.wrapper.bounds.right,
                                    bottom: annotationBase.wrapper.bounds.bottom
                                };
                            } else {
