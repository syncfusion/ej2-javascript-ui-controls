...
export class StickyNotesAnnotation {
    ...
    private setAnnotationType(id: string, type: string, pageNumber: number): void {
        ...
        let storeCommentObject: string = window.sessionStorage.getItem(this.pdfViewerBase.documentId + '_annotations_' + typeString);
    ...
    private getAnnotations(pageIndex: number, shapeAnnotations: any[], type: string): any[] {
        ...
        let storeObject: string = window.sessionStorage.getItem(this.pdfViewerBase.documentId + '_annotations_' + type);
        if (this.pdfViewerBase.isStorageExceed) {
    ...
    public updateStickyNotes(annotation: any, id: any): void {
        let storeObject: string = window.sessionStorage.getItem(this.pdfViewerBase.documentId + '_annotations_sticky');
        if (this.pdfViewerBase.isStorageExceed) {
