    ...
    describe('methods testing', () => {
        ...
        it('for selectAll', (done) => {
            ...
            setTimeout(function () {
                ...
                expect(document.getElementById('file1_largeicons').querySelectorAll('.e-large-icon').length).toEqual(5);
                expect(feObj.selectedItems.length).toEqual(0);
                feObj.selectAll();
                expect(document.getElementById('file1_largeicons').querySelectorAll('.e-large-icon.e-active').length).toEqual(1);
                expect(document.getElementById('file1_largeicons').querySelectorAll('.e-large-icon')[4].classList.contains('e-active')).toBe(true);
                expect(feObj.selectedItems.length).toEqual(1);
                action = 'unselect';
                feObj.clearSelection();
                expect(feObj.selectedItems.length).toEqual(0);
                expect(document.getElementById('file1_largeicons').querySelectorAll('.e-large-icon.e-active').length).toEqual(0);
                expect(i).toEqual(2);
                done();
            }, 500);
        });
