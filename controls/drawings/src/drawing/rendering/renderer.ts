...
export class DrawingRenderer {
    ...
    public renderElement(
        ...
        parentSvg?: SVGSVGElement, createParent?: boolean, fromPalette?: boolean, indexValue?: number, annotationCallback?:(annotationID: string) => boolean, annotationType?: string):
        void {
    ...
    public renderImageElement(
        ...
        transform?: Transforms, parentSvg?: SVGSVGElement, fromPalette?: boolean, annotationCallback?:(annotationID: string) => boolean, annotationType?: string):
        void {
        ...
        this.renderer.drawImage(canvas as HTMLCanvasElement, options as ImageAttributes, parentSvg, fromPalette, annotationCallback, annotationType);
    }
    ...
    public renderTextElement(
        ...
        if(element.isEJ2 === true) {
            ...
            if (this.isFreeTextAnnotation) {
                this.renderer.drawFreeTextBlazor(canvas as HTMLCanvasElement, options as TextAttributes, this.freeTextMaxHeight, this.isFreeTextAnnotation, this.zoomFactor);
            }
            else if ((options as TextAttributes).isShapeLabel) {
                this.renderer.drawTextBlazor(canvas as HTMLCanvasElement, options as TextAttributes, this.freeTextMaxHeight, this.isFreeTextAnnotation, this.zoomFactor);
            }
            else {
    ...
    public renderContainer(
        ...
        transform?: Transforms, parentSvg?: SVGSVGElement, createParent?: boolean, fromPalette?: boolean, indexValue?: number, annotationCallback?:(annotationID: string) => boolean, annotationType?: string):
        void {
