window.sf = window.sf || {};
var sflineargauge = (function (exports) {
'use strict';
...
var Annotation = /** @class */ (function (_super) {
    ...
    __decorate$1([
        sf.base.Complex({ size: '12px', color: null }, Font)
...
var Container = /** @class */ (function (_super) {
    ...
    __decorate$1([
        sf.base.Complex({ width: 1, color: '#bfbfbf' }, Border)
...
var TooltipSettings = /** @class */ (function (_super) {
    ...
    __decorate$1([
        sf.base.Complex({ color: '', size: '13px' }, Font)
...
var Pointer = /** @class */ (function (_super) {
    ...
    __decorate$2([
        sf.base.Property('InvertedTriangle')
    ], Pointer.prototype, "markerType", void 0);
    __decorate$2([
        sf.base.Property(null)
    ], Pointer.prototype, "imageUrl", void 0);
    __decorate$2([
        sf.base.Complex({ color: '#808080' }, Border)
...
var Axis = /** @class */ (function (_super) {
    ...
    __decorate$2([
        sf.base.Complex({ width: 2, height: 20 }, Tick)
    ], Axis.prototype, "majorTicks", void 0);
    __decorate$2([
        sf.base.Complex({ width: 1, height: 10 }, Tick)
...
function getPathToRect(path, size, parentElement) {
    ...
    if (tempDiv === null) {
        tempDiv = sf.base.createElement('text', { id: 'gauge_path' });
...
function calculateShapes(location, shape, size, url, options, orientation, axis, pointer) {
    ...
    switch (shape) {
        case 'Circle':
            ...
            sf.base.merge(options, { 'r': radius, 'cx': locX, 'cy': locY });
            break;
        case 'Diamond':
        case 'Rectangle':
        ...
        case 'InvertedArrow':
            ...
            break;
        case 'Image':
            sf.base.merge(options, { 'href': url, 'height': height, 'width': width, x: locX - (width / 2), y: locY - (height / 2) });
            break;
    }
    return options;
}
...
var AxisRenderer = /** @class */ (function (_super) {
    ...
    AxisRenderer.prototype.drawMarkerPointer = function (axis, axisIndex, pointer, pointerIndex, parentElement) {
        ...
        if (!sf.base.isNullOrUndefined(pointer.position) && (pointer.markerType === 'InvertedTriangle' ||
...
var AxisLayoutPanel = /** @class */ (function () {
    ...
    AxisLayoutPanel.prototype.calculateLineBounds = function (axis, axisIndex) {
        ...
        if (orientation === 'Vertical') {
            y = (sf.base.isNullOrUndefined(lineHeight)) ? containerRect.y :
            ...
            x = (sf.base.isNullOrUndefined(lineHeight)) ? containerRect.x :
    ...
    AxisLayoutPanel.prototype.calculateTickBounds = function (axis, axisIndex) {
        ...
        axis.majorInterval = sf.base.isNullOrUndefined(axis.majorInterval) ? calculateNiceInterval(min, max, size, this.gauge.orientation)
            : major.interval;
...
var Annotations = /** @class */ (function () {
    ...
    Annotations.prototype.renderAnnotationElements = function () {
        ...
        var annotationGroup = sf.base.createElement('div', { id: this.gauge.element.id + '_AnnotationsGroup' });
...
sfBlazor.loadDependencies(sfBlazor.dependencyJson.lineargauge, () => {
