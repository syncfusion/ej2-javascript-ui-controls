...
export const SHFIT_ENTERKEY_EVENT_INIT: KeyboardEventInit = {
    bubbles: true,
    key: "Enter",
    cancelable: true,
    view: window,
...
export const A_KEY_EVENT_INIT: EventInit = {
    bubbles: true,
    cancelable: true,
    view: window,
    key: "a",
...
export const PRINTSCREEN_KEY_EVENT_INIT: KeyboardEventInit = {
    bubbles: true,
    key: "PrintScreen",
    cancelable: true,
    view: window,
