...
describe('Table Module', () => {
    ...
    describe('948232 - Table module edge cases', () => {
        ...
        it('should test updateResizeIconPosition method with different conditions', () => {
            ...
            const tableBox = rteObj.contentModule.getPanel().querySelector('.e-table-box') as HTMLElement;
    ...
    describe('948232 - Table module with different browser environments', () => {
        ...
        it('should test table functionality in Firefox browser', () => {
            ...
            (rteObj.tableModule as any).tableObj.resizeHelper({ target: table, preventDefault: function () { } });
            expect(rteObj.contentModule.getPanel().querySelectorAll('.e-column-resize').length).toBeGreaterThan(0);
            expect(rteObj.contentModule.getPanel().querySelectorAll('.e-row-resize').length).toBeGreaterThan(0);
            expect(rteObj.contentModule.getPanel().querySelector('.e-table-box')).not.toBeNull();
        });
