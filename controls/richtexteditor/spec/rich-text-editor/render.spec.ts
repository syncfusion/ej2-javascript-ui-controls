...
import { Link, Image, Audio, Video, Table, PasteCleanup, Count, Resize, FileManager } from "../../src/rich-text-editor/index";

RichTextEditor.Inject(HtmlEditor, MarkdownEditor, Toolbar, QuickToolbar, Link, Image, Audio, Video, Table, PasteCleanup, Count, Resize, FileManager);
