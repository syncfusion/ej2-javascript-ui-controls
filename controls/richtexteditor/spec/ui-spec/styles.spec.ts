...
describe('UI Spec ', () => {
    ...
    describe('878382: The Iframe editor cursor is not focused and the scroll is improper. ', () => {
        ...
        beforeAll(() => {
            editor = renderRTE({
                value: `<p><img alt="Logo" src="/base/spec/content/image/RTEImage-Feather.png" style="width: 300px;" class="e-rte-image e-img-inline"></p>`,
                iframeSettings: {
                    enable: true
                },
                saveInterval: 0,
    ...
    describe('921212: Image quick toolbar is misplaced for block display', () => {
        ...
        beforeAll(() => {
            editor = renderRTE({
                value: `<p><span class="e-img-caption-container e-img-break" contenteditable="false" draggable="false" style="width:auto"><span class="e-img-wrap"><img src="https://ej2.syncfusion.com/demos/src/rich-text-editor/images/RTEImage-Feather.png" alt="beach-1920x1080-high-definition-wallpaper-preview" width="730" height="412" style="min-width: 0px; max-width: 1456px; min-height: 0px;" class="e-rte-image"><span class="e-img-caption-text" contenteditable="true">Caption</span></span></span> </p>`
            });
        });
        afterAll(() => {
            destroy(editor);
    ...
    describe('872197 - Multiple anchor added to the image - ', () => {
        ...
        beforeAll(() => {
            rteObj = renderRTE({
                ...
                value: `<p><img src="https://ej2.syncfusion.com/javascript/demos/src/rich-text-editor/images/RTEImage-Feather.png" alt="googlelogo_color_272x92dp.png" width="auto" height="auto" style="min-width: 0px; min-height: 0px;" class="e-rte-image e-img-inline"> </p>`
            });
        })
        afterAll(() => {
            destroy(rteObj);
