                    ...
                    switch (key) {
                        case 'formats':
                            ...
                            dropDown.formatDropDown.content = ('<span style="display: inline-flex;' +
                                ...
                                + (sf.base.isNullOrUndefined(result) ? formatContent : result) +
                                '</span></span>');
                        ...
                        case 'alignments':
                            ...
                            dropDown.alignDropDown.iconCss = sf.base.isNullOrUndefined(result) ? 'e-icons e-justify-left' : result;
...
function updateUndoRedoStatus(baseToolbar, undoRedoStatus) {
    ...
    var tbItems = sf.base.selectAll('.' + CLS_TB_ITEM, baseToolbar.toolbarObj.element);
...
var ToolbarRenderer = /** @class */ (function () {
    ...
    ToolbarRenderer.prototype.unWireEvent = function () {
        ...
        if (this.popupOverlay) {
            sf.base.EventHandler.remove(this.popupOverlay, 'click touchmove', this.onPopupOverlay);
        }
    ...
    ToolbarRenderer.prototype.dropDownOpen = function (args) {
        if (sf.base.Browser.isDevice && !args.element.parentElement.classList.contains(CLS_QUICK_DROPDOWN)) {
    ...
    ToolbarRenderer.prototype.renderToolbar = function (args) {
        ...
        args.rteToolbarObj.toolbarObj = new sf.navigations.Toolbar({
            items: args.items,
            width: '100%',
    ...
    ToolbarRenderer.prototype.renderDropDownButton = function (args) {
        ...
        var proxy = this;
        var dropDown = new sf.splitbuttons.DropDownButton({
            items: args.items,
                ...
                for (var index = 0; index < args.element.childNodes.length; index++) {
                    ...
                    if (divNode.textContent.trim() !== ''
                        ...
                        if (!args.element.childNodes[index].classList.contains('e-active')) {
                            sf.base.addClass([args.element.childNodes[index]], 'e-active');
                        }
                    }
                    else {
                        sf.base.removeClass([args.element.childNodes[index]], 'e-active');
                    }
                }
    ...
    ToolbarRenderer.prototype.onPopupOverlay = function (args) {
        if (!sf.base.isNullOrUndefined(this.popupOverlay)) {
            sf.base.closest(this.popupOverlay, '.e-popup-container').style.display = 'none';
            this.popupOverlay.style.display = 'none';
            sf.base.removeClass([this.popupOverlay], 'e-popup-overlay');
        }
    };
    ToolbarRenderer.prototype.setIsModel = function (element) {
        if (!sf.base.closest(element, '.e-popup-container')) {
            ...
            sf.base.addClass([element], 'e-popup-modal');
            ...
            sf.base.EventHandler.add(this.popupOverlay, 'click touchmove', this.onPopupOverlay, this);
        }
        else {
            element.parentElement.style.display = 'flex';
            this.popupOverlay = element.nextElementSibling;
            this.popupOverlay.style.display = 'block';
            sf.base.addClass([this.popupOverlay], 'e-popup-overlay');
        }
    };
    ToolbarRenderer.prototype.paletteSelection = function (dropDownArgs, currentElement) {
        ...
        var colorbox = [].slice.call(sf.base.selectAll('.e-tile', ele.parentElement));
        sf.base.removeClass(colorbox, 'e-selected');
        ...
        (colorbox.filter(function (colorbox) {
            if (colorbox.style.backgroundColor === style) {
                sf.base.addClass([colorbox], 'e-selected');
            }
        }));
    };
    /**
    ...
    ToolbarRenderer.prototype.renderColorPickerDropDown = function (args, item, colorPicker) {
        ...
        var dropDown = new sf.splitbuttons.DropDownButton({
            ...
            beforeOpen: function (dropDownArgs) {
                ...
                if (dropDownArgs.event && dropDownArgs.event.type === 'click' && (element.classList.contains(CLS_COLOR_CONTENT)
                    ...
                    if ((range.startContainer.nodeName === 'TD' || range.startContainer.nodeName === 'TH' ||
                        (sf.base.closest(range.startContainer.parentNode, 'td,th')) ||
                    ...
                    var ele = dropDownArgs.element.querySelector('.e-control.e-colorpicker');
                    var inst = sf.base.getInstance(ele, sf.inputs.ColorPicker);
            ...
            close: function (dropDownArgs) {
                proxy.parent.notify(selectionRestore, {});
                var dropElement = sf.base.closest(dropDownArgs.element.parentElement, '.e-popup-container');
                if (dropElement) {
    ...
    ToolbarRenderer.prototype.pickerRefresh = function (dropDownArgs) {
        if (this.parent.backgroundColor.mode === 'Picker') {
            ...
            sf.base.getInstance(popupElem, sf.popups.Popup).refreshPosition(popupElem);
            popupElem.style.width = (popupElem.offsetWidth - 5).toString() + 'px';
        }
    };
    ToolbarRenderer.prototype.popupModal = function (element) {
        var popupInst = sf.base.getInstance(element, sf.popups.Popup);
    ...
    ToolbarRenderer.prototype.setColorPickerContentWidth = function (colorPicker) {
        ...
        if (colorPickerContent.style.width === '0px') {
            ...
            colorPickerContent.style.width = sf.base.formatUnit(colorPickerContent.children[0].offsetWidth
...
var BaseToolbar = /** @class */ (function () {
    function BaseToolbar(parent, serviceLocator) {
        ...
        if (this.parent.toolbarSettings && Object.keys(this.parent.toolbarSettings.itemConfigs).length > 0) {
            sf.base.extend(this.tools, tools, toObjectLowerCase(this.parent.toolbarSettings.itemConfigs), true);
        }
        else {
            this.tools = tools;
        }
    ...
    BaseToolbar.prototype.setRtl = function (args) {
        if (!sf.base.isNullOrUndefined(this.toolbarObj)) {
        ...
        var _loop_1 = function (item) {
            switch (typeof item) {
                case 'string':
                    ...
                    break;
                default:
                    if (!sf.base.isNullOrUndefined(item.click)) {
                        var proxy_1 = item;
    ...
    BaseToolbar.prototype.render = function (args) {
        this.toolbarRenderer = this.renderFactory.getRenderer(exports.RenderType.Toolbar);
...
var DropDownButtons = /** @class */ (function () {
    ...
    DropDownButtons.prototype.beforeRender = function (args) {
        var item = args.item;
        if (item.cssClass) {
            sf.base.addClass([args.element], item.cssClass);
        }
    ...
    DropDownButtons.prototype.renderDropDowns = function (args) {
        ...
        templateItems.forEach(function (item) {
            ...
            if (getIndex(item, args.items) !== -1) {
                switch (item) {
                    case 'formats':
                        targetElement = sf.base.select('#' + _this.parent.getID() + '_' + type + '_Formats', tbElement);
                        if (sf.base.isNullOrUndefined(targetElement) || targetElement.classList.contains(CLS_DROPDOWN_BTN)) {
                            return;
                        }
                        ...
                        var formatContent = sf.base.isNullOrUndefined(_this.parent.format.default) ? formatItem[0].text :
                        ...
                        break;
                    case 'fontname':
                        targetElement = sf.base.select('#' + _this.parent.getID() + '_' + type + '_FontName', tbElement);
                        if (sf.base.isNullOrUndefined(targetElement) || targetElement.classList.contains(CLS_DROPDOWN_BTN)) {
                            return;
                        }
                        ...
                        var fontNameContent = sf.base.isNullOrUndefined(_this.parent.fontFamily.default) ? fontItem[0].text :
                        ...
                        if (!sf.base.isNullOrUndefined(_this.parent.fontFamily.default)) {
                            _this.getEditNode().style.fontFamily = _this.parent.fontFamily.default;
                        }
                        break;
                    case 'fontsize':
                        targetElement = sf.base.select('#' + _this.parent.getID() + '_' + type + '_FontSize', tbElement);
                        if (sf.base.isNullOrUndefined(targetElement) || targetElement.classList.contains(CLS_DROPDOWN_BTN)) {
                            return;
                        }
                        ...
                        var fontSizeContent = sf.base.isNullOrUndefined(_this.parent.fontSize.default) ? fontsize[1].text :
                        ...
                        if (!sf.base.isNullOrUndefined(_this.parent.fontSize.default)) {
                            _this.getEditNode().style.fontSize = _this.parent.fontSize.default;
                        }
                        break;
                    case 'alignments':
                        targetElement = sf.base.select('#' + _this.parent.getID() + '_' + type + '_Alignments', tbElement);
                        if (sf.base.isNullOrUndefined(targetElement) || targetElement.classList.contains(CLS_DROPDOWN_BTN)) {
                            return;
                        }
                        ...
                        for (var _b = 0, _c = Object.keys(newProp.fontFamily); _b < _c.length; _b++) {
                            ...
                            switch (fontFamily) {
                                ...
                                case 'width':
                                    ...
                                    type = !sf.base.isNullOrUndefined(sf.base.closest(this.fontNameDropDown.element, '.' + CLS_QUICK_TB)) ?
                                        'quick' : 'toolbar';
                                    var fontNameContent = sf.base.isNullOrUndefined(this.parent.fontFamily.default) ? fontItems[0].text :
                        ...
                        for (var _d = 0, _e = Object.keys(newProp.fontSize); _d < _e.length; _d++) {
                            ...
                            switch (fontSize) {
                                ...
                                case 'width':
                                    ...
                                    type = !sf.base.isNullOrUndefined(sf.base.closest(this.fontSizeDropDown.element, '.' + CLS_QUICK_TB)) ? 'quick' : 'toolbar';
                                    var fontSizeContent = sf.base.isNullOrUndefined(this.parent.fontSize.default) ? fontsize[1].text :
                        ...
                        for (var _f = 0, _g = Object.keys(newProp.format); _f < _g.length; _f++) {
                            ...
                            switch (format) {
                                ...
                                case 'width':
                                    ...
                                    type = !sf.base.isNullOrUndefined(sf.base.closest(this.formatDropDown.element, '.' + CLS_QUICK_TB)) ? 'quick' : 'toolbar';
                                    var formatContent = sf.base.isNullOrUndefined(this.parent.format.default) ? formatItems[0].text :
    ...
    DropDownButtons.prototype.rowDropDown = function (type, tbElement, targetElement) {
        targetElement = sf.base.select('#' + this.parent.getID() + '_' + type + '_TableRows', tbElement);
    ...
    DropDownButtons.prototype.columnDropDown = function (type, tbElement, targetElement) {
        targetElement = sf.base.select('#' + this.parent.getID() + '_' + type + '_TableColumns', tbElement);
        if (targetElement.classList.contains(CLS_DROPDOWN_BTN)) {
            return;
        }
    ...
    DropDownButtons.prototype.verticalAlignDropDown = function (type, tbElement, targetElement) {
        targetElement = sf.base.select('#' + this.parent.getID() + '_' + type + '_TableCellVerticalAlign', tbElement);
        if (targetElement.classList.contains(CLS_DROPDOWN_BTN)) {
            return;
        }
    ...
    DropDownButtons.prototype.imageDisplayDropDown = function (type, tbElement, targetElement) {
        targetElement = sf.base.select('#' + this.parent.getID() + '_' + type + '_Display', tbElement);
        if (targetElement.classList.contains(CLS_DROPDOWN_BTN)) {
            return;
        }
    ...
    DropDownButtons.prototype.imageAlignmentDropDown = function (type, tbElement, targetElement) {
        targetElement = sf.base.select('#' + this.parent.getID() + '_' + type + '_Align', tbElement);
        if (targetElement.classList.contains(CLS_DROPDOWN_BTN)) {
            return;
        }
    ...
    DropDownButtons.prototype.tableStylesDropDown = function (type, tbElement, targetElement) {
        targetElement = sf.base.select('#' + this.parent.getID() + '_' + type + '_Styles', tbElement);
        if (targetElement.classList.contains(CLS_DROPDOWN_BTN)) {
            return;
        }
        this.imageAlignDropDown = this.toolbarRenderer.renderDropDownButton({
...
var RendererFactory = /** @class */ (function () {
    ...
    RendererFactory.prototype.addRenderer = function (name, type) {
        var rName = sf.base.getEnumValue(exports.RenderType, name);
...
var ToolbarAction = /** @class */ (function () {
    ...
    ToolbarAction.prototype.toolbarClick = function (args) {
        if (sf.base.isNullOrUndefined(args.item)) {
            return;
        }
        if (!sf.base.isNullOrUndefined(args.item.controlParent)) {
...
var Toolbar$1 = /** @class */ (function () {
    function Toolbar$$1(parent, serviceLocator) {
        ...
        this.renderFactory.addRenderer(exports.RenderType.Toolbar, new ToolbarRenderer(this.parent));
        this.toolbarRenderer = this.renderFactory.getRenderer(exports.RenderType.Toolbar);
    ...
    Toolbar$$1.prototype.initializeInstance = function () {
        this.contentRenderer = this.renderFactory.getRenderer(exports.RenderType.Content);
    ...
    Toolbar$$1.prototype.toolbarBindEvent = function () {
        if (!this.parent.inlineMode.enable) {
            this.keyBoardModule = new sf.base.KeyboardEvents(this.getToolbarElement(), {
    ...
    Toolbar$$1.prototype.getToolbarMode = function () {
        ...
        switch (this.parent.toolbarSettings.type) {
            case exports.ToolbarType.Expand:
                tbMode = 'Extended';
                break;
            case exports.ToolbarType.Scrollable:
                tbMode = 'Scrollable';
                break;
            default:
                tbMode = 'MultiRow';
        }
        if (isIDevice() && this.parent.toolbarSettings.type === exports.ToolbarType.Expand) {
            tbMode = exports.ToolbarType.Scrollable;
        }
        return tbMode;
    };
    Toolbar$$1.prototype.checkToolbarResponsive = function (ele) {
        ...
        var tBarMode;
        if (this.parent.toolbarSettings.type === exports.ToolbarType.Expand) {
            tBarMode = exports.ToolbarType.MultiRow;
        }
        else {
        ...
        if (this.parent.toolbarSettings.type === exports.ToolbarType.Expand) {
            sf.base.addClass([ele], ['e-rte-tb-mobile']);
            if (this.parent.inlineMode.enable) {
                this.addFixedTBarClass();
            }
            else {
                sf.base.addClass([ele], [CLS_TB_STATIC]);
            }
        }
        this.wireEvents();
    ...
    Toolbar$$1.prototype.renderToolbar = function () {
        ...
        if (this.parent.inlineMode.enable) {
            ...
            if (!this.parent.inlineMode.enable) {
                ...
                if (this.parent.toolbarSettings.type === exports.ToolbarType.Expand) {
                    sf.base.addClass([this.parent.element], [CLS_RTE_EXPAND_TB]);
                }
            }
        }
        this.wireEvents();
        ...
        if ((!this.parent.iframeSettings.enable && (!sf.base.isNullOrUndefined(divEle) && divEle.style.display === 'block')) ||
            (this.parent.iframeSettings.enable && (!sf.base.isNullOrUndefined(iframeEle) && iframeEle.style.display === 'block'))) {
    ...
    Toolbar$$1.prototype.addFixedTBarClass = function () {
        sf.base.addClass([this.tbElement], [CLS_TB_FIXED]);
    };
    /**
    ...
    Toolbar$$1.prototype.removeFixedTBarClass = function () {
        sf.base.removeClass([this.tbElement], [CLS_TB_FIXED]);
    };
    ...
    Toolbar$$1.prototype.updateToolbarStatus = function (args) {
        if (!this.tbElement || (this.parent.inlineMode.enable && (isIDevice() || !sf.base.Browser.isDevice))) {
            return;
        }
        var options = {
            args: args,
            ...
            parent: this.parent,
            tbElements: sf.base.selectAll('.' + CLS_TB_ITEM, this.tbElement),
    ...
    Toolbar$$1.prototype.enableTBarItems = function (baseToolbar, items, isEnable, muteToolbarUpdate) {
        ...
        this.tbItems = sf.base.selectAll('.' + CLS_TB_ITEM, baseToolbar.toolbarObj.element);
        ...
        if (!sf.base.select('.e-rte-srctextarea', this.parent.element) && !muteToolbarUpdate) {
    ...
    Toolbar$$1.prototype.removeTBarItems = function (items) {
        if (sf.base.isNullOrUndefined(this.baseToolbar.toolbarObj)) {
        ...
        this.tbItems = (this.parent.inlineMode.enable) ? sf.base.selectAll('.' + CLS_TB_ITEM, this.baseToolbar.toolbarObj.element)
            : sf.base.selectAll('.' + CLS_TB_ITEM, this.parent.element);
        for (var i = 0; i < trgItems.length; i++) {
    ...
    Toolbar$$1.prototype.getExpandTBarPopHeight = function () {
        var popHeight = 0;
        if (this.parent.toolbarSettings.type === exports.ToolbarType.Expand && this.tbElement.classList.contains('e-extended-toolbar')) {
            var expandPopup = sf.base.select('.e-toolbar-extended', this.tbElement);
            if (expandPopup && this.tbElement.classList.contains('e-expand-open')
                ...
                sf.base.removeClass([this.tbElement], [CLS_EXPAND_OPEN]);
            }
        }
        return popHeight;
    };
    ...
    Toolbar$$1.prototype.getToolbarElement = function () {
        return sf.base.select('.' + CLS_TOOLBAR, this.parent.element);
    };
    /**
    ...
    Toolbar$$1.prototype.destroyToolbar = function () {
        if (this.isToolbarDestroyed()) {
            ...
            sf.base.removeClass([this.parent.element], [CLS_RTE_EXPAND_TB]);
            var tbWrapper = sf.base.select('.' + CLS_TB_WRAP, this.parent.element);
            var tbElement = sf.base.select('.' + CLS_TOOLBAR, this.parent.element);
            if (!sf.base.isNullOrUndefined(tbWrapper)) {
                sf.base.detach(tbWrapper);
            }
            else if (!sf.base.isNullOrUndefined(tbElement)) {
                sf.base.detach(tbElement);
            }
        }
    };
    /**
    ...
    Toolbar$$1.prototype.tbFocusHandler = function (e) {
        ...
        var isToolbaractive = sf.base.closest(activeElm, '.e-rte-toolbar');
        if (activeElm === this.parent.getToolbarElement() || isToolbaractive === this.parent.getToolbarElement()) {
            ...
            for (var i = 0; i < toolbarItem.length; i++) {
                if (sf.base.isNullOrUndefined(this.parent.getToolbarElement().querySelector('.e-insert-table-btn'))) {
    ...
    Toolbar$$1.prototype.toolbarMouseDownHandler = function (e) {
        var trg = sf.base.closest(e.target, '.e-hor-nav');
        if (trg && this.parent.toolbarSettings.type === exports.ToolbarType.Expand && !sf.base.isNullOrUndefined(trg)) {
            if (!trg.classList.contains('e-nav-active')) {
                sf.base.removeClass([this.tbElement], [CLS_EXPAND_OPEN]);
                this.parent.setContentHeight('toolbar', false);
            }
            else {
                sf.base.addClass([this.tbElement], [CLS_EXPAND_OPEN]);
                this.parent.setContentHeight('toolbar', true);
            }
        }
        else if (sf.base.Browser.isDevice || this.parent.inlineMode.enable) {
            this.isToolbar = true;
        }
        if (sf.base.isNullOrUndefined(trg) && this.parent.toolbarSettings.type === exports.ToolbarType.Expand) {
            sf.base.removeClass([this.tbElement], [CLS_EXPAND_OPEN]);
        }
    };
    Toolbar$$1.prototype.wireEvents = function () {
        ...
        sf.base.EventHandler.add(this.tbElement, 'click mousedown', this.toolbarMouseDownHandler, this);
    ...
    Toolbar$$1.prototype.unWireEvents = function () {
        sf.base.EventHandler.remove(this.tbElement, 'click mousedown', this.toolbarMouseDownHandler);
    ...
    Toolbar$$1.prototype.onPropertyChanged = function (e) {
        if (!sf.base.isNullOrUndefined(e.newProp.inlineMode)) {
    ...
    Toolbar$$1.prototype.refreshToolbar = function () {
        ...
        if (this.parent.toolbarSettings.enable) {
            ...
            if (!sf.base.select('.e-rte-srctextarea', this.parent.element)) {
                ...
                switch (item) {
                    case 'fontcolor':
                        ...
                        options = {
                            ...
                            element: sf.base.select('#' + _this.parent.getID() + '_' + suffixID + '_FontColor', tbElement),
                            target: ('#' + targetID)
                        };
                    ...
                    case 'backgroundcolor':
                        ...
                        options = {
                            ...
                            command: _this.tools[item.toLocaleLowerCase()].command,
                            subCommand: _this.tools[item.toLocaleLowerCase()].subCommand,
                            element: sf.base.select('#' + _this.parent.getID() + '_' + suffixID + '_BackgroundColor', tbElement),
                            target: ('#' + targetID)
                        };
...
var BaseQuickToolbar = /** @class */ (function () {
    function BaseQuickToolbar(parent, locator) {
        ...
        this.renderFactory = this.locator.getService('rendererFactory');
        this.contentRenderer = this.renderFactory.getRenderer(exports.RenderType.Content);
        this.popupRenderer = this.renderFactory.getRenderer(exports.RenderType.Popup);
    ...
    BaseQuickToolbar.prototype.render = function (args) {
        ...
        var popupId = sf.base.getUniqueID(args.popupType + '_Quick_Popup');
    ...
    BaseQuickToolbar.prototype.setPosition = function (e) {
        var x;
        var y;
        var imgWrapper = sf.base.closest(e.target, '.e-img-caption');
        var target = !sf.base.isNullOrUndefined(imgWrapper) ? imgWrapper : e.target;
        sf.base.addClass([this.toolbarElement], [CLS_RM_WHITE_SPACE]);
        ...
        sf.base.removeClass([this.toolbarElement], [CLS_RM_WHITE_SPACE]);
    };
    ...
    BaseQuickToolbar.prototype.showPopup = function (x, y, target) {
        var _this = this;
        var eventArgs = sf.base.isBlazor() ? { cancel: false, targetElement: target } :
    ...
    BaseQuickToolbar.prototype.removeEleFromDOM = function () {
        ...
        if (this.isDOMElement) {
            ...
            var args = sf.base.isBlazor() ? { element: this.popupObj.element } : this.popupObj;
    ...
    BaseQuickToolbar.prototype.updateStatus = function (args) {
        var options = {
            ...
            parent: this.parent,
            tbElements: sf.base.selectAll('.' + CLS_TB_ITEM, this.element),
...
var QuickToolbar = /** @class */ (function () {
    function QuickToolbar(parent, locator) {
        ...
        this.locator = locator;
        this.renderFactory = this.locator.getService('rendererFactory');
        this.renderFactory.addRenderer(exports.RenderType.Popup, new PopupRenderer(this.parent));
        this.addEventListener();
    }
    ...
    QuickToolbar.prototype.initializeQuickToolbars = function () {
        ...
        if (this.parent.inlineMode.enable && this.parent.inlineMode.onSelection && isIDevice()) {
            sf.base.EventHandler.add(this.contentRenderer.getDocument(), 'selectionchange', this.selectionChangeHandler, this);
        }
    };
    ...
    QuickToolbar.prototype.renderQuickToolbars = function () {
        ...
        this.linkQTBar = this.createQTBar('Link', 'Scrollable', this.parent.quickToolbarSettings.link, exports.RenderType.LinkToolbar);
        this.renderFactory.addRenderer(exports.RenderType.LinkToolbar, this.linkQTBar);
        this.textQTBar = this.createQTBar('Text', 'Scrollable', this.parent.quickToolbarSettings.text, exports.RenderType.TextToolbar);
        this.renderFactory.addRenderer(exports.RenderType.TextToolbar, this.textQTBar);
        this.imageQTBar = this.createQTBar('Image', 'MultiRow', this.parent.quickToolbarSettings.image, exports.RenderType.ImageToolbar);
        this.renderFactory.addRenderer(exports.RenderType.ImageToolbar, this.imageQTBar);
        this.tableQTBar = this.createQTBar('Table', 'MultiRow', this.parent.quickToolbarSettings.table, exports.RenderType.TableToolbar);
        this.renderFactory.addRenderer(exports.RenderType.TableToolbar, this.tableQTBar);
        if (this.linkQTBar) {
            sf.base.EventHandler.add(this.linkQTBar.element, 'mousedown', this.onMouseDown, this);
        }
        if (this.imageQTBar) {
            sf.base.EventHandler.add(this.imageQTBar.element, 'mousedown', this.onMouseDown, this);
        }
        if (this.textQTBar) {
            sf.base.EventHandler.add(this.textQTBar.element, 'mousedown', this.onMouseDown, this);
        }
        if (this.tableQTBar) {
            sf.base.EventHandler.add(this.tableQTBar.element, 'mousedown', this.onMouseDown, this);
        }
    };
    QuickToolbar.prototype.renderInlineQuickToolbar = function () {
        if (this.parent.inlineMode.enable && (!sf.base.Browser.isDevice || isIDevice())) {
            sf.base.addClass([this.parent.element], [CLS_INLINE]);
            this.inlineQTBar = this.createQTBar('Inline', 'MultiRow', this.parent.toolbarSettings.items, exports.RenderType.InlineToolbar);
            this.renderFactory.addRenderer(exports.RenderType.InlineToolbar, this.inlineQTBar);
    ...
    QuickToolbar.prototype.mouseUpHandler = function (e) {
        if (this.parent.inlineMode.enable && (!sf.base.Browser.isDevice || isIDevice())) {
            ...
            if (sf.base.isNullOrUndefined(sf.base.select('.' + CLS_INLINE_POP, document.body))) {
    ...
    QuickToolbar.prototype.keyDownHandler = function () {
        if ((this.parent.inlineMode.enable && (!sf.base.Browser.isDevice || isIDevice()))
            && !sf.base.isNullOrUndefined(sf.base.select('.' + CLS_INLINE_POP, document))) {
            this.hideInlineQTBar();
        }
    };
    ...
    QuickToolbar.prototype.destroy = function () {
        ...
        if (this.textQTBar) {
            sf.base.EventHandler.remove(this.textQTBar.element, 'mousedown', this.onMouseDown);
    ...
    QuickToolbar.prototype.onPropertyChanged = function (e) {
        if (!sf.base.isNullOrUndefined(e.newProp.quickToolbarSettings)) {
...
var Count = /** @class */ (function () {
    ...
    Count.prototype.refresh = function () {
        if (!sf.base.isNullOrUndefined(this.editPanel)) {
            this.appendCount();
            if (this.parent.maxLength !== -1) {
                this.charCountBackground(this.htmlLength);
            }
    ...
    Count.prototype.destroy = function () {
        if (this.element && !sf.base.isNullOrUndefined(this.parent.element.querySelector('.' + CLS_COUNT))) {
...
var Formatter = /** @class */ (function () {
    ...
    Formatter.prototype.process = function (self, args, event, value) {
        ...
        if (sf.base.isNullOrUndefined(args)) {
            ...
            sf.base.extend(args, args, { requestType: args.item.subCommand, cancel: false, itemCollection: value }, true);
            self.trigger(actionBegin, args, function (actionBeginArgs) {
                if (!actionBeginArgs.cancel) {
    ...
    Formatter.prototype.enableUndo = function (self) {
        ...
        if (self.inlineMode.enable && (!sf.base.Browser.isDevice || isIDevice())) {
...
var MarkdownEditor = /** @class */ (function () {
    ...
    MarkdownEditor.prototype.instantiateRenderer = function () {
        this.renderFactory.addRenderer(exports.RenderType.Content, new MarkdownRender(this.parent));
    };
    ...
    MarkdownEditor.prototype.render = function () {
        ...
        if (sf.base.isNullOrUndefined(this.parent.formatter)) {
    ...
    MarkdownEditor.prototype.onPropertyChanged = function (e) {
        ...
        if (!sf.base.isNullOrUndefined(e.newProp.formatter)) {
            var editElement = this.contentRenderer.getEditPanel();
            var option = { undoRedoSteps: this.parent.undoRedoSteps, undoRedoTimer: this.parent.undoRedoTimer };
            this.parent.formatter.updateFormatter(editElement, this.contentRenderer.getDocument(), option);
        }
...
var HtmlEditor = /** @class */ (function () {
    ...
    HtmlEditor.prototype.updateReadOnly = function () {
        if (this.parent.readonly) {
            sf.base.attributes(this.parent.contentModule.getEditPanel(), { contenteditable: 'false' });
            sf.base.addClass([this.parent.element], CLS_RTE_READONLY);
        }
        else {
            sf.base.attributes(this.parent.contentModule.getEditPanel(), { contenteditable: 'true' });
            sf.base.removeClass([this.parent.element], CLS_RTE_READONLY);
        }
    };
    ...
    HtmlEditor.prototype.onPaste = function (e) {
        ...
        if (e.text.match(regex)) {
            ...
            if (!sf.base.isNullOrUndefined(this.parent.pasteCleanupModule)) {
    ...
    HtmlEditor.prototype.onToolbarClick = function (args) {
        ...
        var selectParentEle;
        var item = args.item;
        var closestElement = sf.base.closest(args.originalEvent.target, '.e-rte-quick-popup');
        if (closestElement && !closestElement.classList.contains('e-rte-inline-popup')) {
            ...
            if (!(item.subCommand === 'SourceCode' || item.subCommand === 'Preview' ||
                item.subCommand === 'FontColor' || item.subCommand === 'BackgroundColor')) {
                var range = this.nodeSelectionObj.getRange(this.parent.contentModule.getDocument());
                if (sf.base.isNullOrUndefined(linkDialog) && sf.base.isNullOrUndefined(imageDialog)) {
                    save = this.nodeSelectionObj.save(range, this.parent.contentModule.getDocument());
                }
                selectNodeEle = this.nodeSelectionObj.getNodeCollection(range);
                selectParentEle = this.nodeSelectionObj.getParentNodeCollection(range);
    ...
    HtmlEditor.prototype.instantiateRenderer = function () {
        if (this.parent.iframeSettings.enable) {
            this.renderFactory.addRenderer(exports.RenderType.Content, new IframeContentRender(this.parent, this.locator));
        }
        else {
            this.renderFactory.addRenderer(exports.RenderType.Content, new ContentRender(this.parent, this.locator));
        }
    };
...
var PasteCleanup = /** @class */ (function () {
    ...
    PasteCleanup.prototype.radioRender = function () {
        var keepRadioButton = new sf.buttons.RadioButton({ label: this.i10n.getConstant('keepFormat'), name: 'pasteOption', checked: true });
        ...
        var cleanRadioButton = new sf.buttons.RadioButton({ label: this.i10n.getConstant('cleanFormat'), name: 'pasteOption' });
        ...
        var plainTextRadioButton = new sf.buttons.RadioButton({ label: this.i10n.getConstant('plainText'), name: 'pasteOption' });
            ...
            buttons: [
                {
                    click: function () {
                        if (!dialog.isDestroyed) {
                            ...
                            dialog.hide();
                            var argument = sf.base.isBlazor() ? null : dialog;
                ...
                },
                {
                    click: function () {
                        if (!dialog.isDestroyed) {
                            dialog.hide();
                            var args_1 = sf.base.isBlazor() ? null : dialog;
...
var Resize = /** @class */ (function () {
    ...
    Resize.prototype.resizeStart = function (e) {
        ...
        var args = sf.base.isBlazor() ? { requestType: 'editor' } : { event: e, requestType: 'editor' };
    ...
    FullScreen.prototype.hideFullScreen = function (event) {
        ...
        if (this.parent.element.classList.contains(CLS_FULL_SCREEN)) {
            ...
            for (var i = 0; i < elem.length; i++) {
                sf.base.removeClass([elem[i]], ['e-rte-overflow']);
            }
    ...
    FullScreen.prototype.toggleParentOverflow = function (isAdd) {
        ...
        for (var i = 0; i < this.scrollableParent.length; i++) {
            if (this.scrollableParent[i].nodeName === '#document') {
                ...
                sf.base.addClass([elem], ['e-rte-overflow']);
            }
            else {
...
var Render = /** @class */ (function () {
    ...
    Render.prototype.render = function () {
        var rteObj = this.parent;
        this.contentRenderer = this.renderer.getRenderer(exports.RenderType.Content);
...
var Link = /** @class */ (function () {
    ...
    Link.prototype.showLinkQuickToolbar = function (e) {
        if (e.args.action !== 'enter' && e.args.action !== 'space') {
            ...
            if (e.type !== 'Links' || sf.base.isNullOrUndefined(this.parent.quickToolbarModule) ||
                sf.base.isNullOrUndefined(this.parent.quickToolbarModule.linkQTBar)) {
                return;
            }
    ...
    Link.prototype.linkDialog = function (e, inputDetails) {
        ...
        if (this.parent.editorMode === 'HTML' && (e.selectParent.length > 0 &&
            !sf.base.isNullOrUndefined(e.selectParent[0].classList) &&
        ...
        this.checkBoxObj = new sf.buttons.CheckBox({ label: linkOpenLabel, checked: true, enableRtl: this.parent.enableRtl });
        ...
        var dialogModel = {
            ...
            showCloseIcon: true, closeOnEscape: true, width: (sf.base.Browser.isDevice) ? '290px' : '310px', height: 'inherit',
            isModal: sf.base.Browser.isDevice,
            buttons: [{
            ...
            close: function (event) {
                ...
                sf.base.detach(_this.dialogObj.element);
                var args = sf.base.isBlazor() ? null : _this.dialogObj;
        ...
        this.checkUrl(false);
        if ((this.parent.editorMode === 'HTML' && sf.base.isNullOrUndefined(inputDetails) && ((!sf.base.isNullOrUndefined(selectText)
    ...
    Link.prototype.insertlink = function (e) {
        ...
        if (proxy.parent.editorMode === 'HTML' && sf.base.isNullOrUndefined(sf.base.closest(this.selection.range.startContainer.parentNode, '#' + proxy.parent.contentModule.getPanel().id))) {
            proxy.parent.contentModule.getEditPanel().focus();
            if (sf.base.Browser.isIE && proxy.parent.iframeSettings.enable) {
        ...
        if (isIDevice$1() && proxy.parent.iframeSettings.enable) {
            sf.base.select('iframe', proxy.parent.element).contentWindow.focus();
        }
    ...
    Link.prototype.onDocumentClick = function (e) {
        var target = e.target;
        if (!sf.base.isNullOrUndefined(this.dialogObj) && ((!sf.base.closest(target, '#' + this.dialogObj.element.id) && this.parent.toolbarSettings.enable &&
            this.parent.getToolbarElement() && !this.parent.getToolbarElement().contains(e.target)) ||
            (((this.parent.getToolbarElement() && this.parent.getToolbarElement().contains(e.target)) ||
                this.parent.inlineMode.enable && !sf.base.closest(target, '#' + this.dialogObj.element.id)) &&
                !sf.base.closest(target, '#' + this.parent.getID() + '_toolbar_CreateLink') &&
...
var Image = /** @class */ (function () {
    ...
    Image.prototype.removeEventListener = function () {
        ...
        if (!sf.base.isNullOrUndefined(this.contentModule)) {
            sf.base.EventHandler.remove(this.contentModule.getEditPanel(), sf.base.Browser.touchEndEvent, this.imageClick);
    ...
    Image.prototype.afterRender = function () {
        this.contentModule = this.rendererFactory.getRenderer(exports.RenderType.Content);
        sf.base.EventHandler.add(this.contentModule.getEditPanel(), sf.base.Browser.touchEndEvent, this.imageClick, this);
        if (this.parent.insertImageSettings.resize) {
        ...
        if (args.subCommand.toLowerCase() === 'undo' || args.subCommand.toLowerCase() === 'redo') {
            for (var i = 0; i < this.parent.formatter.getUndoRedoStack().length; i++) {
                ...
                if (temp.querySelector('.e-img-resize') && img.length > 0) {
                    ...
                    sf.base.detach(temp.querySelector('.e-img-resize'));
    ...
    Image.prototype.resizeEnd = function (e) {
        ...
        var args = sf.base.isBlazor() ? { requestType: 'images' } : { event: e, requestType: 'images' };
        this.parent.trigger(resizeStop, args);
    ...
    Image.prototype.resizeStart = function (e, ele) {
        ...
        if (target.classList.contains('e-rte-imageboxmark')) {
            ...
            if (sf.base.Browser.isDevice && this.contentModule.getEditPanel().contains(this.imgResizeDiv) &&
            ...
            sf.base.EventHandler.add(this.contentModule.getDocument(), sf.base.Browser.touchEndEvent, this.resizeEnd, this);
        }
    };
    ...
    Image.prototype.imageResize = function (e) {
        ...
        sf.base.EventHandler.add(this.contentModule.getDocument(), sf.base.Browser.touchMoveEvent, this.resizing, this);
    };
    ...
    Image.prototype.calcPos = function (elem) {
        ...
        var offsetParent = ((elem.offsetParent && (elem.offsetParent.classList.contains('e-img-caption') ||
            ...
            sf.base.closest(elem, '#' + this.parent.getID() + '_rte-edit-view') : elem.offsetParent) || doc.documentElement;
        while (offsetParent &&
    ...
    Image.prototype.removeImgLink = function (e) {
        ...
        e.selection.restore();
        var isCapLink = (this.contentModule.getEditPanel().contains(this.captionEle) && sf.base.select('a', this.captionEle)) ?
            true : false;
    ...
    Image.prototype.imageWithLinkQTBarItemUpdate = function () {
        ...
        for (var i = 0; i < items.length; i++) {
            if (items[i].getAttribute('title') === this.i10n.getConstant('openLink') ||
                ...
                sf.base.addClass([items[i]], 'e-link-groups');
    ...
    Image.prototype.showImageQuickToolbar = function (e) {
        ...
        if (e.type !== 'Images' || sf.base.isNullOrUndefined(this.parent.quickToolbarModule)
            || sf.base.isNullOrUndefined(this.parent.quickToolbarModule.imageQTBar)) {
            return;
        }
        this.quickToolObj = this.parent.quickToolbarModule;
        var args = e.args;
    ...
    Image.prototype.hideImageQuickToolbar = function () {
        if (!sf.base.isNullOrUndefined(this.contentModule.getEditPanel().querySelector('.e-img-focus'))) {
            sf.base.removeClass([this.contentModule.getEditPanel().querySelector('.e-img-focus')], 'e-img-focus');
    ...
    Image.prototype.editAreaClickHandler = function (e) {
        ...
        if (this.parent.editorMode === 'HTML' && this.parent.quickToolbarModule && this.parent.quickToolbarModule.imageQTBar) {
            ...
            if (target.nodeName === 'IMG' && this.parent.quickToolbarModule) {
                ...
                if (sf.base.closest(target, 'a')) {
                    for (var i = 0; i < items.length; i++) {
                        if (items[i].getAttribute('title') === this.i10n.getConstant('openLink') ||
                            items[i].getAttribute('title') === this.i10n.getConstant('editLink') ||
                            items[i].getAttribute('title') === this.i10n.getConstant('removeLink')) {
                            items[i].style.display = '';
                            sf.base.removeClass([items[i]], 'e-link-groups');
                        }
                        else if (items[i].getAttribute('title') === 'Insert Link') {
                            items[i].style.display = 'none';
                        }
                ...
                else if (!sf.base.closest(target, 'a')) {
                    this.imageWithLinkQTBarItemUpdate();
                }
    ...
    Image.prototype.insertImgLink = function (e, inputDetails) {
        ...
        if (!sf.base.isNullOrUndefined(this.dialogObj)) {
            ...
            var linkOpenLabel = this.i10n.getConstant('linkOpenInNewWindow');
            this.checkBoxObj = new sf.buttons.CheckBox({
    ...
    Image.prototype.insertAlt = function (e) {
        if (!sf.base.isNullOrUndefined(e.alt)) {
            e.selection.restore();
            if (this.parent.formatter.getUndoRedoStack().length === 0) {
                this.parent.formatter.saveData();
            }
    ...
    Image.prototype.insertlink = function (e) {
        ...
        if (url === '') {
            sf.base.addClass([e.link], 'e-error');
        ...
        if (!this.isUrl(url)) {
            ...
            sf.base.removeClass([e.link], 'e-error');
        }
        ...
        var captionEle = sf.base.closest(e.selectNode[0], '.e-img-caption');
        if (captionEle) {
    ...
    Image.prototype.imagDialog = function (e) {
        ...
        var dialogModel = {
            ...
            enableRtl: this.parent.enableRtl,
            locale: this.parent.locale,
            showCloseIcon: true, closeOnEscape: true, width: (sf.base.Browser.isDevice) ? '290px' : '340px', height: 'inherit',
            position: { X: 'center', Y: (sf.base.Browser.isDevice) ? 'center' : 'top' },
            isModal: sf.base.Browser.isDevice,
            buttons: [{
    ...
    Image.prototype.onDocumentClick = function (e) {
        ...
        if (!sf.base.isNullOrUndefined(this.dialogObj) && ((!sf.base.closest(target, '#' + this.dialogObj.element.id) && this.parent.toolbarSettings.enable && this.parent.getToolbarElement() &&
            !this.parent.getToolbarElement().contains(e.target)) ||
            (this.parent.getToolbarElement() && this.parent.getToolbarElement().contains(e.target) &&
                !sf.base.closest(target, '#' + this.parent.getID() + '_toolbar_Image') &&
    ...
    Image.prototype.insertImageUrl = function (e) {
        ...
        if (!sf.base.isNullOrUndefined(proxy.uploadUrl) && proxy.uploadUrl.url !== '') {
            ...
            if (proxy.parent.editorMode === 'HTML' && sf.base.isNullOrUndefined(sf.base.closest(this.selection.range.startContainer.parentNode, '#' + proxy.contentModule.getPanel().id))) {
            ...
            var matchUrl = (!sf.base.isNullOrUndefined(url.match(regex)) && proxy.parent.editorMode === 'HTML') ? url.match(regex)[0] : '';
            var value = {
    ...
    Image.prototype.imgsizeInput = function (e) {
        ...
        var heightNum = new sf.inputs.NumericTextBox({
    ...
    Image.prototype.imgUpload = function (e) {
        ...
        if (proxy.parent.editorMode === 'HTML' && (!iframe && sf.base.isNullOrUndefined(sf.base.closest(e.selection.range.startContainer.parentNode, '#' +
        ...
        var spanMsg = this.parent.createElement('span', {
            className: 'e-rte-upload-text', innerHTML: ((sf.base.Browser.isDevice) ? deviceImgUpMsg : imgUpMsg)
        });
        ...
        var button = new sf.buttons.Button({ content: browserMsg, enableRtl: this.parent.enableRtl });
        button.isStringTemplate = true;
        button.createElement = this.parent.createElement;
        button.appendTo(btnEle);
        var btnClick = (sf.base.Browser.isDevice) ? span : btnEle;
        sf.base.EventHandler.add(btnClick, 'click', this.fileSelect, this);
    ...
    Image.prototype.uploadMethod = function (dragEvent, imageElement) {
        ...
        sf.base.addClass([this.popupObj.element], CLS_POPUP_OPEN);
        sf.base.addClass([this.popupObj.element], CLS_RTE_UPLOAD_POPUP);
        ...
        sf.base.detach(this.popupObj.element.querySelector('.e-rte-dialog-upload .e-file-select-wrap'));
    ...
    Image.prototype.showPopupToolBar = function (e, url) {
        ...
        this.parent.quickToolbarModule.createQTBar('Image', 'MultiRow', this.parent.quickToolbarSettings.image, exports.RenderType.ImageToolbar);
        var args = {
            args: e.args,
            type: 'Images',
            isNotify: undefined,
...
var ViewSource = /** @class */ (function () {
    ...
    ViewSource.prototype.sourceCode = function (args) {
        ...
        var tbItems = sf.base.selectAll('.' + CLS_TB_ITEM, this.parent.element);
        this.contentModule = this.rendererFactory.getRenderer(exports.RenderType.Content);
        this.parent.notify(updateToolbarItem, {
            targetItem: 'SourceCode', updateItem: 'Preview',
            baseToolbar: this.parent.getBaseToolbarObject()
        });
        if (sf.base.isNullOrUndefined(this.previewElement)) {
            this.previewElement = this.getSourceCode();
        }
        this.parent.updateValueData();
        if (this.parent.iframeSettings.enable) {
            var rteContent = void 0;
            if (sf.base.isNullOrUndefined(this.parent.element.querySelector('#' + this.parent.element.id + '_source-view'))) {
        ...
        sf.base.removeClass(tbItems, [CLS_ACTIVE]);
...
var Table = /** @class */ (function () {
    ...
    Table.prototype.afterRender = function () {
        ...
        if (!sf.base.Browser.isDevice && this.parent.tableSettings.resize) {
            sf.base.EventHandler.add(this.contentModule.getEditPanel(), 'mouseover', this.resizeHelper, this);
        }
    };
    ...
    Table.prototype.tabSelection = function (event, selection, ele) {
        ...
        if (!event.shiftKey && event.keyCode !== 37) {
            ...
            if (ele === prevElement && ele.cellIndex === 0 &&
                ...
                var clsTble = sf.base.closest(ele, 'table');
    ...
    Table.prototype.tableCellLeave = function (e) {
        sf.base.removeClass(this.dlgDiv.querySelectorAll('.e-rte-tablecell'), 'e-active');
        sf.base.addClass([this.dlgDiv.querySelector('.e-rte-tablecell')], 'e-active');
    ...
    Table.prototype.tableInsert = function (row, col, e, selectionObj) {
        ...
        if (proxy.parent.editorMode === 'HTML' &&
            ((proxy.parent.iframeSettings.enable && !hasClass(parentNode.ownerDocument.querySelector('body'), 'e-lib')) ||
                (!proxy.parent.iframeSettings.enable && sf.base.isNullOrUndefined(sf.base.closest(parentNode, '#' + proxy.contentModule.getPanel().id))))) {
            proxy.contentModule.getEditPanel().focus();
            var range = proxy.parent.formatter.editorManager.nodeSelection.getRange(proxy.contentModule.getDocument());
    ...
    Table.prototype.cellSelect = function (e) {
        ...
        target = (target.nodeName !== 'TD' && tdNode && this.parent.contentModule.getEditPanel().contains(tdNode)) ?
            tdNode : target;
        sf.base.removeClass(this.contentModule.getEditPanel().querySelectorAll('table td, table th'), CLS_TABLE_SEL);
    ...
    Table.prototype.resizeStart = function (e) {
        ...
        if (target.classList.contains(CLS_TB_COL_RES) ||
            ...
            if (sf.base.Browser.isDevice && this.helper && !this.helper.classList.contains('e-reicon')) {
                ...
                var args = sf.base.isBlazor() ? { requestType: 'Table' } : { event: e, requestType: 'Table' };
                this.parent.trigger(resizeStart, args, function (resizeStartArgs) {
                    if (resizeStartArgs.cancel) {
                        _this.cancelResizeAction();
                    }
        ...
        this.parent.trigger(onResize, args, function (resizingArgs) {
            if (resizingArgs.cancel) {
                ...
                if (_this.resizeBtnStat.column) {
                    ...
                    if (!sf.base.Browser.isDevice) {
                        sf.base.EventHandler.remove(_this.contentModule.getEditPanel(), 'mouseover', _this.resizeHelper);
                    }
    ...
    Table.prototype.renderDlgContent = function (args) {
        ...
        button.isStringTemplate = true;
        button.appendTo(btnEle);
        sf.base.EventHandler.add(btnEle, 'click', this.insertTableDialog, { self: this, args: args.args, selection: args.selection });
        ...
        this.popupObj = new sf.popups.Popup(this.dlgDiv, {
            targetType: 'relative',
            relateTo: target,
        ...
        sf.base.addClass([this.popupObj.element], 'e-popup-open');
        this.popupObj.refreshPosition(target);
    };
    Table.prototype.docClick = function (e) {
        var target = e.args.target;
        if (target && target.classList && ((this.popupObj && !sf.base.closest(target, '#' + this.popupObj.element.id) ||
            (this.editdlgObj && !sf.base.closest(target, '#' + this.editdlgObj.element.id)))) && !target.classList.contains('e-create-table') &&
    ...
    Table.prototype.drawTable = function (tableDiv, args) {
        ...
        for (var row = 0; row < 3; row++) {
            ...
            for (var col = 0; col < 10; col++) {
                ...
                if (col === 0 && row === 0) {
                    sf.base.addClass([tableCell], 'e-active');
                }
                sf.base.EventHandler.add(tableCell, 'mousemove', this.tableCellSelect, this);
                sf.base.EventHandler.add(rowDiv, 'mouseleave', this.tableCellLeave, this);
                sf.base.EventHandler.add(tableCell, 'mouseup', this.tableCellClick, { self: this, args: args.args, selection: args.selection });
            }
    ...
    Table.prototype.tableCellDlgContent = function () {
        ...
        this.columnTextBox = new sf.inputs.NumericTextBox({
            format: 'n0',
            min: 1,
            value: 3,
        ...
        this.rowTextBox = new sf.inputs.NumericTextBox({
            format: 'n0',
            min: 1,
            value: 3,
    ...
    Table.prototype.createDialog = function (args) {
        ...
        var dialogModel = {
            ...
            enableRtl: this.parent.enableRtl,
            locale: this.parent.locale,
            showCloseIcon: true, closeOnEscape: true, width: (sf.base.Browser.isDevice) ? '290px' : '340px', height: 'initial',
            position: { X: 'center', Y: (sf.base.Browser.isDevice) ? 'center' : 'top' },
            isModal: sf.base.Browser.isDevice,
            buttons: [{
                    buttonModel: { content: insert, cssClass: 'e-flat e-insert-table', isPrimary: true }
            ...
            close: function (event) {
                ...
                sf.base.detach(_this.editdlgObj.element);
                _this.dialogRenderObj.close(event);
    ...
    Table.prototype.customTable = function (args, e) {
        ...
        if (proxy.rowTextBox.value && proxy.columnTextBox.value) {
            var argument = ((sf.base.Browser.isDevice || (!sf.base.isNullOrUndefined(args.args)
                && !sf.base.isNullOrUndefined(args.args.originalEvent) &&
    ...
    Table.prototype.applyProperties = function (args, e) {
        ...
        var table = sf.base.closest(args.selectNode[0], 'table');
    ...
    Table.prototype.tableDlgContent = function (e) {
        ...
        var widthVal = sf.base.closest(selectNode, 'table').getClientRects()[0].width;
        var padVal = sf.base.closest(selectNode, 'td').style.padding;
        var brdSpcVal = sf.base.closest(selectNode, 'table').getAttribute('cellspacing');
        ...
        var spacing = new sf.inputs.NumericTextBox({
            format: 'n0',
            min: 0,
            value: brdSpcVal !== '' && !sf.base.isNullOrUndefined(brdSpcVal) ? parseInt(brdSpcVal, null) : 0,
...
var TableSettings = /** @class */ (function (_super) {
    ...
    __decorate$2([
        sf.base.Property(TableStyleItems)
...
var QuickToolbarSettings = /** @class */ (function (_super) {
    ...
    __decorate$2([
        sf.base.Property(['Open', 'Edit', 'UnLink'])
    ], QuickToolbarSettings.prototype, "link", void 0);
    __decorate$2([
        sf.base.Property(['Replace', 'Align', 'Caption', 'Remove', '-', 'InsertLink', 'OpenImageLink', 'EditImageLink', 'RemoveImageLink', 'Display', 'AltText', 'Dimension'])
    ], QuickToolbarSettings.prototype, "image", void 0);
    __decorate$2([
        sf.base.Property(['Cut', 'Copy', 'Paste'])
    ], QuickToolbarSettings.prototype, "text", void 0);
    __decorate$2([
        sf.base.Property(['TableHeader', 'TableRows', 'TableColumns', 'BackgroundColor', '-', 'TableRemove', 'Alignments', 'TableCellVerticalAlign', 'Styles'])
...
var PasteCleanupSettings = /** @class */ (function (_super) {
    ...
    __decorate$2([
        sf.base.Property(['background', 'background-color', 'border', 'border-bottom', 'border-left', 'border-radius', 'border-right', 'border-style', 'border-top', 'border-width', 'clear', 'color', 'cursor', 'direction', 'display', 'float', 'font', 'font-family', 'font-size', 'font-weight', 'font-style', 'height', 'left', 'line-height', 'margin', 'margin-top', 'margin-left', 'margin-right', 'margin-bottom', 'max-height', 'max-width', 'min-height', 'min-width', 'overflow', 'overflow-x', 'overflow-y', 'padding', 'padding-bottom', 'padding-left', 'padding-right', 'padding-top', 'position', 'right', 'table-layout', 'text-align', 'text-decoration', 'text-indent', 'top', 'vertical-align', 'visibility', 'white-space', 'width'])
...
var FontFamily = /** @class */ (function (_super) {
    ...
    __decorate$2([
        sf.base.Property('65px')
    ], FontFamily.prototype, "width", void 0);
    __decorate$2([
        sf.base.Property(fontFamily)
...
var FontSize = /** @class */ (function (_super) {
    ...
    __decorate$2([
        sf.base.Property('35px')
    ], FontSize.prototype, "width", void 0);
    __decorate$2([
        sf.base.Property(fontSize)
...
var BackgroundColor = /** @class */ (function (_super) {
    ...
    __decorate$2([
        sf.base.Property(backgroundColor)
...
var RichTextEditor = /** @class */ (function (_super) {
    ...
    RichTextEditor.prototype.preRender = function () {
        ...
        sf.base.attributes(this.element, { role: 'application' });
    };
    ...
    RichTextEditor.prototype.setContainer = function () {
        ...
        sf.base.extend(htmlAttr, this.htmlAttributes, htmlAttr);
        this.setProperties({ htmlAttributes: htmlAttr }, true);
        if (!sf.base.isNullOrUndefined(this.htmlAttributes.id)) {
        ...
        if (this.element.tagName === 'TEXTAREA') {
            ...
            sf.base.removeClass([this.valueContainer], this.element.getAttribute('class').split(' '));
            if (this.isBlazor()) {
                sf.base.addClass([this.element], CLS_RTE_HIDDEN);
            }
        ...
        sf.base.addClass([this.valueContainer], CLS_RTE_HIDDEN);
        ...
        this.trigger(actionBegin, evenArgs, function (pasteArgs) {
            ...
            if (!pasteArgs.cancel && _this.inputElement.contentEditable === 'true' &&
                ...
                if (!sf.base.isNullOrUndefined(_this.pasteCleanupModule)) {
                    ...
                    var value = null;
                    if (e && !sf.base.isNullOrUndefined(e.clipboardData)) {
    ...
    RichTextEditor.prototype.removeAttributes = function () {
        ...
        if (this.readonly) {
            sf.base.removeClass([this.element], CLS_RTE_READONLY);
        }
    ...
    RichTextEditor.prototype.getContent = function () {
        if (this.iframeSettings.enable && sf.base.isBlazor()) {
        ...
        for (var _i = 0, _a = Object.keys(newProp); _i < _a.length; _i++) {
            ...
            switch (prop) {
                case 'value':
                    ...
                    if (!sf.base.isNullOrUndefined(nVal) && nVal !== '') {
    ...
    RichTextEditor.prototype.initializeServices = function () {
        this.serviceLocator.register('rendererFactory', new RendererFactory);
        this.serviceLocator.register('rteLocale', this.localeObj = new sf.base.L10n(this.getModuleName(), defaultLocale, this.locale));
    ...
    RichTextEditor.prototype.RTERender = function () {
        ...
        this.contentModule = rendererFactory.getRenderer(exports.RenderType.Content);
        ...
        this.updateReadOnly();
        this.updatePanelValue();
        if (this.enableHtmlEncode && !sf.base.isNullOrUndefined(this.value)) {
    ...
    RichTextEditor.prototype.isBlazor = function () {
        return (!sf.base.isBlazor() ? false : true);
    };
        ...
        if (this.valueTemplate) {
            if (typeof this.valueTemplate === 'string') {
                ...
                for (var i = 0; i < compiledTemplate.length; i++) {
                    ...
                    sf.base.append([item], this.element);
                }
    ...
    RichTextEditor.prototype.setContentHeight = function (target, isExpand) {
        ...
        if (this.toolbarSettings.type === exports.ToolbarType.Expand && isExpand && target !== 'preview') {
    ...
    RichTextEditor.prototype.getBaseToolbarObject = function () {
        var tbObj;
        if (this.inlineMode.enable && (!sf.base.Browser.isDevice || isIDevice())) {
    ...
    RichTextEditor.prototype.onDocumentClick = function (e) {
        ...
        if (!this.element.contains(e.target) && document !== e.target && rteElement !== this.element &&
            !sf.base.closest(target, '[aria-owns="' + this.getID() + '"]')) {
            this.isBlur = true;
            this.isRTE = false;
        }
    ...
    RichTextEditor.prototype.blurHandler = function (e) {
        ...
        if (trg) {
            ...
            else if (sf.base.closest(trg, '[aria-owns="' + this.getID() + '"]')) {
                this.isBlur = false;
            }
            else {
                this.isBlur = true;
    ...
    RichTextEditor.prototype.wireScrollElementsEvents = function () {
        ...
        if (!this.iframeSettings.enable) {
            sf.base.EventHandler.add(this.contentModule.getPanel(), 'scroll', this.contentScrollHandler, this);
        }
    };
    ...
    RichTextEditor.prototype.unWireScrollElementsEvents = function () {
        ...
        if (!this.iframeSettings.enable) {
            sf.base.EventHandler.remove(this.contentModule.getPanel(), 'scroll', this.contentScrollHandler);
        }
    };
...
exports.executeGroup = executeGroup;
...
exports.toolbarRefresh = toolbarRefresh;
exports.refreshBegin = refreshBegin;
exports.toolbarUpdated = toolbarUpdated;
exports.bindOnEnd = bindOnEnd;
exports.renderColorPicker = renderColorPicker;
exports.htmlToolbarClick = htmlToolbarClick;
exports.markdownToolbarClick = markdownToolbarClick;
exports.destroyColorPicker = destroyColorPicker;
exports.modelChanged = modelChanged;
exports.keyUp = keyUp;
exports.keyDown = keyDown;
exports.mouseUp = mouseUp;
exports.toolbarCreated = toolbarCreated;
exports.toolbarRenderComplete = toolbarRenderComplete;
...
exports.beforeDropDownItemRender = beforeDropDownItemRender;
exports.execCommandCallBack = execCommandCallBack;
exports.imageToolbarAction = imageToolbarAction;
exports.linkToolbarAction = linkToolbarAction;
...
exports.toolbarStatusUpdate = toolbarStatusUpdate;
exports.actionSuccess = actionSuccess;
exports.updateToolbarItem = updateToolbarItem;
exports.insertImage = insertImage;
exports.insertCompleted = insertCompleted;
exports.imageLeft = imageLeft;
exports.imageRight = imageRight;
exports.imageCenter = imageCenter;
exports.imageBreak = imageBreak;
...
exports.toolbarOpen = toolbarOpen;
exports.beforeDropDownOpen = beforeDropDownOpen;
exports.selectionSave = selectionSave;
exports.selectionRestore = selectionRestore;
exports.expandPopupClick = expandPopupClick;
exports.count = count;
exports.contentFocus = contentFocus;
exports.contentBlur = contentBlur;
exports.mouseDown = mouseDown;
exports.sourceCodeMouseDown = sourceCodeMouseDown;
exports.editAreaClick = editAreaClick;
exports.scroll = scroll;
exports.contentscroll = contentscroll;
exports.colorPickerChanged = colorPickerChanged;
exports.tableColorPickerChanged = tableColorPickerChanged;
exports.focusChange = focusChange;
exports.selectAll = selectAll$1;
exports.selectRange = selectRange;
exports.getSelectedHtml = getSelectedHtml;
exports.renderInlineToolbar = renderInlineToolbar;
exports.paste = paste;
exports.imgModule = imgModule;
exports.rtlMode = rtlMode;
exports.createTable = createTable;
exports.docClick = docClick;
exports.tableToolbarAction = tableToolbarAction;
exports.checkUndo = checkUndo;
...
exports.quickToolbarClose = quickToolbarClose;
exports.popupHide = popupHide;
exports.imageSelected = imageSelected;
exports.imageUploading = imageUploading;
...
exports.CLS_DISABLED = CLS_DISABLED;
exports.CLS_SCRIPT_SHEET = CLS_SCRIPT_SHEET;
exports.CLS_STYLE_SHEET = CLS_STYLE_SHEET;
exports.CLS_TOOLBAR = CLS_TOOLBAR;
exports.CLS_TB_FIXED = CLS_TB_FIXED;
exports.CLS_TB_FLOAT = CLS_TB_FLOAT;
exports.CLS_TB_ABS_FLOAT = CLS_TB_ABS_FLOAT;
exports.CLS_INLINE = CLS_INLINE;
exports.CLS_TB_INLINE = CLS_TB_INLINE;
exports.CLS_RTE_EXPAND_TB = CLS_RTE_EXPAND_TB;
exports.CLS_FULL_SCREEN = CLS_FULL_SCREEN;
exports.CLS_QUICK_TB = CLS_QUICK_TB;
exports.CLS_POP = CLS_POP;
exports.CLS_QUICK_POP = CLS_QUICK_POP;
exports.CLS_QUICK_DROPDOWN = CLS_QUICK_DROPDOWN;
exports.CLS_IMAGE_POP = CLS_IMAGE_POP;
exports.CLS_INLINE_POP = CLS_INLINE_POP;
exports.CLS_INLINE_DROPDOWN = CLS_INLINE_DROPDOWN;
exports.CLS_DROPDOWN_POPUP = CLS_DROPDOWN_POPUP;
exports.CLS_DROPDOWN_ICONS = CLS_DROPDOWN_ICONS;
exports.CLS_DROPDOWN_ITEMS = CLS_DROPDOWN_ITEMS;
exports.CLS_DROPDOWN_BTN = CLS_DROPDOWN_BTN;
exports.CLS_RTE_CONTENT = CLS_RTE_CONTENT;
exports.CLS_TB_ITEM = CLS_TB_ITEM;
exports.CLS_TB_EXTENDED = CLS_TB_EXTENDED;
exports.CLS_TB_WRAP = CLS_TB_WRAP;
exports.CLS_POPUP = CLS_POPUP;
exports.CLS_SEPARATOR = CLS_SEPARATOR;
exports.CLS_MINIMIZE = CLS_MINIMIZE;
exports.CLS_MAXIMIZE = CLS_MAXIMIZE;
exports.CLS_BACK = CLS_BACK;
exports.CLS_SHOW = CLS_SHOW;
exports.CLS_HIDE = CLS_HIDE;
exports.CLS_VISIBLE = CLS_VISIBLE;
exports.CLS_FOCUS = CLS_FOCUS;
exports.CLS_RM_WHITE_SPACE = CLS_RM_WHITE_SPACE;
exports.CLS_IMGRIGHT = CLS_IMGRIGHT;
exports.CLS_IMGLEFT = CLS_IMGLEFT;
exports.CLS_IMGCENTER = CLS_IMGCENTER;
exports.CLS_IMGBREAK = CLS_IMGBREAK;
exports.CLS_CAPTION = CLS_CAPTION;
exports.CLS_RTE_CAPTION = CLS_RTE_CAPTION;
exports.CLS_CAPINLINE = CLS_CAPINLINE;
exports.CLS_IMGINLINE = CLS_IMGINLINE;
exports.CLS_COUNT = CLS_COUNT;
exports.CLS_WARNING = CLS_WARNING;
exports.CLS_ERROR = CLS_ERROR;
exports.CLS_ICONS = CLS_ICONS;
exports.CLS_ACTIVE = CLS_ACTIVE;
exports.CLS_EXPAND_OPEN = CLS_EXPAND_OPEN;
exports.CLS_RTE_ELEMENTS = CLS_RTE_ELEMENTS;
exports.CLS_TB_BTN = CLS_TB_BTN;
exports.CLS_HR_SEPARATOR = CLS_HR_SEPARATOR;
exports.CLS_TB_IOS_FIX = CLS_TB_IOS_FIX;
exports.CLS_TB_STATIC = CLS_TB_STATIC;
exports.CLS_FORMATS_TB_BTN = CLS_FORMATS_TB_BTN;
exports.CLS_FONT_NAME_TB_BTN = CLS_FONT_NAME_TB_BTN;
exports.CLS_FONT_SIZE_TB_BTN = CLS_FONT_SIZE_TB_BTN;
exports.CLS_FONT_COLOR_TARGET = CLS_FONT_COLOR_TARGET;
exports.CLS_BACKGROUND_COLOR_TARGET = CLS_BACKGROUND_COLOR_TARGET;
exports.CLS_COLOR_CONTENT = CLS_COLOR_CONTENT;
exports.CLS_FONT_COLOR_DROPDOWN = CLS_FONT_COLOR_DROPDOWN;
exports.CLS_BACKGROUND_COLOR_DROPDOWN = CLS_BACKGROUND_COLOR_DROPDOWN;
exports.CLS_COLOR_PALETTE = CLS_COLOR_PALETTE;
exports.CLS_FONT_COLOR_PICKER = CLS_FONT_COLOR_PICKER;
exports.CLS_BACKGROUND_COLOR_PICKER = CLS_BACKGROUND_COLOR_PICKER;
exports.CLS_RTE_READONLY = CLS_RTE_READONLY;
exports.CLS_TABLE_SEL = CLS_TABLE_SEL;
exports.CLS_TB_DASH_BOR = CLS_TB_DASH_BOR;
exports.CLS_TB_ALT_BOR = CLS_TB_ALT_BOR;
exports.CLS_TB_COL_RES = CLS_TB_COL_RES;
exports.CLS_TB_ROW_RES = CLS_TB_ROW_RES;
exports.CLS_TB_BOX_RES = CLS_TB_BOX_RES;
exports.CLS_RTE_HIDDEN = CLS_RTE_HIDDEN;
exports.CLS_RTE_PASTE_KEEP_FORMAT = CLS_RTE_PASTE_KEEP_FORMAT;
exports.CLS_RTE_PASTE_REMOVE_FORMAT = CLS_RTE_PASTE_REMOVE_FORMAT;
exports.CLS_RTE_PASTE_PLAIN_FORMAT = CLS_RTE_PASTE_PLAIN_FORMAT;
exports.CLS_RTE_PASTE_OK = CLS_RTE_PASTE_OK;
exports.CLS_RTE_PASTE_CANCEL = CLS_RTE_PASTE_CANCEL;
exports.CLS_RTE_DIALOG_MIN_HEIGHT = CLS_RTE_DIALOG_MIN_HEIGHT;
exports.CLS_RTE_RES_HANDLE = CLS_RTE_RES_HANDLE;
exports.CLS_RTE_RES_EAST = CLS_RTE_RES_EAST;
exports.CLS_RTE_IMAGE = CLS_RTE_IMAGE;
exports.CLS_RESIZE = CLS_RESIZE;
exports.CLS_IMG_FOCUS = CLS_IMG_FOCUS;
exports.CLS_RTE_DRAG_IMAGE = CLS_RTE_DRAG_IMAGE;
exports.CLS_RTE_UPLOAD_POPUP = CLS_RTE_UPLOAD_POPUP;
exports.CLS_POPUP_OPEN = CLS_POPUP_OPEN;
exports.CLS_IMG_RESIZE = CLS_IMG_RESIZE;
exports.CLS_DROPAREA = CLS_DROPAREA;
exports.CLS_IMG_INNER = CLS_IMG_INNER;
exports.CLS_UPLOAD_FILES = CLS_UPLOAD_FILES;
exports.CLS_RTE_DIALOG_UPLOAD = CLS_RTE_DIALOG_UPLOAD;
...
exports.getFormattedFontSize = getFormattedFontSize;
exports.pageYOffset = pageYOffset;
exports.getTooltipText = getTooltipText;
exports.setToolbarStatus = setToolbarStatus;
exports.getCollection = getCollection;
exports.getTBarItemsIndex = getTBarItemsIndex;
exports.updateUndoRedoStatus = updateUndoRedoStatus;
exports.dispatchEvent = dispatchEvent;
exports.parseHtml = parseHtml;
exports.getTextNodesUnder = getTextNodesUnder;
exports.toObjectLowerCase = toObjectLowerCase;
exports.getEditValue = getEditValue;
exports.updateTextNode = updateTextNode;
exports.isEditableValueEmpty = isEditableValueEmpty;
