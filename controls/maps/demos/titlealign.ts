...
//tslint:disable:max-func-body-length
    ...
    document.getElementById('labels').onchange = () => {
        ...
        maps.titleSettings.alignment = <Alignment>value; 
        maps.refresh();
    }
    document.getElementById('subtitle').onchange = () => {
        var value = (<HTMLInputElement>document.getElementById('subtitle')).value;
        maps.titleSettings.subtitleSettings.alignment = <Alignment>value; 
        maps.refresh();
    }
