import { Maps, Legend, Marker, MapsTooltip, ILoadEventArgs, MapsTheme, IMarkerClusterClickEventArgs, MapAjax, Zoom, MarkerType } from '../src/index';
...
//tslint:disable:max-func-body-length
    let maps: Maps = new Maps({
        markerClusterClick: (args :IMarkerClusterClickEventArgs) =>{
           args.maps.titleSettings.text = "Marker Cluster Click Event";
        },
        zoomSettings: {
            enable: true
        },
