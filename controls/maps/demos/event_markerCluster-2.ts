import { Maps, Legend, Marker, MapsTooltip, ILoadEventArgs, MapsTheme, IMarkerClusterRenderingEventArgs, MapAjax, Zoom, MarkerType } from '../src/index';
...
//tslint:disable:max-func-body-length
    let maps: Maps = new Maps({
        markerClusterRendering: (args :IMarkerClusterRenderingEventArgs) =>{
            args.height = 100;
            args.width = 100;
        },
        zoomSettings: {
