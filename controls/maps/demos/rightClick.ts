 ...
 * Maps default sample
 */
import { Maps, Legend, Marker, MapsTooltip, IMouseEventArgs, MapsTheme, MapAjax } from '../src/index';
...
let maps: Maps = new Maps({
    ...
    rightClick: (args: IMouseEventArgs) => {
        if (count === 0) {
            maps.titleSettings.text = 'Right Click Event';
			maps.refresh();
			count++;
        }
    },
