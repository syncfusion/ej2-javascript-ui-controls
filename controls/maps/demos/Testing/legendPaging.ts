...
Maps.Inject(Legend, MapsTooltip);
    ...
    document.getElementById('position').onchange = () => {
        let value: string = (<HTMLInputElement>document.getElementById('position')).value;
    ...
    document.getElementById("applyShape").onchange = () => {
        let element: HTMLInputElement = <HTMLInputElement>(document.getElementById('applyShape'));
        maps.legendSettings.toggleLegendSettings.applyShapeSettings = false;
        maps.legendSettings.toggleLegendSettings.fill = "red";
        maps.legendSettings.toggleLegendSettings.opacity = 0.5;
    }
