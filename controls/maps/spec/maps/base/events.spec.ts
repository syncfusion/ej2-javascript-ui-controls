...
/**
 * Maps Mouse and Touch Events for spec documents
 */
...
export class MouseEvents {
    ...
    public doDoubleTab(
        ...
        map.mouseDownOnMap(<PointerEvent>this.onTouchStart(elem, x1, y1, null, null, x3, y3));
        map.mouseEndOnMap(<PointerEvent>this.onTouchEnd(elem, x1, y1, null, null, x3, y3));
        map.mouseDownOnMap(<PointerEvent>this.onTouchStart(elem, x1, y1, null, null, x3, y3));
        map.mouseEndOnMap(<PointerEvent>this.onTouchEnd(elem, x1, y1, null, null, x3, y3));
    }
    ...
    public dragAndDropEvent(
        ...
        endX: number, endY: number, type: string, map: Maps
    ): void {
        map.mouseDownOnMap(<PointerEvent>this.onPointerStart(element, startX, startY, 0, type));
        map.mouseMoveOnMap(<PointerEvent>this.onPointerMove(element, endX, endY, 0, type));
        map.mouseEndOnMap(<PointerEvent>this.onPointerEnd(element, endX, endY, 0, type));
    }
