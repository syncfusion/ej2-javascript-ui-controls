            ...
            setTimeout(function () {
                ...
                if (!document.getElementById(_this.mapObject.element.id + '_animated_tiles') && element) {
                    ...
                    if (type !== 'Pan' && element1 && element) {
                        ...
                        if (!sf.base.isNullOrUndefined(document.getElementById(_this.mapObject.element.id + '_animated_tiles'))) {
                ...
                var _loop_3 = function (tile) {
                    ...
                    imgElement.onload = function () {
                        ...
                        child = sf.base.createElement('div', { id: mapId + '_tile_' + id });
                    ...
                    for (var j = 0; j < this.layers[i].markerSettings.length; j++) {
                        var markerRendered = function () {
                            for (var x = 0; x < _this.layers.length; x++) {
                                ...
                                if (!sf.base.isNullOrUndefined(markerTemplateEle)) {
                        ...
                        sf.base.updateBlazorTemplate(this.element.id + '_MarkerTemplate' + j, 'MarkerTemplate', this.layers[i].markerSettings[j], undefined, markerRendered);
                    }
                }
            }
        }
...
var DataLabel = /** @class */ (function () {
    ...
    DataLabel.prototype.renderLabel = function (layer, layerIndex, shape, layerData, group, labelTemplateElement, index, intersect) {
        ...
        datasrcObj = this.getDataLabel(layer.dataSource, layer.shapeDataPath, shapeData['properties'][propertyPath], layer.shapeDataPath);
        if (!sf.base.isNullOrUndefined(shapes['property'])) {
            shapePoint = [[]];
        ...
        if ((Object.prototype.toString.call(layer.shapePropertyPath) === '[object Array]') &&
            (sf.base.isNullOrUndefined(text) && layer.dataSource['length'] === 0)) {
        ...
        if (sf.base.isNullOrUndefined(text) && (layer.dataLabelSettings.template !== "" && layer.dataSource['length'] === 0)) {
...
var Zoom = /** @class */ (function () {
    ...
    Zoom.prototype.alignToolBar = function () {
        ...
        var size = !sf.base.isNullOrUndefined(map.totalRect) ? map.totalRect : map.mapAreaRect;
        var x = 0;
        var y = 0;
