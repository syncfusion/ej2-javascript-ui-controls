...
let ctn2: string = '<div style="margin: 10px;">AngularJS (commonly referred to as "Angular.js" or "AngularJS 1.X") is a JavaScript-based open-source front-end web application framework mainly maintained by Google  First name:<br><input type="text" name="firstname" value="Mickey"><br>Last name:<br><input type="text" name="lastname" value="Mouse"><br><br><a class="link" href="https://www.syncfusion.com/">Syncfusion.com!</a><br><br><button class="e-btn">value</button></div>';
...
let acrdnObj: Accordion = new Accordion({
    ...
    expanding: expand,
    items: [
        { header: 'What is React?', content: ctn3 },
...
function create() {
    ...
    let acdnObj: Accordion = new Accordion({
        items: [
            { content: ctn1, header: 'React' }, { content: ctn2, header: 'Angular' }]
    });
