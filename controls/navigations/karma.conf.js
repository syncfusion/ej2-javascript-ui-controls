...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            { pattern: 'spec/images/file_icons.png', included: false },
            { pattern: 'spec/images/Shooting.png', included: false },
            { pattern: 'spec/images/Cricket.png', included: false },
            { pattern: 'demos/carousel/images/bird.jpg', included: false },
            { pattern: 'demos/carousel/images/nature.jpg', included: false },
            { pattern: 'demos/carousel/images/night-view.jpg', included: false },
            { pattern: 'demos/carousel/images/sea-view.jpg', included: false },
            { pattern: 'demos/carousel/images/snowfall.jpg', included: false },
