window.sf = window.sf || {};
window.sf.navigations = (function (exports) {
'use strict';
...
var MenuBase = /** @class */ (function (_super) {
            ...
            switch (prop) {
                ...
                case 'enableScrolling':
                    if (newProp.enableScrolling) {
                        ...
                        this_1.element.classList.contains('e-vertical') ? this_1.destroyScrollObj(sf.base.getInstance(ul_3, VScroll), ul_3)
                            : this_1.destroyScrollObj(sf.base.getInstance(ul_3, HScroll), ul_3);
    ...
    __decorate$2([
        sf.base.Complex({}, FieldSettings)
    ], MenuBase.prototype, "fields", void 0);
    __decorate$2([
        sf.base.Collection([], MenuItem)
    ], MenuBase.prototype, "items", void 0);
    __decorate$2([
        sf.base.Complex({}, MenuAnimationSettings)
...
var Toolbar = /** @class */ (function (_super) {
    ...
    Toolbar.prototype.eleContains = function (el) {
        // tslint:disable-next-line:max-line-length
        return el.classList.contains(CLS_SEPARATOR) || el.classList.contains(CLS_DISABLE$2) || el.getAttribute('disabled') || el.classList.contains(CLS_HIDDEN) || !sf.base.isVisible(el);
    ...
    Toolbar.prototype.clickHandler = function (e) {
        ...
        if ((sf.base.isNullOrUndefined(clst) || clst.classList.contains(CLS_DISABLE$2)) && !popupNav.classList.contains(CLS_TBARNAV)) {
            return;
        }
        if (clst) {
    ...
    Toolbar.prototype.enableItems = function (items, isEnable) {
        ...
        if (!sf.base.isNullOrUndefined(len) && len >= 1) {
            ...
            isEnable ? sf.base.removeClass(elements, CLS_DISABLE$2) : sf.base.addClass(elements, CLS_DISABLE$2);
        }
        else {
...
var Accordion = /** @class */ (function (_super) {
    ...
    Accordion.prototype.preRender = function () {
        ...
        if (!this.enablePersistence || sf.base.isNullOrUndefined(this.expandedItems)) {
            this.expandedItems = [];
        }
    };
    ...
    Accordion.prototype.clickHandler = function (e) {
        ...
        var index;
        var tglIcon;
        var acrdEle = sf.base.closest(trgt, '.' + CLS_ROOT$2);
        if (acrdEle !== this.element) {
            return;
        }
        trgt.classList.add('e-target');
        var acrdnItem = sf.base.closest(trgt, '.' + CLS_ITEM$1);
        ...
        var acrdnCtnItem;
        if (acrdnHdr) {
            acrdnCtnItem = sf.base.closest(acrdnHdr, '.' + CLS_ITEM$1);
        }
        else if (acrdnCtn) {
            acrdnCtnItem = sf.base.closest(acrdnCtn, '.' + CLS_ITEM$1);
        }
    ...
    Accordion.prototype.afterContentRender = function (trgt, eventArgs, acrdnItem, acrdnHdr, acrdnCtn, acrdnCtnItem) {
        ...
        var inlineEleAcrdn = acrdnCtn && !sf.base.isNullOrUndefined(sf.base.select('.' + CLS_ROOT$2, acrdnCtn)) && sf.base.isNullOrUndefined(sf.base.closest(trgt, inlineAcrdnSel));
        var nestContCheck = acrdnCtn && sf.base.isNullOrUndefined(sf.base.select('.' + CLS_ROOT$2, acrdnCtn)) || !(sf.base.closest(trgt, '.' + CLS_ROOT$2) === this.element);
    ...
    Accordion.prototype.eleMoveFocus = function (action, root, trgt) {
        var clst;
        var clstItem = sf.base.closest(trgt, '.' + CLS_ITEM$1);
        if (trgt === root) {
    ...
    Accordion.prototype.keyActionHandler = function (e) {
        ...
        if (sf.base.isNullOrUndefined(header) && !trgt.classList.contains(CLS_ROOT$2) && !trgt.classList.contains(CLS_HEADER)) {
            return;
        }
        var clst;
    ...
    Accordion.prototype.renderInnerItem = function (item, index) {
        ...
        if (item.disabled) {
            sf.base.addClass([innerEle], CLS_DISABLE$3);
        }
        if (item.visible === false) {
    ...
    Accordion.prototype.expand = function (trgt) {
        ...
        var eventArgs;
        var items = this.getItems();
        var trgtItemEle = sf.base.closest(trgt, '.' + CLS_ITEM$1);
        if (sf.base.isNullOrUndefined(trgt) || (sf.base.isVisible(trgt) && trgt.getAttribute('e-animate') !== 'true') || trgtItemEle.classList.contains(CLS_DISABLE$3)) {
            return;
        }
    ...
    Accordion.prototype.collapse = function (trgt) {
        ...
        var items = this.getItems();
        var trgtItemEle = sf.base.closest(trgt, '.' + CLS_ITEM$1);
        if (sf.base.isNullOrUndefined(trgt) || !sf.base.isVisible(trgt) || trgtItemEle.classList.contains(CLS_DISABLE$3)) {
            return;
        }
        var animation = {
                ...
                case 'items':
                    ...
                    if (!(newProp.items instanceof Array && oldProp.items instanceof Array)) {
                        ...
                        for (var j = 0; j < changedProp.length; j++) {
                            ...
                            var property = Object.keys(newProp.items[index])[0];
                            var item = sf.base.selectAll('.' + CLS_ITEM$1, this.element)[index];
...
var Tab = /** @class */ (function (_super) {
    ...
    Tab.prototype.destroy = function () {
        ...
        if (!this.isTemplate) {
            ...
            var cntEle = sf.base.select('.' + CLS_TAB + ' > .' + CLS_CONTENT$1, this.element);
    ...
    Tab.prototype.preRender = function () {
        var nested = sf.base.closest(this.element, '.' + CLS_CONTENT$1);
        this.prevIndex = 0;
        this.isNested = false;
        this.isPopup = false;
    ...
    Tab.prototype.renderContainer = function () {
        ...
        if (!sf.base.isNullOrUndefined(sf.base.select('.' + CLS_HEADER$1, this.element)) && !sf.base.isNullOrUndefined(sf.base.select('.' + CLS_CONTENT$1, this.element))) {
            this.renderHeader();
            this.tbItems = sf.base.select('.' + CLS_HEADER$1 + ' .' + CLS_TB_ITEMS, this.element);
    ...
    Tab.prototype.headerReady = function () {
        ...
        this.cntEle = sf.base.select('.' + CLS_TAB + ' > .' + CLS_CONTENT$1, this.element);
        ...
        if (!this.isTemplate) {
            ...
            if (count > 0) {
                ...
                hdrItems.forEach(function (item, index) {
                    ...
                    sf.base.selectAll('.' + CLS_ITEM$2, tabItems_1)[index].appendChild(wrap);
                });
            }
        }
    ...
    Tab.prototype.renderContent = function () {
        this.cntEle = sf.base.select('.' + CLS_CONTENT$1, this.element);
        ...
        if (this.isTemplate) {
            ...
            for (var i = 0; i < hdrItem.length; i++) {
                if (contents.length - 1 >= i) {
                    ...
                    sf.base.attributes(contents.item(i), { 'role': 'tabpanel', 'aria-labelledby': CLS_ITEM$2 + this.tabId + '_' + i });
    ...
    Tab.prototype.removeActiveClass = function () {
        ...
        if (tabHeader) {
            var tabItems = sf.base.selectAll('.' + CLS_TB_ITEM + '.' + CLS_ACTIVE$1, tabHeader);
    ...
    Tab.prototype.setCloseButton = function (val) {
        var trg = sf.base.select('.' + CLS_HEADER$1, this.element);
    ...
    Tab.prototype.triggerAnimation = function (id, value) {
        ...
        var cnt = sf.base.select('.' + CLS_CONTENT$1, this.element);
        var animateObj;
    ...
    Tab.prototype.keyPressed = function (trg) {
        var trgParent = sf.base.closest(trg, '.' + CLS_HEADER$1 + ' .' + CLS_TB_ITEM);
        ...
        if (!sf.base.isNullOrUndefined(this.popEle) && trg.classList.contains('e-hor-nav')) {
            ...
            if (!sf.base.isNullOrUndefined(trgParent) && trgParent.classList.contains(CLS_ACTIVE$1) === false) {
    ...
    Tab.prototype.getTrgContent = function (cntEle, no) {
        ...
        if (this.element.classList.contains(CLS_NEST$1)) {
            ele = sf.base.select('.' + CLS_NEST$1 + '> .' + CLS_CONTENT$1 + ' > #' + CLS_CONTENT$1 + this.tabId + '_' + no, this.element);
        }
        else {
    ...
    Tab.prototype.addVerticalClass = function () {
        if (this.isVertical()) {
            ...
            sf.base.addClass([this.hdrEle], [CLS_VERTICAL$1, tbPos]);
            if (!this.element.classList.contains(CLS_NEST$1)) {
    ...
    Tab.prototype.changeOrientation = function (place) {
        ...
        sf.base.removeClass([this.hdrEle], [CLS_VERTICAL$1, CLS_VLEFT, CLS_VRIGHT]);
    ...
    Tab.prototype.focusItem = function () {
        var curActItem = sf.base.select(' #' + CLS_ITEM$2 + this.tabId + '_' + this.selectedItem, this.hdrEle);
    ...
    Tab.prototype.setOrientation = function (place, ele) {
        ...
        if (place === 'Bottom' && (contentPos > headerPos)) {
            ...
            this.element.insertBefore(ele, sf.base.select('.' + CLS_CONTENT$1, this.element));
        }
    };
    ...
    Tab.prototype.setContentHeight = function (val) {
        ...
        if (this.heightAdjustMode === 'None') {
            ...
            if (this.isTemplate === true) {
                var cnt = sf.base.selectAll('.' + CLS_CONTENT$1 + ' > .' + CLS_ITEM$2, this.element);
    ...
    Tab.prototype.setActiveBorder = function () {
        ...
        var trg = sf.base.select('.' + CLS_TB_ITEM + '.' + CLS_ACTIVE$1, trgHdrEle);
        if (trg === null) {
            return;
        }
    ...
    Tab.prototype.setActive = function (value, skipDataBind) {
        ...
        if (!this.isTemplate) {
            ...
            sf.base.attributes(trg, { 'aria-controls': CLS_CONTENT$1 + this.tabId + '_' + value });
        }
        var id = trg.id;
        ...
        if (this.isTemplate) {
            if (sf.base.select('.' + CLS_CONTENT$1, this.element).children.length > 0) {
                var trg_1 = this.findEle(sf.base.select('.' + CLS_CONTENT$1, this.element).children, CLS_CONTENT$1 + this.tabId + '_' + no);
        ...
        if (!this.initRender && !skipDataBind) {
            ...
            var eventArg = {
                ...
                selectedItem: trg,
                selectedIndex: value,
                selectedContent: sf.base.select('#' + CLS_CONTENT$1 + this.tabId + '_' + this.selectingID, this.content),
    ...
    Tab.prototype.spaceKeyDown = function (e) {
        if ((e.keyCode === 32 && e.which === 32) || (e.keyCode === 35 && e.which === 35)) {
            var clstHead = sf.base.closest(e.target, '.' + CLS_HEADER$1);
    ...
    Tab.prototype.keyHandler = function (e) {
        ...
        var trg = e.target;
        var tabHeader = this.getTabHeader();
        var actEle = sf.base.select('.' + CLS_ACTIVE$1, tabHeader);
        ...
        switch (e.action) {
            ...
            case 'shiftTab':
                if (trg.classList.contains(CLS_WRAP)
                    && sf.base.closest(trg, '.' + CLS_TB_ITEM).classList.contains(CLS_ACTIVE$1) === false) {
    ...
    Tab.prototype.refreshActElePosition = function () {
        var activeEle = sf.base.select('.' + CLS_TB_ITEM + '.' + CLS_TB_POPUP + '.' + CLS_ACTIVE$1, this.element);
    ...
    Tab.prototype.evalOnPropertyChangeItems = function (newProp, oldProp) {
        if (!(newProp.items instanceof Array && oldProp.items instanceof Array)) {
            ...
            for (var i = 0; i < changedProp.length; i++) {
                ...
                var oldVal = Object(oldProp.items[index])[property];
                var newVal = Object(newProp.items[index])[property];
                var hdrItem = sf.base.select('.' + CLS_TB_ITEMS + ' #' + CLS_ITEM$2 + this.tabId + '_' + index, this.element);
                var cntItem = sf.base.select('.' + CLS_CONTENT$1 + ' #' + CLS_CONTENT$1 + this.tabId + '_' + index, this.element);
            ...
            if (sf.base.isNullOrUndefined(this.tbObj)) {
                ...
                this.templateEle = [];
                var selectElement = sf.base.select('.' + CLS_TAB + ' > .' + CLS_CONTENT$1, this.element);
    ...
    Tab.prototype.addingTabContent = function (items, index) {
        var _this = this;
        var lastEleIndex = 0;
        this.hdrEle = sf.base.select('.' + CLS_HEADER$1, this.element);
        if (sf.base.isNullOrUndefined(this.hdrEle)) {
            this.items = items;
            this.reRenderItems();
        }
    ...
    Tab.prototype.removeTab = function (index) {
        ...
        this.trigger('removing', removeArgs, function (tabRemovingArgs) {
            if (!tabRemovingArgs.cancel) {
                ...
                var cntTrg = sf.base.select('#' + CLS_CONTENT$1 + _this.tabId + '_' + _this.extIndex(trg.id), sf.base.select('.' + CLS_CONTENT$1, _this.element));
    ...
    Tab.prototype.hideTab = function (index, value) {
        ...
        if (value === true) {
            ...
            items = sf.base.selectAll('.' + CLS_TB_ITEM + ':not(.' + CLS_HIDDEN$1 + ')', this.tbItems);
    ...
    Tab.prototype.select = function (args) {
        ...
        this.content = sf.base.select('.' + CLS_CONTENT$1, this.element);
        ...
        if (!sf.base.isNullOrUndefined(this.prevItem) && !this.prevItem.classList.contains(CLS_DISABLE$4)) {
        ...
        var eventArg = {
            ...
            selectedContent: !sf.base.isNullOrUndefined(this.content) ?
                sf.base.select('#' + CLS_CONTENT$1 + this.tabId + '_' + this.selectedID, this.content) : null,
            selectingItem: trg,
            selectingIndex: args,
            selectingContent: !sf.base.isNullOrUndefined(this.content) ?
                sf.base.select('#' + CLS_CONTENT$1 + this.tabId + '_' + this.selectingID, this.content) : null,
            isSwiped: this.isSwipeed,
            cancel: false
        };
        if (!this.initRender) {
    ...
    Tab.prototype.selectingContent = function (args) {
        if (typeof args === 'number') {
            if (!sf.base.isNullOrUndefined(this.tbItem[args]) && (this.tbItem[args].classList.contains(CLS_DISABLE$4) ||
...
var TreeView = /** @class */ (function (_super) {
    ...
    TreeView.prototype.setEnableRtl = function () {
        this.enableRtl ? sf.base.addClass([this.element], RTL$1) : sf.base.removeClass([this.element], RTL$1);
    };
        ...
        if (this.fields.dataSource instanceof sf.data.DataManager) {
            if (this.fields.dataSource.ready) {
                this.fields.dataSource.ready.then(function (e) {
                    if (_this.fields.dataSource instanceof sf.data.DataManager && _this.fields.dataSource.dataSource.offline) {
                        _this.treeList.pop();
    ...
    TreeView.prototype.finalizeNode = function (element) {
        ...
        if (this.isLoaded) {
            var sNodes = sf.base.selectAll('.' + SELECTED$1, element);
            for (var i = 0; i < sNodes.length; i++) {
                this.selectNode(sNodes[i], null);
                break;
            }
            sf.base.removeClass(sNodes, SELECTED$1);
        }
    ...
    TreeView.prototype.doSelectionAction = function () {
        var sNodes = sf.base.selectAll('.' + SELECTED$1, this.element);
    ...
    TreeView.prototype.renderChildNodes = function (parentLi, expandChild, callback, loaded) {
        ...
        if (this.fields.dataSource instanceof sf.data.DataManager && (this.fields.dataSource.adaptorName !== 'BlazorAdaptor')) {
            ...
            this.treeList.push('false');
            if (this.fields.dataSource instanceof sf.data.DataManager && (this.fields.dataSource.dataSource.offline)) {
                this.treeList.pop();
    ...
    TreeView.prototype.inputFocusOut = function (e) {
        ...
        if (this.fields.dataSource instanceof sf.data.DataManager && !(this.fields.dataSource.dataSource.offline) && (this.fields.dataSource.adaptorName !== 'BlazorAdaptor')) {
    ...
    TreeView.prototype.dragAction = function (e, virtualEle) {
        ...
        if (this.fullRowSelect && !dropWrap && !sf.base.isNullOrUndefined(classList$$1) && classList$$1.contains(FULLROW)) {
    ...
    */
    ...
    TreeView.prototype.updateNode = function (target, newText) {
        ...
        this.trigger('nodeEditing', eventArgs, function (observedArgs) {
            if (!observedArgs.cancel) {
                if (_this.fields.dataSource instanceof sf.data.DataManager && !(_this.fields.dataSource.dataSource.offline) && (_this.fields.dataSource.adaptorName !== 'BlazorAdaptor')) {
...
var Sidebar = /** @class */ (function (_super) {
    ...
    Sidebar.prototype.setEnableRTL = function () {
        this.enableRtl ? (sf.base.addClass([this.element], RTL$2)) :
    ...
    Sidebar.prototype.documentclickHandler = function (e) {
        if (sf.base.closest(e.target, '.' + CONTROL$1 + '' + '.' + ROOT$1)) {
            return;
        }
        this.hide(e);
    };
...
sfBlazor.loadDependencies(sfBlazor.dependencyJson.navigations, () => {
    sf.navigations = sf.navigations({});
});
