...
import { Tab, SelectingEventArgs, RemoveEventArgs, AddEventArgs, SelectEventArgs, DragEventArgs, TabSwipeMode } from '../src/tab/tab';
...
describe('Tab Control', () => {
    ...
    describe('removeTab method testing', () => {
        ...
        it('Items - Remove all tab after addTab testing', (done: Function) => {
            ...
            expect(element.querySelectorAll('.e-toolbar-items').length).toEqual(0);
            expect(element.querySelectorAll('.e-toolbar-item').length).toEqual(0);
            expect(element.querySelector('.e-toolbar-items')).toBe(null);
            expect(element.querySelector('.e-content')).toBe(null);
            tab.addTab(newItems, 0);
            setTimeout(() => {
                let element: HTMLElement = document.getElementById('ej2Tab');
                expect(element.children.length).toEqual(2);
    ...
    describe('ES-962426 - Encountered a console error when switching between large header tabs in popup mode', () => {
        ...
        beforeEach(() => {
            ...
            tab = new Tab({
                ...
                items: [
                    ...
                    { header: { text: 'C Sharp(C#) C Sharp(C#) C Sharp(C#) C Sharp(C#)' }, content: 'Content2' },
        ...
        it('Verifying tab behavior with large headers in popup mode while resizing', function () {
            const element: HTMLElement = document.getElementById('ej2Tab');
            ...
            expect(element.querySelectorAll('.e-toolbar-items .e-toolbar-item').length).toEqual(0);
            tab.select(2);
            expect(document.getElementById('e-item-ej2Tab_2').classList.contains('e-active')).toBe(true);
        });
    });
    ...
    describe('Swipe event testing', () => {
        ...
        it('Items - Swipe right and left for block both Mouse and Touch testing', () => {
            tab = new Tab({
                items: [
                    { header: { "text": "item1" }, content: "Content1" },
                    { header: { "text": "item2" }, content: "Content2" }
        ...
        it('Items - Swipe right, left for Touch testing', () => {
            tab = new Tab({
                items: [
                    { header: { "text": "item1" }, content: "Content1" },
                    { header: { "text": "item2" }, content: "Content2" }
        ...
        it('Items - Swipe left to right testing at both touch and mouse enabled', () => {
            tab = new Tab({
                width: 100,
                selectedItem: 3,
                items: [
        ...
        it('Swipe left to right testing at mouse only', () => {
            tab = new Tab({
                items: [
                    { header: { "text": "item1" }, content: "Content1" },
                    { header: { "text": "item2" }, content: "Content2" }
    ...
    describe('Items [Popup] - Mobile adaptive mode [Handling]', () => {
        ...
        it('Select element from popup by click event when RTL enable state', () => {
            ...
            targetElement.click();
            expect(element.querySelectorAll('.e-toolbar-item.e-toolbar-popup').item(0).id).toEqual('e-item' + tab.tabId + '_1');
            expect(element.querySelectorAll('.e-toolbar-item.e-toolbar-popup').item(0).classList.contains('e-active')).toEqual(true);
            expect(element.querySelectorAll('.e-toolbar-item.e-toolbar-popup').item(1).id).toEqual('e-item' + tab.tabId + '_0');
            expect(element.querySelectorAll('.e-toolbar-item.e-toolbar-popup').item(1).classList.contains('e-active')).toEqual(false);
        });
    ...
    describe('ES-914300 - First item is selected when an item is removed even there is an item next to the removed item', () => {
        let tab: any;
        let ele: HTMLElement
        beforeEach((): void => {
            tab = undefined;
        ...
        it('Checking item next to the removed item is selected', (done: Function) => {
            tab = new Tab({
                items: [
                    { header: { 'text': 'Tab 1' }, content: 'Content 1' }
                ]
            ...
            tab.appendTo('#ej2Tab');
            tab.addTab([{ header: { 'text': 'Tab 2' }, content: 'Content 2' }], 1);
            expect(tab.items[1].visible).toBe(true);
            expect(tab.items[1].disabled).toBe(false);
            tab.selectedItem = 1;
            tab.dataBind();
            tab.addTab([{ header: { 'text': 'Tab 3' }, content: 'Content 3' }], 2);
            expect(tab.items[2].visible).toBe(true);
            expect(tab.items[2].disabled).toBe(false);
            tab.selectedItem = 2;
            tab.dataBind();
            tab.addTab([{ header: { 'text': 'Tab 4' }, content: 'Content 4' }], 3);
            expect(tab.items[3].visible).toBe(true);
            expect(tab.items[3].disabled).toBe(false);
            tab.selectedItem = 3;
            tab.dataBind();
            tab.addTab([{ header: { 'text': 'Tab 5' }, content: 'Content 5' }], 4);
            expect(tab.items[4].visible).toBe(true);
            expect(tab.items[4].disabled).toBe(false);
            tab.selectedItem = 4;
            tab.dataBind();
            tab.hideTab(2);
            expect(tab.items[2].visible).toBe(false);
            tab.hideTab(3);
            expect(tab.items[3].visible).toBe(false);
            tab.selectedItem = 1;
            tab.dataBind();
            tab.selecting = (args: SelectingEventArgs) => {
                expect(args.selectingIndex).toEqual(3);
                expect(args.selectedIndex).toEqual(args.selectingIndex);
                expect(args.selectedItem.innerText.toUpperCase()).toEqual('TAB 5');
                expect(args.selectedItem.innerText).toEqual(args.selectingItem.innerText);
                expect(args.selectedContent.innerText).toEqual('Content 5');
                expect(args.selectedContent.innerText).toEqual(args.selectingContent.innerText);
            }
            tab.selected = (args: SelectEventArgs) => {
                expect(args.previousIndex).toEqual(3);
                expect(args.previousIndex).toEqual(args.selectedIndex);
                expect(args.previousItem.innerText.toUpperCase()).toEqual('TAB 5');
                expect(args.previousItem.innerText).toEqual(args.selectedItem.innerText);
                expect(args.selectedContent.innerText).toEqual('Content 5');
                done();
            }
    ...
    describe('Checking support for render tab contents based on the loadOn mode scenarios', () => {
        let tab: Tab;
        beforeEach((): void => {
            tab = undefined;
            const ele: HTMLElement = createElement('div', { id: 'ej2Tab' });
        ...
        it('Render tab content dynamic mode', () => {
            tab = new Tab({
                showCloseButton: true,
                items: [
                    { header: { 'text': 'item1' }, content: 'Content1' },
            ...
            tab.appendTo('#ej2Tab');
            const element: HTMLElement = document.getElementById('ej2Tab');
            expect(element.querySelectorAll('.e-content > .e-item').length).toBe(1);
            const ele2: HTMLElement = <HTMLElement>element.querySelectorAll('.e-toolbar-item').item(1);
            ele2.click();
            expect(tab.selectedItem).toEqual(1);
            expect(element.querySelectorAll('.e-content > .e-item').length).toBe(1);
            expect(element.querySelector('.e-content').querySelectorAll('.e-item')[0].classList.contains('e-active')).toEqual(true);
            expect(element.querySelector('.e-content').querySelectorAll('.e-item')[0].id).toBe('e-content-ej2Tab_1');
            const target: HTMLElement = <HTMLElement>element.querySelectorAll('.e-toolbar-item .e-close-icon')[0];
            target.click();
            expect(tab.selectedItem).toEqual(0);
            expect(element.querySelectorAll('.e-content > .e-item').length).toBe(1);
            expect(element.querySelectorAll('.e-toolbar-item').item(0).classList.contains('e-active')).toEqual(true);
            ...
            expect(element.querySelectorAll('.e-content > .e-item').length).toBe(1);
            expect(element.querySelectorAll('.e-toolbar-item').item(1).classList.contains('e-active')).toEqual(true);
            expect(element.querySelector('.e-content').querySelectorAll('.e-item')[0].id).toBe('e-content-ej2Tab_2');
        });
        it('Render tab content init mode', () => {
            tab = new Tab({
                showCloseButton: true,
                loadOn: 'Init',
                items: [
            ...
            tab.appendTo('#ej2Tab');
            const element: HTMLElement = document.getElementById('ej2Tab');
            expect(element.querySelectorAll('.e-content > .e-item').length).toBe(3);
            const ele2: HTMLElement = <HTMLElement>element.querySelectorAll('.e-toolbar-item').item(1);
            ele2.click();
            expect(tab.selectedItem).toEqual(1);
            expect(element.querySelectorAll('.e-content > .e-item').length).toBe(3);
            ...
            expect(element.querySelectorAll('.e-content > .e-item').length).toBe(2);
            expect(element.querySelectorAll('.e-toolbar-item').item(1).classList.contains('e-active')).toEqual(true);
            expect(element.querySelector('.e-content').querySelectorAll('.e-item')[1].id).toBe('e-content-ej2Tab_2');
        });
        it('Negative selected item value – Render tab content in dynamic mode', () => {
            tab = new Tab({
                items: [
                    { header: { 'text': 'item1' }, content: 'Content1' },
                    { header: { 'text': 'item2' }, content: 'Content2' }
        ...
        it('Negative selected item value – Render tab content in init mode', () => {
            tab = new Tab({
                items: [
                    { header: { 'text': 'item1' }, content: 'Content1' },
                    { header: { 'text': 'item2' }, content: 'Content2' }
        ...
        it('Dynamic - checking dynamically adding, then removing, and re-adding tabs', () => {
            tab = new Tab({
                items: [
                    { header: { 'text': 'item1' }, content: 'Content1' },
                    { header: { 'text': 'item2' }, content: 'Content2' }
        ...
        it('Init - checking dynamically adding, then removing, and re-adding tabs', () => {
            tab = new Tab({
                items: [
                    { header: { 'text': 'item1' }, content: 'Content1' },
                    { header: { 'text': 'item2' }, content: 'Content2' }
    ...
    describe('Checking support for render tab contents based on the loadOn mode in hideTab scenorios', () => {
        let tab: Tab;
        beforeEach((): void => {
            tab = undefined;
            const ele: HTMLElement = createElement('div', { id: 'ej2Tab' });
        ...
        it('HidTab - Render tab content dynamic mode', () => {
            tab = new Tab({
                showCloseButton: true,
                items: [
                    { header: { 'text': 'item1' }, content: 'Content1' },
        ...
        it('HidTab - Render tab content init mode', () => {
            tab = new Tab({
                showCloseButton: true,
                loadOn: 'Init',
                items: [
    ...
    describe('Ensure content renders without a header', () => {
        let tab: Tab;
        beforeEach((): void => {
            tab = undefined;
            const ele: HTMLElement = createElement('div', { id: 'ej2Tab' });
        ...
        it('Init - Render tab content without header', () => {
            tab = new Tab({
                items: [
                    { content: 'Content1' },
                    { header: { 'text': 'item2' }, content: 'Content2' },
            ...
            const element: HTMLElement = document.getElementById('ej2Tab');
            expect(element.querySelectorAll('.e-content > .e-item').length).toBe(2);
            expect(element.querySelectorAll('.e-content > .e-item.e-active').length).toBe(1);
            expect(element.querySelectorAll('.e-content > .e-item')[0].id).toBe('e-content-ej2Tab_1');
            expect(element.querySelectorAll('.e-toolbar-item').item(0).classList.contains('e-active')).toEqual(true);
            expect(element.querySelectorAll('.e-toolbar-item').item(1).classList.contains('e-active')).toEqual(false);
            expect(element.querySelectorAll('.e-content > .e-item')[0].id)
            .toBe(element.querySelectorAll('.e-toolbar-item').item(0).firstElementChild.getAttribute('aria-controls'));
        
        });
        it('Dynamic - Render tab content without header', () => {
            tab = new Tab({
                loadOn: 'Dynamic',
                items: [
                    { content: 'Content1' },
    ...
    describe('enable persistence with nested tab testing', () => {
        let tabObj: Tab
        beforeAll((): void => {
            let css: string = ".e-hor-nav { position: absolute }";
            let style: HTMLStyleElement = document.createElement('style');
        ...
        it('selected tab with init mode testing', () => {
            expect(tabObj.selectedItem).toEqual(1);
            expect(tabObj.element.querySelectorAll('.e-toolbar-item').item(1).classList.contains('e-active')).toEqual(true);
            const parentContent: HTMLElement = tabObj.element.querySelector('.e-content') as HTMLElement;
            const items: HTMLCollection = parentContent.children;
            let activeItemsCount: number = 0;
            for (let i = 0; i < items.length; i++) {
                if (items[i].classList.contains('e-active')) {
                    activeItemsCount++;
                }
            }
    ...
    describe('Tab show/hide scenario with 7 tabs', () => {
        let tabObj: Tab;
        ...
        const tabItems = [
            ...
            {
                id: 'snapchat-tab',
                header: { text: 'Snapchat' },
                content: 'Snapchat Content',
            },
            {
                id: 'telegram-tab',
        ...
        beforeEach(() => {
            elem = createElement('div', { id: 'tab_default_scenario' });
            document.body.appendChild(elem);
            tabObj = new Tab({
                items: tabItems
            });
            tabObj.appendTo('#tab_default_scenario');
        });
        afterEach(() => {
            if (tabObj) {
                tabObj.destroy();
        ...
        it('should show Instagram and hide other apps', () => {
            let tabs = tabObj.element.querySelectorAll('.e-toolbar-item');
            expect(tabs[3].classList.contains('e-hidden')).toBe(true);
            tabObj.hideTab(tabObj.getItemIndex(tabs[4].getAttribute('data-id')), true);
            tabObj.hideTab(tabObj.getItemIndex(tabs[5].getAttribute('data-id')), true);
            tabObj.hideTab(tabObj.getItemIndex(tabs[6].getAttribute('data-id')), true);
            tabObj.hideTab(tabObj.getItemIndex(tabs[3].getAttribute('data-id')), false);
            tabObj.selectedItem = tabObj.getItemIndex(tabs[3].getAttribute('data-id'));
            tabs = tabObj.element.querySelectorAll('.e-toolbar-item');
            expect(tabs[3].classList.contains('e-hidden')).toBe(false);
            expect(tabs[4].classList.contains('e-hidden')).toBe(true);
            expect(tabs[5].classList.contains('e-hidden')).toBe(true);
        ...
        it('should show chat apps and hide Instagram', () => {
            ...
            tabObj.hideTab(tabObj.getItemIndex(tabs[4].getAttribute('data-id')), false);
            tabObj.hideTab(tabObj.getItemIndex(tabs[5].getAttribute('data-id')), false);
            tabObj.hideTab(tabObj.getItemIndex(tabs[6].getAttribute('data-id')), false);
            tabObj.selectedItem = tabObj.getItemIndex(tabs[4].getAttribute('data-id'));
            tabs = tabObj.element.querySelectorAll('.e-toolbar-item');
            expect(tabs[3].classList.contains('e-hidden')).toBe(true);
            expect(tabs[4].classList.contains('e-hidden')).toBe(false);
            expect(tabs[5].classList.contains('e-hidden')).toBe(false);
            expect(tabs[6].classList.contains('e-hidden')).toBe(false);
            expect(tabObj.selectedItem).toBe(4);
        });
    });
    ...
    it('memory leak', () => {
        ...
        describe('ISSUE: Tab Fill Mode - Regression Fix', () => {
        describe('Issue #1: Nested Div Without Explicit Parent Height', () => {
            let tab: Tab;
            let tabEle: HTMLElement;

            beforeEach(() => {
                // Create structure without explicit parent height
                const parentDiv = document.createElement('div');
                parentDiv.style.display = 'flex';
                parentDiv.style.flexDirection = 'column';
                // NO explicit height - this is the problem case
                
                const nestedDiv = document.createElement('div');
                nestedDiv.style.flex = '1';
                
                tabEle = document.createElement('div');
                tabEle.id = 'ej2_tab_issue_no_height';
                
                nestedDiv.appendChild(tabEle);
            ...
            it('should NOT introduce scrollbars in deeply nested structure', () => {
                ...
                tab = new Tab({
                    heightAdjustMode: 'Fill',
                    items: [
                        { header: { text: 'Tab 1' }, content: 'Some content here' },
                        { header: { text: 'Tab 2' }, content: 'More content' }
                    ]
                }, tabEle);

                const contentEle = tab.element.querySelector('.e-content') as HTMLElement;
                
                // Assert - No internal scrollbars should appear
                expect(contentEle.scrollHeight).toBeLessThanOrEqual(contentEle.clientHeight + 1);
            });
        });

        describe('Issue: Nested Div With Padding and Parent 100%', () => {
            let tab: Tab;
            let tabEle: HTMLElement;
            beforeEach(() => {
                ...
                const paddedParent = document.createElement('div');
                paddedParent.style.paddingTop = '70px';
                paddedParent.style.height = '100%';
                
                const nestedDiv = document.createElement('div');
                
                tabEle = document.createElement('div');
                tabEle.id = 'ej2_tab_issue_padding';
                
                nestedDiv.appendChild(tabEle);
                paddedParent.appendChild(nestedDiv);
                containerDiv.appendChild(paddedParent);
            ...
            it('should NOT introduce scrollbars despite padding in parent', () => {
                // Arrange & Act
                tab = new Tab({
                    heightAdjustMode: 'Fill',
                    items: [
                        { header: { text: 'Tab 1' }, content: 'Padded parent test' },
                        { header: { text: 'Tab 2' }, content: 'Second tab' }
                    ]
                }, tabEle);
                ...
                // Assert - Content should respect padding and not overflow
                const contentScrollHeight = contentEle.scrollHeight;
                const containerHeight = (tab.element as HTMLElement).offsetHeight;
                const headerHeight = headerEle.offsetHeight;

                expect(contentScrollHeight).toBeLessThanOrEqual(containerHeight - headerHeight + 1); // +1 for rounding
            });
        });
    });
