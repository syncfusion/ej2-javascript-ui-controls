...
describe('TreeView control', () => {
    ...
    describe('Hierarchical data binding testing', () => {
        describe('Default functionality testing', () => {
            ...
            it('showCheckBox property testing', (done: Function) => {
                ...
                jasmine.DEFAULT_TIMEOUT_INTERVAL = 10000;
                setTimeout(function() {
                    let checkEle: Element[] = <Element[] & NodeListOf<Element>>treeObj.element.querySelectorAll('li');
		    ...
		    let liElement: Element[] = <Element[] & NodeListOf<Element>>treeObj.element.querySelectorAll('li');
                    expect(liElement[1].getAttribute('aria-checked')).toBe('false');
			...
			let checkEle: Element[] = <Element[] & NodeListOf<Element>>treeObj.element.querySelectorAll('.e-checkbox-wrapper');
		        let liEle: Element[] = <Element[] & NodeListOf<Element>>treeObj.element.querySelectorAll('li');
                        ...
                        var e = new MouseEvent("click", { view: window, bubbles: true, cancelable: true });
                        checkEle[0].querySelector('.e-frame').dispatchEvent(e);
                        expect(liEle[0].getAttribute('aria-checked')).toBe('true');
                        treeObj.expandAll(['01']);
                        expect(liEle[1].getAttribute('aria-checked')).toBe('true');
            ...
            it('right arrow key pressed', (done: Function) => {
                ...
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        ...
                        expect(newli[1].classList.contains('e-hover')).toBe(false);
        ...
        describe('methods testing', () => {
            ...
            it('refreshNode parent and child nodes together rendered in DOM with parent in collapsed state', function () {
                ...
                treeObj.expandedNodes = ['04'];
                treeObj.dataBind();
                var newli = treeObj.element.querySelectorAll('li');
                expect(newli[3].querySelector('.e-list-icon').classList.contains('folder')).toBe(true);
                expect(newli[3].getAttribute('title')).toBe("This is refreshed node");
                expect(newli[3].querySelector('.e-list-url').href.indexOf('https://ej2.syncfusion.com/home/')).not.toBe(-1);
                ...
                treeObj.dataBind();
                var refreshedChild = newli[3].querySelector('ul li');
    ...
    describe('Drop position testing', function() {
        ...
        it('ensureVisible for self-referential data', (done: Function) => {
            ...
            setTimeout(function () {
                let li: Element[] = <Element[] & NodeListOf<Element>>treeObj.element.querySelectorAll('li');        
                expect(li[4].getAttribute('aria-expanded')).toBe('false');
                treeObj.ensureVisible('05-01-01');
                jasmine.DEFAULT_TIMEOUT_INTERVAL = 10000;
                setTimeout(function() {
                    expect(li[4].querySelector('.e-icons').classList.contains('e-icon-collapsible')).toBe(true);
                    expect(li[4].getElementsByTagName("li")[0].querySelector('.e-icons').classList.contains('e-icon-collapsible')).toBe(true);
                    done();
                }, 450);
            }, 450);
        });
    ...
    xdescribe('Checked Node on loadondemand enabled', () => {
        ...
        describe('LoadOnDemand for hierarchial data testing', () => {
            ...
            it('checkedNodes property testing', (done: Function) => {
                ...
                expect(li[8].getAttribute('aria-checked')).toBe("true");
                expect(li[19].getAttribute('aria-checked')).toBe("true");
                done();
            });
        ...
        describe('loadOnDemand for local data testing', () => {
            ...
            it('showCheckBox property testing', (done: Function) => {
                ...
                let checkEle: Element[] = <Element[] & NodeListOf<Element>>treeObj.element.querySelectorAll('.e-checkbox-wrapper');
                    ...
                    jasmine.DEFAULT_TIMEOUT_INTERVAL = 10000;
                    setTimeout(function() {
                        expect(li[1].getAttribute('aria-checked')).toBe('true');
                        done();
                    }, 450);
            });
            it('allowMultiSelection property testing', (done: Function) => {
            ...
            it('checkedNodes property testing', (done: Function) => {
                ...
                expect(treeObj.checkedNodes).toContain('20');
                expect(li[9].getAttribute('aria-checked')).toBe("true");
                expect(li[19].getAttribute('aria-checked')).toBe("true");
                done();
            });
        ...
        it('showCheckBox property testing', (done: Function) => {
            ...
            let checkEle: Element[] = <Element[] & NodeListOf<Element>>treeObj.element.querySelectorAll('.e-checkbox-wrapper');
                ...
                setTimeout(function() {
                    let li: Element[] = <Element[] & NodeListOf<HTMLLIElement>>document.getElementById('tree1').querySelectorAll('li')
                    expect(li[3].getAttribute('aria-checked')).toBe('true');
                    done();
                }, 450);
        });
        it('expandedNodes property testing', (done: Function) => {
