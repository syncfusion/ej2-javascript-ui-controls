...
let chart: AccumulationChart = new AccumulationChart({
    ...
    annotations: [{
        content: '<div>Tamil score:55.9</div>',
        region: 'Series',
...
let semiDoughnut: AccumulationChart = new AccumulationChart({
    ...
    annotations: [{
        content: '<div style="border: 1px solid black;background-color:#f5f5f5;fill:blue; padding: 5px 5px 5px 5px">Maths : 76.8</div>',
        region: 'Series',
        coordinateUnits: 'Point',
        x: 'Maths',
        y: 76.8,
...
let chartAnnotation: AccumulationChart = new AccumulationChart({
    width: '200',
    height: '200',
    background: 'transparent',
    series: [
        {
            dataSource: [{ x: 'Jan', y: 3 }, { x: 'Feb', y: 3.5 }, { x: 'Mar', y: 7 }],
            xName: 'x',
            yName: 'y',
            innerRadius: '80%'
        }
...
let piechart: AccumulationChart = new AccumulationChart({
    ...
    loaded: () => {
        chartAnnotation.appendTo('#annotation');
    }
}, '#container5');