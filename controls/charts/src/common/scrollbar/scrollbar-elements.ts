...
export class ScrollElements {
    ...
    private thumbGrip(scroll: ScrollBar, renderer: SvgRenderer, parent: Element, scrollBar: ScrollbarSettingsModel): void {
        let sidePadding: number = (scroll.component.theme.indexOf('Fluent2') > -1 || (scroll.component.theme.indexOf('Bootstrap5')) > -1 || scroll.component.theme.indexOf('Tailwind3') > -1) ? -5 : 0;
