...
     * * Right: Steps start from the right side of the 1st point. 
     ...
     */
    @Complex<SeriesAccessibilityModel>({}, SeriesAccessibility)
    public accessibility: SeriesAccessibilityModel;
     ...
     */
    public formatAccessibilityDescription(point: Points, series: Series): string {
        const format: string = series.accessibility.accessibilityDescriptionFormat;
        return format
