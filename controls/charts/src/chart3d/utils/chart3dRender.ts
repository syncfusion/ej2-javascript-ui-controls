...
export class Svg3DRenderer {
     ...
     */
    public colorNameToHex(colour: string): string  {
        ...
        const lowerCaseColor: string = colour.toLowerCase();
        if (colors[lowerCaseColor as string]) {
            return colors[lowerCaseColor as string];
        }
