        ...
        describe('Checking for multiple axes', () => {
            ...
            it('Checking mouse wheel zooming', (done: Function) => {
                loaded = (args: Object): void => {
                    ...
                    expect(chartObj.primaryXAxis.zoomFactor.toFixed(2)).toBe('1.00');
                    expect(chartObj.primaryYAxis.zoomFactor.toFixed(2)).toBe('1.00');
                    expect(chartObj.primaryXAxis.zoomPosition.toFixed(2)).toBe('0.00');
                    expect(chartObj.primaryYAxis.zoomPosition.toFixed(2)).toBe('0.00');
                    done();
                };
            ...
            it('Checking  zooming with touch', (done: Function) => {
                loaded = (args: Object): void => {
                    ...
                    expect(content == '0.31' || content == '1.00').toBe(true);
                    ...
                    expect(content == '0.70' || content =='0.00').toBe(true);
