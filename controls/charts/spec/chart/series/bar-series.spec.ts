...
describe('Chart Control', () => {
    ...
    /**
     * Check DataLabel IntersectAction
     */
    describe('LabelIntersectAction in DataLabel', () => {
        let chartObj: Chart;
        let loaded: EmitType<ILoadedEventArgs>;
        let element: HTMLElement;
        element = createElement('div', { id: 'container' });
                ...
                series: [
                    {
                        type:'Bar',
                        dataSource: [
                            { x: 1, y: 0.05 }, { x: 2, y: -3.5},
                            { x: 3, y: 7 }, { x: 5.8, y:  -13.5 },
                            { x: 5, y: 7 }, { x: 6, y: -13.5 },
                            { x: 7.8, y: -13.5 }, { x: 8, y: -13.5 },
                        ],
                        xName: 'x', width: 2, 
                        animation: { enable: false },
                        marker: {
        ...
        it(' checking labelIntersectAction as none ', (done: Function) => {
            loaded = (args: Object): void => {
                let label: HTMLElement = document.getElementById('container_Series_0_Point_5_Text_0');
                expect(label != null).toBe(true);
                done();
            };
            chartObj.loaded = loaded;
            chartObj.series[0].marker.dataLabel.labelIntersectAction = 'None';
            chartObj.refresh();
         });
        it(' checking as labelIntersectAction as hide', (done: Function) => {
            loaded = (args: Object): void => {
                let label: HTMLElement = document.getElementById('container_Series_0_Point_5_Text_0');
                expect(label == null).toBe(true);
                done();
            ...
            chartObj.loaded = loaded;
            chartObj.series[0].marker.dataLabel.labelIntersectAction = 'Hide';
            chartObj.refresh();
        });
        it(' checking as labelIntersectAction as none for top level datalabel', (done: Function) => {
            loaded = (args: Object): void => {
                let label: HTMLElement = document.getElementById('container_Series_0_Point_7_Text_0');
                expect(label != null).toBe(true);
                done();
            };
            chartObj.loaded = loaded;
        ...
        it(' checking as labelIntersectAction as hide for top level datalabel', (done: Function) => {
            loaded = (args: Object): void => {
                let label: HTMLElement = document.getElementById('container_Series_0_Point_7_Text_0');
                expect(label == null).toBe(true);
                done();
        ...
        it(' checking the intersect Datalabel in inverted', (done: Function) => {
            loaded = (args: Object): void => {
                let label: HTMLElement = document.getElementById('container_Series_0_Point_5_Text_0');
                expect(label == null).toBe(true);
                done();
        ...
        it(' checking after labelIntersectAction as none in inverted', (done: Function) => {
            loaded = (args: Object): void => {
                let label: HTMLElement = document.getElementById('container_Series_0_Point_5_Text_0');
                expect(label != null).toBe(true);
                done();
