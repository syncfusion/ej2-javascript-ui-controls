...
import { SplineRangeAreaSeries } from '../../../src/chart/series/spline-range-area-series';
...
Chart.Inject(
    SplineSeries, DataLabel, Category, DateTime, SplineRangeAreaSeries,
...
describe('Chart', () => {
    ...
    describe('Spline Range Area Series', () => {
        let chartObj: Chart;
            ...
            chartObj = new Chart(
                {
                    ...
                    {
                        dataSource: doubleData, xName: 'x', low: 'low', high: 'high', animation: { enable: false }, type: 'SplineRangeArea',
    ...
    describe('Inversed Spline Range Area Series', () => {
        let chartObj: Chart;
        let loaded: EmitType<ILoadedEventArgs>;
        let animate: EmitType<IAnimationCompleteEventArgs>;
        let trigger: MouseEvents = new MouseEvents();
        ...
        it('Checking inversed  spline range area series', (done: Function) => {
            loaded = (args: Object): void => {
                let svg = document.getElementById('container_Series_0');
        ...
        it('Checking transposed  spline range area series', (done: Function) => {
            loaded = (args: Object): void => {
                let svg = document.getElementById('container_Series_0');
                let bounds: ClientRect = svg.getBoundingClientRect();
        ...
        it('Checking inversed & transposed  spline range area series', (done: Function) => {
            loaded = (args: Object): void => {
                let svg = document.getElementById('container_Series_0');
                let bounds: ClientRect = svg.getBoundingClientRect();
                expect(bounds.top == 50.25 || bounds.top == 53.25).toBe(true);
        ...
        it('Checking spline range area series with Monotonic Splinetype', (done: Function) => {
            loaded = (args: Object): void => {
                let seriesElements: number = document.getElementById('containerSeriesGroup0').childNodes.length;
        ...
        it('Checking spline range area series with Cardinal Splinetype', (done: Function) => {
            loaded = (args: Object): void => {
                let seriesElements: number = document.getElementById('containerSeriesGroup0').childNodes.length;
                expect(seriesElements == 2).toBe(true);
                done();
        ...
        it('Checking spline range area series with Clamped Splinetype', (done: Function) => {
            loaded = (args: Object): void => {
                let seriesElements: number = document.getElementById('containerSeriesGroup0').childNodes.length;
                expect(seriesElements == 2).toBe(true);
                done();
