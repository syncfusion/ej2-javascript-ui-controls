/**
 * Test cases for BollingerBand indicators
 */
...
import { BollingerBands } from '../../../src/chart/technical-indicators/bollinger-bands';
...
Chart.Inject(Zoom, Legend, BollingerBands, LineSeries, CandleSeries, Category,
    Tooltip, Crosshair);
...
describe('Chart', () => {
    ...
    describe('BollingerBand Indicators', () => {
        let chartObj: Chart;
        ...
        it('BollingerBand Technical Indicators without series', (done: Function) => {
            loaded = (args: Object): void => {
                done();
            };
            chartObj.loaded = loaded;
            chartObj.indicators = [{
                type: 'BollingerBands', period: 3, animation: { enable: false }
            }];
            chartObj.refresh();

        });

        it('BollingerBand Technical indicator for a series with 0 points', (done: Function) => {
            loaded = (args: Object): void => {
        ...
        it('BollingerBand Technical Indicator for a series with 1 point', (done: Function) => {
            loaded = (args: Object): void => {
        ...
        it('BollingerBand Technical indicator for a series with valid points & primary axis', (done: Function) => {
            loaded = (args: Object): void => {
                ...
                expect(Math.round(<number>chartObj.visibleSeries[2].points[0].y)).toBe(3);
                expect(chartObj.visibleSeries[1].points[3].x).toBe('Jun');
                expect(Math.round(<number>chartObj.visibleSeries[2].points[5].y)).toBe(10);
                done();
            };
        ...
        //negative points
        it('BollingerBand Technical indicator for a series with negative points', (done: Function) => {
            loaded = (args: Object): void => {
                ...
                expect(Math.round(<number>chartObj.visibleSeries[2].points[3].y)).toBe(5);
                done();
        ...
        it('BollingerBand Technical indicator for a series with secondary y axis', (done: Function) => {
            loaded = (args: Object): void => {
        ...
        it('BollingerBand Technical indicator with hidden series', (done: Function) => {
            loaded = (args: Object): void => {
        ...
        it('BollingerBand Technical indicator with opposed position', (done: Function) => {
            loaded = (args: Object): void => {
        ...
        //plot offset
        it('BollingerBand Technical indicator with secondary axis and plot offset', (done: Function) => {
            loaded = (args: Object): void => {
        ...
        it('BollingerBand Technical indicator with custom color', (done: Function) => {
            loaded = (args: Object): void => {
        ...
        it('BollingerBand Technical indicator with custom stroke style', (done: Function) => {
            loaded = (args: Object): void => {
        ...
        //tooltip
        it('BollingerBand Technical indicator with tooltip', (done: Function) => {
            loaded = (args: Object): void => {
        ...
        //crosshair
        it('BollingerBand Technical indicator with cross hair', (done: Function) => {
            loaded = (args: Object): void => {
        ...
        //trackball
        it('BollingerBand Technical indicator with track ball', (done: Function) => {
            loaded = (args: Object): void => {
        ...
        //resizing charts
        it('BollingerBand Technical indicator when resizing the chart', (done: Function) => {
            loaded = (args: Object): void => {
        ...
        it('checking mouse wheel zooming', (done: Function) => {
            loaded = (args: Object): void => {
                ...
                expect(chartObj.primaryYAxis.zoomPosition.toFixed(2) == '0.01' ||
        ...
        it('checking zooming with touch', (done: Function) => {
            loaded = (args: Object): void => {
                ...
                expect(content == '0.02'  || content == '0.23' || content == '0.19').toBe(true);
                ...
                expect(content == '0.625'  || content == '0.72' || content == '0.65').toBe(true);
        ...
        //---multiple panel----
        it('BollingerBand Technical indicator using panels', (done: Function) => {
            loaded = (args: Object): void => {
        ...
        it('Checking with bollinger band - color', (done: Function) => {
            loaded = (args: Object): void => {
                chartObj.loaded = null;
                let target: HTMLElement = document.getElementById('container_Indicator_0_BollingerBand');
                expect(target.getAttribute('fill')).toBe('violet');
                done();
            };
            chartObj.indicators[0].bandColor = 'violet';
            chartObj.loaded = loaded;
            chartObj.refresh();
        });
        it('Checking with bollinger band - enable', (done: Function) => {
            loaded = (args: Object): void => {
                chartObj.loaded = null;
                let target: HTMLElement = document.getElementById('container_Indicator_0_BollingerBand');
            ...
            chartObj.indicators[0].bandColor = 'transparent';
            chartObj.loaded = loaded;
            chartObj.refresh();
        });
    });
