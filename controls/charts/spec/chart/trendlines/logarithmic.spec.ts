/**
 * Test cases for logarithmic trendlines
 */
...
describe('Chart', () => {
    ...
    describe('Logarithmic Trendlines', () => {
        let chartObj: Chart;
        ...
        it('Logarithmic Trendlines without series points and with trendline emptycollection', (done: Function) => {
        ...
        it('Logarithmic Trendlines without series points and with trendline validcollection', (done: Function) => {
            loaded = (args: Object): void => {
                let svg: number = document.getElementById('containerSeriesGroup0').childNodes.length;
                expect(svg == 1).toBe(true);
                let xAxisLabelCollection: HTMLElement = document.getElementById('containerAxisLabels0');
            ...
            chartObj.loaded = loaded;
            chartObj.series[0].trendlines = [{ type: 'Logarithmic' }];
            chartObj.refresh();
        });

        it('Logarithmic Trendlines with series points and with trendline emptycollection', (done: Function) => {
            loaded = (args: Object): void => {
                let svg: number = document.getElementById('containerSeriesGroup0').childNodes.length;
        ...
        it('Logarithmic Trendlines with series points and with trendline validcollection', (done: Function) => {
            loaded = (args: Object): void => {
            ...
            chartObj.loaded = loaded;
            chartObj.series[0].trendlines = [{ type: 'Logarithmic', animation: { enable: false } }];
            chartObj.refresh();
        });

        it('Logarithmic Trendlines with default appearance', (done: Function) => {
            loaded = (args: Object): void => {
        ...
        it('Logarithmic Trendlines with custom appearance', (done: Function) => {
            loaded = (args: Object): void => {
                let stroke: string = document.getElementById('container_Series_0_TrendLine_0').getAttribute('stroke');
        ...
        it('Logaritmic Trendlines with marker', (done: Function) => {
            loaded = (args: Object): void => {
        ...
        it('Logarithmic Trendlines with default forecast values', (done: Function) => {
            loaded = (args: Object): void => {
                let path: string = document.getElementById('container_Series_0_TrendLine_0').getAttribute('d');
                expect(path !== null).toBe(true);
                expect(chartObj.visibleSeries[1].points[0].x).toBe(1973);
        ...
        it('Logarithmic Trendlines with custom forwardforecast positive values', (done: Function) => {
            loaded = (args: Object): void => {
                let path: string = document.getElementById('container_Series_0_TrendLine_0').getAttribute('d');
                expect(path !== null).toBe(true);
                expect(chartObj.visibleSeries[1].points[0].x).toBe(1973);
        ...
        it('Logarithmic Trendlines with forwardforecast negative values', (done: Function) => {
            loaded = (args: Object): void => {
                let path: string = document.getElementById('container_Series_0_TrendLine_0').getAttribute('d');
                expect(path !== null).toBe(true);
                expect(chartObj.visibleSeries[1].points[0].x).toBe(1973);
        ...
        it('Logarithmic Trendlines with backward forecast positive values', (done: Function) => {
            loaded = (args: Object): void => {
                let path: string = document.getElementById('container_Series_0_TrendLine_0').getAttribute('d');
                expect(path !== null).toBe(true);
        ...
        it('Logarithmic Trendlines with enableLegend', (done: Function) => {
            loaded = (args: Object): void => {
        ...
        it('Logarithmic Trendlines with disableLegend', (done: Function) => {
            loaded = (args: Object): void => {
                let legendElement: Element = document.getElementById('container_chart_legend_g_1');
                expect(legendElement === null);
        ...
        it('Logarithmic Trendlines with tooltip', (done: Function) => {
            loaded = (args: Object): void => {
                ...
                expect(tooltip.childNodes[0].childNodes[0].childNodes[1].textContent.replace(/\u200E/g, '')).toEqual('Logarithmic1993 : 28.157');
        ...
        it('Logarithmic Trendlines with trackball', (done: Function) => {
            loaded = (args: Object): void => {
    ...
    describe('Logarithmic Trendlines with category data', () => {
        let chartObj: Chart;
        let loaded: EmitType<ILoadedEventArgs>;
        let trigger: MouseEvents = new MouseEvents();
        element = createElement('div', { id: 'container' });
            ...
            chartObj = new Chart(
                {
                    ...
                    series: [{
                        ...
                        trendlines: [{ type: 'Logarithmic',
                         name: 'Logarithmic_trend1', fill: 'red', enableTooltip: true, marker: { visible: true } }],
                    },
                    {
                        name: 'MTBV',
                        width: 2,
                        ...
                        trendlines: [{ type: 'Logarithmic',
                        name: 'Logarithmic_trend2', fill: 'red', enableTooltip: true, marker: { visible: true } }],
                    }],
                    title: 'Online trading'
                });
            chartObj.appendTo('#container');
        ...
        it('Logarithmic Trendlines with category values', (done: Function) => {
            loaded = (args: Object): void => {
                let svg: number = document.getElementById('containerSeriesGroup0').childNodes.length;
