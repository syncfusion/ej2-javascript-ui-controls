...
describe('Chart Control', () => {
    ...
    describe('Polar Radar Smart Datalabel', () => {
        ...
        it('Polar Chart: datalabel count check with X axis label inside', (done: Function) => {
            chartObj.loaded = (args: Arg): void => {
                let datalabel: Element = getElement("containerTextGroup0");
                expect(datalabel.childElementCount === 16 || datalabel.childElementCount === 31 || datalabel.childElementCount === 19).toBe(true);
                done();
            };
        ...
        it('Polar Chart: datalabel count check with Y axis label inside', (done: Function) => {
            chartObj.loaded = (args: Arg): void => {
                let datalabel: Element = getElement("containerTextGroup0");
                expect(datalabel.childElementCount === 14 || datalabel.childElementCount === 31 || datalabel.childElementCount === 16 || datalabel.childElementCount === 17).toBe(true);
                done();
            };
        ...
        it('Radar Chart: datalabel count check with X axis label outside', (done: Function) => {
            chartObj.loaded = (args: Arg): void => {
                let datalabel: Element = getElement("containerTextGroup0");
                expect(datalabel.childElementCount === 36 || datalabel.childElementCount === 31 || datalabel.childElementCount === 28 || datalabel.childElementCount === 32).toBe(true);
                done();
            };
            chartObj.series[0].type = 'Radar';
    ...
    describe('Radar series - Checking stacking area series', () => {
        ...
        it('Radar Chart: Checking highlight with tooltip', function (done) {
            chartObj.loaded = function (args) {
                let element = document.getElementById('container_Series_0_Point_1');
