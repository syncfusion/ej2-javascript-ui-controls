...
describe('Range navigator', () => {
    ...
    describe('Checking with tailwind 3 themes', () => {
        let element: Element;
        let targetElement: Element;
        let range: RangeNavigator;
        let rangeElement: HTMLElement = createElement('div', { id: 'container' });
        ...
        it('checking tailwind3 theme', (done: Function) => {
            range.loaded = (args: Object): void => {
                element = document.getElementById('containerSeriesGroup0');
                expect(element !== null).toBe(true);
                done();
            };
            range.changed = null;
            range.theme = 'Tailwind3';
            range.refresh();
        });
        it('checking tailwind3 theme', (done: Function) => {
            range.loaded = (args: Object): void => {
