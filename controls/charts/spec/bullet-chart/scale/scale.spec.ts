...
describe('Bullet Chart Scale', () => {
    ...
    describe('with multiple data', () => {
        ...
        it('Checking theme as Material3 with valueFill as null with enableRtl with minimum width', (done: Function) => {
            bullet.theme = 'Material3Dark';
            bullet.dataSource = [
                { value: -1, target: 75, category: 'Year 1' },
            ];
        ...
        it('Checking theme as Material3 with valueFill as null with enableRtl with minimum height', (done: Function) => {
            bullet.theme = 'Material3Dark';
            bullet.dataSource = [
                { value: -1, target: 75, category: 'Year 1' },
            ];
        ...
        it('Checking theme as Material3 with valueFill as null with enableRtl with minimum height with titleStyle as Right', (done: Function) => {
            bullet.theme = 'Material3Dark';
            bullet.dataSource = [
                { value: -1, target: 75, category: 'Year 1' },
            ];
        ...
        it('Checking theme as Material3 with valueFill as null with enableRtl with minimum height with titleStyle as Left', (done: Function) => {
            bullet.theme = 'Material3Dark';
            bullet.dataSource = [
                { value: -1, target: 75, category: 'Year 1' },
            ];
        ...
        it('Checking theme as Material3 with valueFill as null with enableRtl with minimum height with titleStyle as Bottom', (done: Function) => {
            bullet.theme = 'Material3Dark';
            bullet.dataSource = [
                { value: -1, target: 75, category: 'Year 1' },
            ];
