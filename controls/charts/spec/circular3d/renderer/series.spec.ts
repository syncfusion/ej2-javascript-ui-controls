    ...
    describe('Pie Series checking', () => {
        ...
        it('Check pie series with multiple points and various radius', (done: Function) => {
            pie.loaded = () => {
                ...
                Element = getElement(id + '-svg-10-region-series-0-point-8');
                expect(Element.getAttribute('d')).toBe('M 259.294607695781 133.9331320754523 L 259.294607695781 133.9331320754523 L 266.29849789740723 130.10029502187484 L 273.6591452967249 127.00740192662717 L 281.29863158815283 124.68719352245353 L 289.1360867347164 123.16423106023863 L 297.08854504169375 122.45463630863702 L 305.0718234144642 122.56592089233258 L 313.00141250350424 123.49690677551838 L 320.7933713030496 125.23773873234227 L 328.3652157333882 127.76998867230917 L 335.63679180043107 131.06685071627197 L 300 200 ');
                Element = getElement(id + '-svg-4-region-series-0-point-8');
