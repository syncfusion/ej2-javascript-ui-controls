...
export class Annotation {
    ...
    public deleteAnnotation(): void {
        ...
        if (selectedAnnotation){
            const data : string = window.sessionStorage.getItem(this.pdfViewerBase.documentId + '_formfields');
            ...
            for (let i: number = 0; i < storageLength; i++) {
                if (window.sessionStorage.key(i) && window.sessionStorage.key(i).split('_')[3]) {
                    if (window.sessionStorage.key(i).split('_')[3] === 'annotations') {
                        this.pdfViewerBase.annotationStorage[window.sessionStorage.key(i)] =
    ...
    public storeAnnotations(pageNumber: number, annotation: any, annotationId: string): number {
        ...
        let storeObject: string = window.sessionStorage.getItem(this.pdfViewerBase.documentId + annotationId);
        if (this.pdfViewerBase.isStorageExceed) {
    ...
    public getStoredAnnotations(pageIndex: number, shapeAnnotations: any[], idString: string): any[] {
        ...
        let storeObject: string = window.sessionStorage.getItem(this.pdfViewerBase.documentId + idString);
        if (this.pdfViewerBase.isStorageExceed) {
    ...
    private updateCollection(annotationId: any, pageNumber: number, annotation: any, annotationType: string): void {
        let annotationCollection: any[];
        let storeObject: string = window.sessionStorage.getItem(this.pdfViewerBase.documentId + '_annotations_' + annotationType);
        if (this.pdfViewerBase.isStorageExceed) {
    ...
    private getPageShapeAnnotations(pageNumber: number): any {
        ...
        const inkObject: string = window.sessionStorage.getItem(this.pdfViewerBase.documentId + '_annotations_ink');
        if (inkObject) {
        ...
        const shapeObject: string = window.sessionStorage.getItem(this.pdfViewerBase.documentId + '_annotations_shape');
        if (shapeObject) {
        ...
        const measureObject: string = window.sessionStorage.getItem(this.pdfViewerBase.documentId + '_annotations_shape_measure');
        if (measureObject) {
        ...
        const stampObject: string = window.sessionStorage.getItem(this.pdfViewerBase.documentId + '_annotations_stamp');
        if (stampObject) {
        ...
        const freeTextObject: string = window.sessionStorage.getItem(this.pdfViewerBase.documentId + '_annotations_freetext');
        if (freeTextObject) {
        ...
        const stickyObject: string = window.sessionStorage.getItem(this.pdfViewerBase.documentId + '_annotations_sticky');
        if (stickyObject) {
        ...
        const textMarkupObject: string = window.sessionStorage.getItem(this.pdfViewerBase.documentId + '_annotations_textMarkup');
        if (textMarkupObject) {
