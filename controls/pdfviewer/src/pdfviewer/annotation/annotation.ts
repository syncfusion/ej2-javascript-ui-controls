...
export class Annotation {
    ...
    public deleteAnnotation(): void {
        ...
        if (selectedAnnotation){
            const data : string = PdfViewerBase.sessionStorageManager.getItem(this.pdfViewerBase.documentId + '_formfields');
    ...
    public clearAnnotationStorage(): void {
        ...
        if (sessionSize > maxSessionSize) {
            const storageLength: number = PdfViewerBase.sessionStorageManager.getSessionLength();
    ...
    private getTextMarkupAnnotations(pageIndex: number, annotation: AnnotationsInternal): IPageAnnotations {
        let storeObject: string = PdfViewerBase.sessionStorageManager.getItem(this.pdfViewerBase.documentId + '_annotations_textMarkup');
            ...
            case 'Resize':
                if (isLineShapes(actionObject.annotation)) {
                    this.pdfViewer.nodePropertyChange(
                        actionObject.annotation, { bounds: actionObject.redoElement.bounds, vertexPoints:
    ...
    public storeAnnotations(pageNumber: number, annotation: any, annotationId: string): number {
        ...
        let storeObject: string = PdfViewerBase.sessionStorageManager.getItem(this.pdfViewerBase.documentId + annotationId);
        if (this.pdfViewerBase.isStorageExceed) {
    ...
    public getStoredAnnotations(pageIndex: number, shapeAnnotations: any[], idString: string): any[] {
        ...
        let storeObject: string = PdfViewerBase.sessionStorageManager.getItem(this.pdfViewerBase.documentId + idString);
        if (this.pdfViewerBase.isStorageExceed) {
    ...
    private updateCollection(annotationId: any, pageNumber: number, annotation: any, annotationType: string): void {
        let annotationCollection: any[];
        let storeObject: string = PdfViewerBase.sessionStorageManager.getItem(this.pdfViewerBase.documentId + '_annotations_' + annotationType);
        if (this.pdfViewerBase.isStorageExceed) {
    ...
    private getPageShapeAnnotations(pageNumber: number): any {
        ...
        const inkObject: string = PdfViewerBase.sessionStorageManager.getItem(this.pdfViewerBase.documentId + '_annotations_ink');
        if (inkObject) {
        ...
        const shapeObject: string = PdfViewerBase.sessionStorageManager.getItem(this.pdfViewerBase.documentId + '_annotations_shape');
        if (shapeObject) {
        ...
        const measureObject: string = PdfViewerBase.sessionStorageManager.getItem(this.pdfViewerBase.documentId + '_annotations_shape_measure');
        if (measureObject) {
        ...
        const stampObject: string = PdfViewerBase.sessionStorageManager.getItem(this.pdfViewerBase.documentId + '_annotations_stamp');
        if (stampObject) {
        ...
        const freeTextObject: string = PdfViewerBase.sessionStorageManager.getItem(this.pdfViewerBase.documentId + '_annotations_freetext');
        if (freeTextObject) {
        ...
        const stickyObject: string = PdfViewerBase.sessionStorageManager.getItem(this.pdfViewerBase.documentId + '_annotations_sticky');
        if (stickyObject) {
        ...
        const textMarkupObject: string = PdfViewerBase.sessionStorageManager.getItem(this.pdfViewerBase.documentId + '_annotations_textMarkup');
        if (textMarkupObject) {
