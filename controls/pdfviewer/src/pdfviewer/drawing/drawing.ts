                ...
                for (let j: number = 0; j < copiedItems.length; j++) {
                    ...
                    if (addedAnnot.formFieldAnnotationType && addedAnnot.pageIndex === index) {
                        ...
                        const formField: FormFieldModel = {
                            ...
                            // eslint-disable-next-line max-len
                            isPrint: addedAnnot.isPrint, isSelected: (addedAnnot as PdfFormFieldBaseModel).isSelected, isChecked: (addedAnnot as PdfFormFieldBaseModel).isChecked, tooltip: (addedAnnot as PdfFormFieldBaseModel).tooltip, bounds: addedAnnot.bounds as IFormFieldBound, thickness: addedAnnot.thickness, borderColor: (addedAnnot as PdfFormFieldBaseModel).borderColor, signatureIndicatorSettings: (addedAnnot as PdfFormFieldBaseModel).signatureIndicatorSettings, insertSpaces : (addedAnnot as PdfFormFieldBaseModel).insertSpaces, isMultiline : (addedAnnot as PdfFormFieldBaseModel).isMultiline,  isTransparent : (addedAnnot as PdfFormFieldBaseModel).isTransparent, options : (addedAnnot as PdfFormFieldBaseModel).options, pageIndex : addedAnnot.pageIndex, pageNumber : (addedAnnot as PdfFormFieldBaseModel).pageNumber, rotateAngle : (addedAnnot as PdfFormFieldBaseModel).rotateAngle, signatureType : (addedAnnot as any).signatureType, zIndex : (addedAnnot as PdfFormFieldBaseModel).zIndex, selectedIndex : (addedAnnot as PdfFormFieldBaseModel).selectedIndex
                        };
