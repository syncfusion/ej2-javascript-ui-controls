...
/** @hidden */
export const TABULAR_ROW_BUTTON: string = 'e-tabular-row-btn';
/** @hidden */
export const TABULAR_PIVOT_BUTTON: string = 'e-tabular-pvt-btn';
/** @hidden */
export const GROUP_ROW: string = 'e-group-row';
/** @hidden */
export const FREEZE_LEFT_BORDER: string = 'e-freezeleftborder';
/** @hidden */
