...
export class PivotEngine {
    ...
    public getFormattedValue(value: number | string, fieldName: string): IAxisSet {
        ...
        if (this.formatFields[fieldName as string] && (this.formatFields[fieldName as string].format || this.formatFields[fieldName as string].skeleton) && !isNullOrUndefined(value)) {
            try {
