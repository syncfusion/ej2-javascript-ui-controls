...
module.exports = function (config) {
  config.set({
    ...
    files: [
        ...
        { pattern: "spec/base/calculated-field.spec.js", included: false },
        { pattern: "spec/base/aggregation.spec.js", included: false },
        { pattern: "spec/base/date-filter.spec.js", included: false },
        { pattern: "spec/base/grouping.spec.js", included: false },
        { pattern: "spec/base/label-filter.spec.js", included: false },
        { pattern: "spec/base/member-filter.spec.js", included: false },
        { pattern: "spec/base/number-filter.spec.js", included: false },
        { pattern: "spec/base/value-filter.spec.js", included: false },
        { pattern: "spec/field-list/pivotfieldlist.spec.js", included: false },
        { pattern: "spec/field-list/member-editor.spec.js", included: false },
        { pattern: "spec/field-list/render-mode.spec.js", included: false },
        { pattern: "spec/field-list/mobile.spec.js", included: false },
        { pattern: "spec/field-list/member-filter.spec.js", included: false },
        { pattern: "spec/field-list/label-filter.spec.js", included: false },
        { pattern: "spec/field-list/date-filter.spec.js", included: false },
        { pattern: "spec/field-list/number-filter.spec.js", included: false },
        { pattern: "spec/field-list/value-filter.spec.js", included: false },
        ...
        { pattern: "spec/pivotview/no-data.spec.js", included: false },
        { pattern: "spec/pivotview/member-editor.spec.js", included: false },
        { pattern: "spec/pivotview/drill-through.spec.js", included: false },
        { pattern: "spec/pivotview/editing.spec.js", included: false },
        { pattern: "spec/pivotview/grid-options.spec.js", included: false },
        { pattern: "spec/pivotview/exporting.spec.js", included: false },
        { pattern: "spec/pivotview/hyperlink.spec.js", included: false },
        { pattern: "spec/pivotview/show-hide-totals.spec.js", included: false },
        { pattern: "spec/pivotview/selection.spec.js", included: false },
        { pattern: "spec/pivotview/single-measure.spec.js", included: false },
        ...
        { pattern: "spec/pivotview/drag-and-drop.spec.js", included: false },
        { pattern: "spec/pivotview/sorting.spec.js", included: false },
        { pattern: "spec/pivotview/aggregated-info.spec.js", included: false },
