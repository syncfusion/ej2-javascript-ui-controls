...
export class QRCode {
    ...
    public draw(
        ...
        margin?: MarginModel, displayText?: DisplayTextModel, mode?: boolean, foreColor?: string, logo?: QRCodeLogoModel):
        boolean {
        this.isSvgMode = mode;
        this.generateValues();
        if (this.validInput) {
            ...
            if (imageAttributes) {
                this.drawImage(canvas as HTMLCanvasElement, [imageAttributes] as any);
            }
