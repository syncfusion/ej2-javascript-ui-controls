window.sf = window.sf || {};
window.sf.dropdowns = (function (exports) {
'use strict';
...
var DropDownList = /** @class */ (function (_super) {
    ...
    DropDownList.prototype.onMouseClick = function (e) {
        ...
        var li = sf.base.closest(target, '.' + dropDownBaseClasses.li);
    ...
    DropDownList.prototype.onMouseOver = function (e) {
        var currentLi = sf.base.closest(e.target, '.' + dropDownBaseClasses.li);
    ...
    DropDownList.prototype.setHover = function (li) {
        if (this.enabled && this.isValidLI(li) && !li.classList.contains(dropDownBaseClasses.hover)) {
            this.removeHover();
            sf.base.addClass([li], dropDownBaseClasses.hover);
        }
    };
    ...
    DropDownList.prototype.removeHover = function () {
        if (this.list) {
            ...
            if (hoveredItem && hoveredItem.length) {
                sf.base.removeClass(hoveredItem, dropDownBaseClasses.hover);
            }
        }
    };
    ...
    DropDownList.prototype.dropDownClick = function (e) {
        ...
        if (!this.readonly) {
            ...
            var proxy_1 = this;
            var duration = (sf.base.isBlazor()) ? 1000 : 100;
    ...
    DropDownList.prototype.selectEventCallback = function (li, e, preventSelect, selectedData, value) {
        ...
        if (focusedItem) {
            sf.base.removeClass([focusedItem], dropDownBaseClasses.focus);
        }
    ...
    DropDownList.prototype.removeSelection = function () {
        if (this.list) {
            ...
            if (selectedItems.length) {
                sf.base.removeClass(selectedItems, dropDownBaseClasses.selected);
        ...
        if (this.isServerBlazor && (this.value !== null || this.index !== null || this.text !== null) ||
            ...
            if (this.isServerBlazor && this.getModuleName() !== 'dropdownlist' &&
                ...
                if (!this.ulElement.querySelector('li').classList.contains(dropDownBaseClasses.hover)) {
                    sf.base.addClass([this.ulElement.querySelector('li')], dropDownBaseClasses.hover);
                }
            }
        }
    };
    ...
    DropDownList.prototype.updateServerPopup = function (popupEle) {
        if (this.isServerBlazor) {
            if (popupEle && popupEle.querySelector('li')) {
                sf.base.removeClass([this.list], ['e-nodata']);
            }
            this.initial = false;
    ...
    DropDownList.prototype.showPopup = function () {
        ...
        else if (sf.base.isNullOrUndefined(this.list) || !sf.base.isUndefined(this.list) && this.list.classList.contains(dropDownBaseClasses.noData)) {
            this.renderList();
        }
        ...
        if (this.isServerBlazor && !sf.base.isNullOrUndefined(this.list) && (this.getModuleName() === 'dropdownlist' || !this.isFiltering())) {
            this.invokeRenderPopup();
        }
    };
    DropDownList.prototype.invokeRenderPopup = function () {
        ...
        if (!sf.base.isNullOrUndefined(this.list.children[0]) || this.list.classList.contains(dropDownBaseClasses.noData)) {
            this.renderPopup();
        }
        sf.base.attributes(this.targetElement(), { 'aria-activedescendant': this.selectedLI ? this.selectedLI.id : null });
    };
    DropDownList.prototype.clientRenderPopup = function (data, popupEle) {
        if (popupEle) {
            ...
            this.ulElement = this.list.querySelector('ul');
            if (sf.base.isNullOrUndefined(this.ulElement) && !this.list.classList.contains(dropDownBaseClasses.noData)) {
                sf.base.addClass([this.list], [dropDownBaseClasses.noData]);
            }
    ...
    DropDownList.prototype.hidePopup = function (e) {
        ...
        if (this.inputElement.value.trim() === '' && !this.isInteracted && (this.isSelectCustom ||
            !sf.base.isNullOrUndefined(this.selectedLI) && this.inputElement.value !== dataItem.text)) {
            this.isSelectCustom = false;
            this.clearAll(e);
        }
    };
...
var ComboBox = /** @class */ (function (_super) {
    ...
    ComboBox.prototype.preventBlur = function (e) {
        if ((!this.allowFiltering && document.activeElement !== this.inputElement &&
            !document.activeElement.classList.contains(dropDownListClasses.input) && sf.base.Browser.isDevice || !sf.base.Browser.isDevice)) {
            e.preventDefault();
        }
    };
        ...
        if ((sf.base.Browser.isDevice && !this.isDropDownClick || !sf.base.Browser.isDevice) &&
            ...
            if (!sf.base.isNullOrUndefined(activeElement)) {
                ...
                if (!isNaN(height) && this.getModuleName() !== 'autocomplete') {
                    ...
                    sf.base.addClass([activeElement], dropDownListClasses.focus);
                }
            }
            else {
...
var AutoComplete = /** @class */ (function (_super) {
    ...
    AutoComplete.prototype.onActionComplete = function (ulElement, list, e, isUpdated) {
        ...
        if (!sf.base.isNullOrUndefined(item)) {
            sf.base.removeClass([item], dropDownListClasses.focus);
        }
        this.postBackAction();
    };
    ...
    AutoComplete.prototype.setSelection = function (li, e) {
        ...
        if (!sf.base.isNullOrUndefined(e) && e.type === 'keydown' && e.action !== 'enter' && this.isValidLI(li)) {
            var value = this.getFormattedValue(li.getAttribute('data-value'));
            this.activeIndex = this.getIndexByValue(value);
            if (this.isServerBlazor) {
                this.removeHover();
            ...
            switch (prop) {
                case 'showPopupButton':
                    if (this.showPopupButton) {
                        if (!this.isServerBlazor) {
                            var button = sf.inputs.Input.appendSpan(dropDownListClasses.icon, this.inputWrapper.container, this.createElement);
    ...
    __decorate$4([
        sf.base.Complex({ value: null, iconCss: null, groupBy: null }, FieldSettings)
...
var MultiSelect = /** @class */ (function (_super) {
            ...
            for (var index = 0; !sf.base.isNullOrUndefined(this.value[index]); index++) {
                ...
                if (element) {
                    ...
                    if (this.hideSelectedItem && element.classList.contains(dropDownBaseClasses.focus)) {
                        sf.base.removeClass([element], dropDownBaseClasses.focus);
                        var listEle = element.parentElement.querySelectorAll('.' +
                            dropDownBaseClasses.li + ':not(.' + HIDE_LIST + ')');
                        if (listEle.length > 0) {
                            sf.base.addClass([listEle[0]], dropDownBaseClasses.focus);
                        }
                        else {
    ...
    MultiSelect.prototype.chipClick = function (e) {
        if (this.enabled) {
            var elem = sf.base.closest(e.target, '.' + CHIP$1);
            this.removeChipSelection();
    ...
    MultiSelect.prototype.onMobileChipInteraction = function (e) {
        var chipElem = sf.base.closest(e.target, '.' + CHIP$1);
    ...
    MultiSelect.prototype.removeFocus = function () {
        if (this.list && this.mainList) {
            ...
            if (hoveredItem && hoveredItem.length) {
                sf.base.removeClass(hoveredItem, dropDownBaseClasses.focus);
                sf.base.removeClass(mainlist, dropDownBaseClasses.focus);
            }
        }
    };
    ...
    MultiSelect.prototype.addListFocus = function (element) {
        if (this.enabled && this.isValidLI(element)) {
            this.removeFocus();
            sf.base.addClass([element], dropDownBaseClasses.focus);
        }
        else {
            if (this.enableGroupCheckBox && this.mode === 'CheckBox' && !sf.base.isNullOrUndefined(this.fields.groupBy)) {
                sf.base.addClass([element], dropDownBaseClasses.focus);
    ...
    MultiSelect.prototype.onMouseClick = function (e) {
        ...
        var target = e.target;
        var li = sf.base.closest(target, '.' + dropDownBaseClasses.li);
        var headerLi = sf.base.closest(target, '.' + dropDownBaseClasses.group);
    ...
    MultiSelect.prototype.onMouseOver = function (e) {
        ...
        if (currentLi === null && this.mode === 'CheckBox' && !sf.base.isNullOrUndefined(this.fields.groupBy)
            ...
            currentLi = sf.base.closest(e.target, '.' + dropDownBaseClasses.group);
        }
...
var CheckBoxSelection = /** @class */ (function () {
    ...
    CheckBoxSelection.prototype.checboxCreate = function (e) {
        ...
        if (this.parent.enableGroupCheckBox || (item.className !== 'e-list-group-item '
            ...
            sf.base.select('.' + CHECKBOXFRAME$1, checkboxEle);
            var frame = sf.base.select('.' + CHECKBOXFRAME$1, checkboxEle);
    ...
    CheckBoxSelection.prototype.listSelection = function (args) {
        ...
        if (!sf.base.isNullOrUndefined(target)) {
            this.checkWrapper = sf.base.closest(target, '.' + CHECKBOXWRAP$1);
        }
        if (!sf.base.isNullOrUndefined(this.checkWrapper)) {
            var checkElement = sf.base.select('.' + CHECKBOXFRAME$1, this.checkWrapper);
    ...
    CheckBoxSelection.prototype.changeState = function (wrapper, state, e, isPrevent, selectAll$$1) {
        ...
        if (state === 'check' && !frameSpan.classList.contains(CHECK$1)) {
            ...
            sf.base.removeClass([frameSpan], [CHECK$1, INDETERMINATE]);
            ariaState = 'false';
            if (selectAll$$1) {
            ...
            sf.base.removeClass([frameSpan], [CHECK$1]);
...
var ListBox = /** @class */ (function (_super) {
    ...
    ListBox.prototype.initWrapper = function () {
        ...
        sf.base.removeClass([this.list], [dropDownBaseClasses.content, dropDownBaseClasses.root]);
    ...
    ListBox.prototype.moveData = function (fListBox, tListBox, isKey, value, index) {
        ...
        if (elems.length) {
            ...
            if (elems.length === 1 && childCnt && !fListBox.selectionSettings.showCheckbox) {
                ...
                if (validIdx > -1) {
                    (fListBox.ulElement.querySelectorAll('.e-list-item')[validIdx].classList.add(sf.lists.cssClass.selected));
                }
            }
            if (isKey) {
                this.list.focus();
    ...
    ListBox.prototype.destroy = function () {
        if (this.itemTemplate) {
            sf.base.resetBlazorTemplate("" + this.element.id + ITEMTEMPLATE_PROPERTY$1, ITEMTEMPLATE_PROPERTY$1);
        }
        this.unwireEvents();
        if (this.element.tagName === 'EJS-LISTBOX') {
...
sfBlazor.loadDependencies(sfBlazor.dependencyJson.dropdowns, () => {
