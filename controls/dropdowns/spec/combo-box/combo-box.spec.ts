 ...
 */
import { createElement, isVisible, isNullOrUndefined, Browser, EmitType, KeyboardEventArgs } from '@syncfusion/ej2-base';
...
describe('ComboBox', () => {
    ...
    describe('actionFailure event', () => {
        ...
        beforeAll(() => {
            document.body.appendChild(element);
            listObj = new ComboBox({ dataSource: remoteData, query: new Query().take(10), value: 1004, fields: { value: 'EmployeeID', text: 'FirstName' } });
...
describe('EJ2MVC-335 - Value updated incorrectly for autofill true case', () => {
    ...
    describe('Coverage ', () => {
        ...
        it('updateIconState method ', () => {
            listObj.updateIconState();
        });
        it('incrementalSearch', () => {
