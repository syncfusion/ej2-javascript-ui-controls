...
describe('DropDown Tree control List datasource', () => {
    ...
    describe('Custom Mode testing -', () => {
        ...
        it('For allowMultiSelection with selected field', () => {
            ddtreeObj = new DropDownTree({
                fields: { dataSource: listData, value: "id", text: "name", parentValue: "pid", hasChildren: "hasChild", selected: 'isSelected', expanded: 'expanded' },
                allowMultiSelection: true,
                width: '150px',
                mode: 'Custom',
            }, '#ddtree');
    ...
    describe('Combinational testing ', () => {
        ...
        it('Custom Mode with delimiterChar', () => {
            ddtreeObj = new DropDownTree({ 
                fields: { dataSource: listData, value: "id", text: "name", parentValue: "pid", hasChildren: "hasChild", expanded: 'expanded' },
                mode: 'Custom', allowMultiSelection: true, delimiterChar: '*' }, '#ddtree');
        ...
        it('Custom Mode with ShowSelectAll', (done: Function) => {
            ddtreeObj = new DropDownTree({ 
                fields: { dataSource: listData, value: "id", text: "name", parentValue: "pid", hasChildren: "hasChild", expanded: 'expanded' },
                showSelectAll: true, showCheckBox: true, mode: 'Custom', }, '#ddtree');
            let ele = ddtreeObj.element;
            var e = new MouseEvent("mousedown", { view: window, bubbles: true, cancelable: true });
            ele.dispatchEvent(e);
            var e = new MouseEvent("mouseup", { view: window, bubbles: true, cancelable: true });
