...
describe('FileManager control LargeIcons view', () => {
    describe('mobile testing', () => {
        ...
        it('tapHold with multiselection', (done: Function) => {
            let li: any = document.getElementById('file_largeicons').querySelectorAll('li');
            expect(li[4].classList.contains('e-active')).toBe(false);
            expect(li[4].classList.contains('e-focus')).toBe(false);
            expect(li[4].querySelector('.e-frame').classList.contains('e-check')).toBe(false);
            ...
            expect(nli[4].classList.contains('e-focus')).toBe(true);
            expect(nli[4].querySelector('.e-frame').classList.contains('e-check')).toBe(true);
            expect(feObj.element.classList.contains('e-fe-m-select')).toBe(true);
                ...
                setTimeout(function () {
                    ...
                    setTimeout(function () {
                        ...
                        setTimeout(function () {
                            ...
                            expect(li1[4].querySelector('.e-frame').classList.contains('e-check')).toBe(false);
                            mouseEventArgs.target = li[4];
                            feObj.largeiconsviewModule.clickObj.tapHold(tapEvent);
                            ...
                            expect(nli1[4].querySelector('.e-frame').classList.contains('e-check')).toBe(true);
                            expect(feObj.element.classList.contains('e-fe-m-select')).toBe(true);
                            mouseEventArgs.target = nli1[4];
                            feObj.largeiconsviewModule.clickObj.tap(tapEvent);
                            setTimeout(function () {
                                let nli2: any = document.getElementById('file_largeicons').querySelectorAll('li');
                                expect(nli2[4].classList.contains('e-active')).toBe(false);
                                expect(nli2[4].classList.contains('e-focus')).toBe(true);
                                expect(nli2[4].querySelector('.e-frame').classList.contains('e-check')).toBe(false);
                                expect(feObj.element.classList.contains('e-fe-m-select')).toBe(false);
                                done();
                            }, 500);
                        }, 500);
        ...
        it('mouse click on toolbar selectall button', () => {
            ...
            item.click();
            let li: any = document.getElementById('file_largeicons').querySelectorAll('li');
            let ali: any = document.getElementById('file_largeicons').querySelectorAll('li.e-active');
            expect(li.length).toBe(ali.length);
        });
        it('mouse click on toolbar clear all button', () => {
            ...
            expect(li.length).toBe(ali.length);
            expect(feObj.element.classList.contains('e-fe-m-select')).toBe(false);
            let clearItem: any = document.getElementById('file_toolbar').querySelector('.e-fe-clear');
            clearItem.click();
            let ali1: any = document.getElementById('file_largeicons').querySelectorAll('li.e-active');
            expect(ali1.length).toBe(0);
            expect(feObj.element.classList.contains('e-fe-m-select')).toBe(false);
        });
    });
    describe('mobile testing', () => {
