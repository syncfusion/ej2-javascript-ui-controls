...
describe('FileManager control LargeIcons view', () => {
    describe('property testing', () => {
        ...
        it('for enableRangeSelection', (done) => {
            ...
            setTimeout(function () {
                let viewElement: HTMLElement = document.querySelector(".e-large-icons") as HTMLElement;
                const firstElem: HTMLElement = viewElement.firstElementChild as HTMLElement;
                const dragContainer: HTMLElement = (firstElem && firstElem.tagName === 'UL') ? firstElem : viewElement;
                ...
                dragContainer.dispatchEvent(moveEvent);
