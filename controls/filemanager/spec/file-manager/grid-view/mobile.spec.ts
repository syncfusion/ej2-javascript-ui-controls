...
describe('FileManager control Grid view', () => {
    describe('mobile testing', () => {
        ...
        it('tapHold with multiselection', () => {
            ...
            nli1[4].querySelector('.e-frame').click();
            let nli2: any = document.getElementById('file_grid').querySelectorAll('.e-row');
            expect(nli2[4].getAttribute('aria-selected')).toBe(null);
        ...
        it('mouse click on toolbar selectall button', () => {
            ...
            expect(feObj.detailsviewModule.gridObj.getSelectedRows().length).toEqual(rows.length);
        });
