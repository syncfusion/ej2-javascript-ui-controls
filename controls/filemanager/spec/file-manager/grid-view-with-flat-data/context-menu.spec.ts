...
describe('FileManager control Grid view', () => {
    ...
    describe('for Grid View', () => {
        ...
        it('Bidirectional folder renaming synchronization between navigation pane and main layout', (done: Function) => {
            const treeObj: any = feObj.navigationpaneModule.treeObj;
            ...
            setTimeout(function () {
                ...
                const sourceElement: any = el.ej2_instances[0];
                ...
                setTimeout(function () {
                    ...
                    expect(ntr[0].textContent).toBe('Document');
                    (document.getElementById('rename') as any).value = 'My Folder';
                    (document.getElementById('file_dialog') as any).querySelectorAll('.e-btn')[1].click();
                    setTimeout(function () {
