...
describe('FileManager control single selection LargeIcons view', () => {
    xdescribe('context menu testing', () => {
        ...
        it("Contextmenu - custom menu items in folder", (done: Function) => {
        ...
        xit("Contextmenu - custom menu items in file", (done: Function) => {
            feObj.contextMenuSettings = {
                file: ['Open', '|', 'Delete', 'Download', 'Rename', '|', 'Details', "Openinnewwindow", "OpeninVS", "|", "Giveaccessto"],
                folder: ['Open', '|', 'Delete', 'Rename', 'Download', '|', 'Details', "Custom1", "Custom2", "Custom3"],
                layout: ['SortBy', 'View', 'Refresh', '|', 'NewFolder', 'Upload', '|', 'Details', '|', 'SelectAll', "Custom1", "Custom2", "Custom3"]
        ...
        xit("Contextmenu - custom menu items in layout", (done: Function) => {
            feObj.contextMenuSettings = {
                file: ['Open', '|', 'Delete', 'Download', 'Rename', '|', 'Details', "Openinnewwindow", "OpeninVS", "|", "Giveaccessto"],
                folder: ['Open', '|', 'Delete', 'Rename', 'Download', '|', 'Details', "Custom1", "Custom2", "Custom3"],
                layout: ['SortBy', 'View', 'Refresh', '|', 'NewFolder', 'Upload', '|', 'Details', '|', 'SelectAll', "Custom1", "Custom2", "Custom3"]
    ...
    xdescribe('access control context menu testing', () => {
        ...
        it('mouse click on new folder button', (done: Function) => {
            ...
            setTimeout(function () {
                let menuEle = document.getElementById(feObj.element.id + '_contextmenu');
                let menuObj = (menuEle as any).ej2_instances[0];
                menuObj.animationSettings = { effect: 'None' };
                menuObj.dataBind();
                let treeEle = document.getElementById("file_tree");
                let treeObj = (treeEle as any).ej2_instances[0];
                ...
                let dialogEle = document.getElementById("file_dialog");
                let dialogObj = (dialogEle as any).ej2_instances[0];
        ...
        it('mouse click on details button', (done: Function) => {
            ...
            setTimeout(function () {
                const menuEle = document.getElementById(feObj.element.id + '_contextmenu');
                expect(menuEle).not.toBeNull();
                const menuObj: any = (menuEle as any).ej2_instances[0];
                ...
                setTimeout(function () {
                    let dialogEle: any = (document.getElementById("file_dialog") as any);
                    let dialogObj = (dialogEle as any).ej2_instances[0];
