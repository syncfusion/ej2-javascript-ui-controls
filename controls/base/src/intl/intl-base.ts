...
import { FormatOptions } from './date-formatter';
...
let NumberFormat: typeof import('./number-formatter').NumberFormat = null;

let DateFormat: typeof import('./date-formatter').DateFormat = null;

export function setDefaultCurrencyCode(value: string): void { defaultCurrencyCode = value; }
export function setNumberFormat(value: typeof import('./number-formatter').NumberFormat): void { NumberFormat = value; }
export function setDateFormat(value: typeof import('./date-formatter').DateFormat): void { DateFormat = value; }
