...
export class _PdfCatalog {
    ...
    /**
     * Backing dictionary for the catalog object.
     *
     * @private
     */
    ...
    /**
     * Root pages dictionary of the document.
     *
     * @private
     */
    ...
    /**
     * Indicates whether the page tree format is invalid and requires linear traversal.
     *
     * @private
     */
