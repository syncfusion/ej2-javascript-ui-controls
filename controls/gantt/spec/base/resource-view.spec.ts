 ...
 */
import { Gantt, Selection, Toolbar, DayMarkers, Edit, Filter, VirtualScroll, ContextMenu, Sort } from '../../src/index';
...
Gantt.Inject(Edit, Selection, Toolbar, Filter, DayMarkers, VirtualScroll, ContextMenu, Sort);
...
describe('CR-917356: An invalid resource collection is being passed, resulting in a script error', () => {
    let ganttObj: Gantt;
    beforeAll((done: Function) => {
        ganttObj = createGantt({
            dataSource: [
                    ...
                    subtasks: [
                        {
                            ...
                            Progress: 30, work: 16, resources: '1'
                        },
                        {
