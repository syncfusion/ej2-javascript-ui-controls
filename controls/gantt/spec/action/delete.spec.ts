...
describe('Gantt delete support', () => {
    describe('Gantt delete action', () => {
        ...
        it('Delete a record that has parent & child links', () => {
            ...
            expect(ganttObj.flatData[7].index).toBe(7);
        });
    ...
    describe('deleting unassined task make expand', () => {
        let ganttObj: Gantt;
        const dataResource: Object[] = [{
        ...
        it('deleting unassined task', () => {
            ganttObj.deleteRecord(ganttObj.currentViewData[0]);
