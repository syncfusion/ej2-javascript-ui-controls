import { Gantt, Selection,UndoRedo, Edit, Toolbar,Filter, Sort, ContextMenu } from '../../src/index';
...
describe('Gantt Selection support', () => {
    ...
    //             ganttObj.keyboardModule.keyAction(args);
    //             expect(ganttObj.element.getElementsByClassName('e-editedbatchcell')[0].getAttribute('data-colindex')).toBe("3");
