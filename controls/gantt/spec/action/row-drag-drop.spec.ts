...
describe('Gantt Drag and Drop support', () => {
    describe('Resource view data binding', () => {
        ...
        it('Drag and drop', () => {
            expect((ganttObj_resource.flatData[1] as IGanttData)[ganttObj_resource.taskFields.resourceInfo]).toBe('Martin Tamer[41.67%]');
            ganttObj_resource.reorderRows([1], 4, 'above');
            expect((ganttObj_resource.flatData[3] as IGanttData)[ganttObj_resource.taskFields.resourceInfo]).toBe('Rose Fuller');
        });
    });
