...
describe('Spreadsheet cell navigation module ->', () => {
    ...
    describe('CR-Issues ->', () => {
        ...
        describe('EJ2-59905, EJ2-1012221 ->', () => {
            beforeEach((done: Function) => {
                helper.initializeSpreadsheet(
            ...
            it('EJ2-1012221: Cell edit triggers unwanted horizontal scrolling for column width greater than the viewport range', (done: Function) => {
                const spreadsheet: any = helper.getInstance();
                helper.invoke('selectRange', ['A2']);
                spreadsheet.updateCell({ value: 'Doubleclick selection check-1' }, 'A2');
                spreadsheet.setColWidth(2600, 0, 0);
                let leftBeforeScroll: any = spreadsheet.getScrollElement().scrollLeft;
                ...
                setTimeout(() => {
                    expect(spreadsheet.getScrollElement().scrollLeft).toBe(leftBeforeScroll);
                    helper.triggerKeyNativeEvent(9, false, false, null, 'keydown', false, document.activeElement);
                    setTimeout(() => {
