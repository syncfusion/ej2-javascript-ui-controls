...
export function dataSource(): void {
    ...
    for (let i: number = 0; i < 100000; i++) {
        virtualData.push({
            ...
            'Year': 1967 + (i % 10),
            'Stint': Math.floor(Math.random() * 200),
            'TMID': Math.floor(Math.random() * 100),
            'LGID': Math.floor(Math.random() * 2000),
            'GP': Math.floor(Math.random() * 1000),
            'GS': Math.floor(Math.random() * 100),
            'Minutes': Math.floor(Math.random() * 10),
            'Points': Math.floor(Math.random() * 10),
            'OREB': Math.floor(Math.random() * 100),
            'DREB': Math.floor(Math.random() * 100),
            'REB': Math.floor(Math.random() * 1000),
            'Assists': Math.floor(Math.random() * 10),
            'Steals': Math.floor(Math.random() * 10),
            'Blocks': Math.floor(Math.random() * 1000),
            'Turnovers': Math.floor(Math.random() * 200),
            'PF': Math.floor(Math.random() * 300),
            'FGA': Math.floor(Math.random() * 400),
            'FGM': Math.floor(Math.random() * 500),
            'FTA': Math.floor(Math.random() * 700),
            'FTM': Math.floor(Math.random() * 800),
            'Post GP': Math.floor(Math.random() * 150),
            'Post GS': Math.floor(Math.random() * 1000),
            'Post ORE': Math.floor(Math.random() * 600),
            'Post DRE': Math.floor(Math.random() * 500),
            'Post REB': Math.floor(Math.random() * 300)
        });
    }
}
export let productData: Object[] = [
    ...
    },
    {
        ...
        'Supplier Id': 8,
        'Quantity Per Unit': '10 boxes x 12 pieces',
        'Unit Price': 9.20,
        'Units In Stock': 25,
        'Discontinued': false
    },
    {
        ...
        'Supplier Id': 8,
        'Quantity Per Unit': '30 gift boxes',
        'Unit Price': 81.00,
        'Units In Stock': 40,
        'Discontinued': false
    },
    {
        ...
        'Supplier Id': 8,
        'Quantity Per Unit': '24 pkgs. x 4 pieces',
        'Unit Price': 10.00,
        'Units In Stock': 3,
        'Discontinued': false
    },
    {
        ...
        'Supplier Id': 9,
        'Quantity Per Unit': '24 - 500 g pkgs.',
        'Unit Price': 21.00,
        'Units In Stock': 104,
        'Discontinued': false
    },
    {
        ...
        'Supplier Id': 9,
        'Quantity Per Unit': '12 - 250 g pkgs.',
        'Unit Price': 9.00,
        'Units In Stock': 61,
        'Discontinued': false
    },
    {
        ...
        'Supplier Id': 10,
        'Quantity Per Unit': '12 - 355 ml cans',
        'Unit Price': 4.50,
        'Units In Stock': 20,
        'Discontinued': true
    },
    {
        ...
        'Supplier Id': 11,
        'Quantity Per Unit': '20 - 450 g glasses',
        'Unit Price': 14.00,
        'Units In Stock': 76,
        'Discontinued': false
    },
    {
        ...
        'Supplier Id': 11,
        'Quantity Per Unit': '100 - 250 g bags',
        'Unit Price': 31.23,
        'Units In Stock': 15,
        'Discontinued': true
    },
    {
        ...
        'Supplier Id': 11,
        'Quantity Per Unit': '100 - 100 g pieces',
        'Unit Price': 43.90,
        'Units In Stock': 49,
        'Discontinued': true
    },
    {
        ...
        'Supplier Id': 12,
        'Quantity Per Unit': '25 - 825 g cans',
        'Unit Price': 45.60,
        'Units In Stock': 26,
        'Discontinued': true
    },
    {
        ...
        'Supplier Id': 12,
        'Quantity Per Unit': '50 bags x 30 sausgs.',
        'Unit Price': 123.79,
        'Units In Stock': 0,
        'Discontinued': true
    },
    {
        ...
        'Supplier Id': 13,
        'Quantity Per Unit': '10 - 200 g glasses',
        'Unit Price': 25.89,
        'Units In Stock': 10,
        'Discontinued': true
    },
    {
        ...
        'Supplier Id': 14,
        'Quantity Per Unit': '12 - 100 g pkgs',
        'Unit Price': 12.50,
        'Units In Stock': 0,
        'Discontinued': true
    },
    {
        ...
        'Supplier Id': 14,
        'Quantity Per Unit': '24 - 200 g pkgs.',
        'Unit Price': 32.00,
        'Units In Stock': 9,
        'Discontinued': false
    },
    ...
    },
    {
        ...
        'Supplier Id': 17,
        'Quantity Per Unit': '24 - 250 g  jars',
        'Unit Price': 19.00,
        'Units In Stock': 112,
        'Discontinued': false
    },
    {
        ...
        'Supplier Id': 17,
        'Quantity Per Unit': '12 - 500 g pkgs.',
        'Unit Price': 26.00,
        'Units In Stock': 11,
        'Discontinued': false
    },
    {
        ...
        'Supplier Id': 18,
        'Quantity Per Unit': '12 - 75 cl bottles',
        'Unit Price': 263.50,
        'Units In Stock': 17,
        'Discontinued': false
    },
    {
        ...
        'Supplier Id': 18,
        'Quantity Per Unit': '750 cc per bottle',
        'Unit Price': 18.00,
        'Units In Stock': 69,
        'Discontinued': true
    },
    ...
    },
    {
        ...
        'Supplier Id': 21,
        'Quantity Per Unit': '4 - 450 g glasses',
        'Unit Price': 12.00,
        'Units In Stock': 95,
        'Discontinued': true
    },
    {
        ...
        'Supplier Id': 22,
        'Quantity Per Unit': '10 - 4 oz boxes',
        'Unit Price': 9.50,
        'Units In Stock': 36,
        'Discontinued': true
    },
    ...
    },
    {
        ...
        'Supplier Id': 23,
        'Quantity Per Unit': '24 - 50 g pkgs.',
        'Unit Price': 20.00,
        'Units In Stock': 10,
        'Discontinued': false
    },
    {
        ...
        'Supplier Id': 23,
        'Quantity Per Unit': '12 - 100 g bars',
        'Unit Price': 16.25,
        'Units In Stock': 65,
        'Discontinued': false
    },
    {
        ...
        'Supplier Id': 24,
        'Quantity Per Unit': '50 - 300 g pkgs.',
        'Unit Price': 53.00,
        'Units In Stock': 20,
        'Discontinued': false
    },
    {
        ...
        'Supplier Id': 24,
        'Quantity Per Unit': '16 - 2 kg boxes',
        'Unit Price': 7.00,
        'Units In Stock': 38,
        'Discontinued': true
    },
    ...
    },
    {
        ...
        'Supplier Id': 25,
        'Quantity Per Unit': '24 boxes x 2 pies',
        'Unit Price': 24.00,
        'Units In Stock': 115,
        'Discontinued': true
    },
    {
        ...
        'Supplier Id': 26,
        'Quantity Per Unit': '24 - 250 g pkgs.',
        'Unit Price': 38.00,
        'Units In Stock': 21,
        'Discontinued': false
    },
    ...
    },
    {
        ...
        'Supplier Id': 28,
        'Quantity Per Unit': '15 - 300 g rounds',
        'Unit Price': 34.00,
        'Units In Stock': 19,
        'Discontinued': false
    },
    {
        ...
        'Supplier Id': 29,
        'Quantity Per Unit': '24 - 500 ml bottles',
        'Unit Price': 28.50,
        'Units In Stock': 113,
        'Discontinued': false
    },
    ...
    },
    {
        ...
        'Supplier Id': 7,
        'Quantity Per Unit': '15 - 625 g jars',
        'Unit Price': 43.90,
        'Units In Stock': 24,
        'Discontinued': true
    },
    {
        ...
        'Supplier Id': 12,
        'Quantity Per Unit': '20 bags x 4 pieces',
        'Unit Price': 33.25,
        'Units In Stock': 22,
        'Discontinued': true
    },
    ...
    },
    {
        ...
        'Supplier Id': 8,
        'Quantity Per Unit': '10 boxes x 8 pieces',
        'Unit Price': 12.50,
        'Units In Stock': 6,
        'Discontinued': false
    },
    ...
    },
    {
        ...
        'Supplier Id': 7,
        'Quantity Per Unit': '24 - 355 ml bottles',
        'Unit Price': 15.00,
        'Units In Stock': 15,
        'Discontinued': false
    },
    ...
    },
    {
        ...
        'Supplier Id': 17,
        'Quantity Per Unit': '24 - 150 g jars',
        'Unit Price': 15.00,
        'Units In Stock': 101,
        'Discontinued': true
    },
    ...
    },
    {
        ...
        'Supplier Id': 12,
        'Quantity Per Unit': '24 - 0.5 l bottles',
        'Unit Price': 7.75,
        'Units In Stock': 125,
        'Discontinued': true
    },
...
export let mergeCellsData: object[] = [
    {
        'Employee ID': 10001,
    ...
    {
        'Employee ID': 10007,
        'Employee Name': 'Suyama',
        '9:00 AM': 'Analysis Tasks',
        '9:30 AM': 'Analysis Tasks',
        '10:00 AM': 'Testing',
        '10:30 AM': 'Development',
        '11:00 AM': 'Development',
        '11:30 AM': 'Testing',
        '12:00 PM': 'Testing',
        '12:30 PM': 'Testing',
...
export let filterData: Object[] = [
    {
        'OrderID': 10248, 'CustomerID': 'VINET', 'OrderDate': new Date(836418600000), 'ShipName': 'Vins et alcools Chevalier', 'ShipCity': 'Reims', 'ShipAddress': '59 rue de l\u0027Abbaye', 'ShipRegion': null, 'ShipPostalCode': '51100', 'ShipCountry': 'France', 'Freight': 32.3800, 'Verified': true
    },
    {
        'OrderID': 10249, 'CustomerID': 'TOMSP', 'OrderDate': new Date(836505000000), 'ShipName': 'Toms Spezialitäten', 'ShipCity': 'Münster', 'ShipAddress': 'Luisenstr. 48', 'ShipRegion': null, 'ShipPostalCode': '44087', 'ShipCountry': 'Germany', 'Freight': 11.6100, 'Verified': false
    },
    {
        'OrderID': 10250, 'CustomerID': 'HANAR', 'OrderDate': new Date(836764200000), 'ShipName': 'Hanari Carnes', 'ShipCity': 'Rio de Janeiro', 'ShipAddress': 'Rua do Paço, 67', 'ShipRegion': 'RJ', 'ShipPostalCode': '05454-876', 'ShipCountry': 'Brazil', 'Freight': 65.8300, 'Verified': true
    },
    {
        'OrderID': 10251, 'CustomerID': 'VICTE', 'OrderDate': new Date(836764200000), 'ShipName': 'Victuailles en stock', 'ShipCity': 'Lyon', 'ShipAddress': '2, rue du Commerce', 'ShipRegion': null, 'ShipPostalCode': '69004', 'ShipCountry': 'France', 'Freight': 41.3400, 'Verified': true
    },
    {
        'OrderID': 10252, 'CustomerID': 'SUPRD', 'OrderDate': new Date(836850600000), 'ShipName': 'Suprêmes délices', 'ShipCity': 'Charleroi', 'ShipAddress': 'Boulevard Tirou, 255', 'ShipRegion': null, 'ShipPostalCode': 'B-6000', 'ShipCountry': 'Belgium', 'Freight': 51.3000, 'Verified': true
    },
    {
        'OrderID': 10253, 'CustomerID': 'HANAR', 'OrderDate': new Date(836937000000), 'ShipName': 'Hanari Carnes', 'ShipCity': 'Rio de Janeiro', 'ShipAddress': 'Rua do Paço, 67', 'ShipRegion': 'RJ', 'ShipPostalCode': '05454-876', 'ShipCountry': 'Brazil', 'Freight': 58.1700, 'Verified': true
    },
    {
        'OrderID': 10254, 'CustomerID': 'CHOPS', 'OrderDate': new Date(837023400000), 'ShipName': 'Chop-suey Chinese', 'ShipCity': 'Bern', 'ShipAddress': 'Hauptstr. 31', 'ShipRegion': null, 'ShipPostalCode': '3012', 'ShipCountry': 'Switzerland', 'Freight': 22.9800, 'Verified': false
    },
    {
        'OrderID': 10255, 'CustomerID': 'RICSU', 'OrderDate': new Date(837109800000), 'ShipName': 'Richter Supermarkt', 'ShipCity': 'Genève', 'ShipAddress': 'Starenweg 5', 'ShipRegion': null, 'ShipPostalCode': '1204', 'ShipCountry': 'Switzerland', 'Freight': 148.3300, 'Verified': true
    },
    {
        'OrderID': 10256, 'CustomerID': 'WELLI', 'OrderDate': new Date(837369000000), 'ShipName': 'Wellington Importadora', 'ShipCity': 'Resende', 'ShipAddress': 'Rua do Mercado, 12', 'ShipRegion': 'SP', 'ShipPostalCode': '08737-363', 'ShipCountry': 'Brazil', 'Freight': 13.9700, 'Verified': false
    },
    {
        'OrderID': 10257, 'CustomerID': 'HILAA', 'OrderDate': new Date(837455400000), 'ShipName': 'HILARION-Abastos', 'ShipCity': 'San Cristóbal', 'ShipAddress': 'Carrera 22 con Ave. Carlos Soublette #8-35', 'ShipRegion': 'Táchira', 'ShipPostalCode': '5022', 'ShipCountry': 'Venezuela', 'Freight': 81.9100, 'Verified': true
    },
    {
        'OrderID': 10258, 'CustomerID': 'ERNSH', 'OrderDate': new Date(837541800000), 'ShipName': 'Ernst Handel', 'ShipCity': 'Graz', 'ShipAddress': 'Kirchgasse 6', 'ShipRegion': null, 'ShipPostalCode': '8010', 'ShipCountry': 'Austria', 'Freight': 140.5100, 'Verified': true
    },
    {
        'OrderID': 10259, 'CustomerID': 'CENTC', 'OrderDate': new Date(837628200000), 'ShipName': 'Centro comercial Moctezuma', 'ShipCity': 'México D.F.', 'ShipAddress': 'Sierras de Granada 9993', 'ShipRegion': null, 'ShipPostalCode': '05022', 'ShipCountry': 'Mexico', 'Freight': 3.2500, 'Verified': false
    },
    {
        'OrderID': 10260, 'CustomerID': 'OTTIK', 'OrderDate': new Date(837714600000), 'ShipName': 'Ottilies Käseladen', 'ShipCity': 'Köln', 'ShipAddress': 'Mehrheimerstr. 369', 'ShipRegion': null, 'ShipPostalCode': '50739', 'ShipCountry': 'Germany', 'Freight': 55.0900, 'Verified': true
    },
    {
        'OrderID': 10261, 'CustomerID': 'QUEDE', 'OrderDate': new Date(837714600000), 'ShipName': 'Que Delícia', 'ShipCity': 'Rio de Janeiro', 'ShipAddress': 'Rua da Panificadora, 12', 'ShipRegion': 'RJ', 'ShipPostalCode': '02389-673', 'ShipCountry': 'Brazil', 'Freight': 3.0500, 'Verified': false
    },
    {
        'OrderID': 10262, 'CustomerID': 'RATTC', 'OrderDate': new Date(837973800000), 'ShipName': 'Rattlesnake Canyon Grocery', 'ShipCity': 'Albuquerque', 'ShipAddress': '2817 Milton Dr.', 'ShipRegion': 'NM', 'ShipPostalCode': '87110', 'ShipCountry': 'USA', 'Freight': 48.2900, 'Verified': true
    },
    {
        'OrderID': 10263, 'CustomerID': 'ERNSH', 'OrderDate': new Date(838060200000), 'ShipName': 'Ernst Handel', 'ShipCity': 'Graz', 'ShipAddress': 'Kirchgasse 6', 'ShipRegion': null, 'ShipPostalCode': '8010', 'ShipCountry': 'Austria', 'Freight': 146.0600, 'Verified': true
    },
    {
        'OrderID': 10264, 'CustomerID': 'FOLKO', 'OrderDate': new Date(838146600000), 'ShipName': 'Folk och fä HB', 'ShipCity': 'Bräcke', 'ShipAddress': 'Åkergatan 24', 'ShipRegion': null, 'ShipPostalCode': 'S-844 67', 'ShipCountry': 'Sweden', 'Freight': 3.6700, 'Verified': false
    },
    {
        'OrderID': 10265, 'CustomerID': 'BLONP', 'OrderDate': new Date(838233000000), 'ShipName': 'Blondel père et fils', 'ShipCity': 'Strasbourg', 'ShipAddress': '24, place Kléber', 'ShipRegion': null, 'ShipPostalCode': '67000', 'ShipCountry': 'France', 'Freight': 55.2800, 'Verified': true
    },
    {
        'OrderID': 10266, 'CustomerID': 'WARTH', 'OrderDate': new Date(838319400000), 'ShipName': 'Wartian Herkku', 'ShipCity': 'Oulu', 'ShipAddress': 'Torikatu 38', 'ShipRegion': null, 'ShipPostalCode': '90110', 'ShipCountry': 'Finland', 'Freight': 25.7300, 'Verified': false }, { 'OrderID': 10267, 'CustomerID': 'FRANK', 'OrderDate': new Date(838578600000), 'ShipName': 'Frankenversand', 'ShipCity': 'München', 'ShipAddress': 'Berliner Platz 43', 'ShipRegion': null, 'ShipPostalCode': '80805', 'ShipCountry': 'Germany', 'Freight': 208.5800, 'Verified': true }, { 'OrderID': 10268, 'CustomerID': 'GROSR', 'OrderDate': new Date(838665000000), 'ShipName': 'GROSELLA-Restaurante', 'ShipCity': 'Caracas', 'ShipAddress': '5ª Ave. Los Palos Grandes', 'ShipRegion': 'DF', 'ShipPostalCode': '1081', 'ShipCountry': 'Venezuela', 'Freight': 66.2900, 'Verified': true }, { 'OrderID': 10269, 'CustomerID': 'WHITC', 'OrderDate': new Date(838751400000), 'ShipName': 'White Clover Markets', 'ShipCity': 'Seattle', 'ShipAddress': '1029 - 12th Ave. S.', 'ShipRegion': 'WA', 'ShipPostalCode': '98124', 'ShipCountry': 'USA', 'Freight': 4.5600, 'Verified': false }, { 'OrderID': 10270, 'CustomerID': 'WARTH', 'OrderDate': new Date(838837800000), 'ShipName': 'Wartian Herkku', 'ShipCity': 'Oulu', 'ShipAddress': 'Torikatu 38', 'ShipRegion': null, 'ShipPostalCode': '90110', 'ShipCountry': 'Finland', 'Freight': 136.5400, 'Verified': true }, { 'OrderID': 10271, 'CustomerID': 'SPLIR', 'OrderDate': new Date(838837800000), 'ShipName': 'Split Rail Beer \u0026 Ale', 'ShipCity': 'Lander', 'ShipAddress': 'P.O. Box 555', 'ShipRegion': 'WY', 'ShipPostalCode': '82520', 'ShipCountry': 'USA', 'Freight': 4.5400, 'Verified': false }, { 'OrderID': 10272, 'CustomerID': 'RATTC', 'OrderDate': new Date(838924200000), 'ShipName': 'Rattlesnake Canyon Grocery', 'ShipCity': 'Albuquerque', 'ShipAddress': '2817 Milton Dr.', 'ShipRegion': 'NM', 'ShipPostalCode': '87110', 'ShipCountry': 'USA', 'Freight': 98.0300, 'Verified': true }, { 'OrderID': 10273, 'CustomerID': 'QUICK', 'OrderDate': new Date(839183400000), 'ShipName': 'QUICK-Stop', 'ShipCity': 'Cunewalde', 'ShipAddress': 'Taucherstraße 10', 'ShipRegion': null, 'ShipPostalCode': '01307', 'ShipCountry': 'Germany', 'Freight': 76.0700, 'Verified': true }, { 'OrderID': 10274, 'CustomerID': 'VINET', 'OrderDate': new Date(839269800000), 'ShipName': 'Vins et alcools Chevalier', 'ShipCity': 'Reims', 'ShipAddress': '59 rue de l\u0027Abbaye', 'ShipRegion': null, 'ShipPostalCode': '51100', 'ShipCountry': 'France', 'Freight': 6.0100, 'Verified': false }, { 'OrderID': 10275, 'CustomerID': 'MAGAA', 'OrderDate': new Date(839356200000), 'ShipName': 'Magazzini Alimentari Riuniti', 'ShipCity': 'Bergamo', 'ShipAddress': 'Via Ludovico il Moro 22', 'ShipRegion': null, 'ShipPostalCode': '24100', 'ShipCountry': 'Italy', 'Freight': 26.9300, 'Verified': false }, { 'OrderID': 10276, 'CustomerID': 'TORTU', 'OrderDate': new Date(839442600000), 'ShipName': 'Tortuga Restaurante', 'ShipCity': 'México D.F.', 'ShipAddress': 'Avda. Azteca 123', 'ShipRegion': null, 'ShipPostalCode': '05033', 'ShipCountry': 'Mexico', 'Freight': 13.8400, 'Verified': false }, { 'OrderID': 10277, 'CustomerID': 'MORGK', 'OrderDate': new Date(839529000000), 'ShipName': 'Morgenstern Gesundkost', 'ShipCity': 'Leipzig', 'ShipAddress': 'Heerstr. 22', 'ShipRegion': null, 'ShipPostalCode': '04179', 'ShipCountry': 'Germany', 'Freight': 125.7700, 'Verified': true }, { 'OrderID': 10278, 'CustomerID': 'BERGS', 'OrderDate': new Date(839788200000), 'ShipName': 'Berglunds snabbköp', 'ShipCity': 'Luleå', 'ShipAddress': 'Berguvsvägen  8', 'ShipRegion': null, 'ShipPostalCode': 'S-958 22', 'ShipCountry': 'Sweden', 'Freight': 92.6900, 'Verified': true }, { 'OrderID': 10279, 'CustomerID': 'LEHMS', 'OrderDate': new Date(839874600000), 'ShipName': 'Lehmanns Marktstand', 'ShipCity': 'Frankfurt a.M.', 'ShipAddress': 'Magazinweg 7', 'ShipRegion': null, 'ShipPostalCode': '60528', 'ShipCountry': 'Germany', 'Freight': 25.8300, 'Verified': false }, { 'OrderID': 10280, 'CustomerID': 'BERGS', 'OrderDate': new Date(839961000000), 'ShipName': 'Berglunds snabbköp', 'ShipCity': 'Luleå', 'ShipAddress': 'Berguvsvägen  8', 'ShipRegion': null, 'ShipPostalCode': 'S-958 22', 'ShipCountry': 'Sweden', 'Freight': 8.9800, 'Verified': false }, { 'OrderID': 10281, 'CustomerID': 'ROMEY', 'OrderDate': new Date(839961000000), 'ShipName': 'Romero y tomillo', 'ShipCity': 'Madrid', 'ShipAddress': 'Gran Vía, 1', 'ShipRegion': null, 'ShipPostalCode': '28001', 'ShipCountry': 'Spain', 'Freight': 2.9400, 'Verified': false }, { 'OrderID': 10282, 'CustomerID': 'ROMEY', 'OrderDate': new Date(840047400000), 'ShipName': 'Romero y tomillo', 'ShipCity': 'Madrid', 'ShipAddress': 'Gran Vía, 1', 'ShipRegion': null, 'ShipPostalCode': '28001', 'ShipCountry': 'Spain', 'Freight': 12.6900, 'Verified': false }, { 'OrderID': 10283, 'CustomerID': 'LILAS', 'OrderDate': new Date(840133800000), 'ShipName': 'LILA-Supermercado', 'ShipCity': 'Barquisimeto', 'ShipAddress': 'Carrera 52 con Ave. Bolívar #65-98 Llano Largo', 'ShipRegion': 'Lara', 'ShipPostalCode': '3508', 'ShipCountry': 'Venezuela', 'Freight': 84.8100, 'Verified': true }, { 'OrderID': 10284, 'CustomerID': 'LEHMS', 'OrderDate': new Date(840393000000), 'ShipName': 'Lehmanns Marktstand', 'ShipCity': 'Frankfurt a.M.', 'ShipAddress': 'Magazinweg 7', 'ShipRegion': null, 'ShipPostalCode': '60528', 'ShipCountry': 'Germany', 'Freight': 76.5600, 'Verified': true }, { 'OrderID': 10285, 'CustomerID': 'QUICK', 'OrderDate': new Date(840479400000), 'ShipName': 'QUICK-Stop', 'ShipCity': 'Cunewalde', 'ShipAddress': 'Taucherstraße 10', 'ShipRegion': null, 'ShipPostalCode': '01307', 'ShipCountry': 'Germany', 'Freight': 76.8300, 'Verified': true }, { 'OrderID': 10286, 'CustomerID': 'QUICK', 'OrderDate': new Date(840565800000), 'ShipName': 'QUICK-Stop', 'ShipCity': 'Cunewalde', 'ShipAddress': 'Taucherstraße 10', 'ShipRegion': null, 'ShipPostalCode': '01307', 'ShipCountry': 'Germany', 'Freight': 229.2400, 'Verified': true }, { 'OrderID': 10287, 'CustomerID': 'RICAR', 'OrderDate': new Date(840652200000), 'ShipName': 'Ricardo Adocicados', 'ShipCity': 'Rio de Janeiro', 'ShipAddress': 'Av. Copacabana, 267', 'ShipRegion': 'RJ', 'ShipPostalCode': '02389-890', 'ShipCountry': 'Brazil', 'Freight': 12.7600, 'Verified': false }, { 'OrderID': 10288, 'CustomerID': 'REGGC', 'OrderDate': new Date(840738600000), 'ShipName': 'Reggiani Caseifici', 'ShipCity': 'Reggio Emilia', 'ShipAddress': 'Strada Provinciale 124', 'ShipRegion': null, 'ShipPostalCode': '42100', 'ShipCountry': 'Italy', 'Freight': 7.4500, 'Verified': false }, { 'OrderID': 10289, 'CustomerID': 'BSBEV', 'OrderDate': new Date(840997800000), 'ShipName': 'B\u0027s Beverages', 'ShipCity': 'London', 'ShipAddress': 'Fauntleroy Circus', 'ShipRegion': null, 'ShipPostalCode': 'EC2 5NT', 'ShipCountry': 'UK', 'Freight': 22.7700, 'Verified': false }, { 'OrderID': 10290, 'CustomerID': 'COMMI', 'OrderDate': new Date(841084200000), 'ShipName': 'Comércio Mineiro', 'ShipCity': 'Sao Paulo', 'ShipAddress': 'Av. dos Lusíadas, 23', 'ShipRegion': 'SP', 'ShipPostalCode': '05432-043', 'ShipCountry': 'Brazil', 'Freight': 79.7000, 'Verified': true }, { 'OrderID': 10291, 'CustomerID': 'QUEDE', 'OrderDate': new Date(841084200000), 'ShipName': 'Que Delícia', 'ShipCity': 'Rio de Janeiro', 'ShipAddress': 'Rua da Panificadora, 12', 'ShipRegion': 'RJ', 'ShipPostalCode': '02389-673', 'ShipCountry': 'Brazil', 'Freight': 6.4000, 'Verified': false }, { 'OrderID': 10292, 'CustomerID': 'TRADH', 'OrderDate': new Date(841170600000), 'ShipName': 'Tradiçao Hipermercados', 'ShipCity': 'Sao Paulo', 'ShipAddress': 'Av. Inês de Castro, 414', 'ShipRegion': 'SP', 'ShipPostalCode': '05634-030', 'ShipCountry': 'Brazil', 'Freight': 1.3500, 'Verified': false }, { 'OrderID': 10293, 'CustomerID': 'TORTU', 'OrderDate': new Date(841257000000), 'ShipName': 'Tortuga Restaurante', 'ShipCity': 'México D.F.', 'ShipAddress': 'Avda. Azteca 123', 'ShipRegion': null, 'ShipPostalCode': '05033', 'ShipCountry': 'Mexico', 'Freight': 21.1800, 'Verified': false }, { 'OrderID': 10294, 'CustomerID': 'RATTC', 'OrderDate': new Date(841343400000), 'ShipName': 'Rattlesnake Canyon Grocery', 'ShipCity': 'Albuquerque', 'ShipAddress': '2817 Milton Dr.', 'ShipRegion': 'NM', 'ShipPostalCode': '87110', 'ShipCountry': 'USA', 'Freight': 147.2600, 'Verified': true }, { 'OrderID': 10295, 'CustomerID': 'VINET', 'OrderDate': new Date(841602600000), 'ShipName': 'Vins et alcools Chevalier', 'ShipCity': 'Reims', 'ShipAddress': '59 rue de l\u0027Abbaye', 'ShipRegion': null, 'ShipPostalCode': '51100', 'ShipCountry': 'France', 'Freight': 1.1500, 'Verified': false }, { 'OrderID': 10296, 'CustomerID': 'LILAS', 'OrderDate': new Date(841689000000), 'ShipName': 'LILA-Supermercado', 'ShipCity': 'Barquisimeto', 'ShipAddress': 'Carrera 52 con Ave. Bolívar #65-98 Llano Largo', 'ShipRegion': 'Lara', 'ShipPostalCode': '3508', 'ShipCountry': 'Venezuela', 'Freight': 0.1200, 'Verified': false }, { 'OrderID': 10297, 'CustomerID': 'BLONP', 'OrderDate': new Date(841775400000), 'ShipName': 'Blondel père et fils', 'ShipCity': 'Strasbourg', 'ShipAddress': '24, place Kléber', 'ShipRegion': null, 'ShipPostalCode': '67000', 'ShipCountry': 'France', 'Freight': 5.7400, 'Verified': false }, { 'OrderID': 10298, 'CustomerID': 'HUNGO', 'OrderDate': new Date(841861800000), 'ShipName': 'Hungry Owl All-Night Grocers', 'ShipCity': 'Cork', 'ShipAddress': '8 Johnstown Road', 'ShipRegion': 'Co. Cork', 'ShipPostalCode': null, 'ShipCountry': 'Ireland', 'Freight': 168.2200, 'Verified': true }, { 'OrderID': 10299, 'CustomerID': 'RICAR', 'OrderDate': new Date(841948200000), 'ShipName': 'Ricardo Adocicados', 'ShipCity': 'Rio de Janeiro', 'ShipAddress': 'Av. Copacabana, 267', 'ShipRegion': 'RJ', 'ShipPostalCode': '02389-890', 'ShipCountry': 'Brazil', 'Freight': 29.7600, 'Verified': false }, { 'OrderID': 10300, 'CustomerID': 'MAGAA', 'OrderDate': new Date(842207400000), 'ShipName': 'Magazzini Alimentari Riuniti', 'ShipCity': 'Bergamo', 'ShipAddress': 'Via Ludovico il Moro 22', 'ShipRegion': null, 'ShipPostalCode': '24100', 'ShipCountry': 'Italy', 'Freight': 17.6800, 'Verified': false }, { 'OrderID': 10301, 'CustomerID': 'WANDK', 'OrderDate': new Date(842207400000), 'ShipName': 'Die Wandernde Kuh', 'ShipCity': 'Stuttgart', 'ShipAddress': 'Adenauerallee 900', 'ShipRegion': null, 'ShipPostalCode': '70563', 'ShipCountry': 'Germany', 'Freight': 45.0800, 'Verified': true }, { 'OrderID': 10302, 'CustomerID': 'SUPRD', 'OrderDate': new Date(842293800000), 'ShipName': 'Suprêmes délices', 'ShipCity': 'Charleroi', 'ShipAddress': 'Boulevard Tirou, 255', 'ShipRegion': null, 'ShipPostalCode': 'B-6000', 'ShipCountry': 'Belgium', 'Freight': 6.2700, 'Verified': false }, { 'OrderID': 10303, 'CustomerID': 'GODOS', 'OrderDate': new Date(842380200000), 'ShipName': 'Godos Cocina Típica', 'ShipCity': 'Sevilla', 'ShipAddress': 'C/ Romero, 33', 'ShipRegion': null, 'ShipPostalCode': '41101', 'ShipCountry': 'Spain', 'Freight': 107.8300, 'Verified': true }, { 'OrderID': 10304, 'CustomerID': 'TORTU', 'OrderDate': new Date(842466600000), 'ShipName': 'Tortuga Restaurante', 'ShipCity': 'México D.F.', 'ShipAddress': 'Avda. Azteca 123', 'ShipRegion': null, 'ShipPostalCode': '05033', 'ShipCountry': 'Mexico', 'Freight': 63.7900, 'Verified': true }, { 'OrderID': 10305, 'CustomerID': 'OLDWO', 'OrderDate': new Date(842553000000), 'ShipName': 'Old World Delicatessen', 'ShipCity': 'Anchorage', 'ShipAddress': '2743 Bering St.', 'ShipRegion': 'AK', 'ShipPostalCode': '99508', 'ShipCountry': 'USA', 'Freight': 257.6200, 'Verified': true }, { 'OrderID': 10306, 'CustomerID': 'ROMEY', 'OrderDate': new Date(842812200000), 'ShipName': 'Romero y tomillo', 'ShipCity': 'Madrid', 'ShipAddress': 'Gran Vía, 1', 'ShipRegion': null, 'ShipPostalCode': '28001', 'ShipCountry': 'Spain', 'Freight': 7.5600, 'Verified': false }, { 'OrderID': 10307, 'CustomerID': 'LONEP', 'OrderDate': new Date(842898600000), 'ShipName': 'Lonesome Pine Restaurant', 'ShipCity': 'Portland', 'ShipAddress': '89 Chiaroscuro Rd.', 'ShipRegion': 'OR', 'ShipPostalCode': '97219', 'ShipCountry': 'USA', 'Freight': 0.5600, 'Verified': false }, { 'OrderID': 10308, 'CustomerID': 'ANATR', 'OrderDate': new Date(842985000000), 'ShipName': 'Ana Trujillo Emparedados y helados', 'ShipCity': 'México D.F.', 'ShipAddress': 'Avda. de la Constitución 2222', 'ShipRegion': null, 'ShipPostalCode': '05021', 'ShipCountry': 'Mexico', 'Freight': 1.6100, 'Verified': false }, { 'OrderID': 10309, 'CustomerID': 'HUNGO', 'OrderDate': new Date(843071400000), 'ShipName': 'Hungry Owl All-Night Grocers', 'ShipCity': 'Cork', 'ShipAddress': '8 Johnstown Road', 'ShipRegion': 'Co. Cork', 'ShipPostalCode': null, 'ShipCountry': 'Ireland', 'Freight': 47.3000, 'Verified': true }, { 'OrderID': 10310, 'CustomerID': 'THEBI', 'OrderDate': new Date(843157800000), 'ShipName': 'The Big Cheese', 'ShipCity': 'Portland', 'ShipAddress': '89 Jefferson Way Suite 2', 'ShipRegion': 'OR', 'ShipPostalCode': '97201', 'ShipCountry': 'USA', 'Freight': 17.5200, 'Verified': false }, { 'OrderID': 10311, 'CustomerID': 'DUMON', 'OrderDate': new Date(843157800000), 'ShipName': 'Du monde entier', 'ShipCity': 'Nantes', 'ShipAddress': '67, rue des Cinquante Otages', 'ShipRegion': null, 'ShipPostalCode': '44000', 'ShipCountry': 'France', 'Freight': 24.6900, 'Verified': false }, { 'OrderID': 10312, 'CustomerID': 'WANDK', 'OrderDate': new Date(843417000000), 'ShipName': 'Die Wandernde Kuh', 'ShipCity': 'Stuttgart', 'ShipAddress': 'Adenauerallee 900', 'ShipRegion': null, 'ShipPostalCode': '70563', 'ShipCountry': 'Germany', 'Freight': 40.2600, 'Verified': true }, { 'OrderID': 10313, 'CustomerID': 'QUICK', 'OrderDate': new Date(843503400000), 'ShipName': 'QUICK-Stop', 'ShipCity': 'Cunewalde', 'ShipAddress': 'Taucherstraße 10', 'ShipRegion': null, 'ShipPostalCode': '01307', 'ShipCountry': 'Germany', 'Freight': 1.9600, 'Verified': false }, { 'OrderID': 10314, 'CustomerID': 'RATTC', 'OrderDate': new Date(843589800000), 'ShipName': 'Rattlesnake Canyon Grocery', 'ShipCity': 'Albuquerque', 'ShipAddress': '2817 Milton Dr.', 'ShipRegion': 'NM', 'ShipPostalCode': '87110', 'ShipCountry': 'USA', 'Freight': 74.1600, 'Verified': true }, { 'OrderID': 10315, 'CustomerID': 'ISLAT', 'OrderDate': new Date(843676200000), 'ShipName': 'Island Trading', 'ShipCity': 'Cowes', 'ShipAddress': 'Garden House Crowther Way', 'ShipRegion': 'Isle of Wight', 'ShipPostalCode': 'PO31 7PJ', 'ShipCountry': 'UK', 'Freight': 41.7600, 'Verified': true }, { 'OrderID': 10316, 'CustomerID': 'RATTC', 'OrderDate': new Date(843762600000), 'ShipName': 'Rattlesnake Canyon Grocery', 'ShipCity': 'Albuquerque', 'ShipAddress': '2817 Milton Dr.', 'ShipRegion': 'NM', 'ShipPostalCode': '87110', 'ShipCountry': 'USA', 'Freight': 150.1500, 'Verified': true }, { 'OrderID': 10317, 'CustomerID': 'LONEP', 'OrderDate': new Date(844021800000), 'ShipName': 'Lonesome Pine Restaurant', 'ShipCity': 'Portland', 'ShipAddress': '89 Chiaroscuro Rd.', 'ShipRegion': 'OR', 'ShipPostalCode': '97219', 'ShipCountry': 'USA', 'Freight': 12.6900, 'Verified': false }, { 'OrderID': 10318, 'CustomerID': 'ISLAT', 'OrderDate': new Date(844108200000), 'ShipName': 'Island Trading', 'ShipCity': 'Cowes', 'ShipAddress': 'Garden House Crowther Way', 'ShipRegion': 'Isle of Wight', 'ShipPostalCode': 'PO31 7PJ', 'ShipCountry': 'UK', 'Freight': 4.7300, 'Verified': false }, { 'OrderID': 10319, 'CustomerID': 'TORTU', 'OrderDate': new Date(844194600000), 'ShipName': 'Tortuga Restaurante', 'ShipCity': 'México D.F.', 'ShipAddress': 'Avda. Azteca 123', 'ShipRegion': null, 'ShipPostalCode': '05033', 'ShipCountry': 'Mexico', 'Freight': 64.5000, 'Verified': true }, { 'OrderID': 10320, 'CustomerID': 'WARTH', 'OrderDate': new Date(844281000000), 'ShipName': 'Wartian Herkku', 'ShipCity': 'Oulu', 'ShipAddress': 'Torikatu 38', 'ShipRegion': null, 'ShipPostalCode': '90110', 'ShipCountry': 'Finland', 'Freight': 34.5700, 'Verified': true }, { 'OrderID': 10321, 'CustomerID': 'ISLAT', 'OrderDate': new Date(844281000000), 'ShipName': 'Island Trading', 'ShipCity': 'Cowes', 'ShipAddress': 'Garden House Crowther Way', 'ShipRegion': 'Isle of Wight', 'ShipPostalCode': 'PO31 7PJ', 'ShipCountry': 'UK', 'Freight': 3.4300, 'Verified': false }, { 'OrderID': 10322, 'CustomerID': 'PERIC', 'OrderDate': new Date(844367400000), 'ShipName': 'Pericles Comidas clásicas', 'ShipCity': 'México D.F.', 'ShipAddress': 'Calle Dr. Jorge Cash 321', 'ShipRegion': null, 'ShipPostalCode': '05033', 'ShipCountry': 'Mexico', 'Freight': 0.4000, 'Verified': false }, { 'OrderID': 10323, 'CustomerID': 'KOENE', 'OrderDate': new Date(844626600000), 'ShipName': 'Königlich Essen', 'ShipCity': 'Brandenburg', 'ShipAddress': 'Maubelstr. 90', 'ShipRegion': null, 'ShipPostalCode': '14776', 'ShipCountry': 'Germany', 'Freight': 4.8800, 'Verified': false }, { 'OrderID': 10324, 'CustomerID': 'SAVEA', 'OrderDate': new Date(844713000000), 'ShipName': 'Save-a-lot Markets', 'ShipCity': 'Boise', 'ShipAddress': '187 Suffolk Ln.', 'ShipRegion': 'ID', 'ShipPostalCode': '83720', 'ShipCountry': 'USA', 'Freight': 214.2700, 'Verified': true }, { 'OrderID': 10325, 'CustomerID': 'KOENE', 'OrderDate': new Date(844799400000), 'ShipName': 'Königlich Essen', 'ShipCity': 'Brandenburg', 'ShipAddress': 'Maubelstr. 90', 'ShipRegion': null, 'ShipPostalCode': '14776', 'ShipCountry': 'Germany', 'Freight': 64.8600, 'Verified': true }, { 'OrderID': 10326, 'CustomerID': 'BOLID', 'OrderDate': new Date(844885800000), 'ShipName': 'Bólido Comidas preparadas', 'ShipCity': 'Madrid', 'ShipAddress': 'C/ Araquil, 67', 'ShipRegion': null, 'ShipPostalCode': '28023', 'ShipCountry': 'Spain', 'Freight': 77.9200, 'Verified': true }, { 'OrderID': 10327, 'CustomerID': 'FOLKO', 'OrderDate': new Date(844972200000), 'ShipName': 'Folk och fä HB', 'ShipCity': 'Bräcke', 'ShipAddress': 'Åkergatan 24', 'ShipRegion': null, 'ShipPostalCode': 'S-844 67', 'ShipCountry': 'Sweden', 'Freight': 63.3600, 'Verified': true }, { 'OrderID': 10328, 'CustomerID': 'FURIB', 'OrderDate': new Date(845231400000), 'ShipName': 'Furia Bacalhau e Frutos do Mar', 'ShipCity': 'Lisboa', 'ShipAddress': 'Jardim das rosas n. 32', 'ShipRegion': null, 'ShipPostalCode': '1675', 'ShipCountry': 'Portugal', 'Freight': 87.0300, 'Verified': true }, { 'OrderID': 10329, 'CustomerID': 'SPLIR', 'OrderDate': new Date(845317800000), 'ShipName': 'Split Rail Beer \u0026 Ale', 'ShipCity': 'Lander', 'ShipAddress': 'P.O. Box 555', 'ShipRegion': 'WY', 'ShipPostalCode': '82520', 'ShipCountry': 'USA', 'Freight': 191.6700, 'Verified': true }, { 'OrderID': 10330, 'CustomerID': 'LILAS', 'OrderDate': new Date(845404200000), 'ShipName': 'LILA-Supermercado', 'ShipCity': 'Barquisimeto', 'ShipAddress': 'Carrera 52 con Ave. Bolívar #65-98 Llano Largo', 'ShipRegion': 'Lara', 'ShipPostalCode': '3508', 'ShipCountry': 'Venezuela', 'Freight': 12.7500, 'Verified': false }, { 'OrderID': 10331, 'CustomerID': 'BONAP', 'OrderDate': new Date(845404200000), 'ShipName': 'Bon app\u0027', 'ShipCity': 'Marseille', 'ShipAddress': '12, rue des Bouchers', 'ShipRegion': null, 'ShipPostalCode': '13008', 'ShipCountry': 'France', 'Freight': 10.1900, 'Verified': false }, { 'OrderID': 10332, 'CustomerID': 'MEREP', 'OrderDate': new Date(845490600000), 'ShipName': 'Mère Paillarde', 'ShipCity': 'Montréal', 'ShipAddress': '43 rue St. Laurent', 'ShipRegion': 'Québec', 'ShipPostalCode': 'H1J 1C3', 'ShipCountry': 'Canada', 'Freight': 52.8400, 'Verified': true }, { 'OrderID': 10333, 'CustomerID': 'WARTH', 'OrderDate': new Date(845577000000), 'ShipName': 'Wartian Herkku', 'ShipCity': 'Oulu', 'ShipAddress': 'Torikatu 38', 'ShipRegion': null, 'ShipPostalCode': '90110', 'ShipCountry': 'Finland', 'Freight': 0.5900, 'Verified': false }, { 'OrderID': 10334, 'CustomerID': 'VICTE', 'OrderDate': new Date(845836200000), 'ShipName': 'Victuailles en stock', 'ShipCity': 'Lyon', 'ShipAddress': '2, rue du Commerce', 'ShipRegion': null, 'ShipPostalCode': '69004', 'ShipCountry': 'France', 'Freight': 8.5600, 'Verified': false }, { 'OrderID': 10335, 'CustomerID': 'HUNGO', 'OrderDate': new Date(845922600000), 'ShipName': 'Hungry Owl All-Night Grocers', 'ShipCity': 'Cork', 'ShipAddress': '8 Johnstown Road', 'ShipRegion': 'Co. Cork', 'ShipPostalCode': null, 'ShipCountry': 'Ireland', 'Freight': 42.1100, 'Verified': true }, { 'OrderID': 10336, 'CustomerID': 'PRINI', 'OrderDate': new Date(846009000000), 'ShipName': 'Princesa Isabel Vinhos', 'ShipCity': 'Lisboa', 'ShipAddress': 'Estrada da saúde n. 58', 'ShipRegion': null, 'ShipPostalCode': '1756', 'ShipCountry': 'Portugal', 'Freight': 15.5100, 'Verified': false }, { 'OrderID': 10337, 'CustomerID': 'FRANK', 'OrderDate': new Date(846095400000), 'ShipName': 'Frankenversand', 'ShipCity': 'München', 'ShipAddress': 'Berliner Platz 43', 'ShipRegion': null, 'ShipPostalCode': '80805', 'ShipCountry': 'Germany', 'Freight': 108.2600, 'Verified': true }, { 'OrderID': 10338, 'CustomerID': 'OLDWO', 'OrderDate': new Date(846181800000), 'ShipName': 'Old World Delicatessen', 'ShipCity': 'Anchorage', 'ShipAddress': '2743 Bering St.', 'ShipRegion': 'AK', 'ShipPostalCode': '99508', 'ShipCountry': 'USA', 'Freight': 84.2100, 'Verified': true }, { 'OrderID': 10339, 'CustomerID': 'MEREP', 'OrderDate': new Date(846441000000), 'ShipName': 'Mère Paillarde', 'ShipCity': 'Montréal', 'ShipAddress': '43 rue St. Laurent', 'ShipRegion': 'Québec', 'ShipPostalCode': 'H1J 1C3', 'ShipCountry': 'Canada', 'Freight': 15.6600, 'Verified': false }, { 'OrderID': 10340, 'CustomerID': 'BONAP', 'OrderDate': new Date(846527400000), 'ShipName': 'Bon app\u0027', 'ShipCity': 'Marseille', 'ShipAddress': '12, rue des Bouchers', 'ShipRegion': null, 'ShipPostalCode': '13008', 'ShipCountry': 'France', 'Freight': 166.3100, 'Verified': true }, { 'OrderID': 10341, 'CustomerID': 'SIMOB', 'OrderDate': new Date(846527400000), 'ShipName': 'Simons bistro', 'ShipCity': 'Kobenhavn', 'ShipAddress': 'Vinbæltet 34', 'ShipRegion': null, 'ShipPostalCode': '1734', 'ShipCountry': 'Denmark', 'Freight': 26.7800, 'Verified': false }, { 'OrderID': 10342, 'CustomerID': 'FRANK', 'OrderDate': new Date(846613800000), 'ShipName': 'Frankenversand', 'ShipCity': 'München', 'ShipAddress': 'Berliner Platz 43', 'ShipRegion': null, 'ShipPostalCode': '80805', 'ShipCountry': 'Germany', 'Freight': 54.8300, 'Verified': true }, { 'OrderID': 10343, 'CustomerID': 'LEHMS', 'OrderDate': new Date(846700200000), 'ShipName': 'Lehmanns Marktstand', 'ShipCity': 'Frankfurt a.M.', 'ShipAddress': 'Magazinweg 7', 'ShipRegion': null, 'ShipPostalCode': '60528', 'ShipCountry': 'Germany', 'Freight': 110.3700, 'Verified': true }, { 'OrderID': 10344, 'CustomerID': 'WHITC', 'OrderDate': new Date(846786600000), 'ShipName': 'White Clover Markets', 'ShipCity': 'Seattle', 'ShipAddress': '1029 - 12th Ave. S.', 'ShipRegion': 'WA', 'ShipPostalCode': '98124', 'ShipCountry': 'USA', 'Freight': 23.2900, 'Verified': false }, { 'OrderID': 10345, 'CustomerID': 'QUICK', 'OrderDate': new Date(847045800000), 'ShipName': 'QUICK-Stop', 'ShipCity': 'Cunewalde', 'ShipAddress': 'Taucherstraße 10', 'ShipRegion': null, 'ShipPostalCode': '01307', 'ShipCountry': 'Germany', 'Freight': 249.0600, 'Verified': true }, { 'OrderID': 10346, 'CustomerID': 'RATTC', 'OrderDate': new Date(847132200000), 'ShipName': 'Rattlesnake Canyon Grocery', 'ShipCity': 'Albuquerque', 'ShipAddress': '2817 Milton Dr.', 'ShipRegion': 'NM', 'ShipPostalCode': '87110', 'ShipCountry': 'USA', 'Freight': 142.0800, 'Verified': true }, { 'OrderID': 10347, 'CustomerID': 'FAMIA', 'OrderDate': new Date(847218600000), 'ShipName': 'Familia Arquibaldo', 'ShipCity': 'Sao Paulo', 'ShipAddress': 'Rua Orós, 92', 'ShipRegion': 'SP', 'ShipPostalCode': '05442-030', 'ShipCountry': 'Brazil', 'Freight': 3.1000, 'Verified': false }, { 'OrderID': 10348, 'CustomerID': 'WANDK', 'OrderDate': new Date(847305000000), 'ShipName': 'Die Wandernde Kuh', 'ShipCity': 'Stuttgart', 'ShipAddress': 'Adenauerallee 900', 'ShipRegion': null, 'ShipPostalCode': '70563', 'ShipCountry': 'Germany', 'Freight': 0.7800, 'Verified': false }, { 'OrderID': 10349, 'CustomerID': 'SPLIR', 'OrderDate': new Date(847391400000), 'ShipName': 'Split Rail Beer \u0026 Ale', 'ShipCity': 'Lander', 'ShipAddress': 'P.O. Box 555', 'ShipRegion': 'WY', 'ShipPostalCode': '82520', 'ShipCountry': 'USA', 'Freight': 8.6300, 'Verified': false }, { 'OrderID': 10350, 'CustomerID': 'LAMAI', 'OrderDate': new Date(847650600000), 'ShipName': 'La maison d\u0027Asie', 'ShipCity': 'Toulouse', 'ShipAddress': '1 rue Alsace-Lorraine', 'ShipRegion': null, 'ShipPostalCode': '31000', 'ShipCountry': 'France', 'Freight': 64.1900, 'Verified': true }, { 'OrderID': 10351, 'CustomerID': 'ERNSH', 'OrderDate': new Date(847650600000), 'ShipName': 'Ernst Handel', 'ShipCity': 'Graz', 'ShipAddress': 'Kirchgasse 6', 'ShipRegion': null, 'ShipPostalCode': '8010', 'ShipCountry': 'Austria', 'Freight': 162.3300, 'Verified': true }, { 'OrderID': 10352, 'CustomerID': 'FURIB', 'OrderDate': new Date(847737000000), 'ShipName': 'Furia Bacalhau e Frutos do Mar', 'ShipCity': 'Lisboa', 'ShipAddress': 'Jardim das rosas n. 32', 'ShipRegion': null, 'ShipPostalCode': '1675', 'ShipCountry': 'Portugal', 'Freight': 1.3000, 'Verified': false }, { 'OrderID': 10353, 'CustomerID': 'PICCO', 'OrderDate': new Date(847823400000), 'ShipName': 'Piccolo und mehr', 'ShipCity': 'Salzburg', 'ShipAddress': 'Geislweg 14', 'ShipRegion': null, 'ShipPostalCode': '5020', 'ShipCountry': 'Austria', 'Freight': 360.6300, 'Verified': true }, { 'OrderID': 10354, 'CustomerID': 'PERIC', 'OrderDate': new Date(847909800000), 'ShipName': 'Pericles Comidas clásicas', 'ShipCity': 'México D.F.', 'ShipAddress': 'Calle Dr. Jorge Cash 321', 'ShipRegion': null, 'ShipPostalCode': '05033', 'ShipCountry': 'Mexico', 'Freight': 53.8000, 'Verified': true }, { 'OrderID': 10355, 'CustomerID': 'AROUT', 'OrderDate': new Date(847996200000), 'ShipName': 'Around the Horn', 'ShipCity': 'Colchester', 'ShipAddress': 'Brook Farm Stratford St. Mary', 'ShipRegion': 'Essex', 'ShipPostalCode': 'CO7 6JX', 'ShipCountry': 'UK', 'Freight': 41.9500, 'Verified': true }, { 'OrderID': 10356, 'CustomerID': 'WANDK', 'OrderDate': new Date(848255400000), 'ShipName': 'Die Wandernde Kuh', 'ShipCity': 'Stuttgart', 'ShipAddress': 'Adenauerallee 900', 'ShipRegion': null, 'ShipPostalCode': '70563', 'ShipCountry': 'Germany', 'Freight': 36.7100, 'Verified': true }, { 'OrderID': 10357, 'CustomerID': 'LILAS', 'OrderDate': new Date(848341800000), 'ShipName': 'LILA-Supermercado', 'ShipCity': 'Barquisimeto', 'ShipAddress': 'Carrera 52 con Ave. Bolívar #65-98 Llano Largo', 'ShipRegion': 'Lara', 'ShipPostalCode': '3508', 'ShipCountry': 'Venezuela', 'Freight': 34.8800, 'Verified': true }, { 'OrderID': 10358, 'CustomerID': 'LAMAI', 'OrderDate': new Date(848428200000), 'ShipName': 'La maison d\u0027Asie', 'ShipCity': 'Toulouse', 'ShipAddress': '1 rue Alsace-Lorraine', 'ShipRegion': null, 'ShipPostalCode': '31000', 'ShipCountry': 'France', 'Freight': 19.6400, 'Verified': false }, { 'OrderID': 10359, 'CustomerID': 'SEVES', 'OrderDate': new Date(848514600000), 'ShipName': 'Seven Seas Imports', 'ShipCity': 'London', 'ShipAddress': '90 Wadhurst Rd.', 'ShipRegion': null, 'ShipPostalCode': 'OX15 4NB', 'ShipCountry': 'UK', 'Freight': 288.4300, 'Verified': true }, { 'OrderID': 10360, 'CustomerID': 'BLONP', 'OrderDate': new Date(848601000000), 'ShipName': 'Blondel père et fils', 'ShipCity': 'Strasbourg', 'ShipAddress': '24, place Kléber', 'ShipRegion': null, 'ShipPostalCode': '67000', 'ShipCountry': 'France', 'Freight': 131.7000, 'Verified': true }, { 'OrderID': 10361, 'CustomerID': 'QUICK', 'OrderDate': new Date(848601000000), 'ShipName': 'QUICK-Stop', 'ShipCity': 'Cunewalde', 'ShipAddress': 'Taucherstraße 10', 'ShipRegion': null, 'ShipPostalCode': '01307', 'ShipCountry': 'Germany', 'Freight': 183.1700, 'Verified': true }, { 'OrderID': 10362, 'CustomerID': 'BONAP', 'OrderDate': new Date(848860200000), 'ShipName': 'Bon app\u0027', 'ShipCity': 'Marseille', 'ShipAddress': '12, rue des Bouchers', 'ShipRegion': null, 'ShipPostalCode': '13008', 'ShipCountry': 'France', 'Freight': 96.0400, 'Verified': true }, { 'OrderID': 10363, 'CustomerID': 'DRACD', 'OrderDate': new Date(848946600000), 'ShipName': 'Drachenblut Delikatessen', 'ShipCity': 'Aachen', 'ShipAddress': 'Walserweg 21', 'ShipRegion': null, 'ShipPostalCode': '52066', 'ShipCountry': 'Germany', 'Freight': 30.5400, 'Verified': true }, { 'OrderID': 10364, 'CustomerID': 'EASTC', 'OrderDate': new Date(848946600000), 'ShipName': 'Eastern Connection', 'ShipCity': 'London', 'ShipAddress': '35 King George', 'ShipRegion': null, 'ShipPostalCode': 'WX3 6FW', 'ShipCountry': 'UK', 'Freight': 71.9700, 'Verified': true }, { 'OrderID': 10365, 'CustomerID': 'ANTON', 'OrderDate': new Date(849033000000), 'ShipName': 'Antonio Moreno Taquería', 'ShipCity': 'México D.F.', 'ShipAddress': 'Mataderos  2312', 'ShipRegion': null, 'ShipPostalCode': '05023', 'ShipCountry': 'Mexico', 'Freight': 22.0000, 'Verified': false }, { 'OrderID': 10366, 'CustomerID': 'GALED', 'OrderDate': new Date(849119400000), 'ShipName': 'Galería del gastronómo', 'ShipCity': 'Barcelona', 'ShipAddress': 'Rambla de Cataluña, 23', 'ShipRegion': null, 'ShipPostalCode': '8022', 'ShipCountry': 'Spain', 'Freight': 10.1400, 'Verified': false }, { 'OrderID': 10367, 'CustomerID': 'VAFFE', 'OrderDate': new Date(849119400000), 'ShipName': 'Vaffeljernet', 'ShipCity': 'Århus', 'ShipAddress': 'Smagsloget 45', 'ShipRegion': null, 'ShipPostalCode': '8200', 'ShipCountry': 'Denmark', 'Freight': 13.5500, 'Verified': false }, { 'OrderID': 10368, 'CustomerID': 'ERNSH', 'OrderDate': new Date(849205800000), 'ShipName': 'Ernst Handel', 'ShipCity': 'Graz', 'ShipAddress': 'Kirchgasse 6', 'ShipRegion': null, 'ShipPostalCode': '8010', 'ShipCountry': 'Austria', 'Freight': 101.9500, 'Verified': true }, { 'OrderID': 10369, 'CustomerID': 'SPLIR', 'OrderDate': new Date(849465000000), 'ShipName': 'Split Rail Beer \u0026 Ale', 'ShipCity': 'Lander', 'ShipAddress': 'P.O. Box 555', 'ShipRegion': 'WY', 'ShipPostalCode': '82520', 'ShipCountry': 'USA', 'Freight': 195.6800, 'Verified': true }, { 'OrderID': 10370, 'CustomerID': 'CHOPS', 'OrderDate': new Date(849551400000), 'ShipName': 'Chop-suey Chinese', 'ShipCity': 'Bern', 'ShipAddress': 'Hauptstr. 31', 'ShipRegion': null, 'ShipPostalCode': '3012', 'ShipCountry': 'Switzerland', 'Freight': 1.1700, 'Verified': false }, { 'OrderID': 10371, 'CustomerID': 'LAMAI', 'OrderDate': new Date(849551400000), 'ShipName': 'La maison d\u0027Asie', 'ShipCity': 'Toulouse', 'ShipAddress': '1 rue Alsace-Lorraine', 'ShipRegion': null, 'ShipPostalCode': '31000', 'ShipCountry': 'France', 'Freight': 0.4500, 'Verified': false }, { 'OrderID': 10372, 'CustomerID': 'QUEEN', 'OrderDate': new Date(849637800000), 'ShipName': 'Queen Cozinha', 'ShipCity': 'Sao Paulo', 'ShipAddress': 'Alameda dos Canàrios, 891', 'ShipRegion': 'SP', 'ShipPostalCode': '05487-020', 'ShipCountry': 'Brazil', 'Freight': 890.7800, 'Verified': true }, { 'OrderID': 10373, 'CustomerID': 'HUNGO', 'OrderDate': new Date(849724200000), 'ShipName': 'Hungry Owl All-Night Grocers', 'ShipCity': 'Cork', 'ShipAddress': '8 Johnstown Road', 'ShipRegion': 'Co. Cork', 'ShipPostalCode': null, 'ShipCountry': 'Ireland', 'Freight': 124.1200, 'Verified': true }, { 'OrderID': 10374, 'CustomerID': 'WOLZA', 'OrderDate': new Date(849724200000), 'ShipName': 'Wolski Zajazd', 'ShipCity': 'Warszawa', 'ShipAddress': 'ul. Filtrowa 68', 'ShipRegion': null, 'ShipPostalCode': '01-012', 'ShipCountry': 'Poland', 'Freight': 3.9400, 'Verified': false }, { 'OrderID': 10375, 'CustomerID': 'HUNGC', 'OrderDate': new Date(849810600000), 'ShipName': 'Hungry Coyote Import Store', 'ShipCity': 'Elgin', 'ShipAddress': 'City Center Plaza 516 Main St.', 'ShipRegion': 'OR', 'ShipPostalCode': '97827', 'ShipCountry': 'USA', 'Freight': 20.1200, 'Verified': false }, { 'OrderID': 10376, 'CustomerID': 'MEREP', 'OrderDate': new Date(850069800000), 'ShipName': 'Mère Paillarde', 'ShipCity': 'Montréal', 'ShipAddress': '43 rue St. Laurent', 'ShipRegion': 'Québec', 'ShipPostalCode': 'H1J 1C3', 'ShipCountry': 'Canada', 'Freight': 20.3900, 'Verified': false }, { 'OrderID': 10377, 'CustomerID': 'SEVES', 'OrderDate': new Date(850069800000), 'ShipName': 'Seven Seas Imports', 'ShipCity': 'London', 'ShipAddress': '90 Wadhurst Rd.', 'ShipRegion': null, 'ShipPostalCode': 'OX15 4NB', 'ShipCountry': 'UK', 'Freight': 22.2100, 'Verified': false }, { 'OrderID': 10378, 'CustomerID': 'FOLKO', 'OrderDate': new Date(850156200000), 'ShipName': 'Folk och fä HB', 'ShipCity': 'Bräcke', 'ShipAddress': 'Åkergatan 24', 'ShipRegion': null, 'ShipPostalCode': 'S-844 67', 'ShipCountry': 'Sweden', 'Freight': 5.4400, 'Verified': false }, { 'OrderID': 10379, 'CustomerID': 'QUEDE', 'OrderDate': new Date(850242600000), 'ShipName': 'Que Delícia', 'ShipCity': 'Rio de Janeiro', 'ShipAddress': 'Rua da Panificadora, 12', 'ShipRegion': 'RJ', 'ShipPostalCode': '02389-673', 'ShipCountry': 'Brazil', 'Freight': 45.0300, 'Verified': true }, { 'OrderID': 10380, 'CustomerID': 'HUNGO', 'OrderDate': new Date(850329000000), 'ShipName': 'Hungry Owl All-Night Grocers', 'ShipCity': 'Cork', 'ShipAddress': '8 Johnstown Road', 'ShipRegion': 'Co. Cork', 'ShipPostalCode': null, 'ShipCountry': 'Ireland', 'Freight': 35.0300, 'Verified': true }, { 'OrderID': 10381, 'CustomerID': 'LILAS', 'OrderDate': new Date(850329000000), 'ShipName': 'LILA-Supermercado', 'ShipCity': 'Barquisimeto', 'ShipAddress': 'Carrera 52 con Ave. Bolívar #65-98 Llano Largo', 'ShipRegion': 'Lara', 'ShipPostalCode': '3508', 'ShipCountry': 'Venezuela', 'Freight': 7.9900, 'Verified': false }, { 'OrderID': 10382, 'CustomerID': 'ERNSH', 'OrderDate': new Date(850415400000), 'ShipName': 'Ernst Handel', 'ShipCity': 'Graz', 'ShipAddress': 'Kirchgasse 6', 'ShipRegion': null, 'ShipPostalCode': '8010', 'ShipCountry': 'Austria', 'Freight': 94.7700, 'Verified': true }, { 'OrderID': 10383, 'CustomerID': 'AROUT', 'OrderDate': new Date(850674600000), 'ShipName': 'Around the Horn', 'ShipCity': 'Colchester', 'ShipAddress': 'Brook Farm Stratford St. Mary', 'ShipRegion': 'Essex', 'ShipPostalCode': 'CO7 6JX', 'ShipCountry': 'UK', 'Freight': 34.2400, 'Verified': true }, { 'OrderID': 10384, 'CustomerID': 'BERGS', 'OrderDate': new Date(850674600000), 'ShipName': 'Berglunds snabbköp', 'ShipCity': 'Luleå', 'ShipAddress': 'Berguvsvägen  8', 'ShipRegion': null, 'ShipPostalCode': 'S-958 22', 'ShipCountry': 'Sweden', 'Freight': 168.6400, 'Verified': true }, { 'OrderID': 10385, 'CustomerID': 'SPLIR', 'OrderDate': new Date(850761000000), 'ShipName': 'Split Rail Beer \u0026 Ale', 'ShipCity': 'Lander', 'ShipAddress': 'P.O. Box 555', 'ShipRegion': 'WY', 'ShipPostalCode': '82520', 'ShipCountry': 'USA', 'Freight': 30.9600, 'Verified': true }, { 'OrderID': 10386, 'CustomerID': 'FAMIA', 'OrderDate': new Date(850847400000), 'ShipName': 'Familia Arquibaldo', 'ShipCity': 'Sao Paulo', 'ShipAddress': 'Rua Orós, 92', 'ShipRegion': 'SP', 'ShipPostalCode': '05442-030', 'ShipCountry': 'Brazil', 'Freight': 13.9900, 'Verified': false }, { 'OrderID': 10387, 'CustomerID': 'SANTG', 'OrderDate': new Date(850847400000), 'ShipName': 'Santé Gourmet', 'ShipCity': 'Stavern', 'ShipAddress': 'Erling Skakkes gate 78', 'ShipRegion': null, 'ShipPostalCode': '4110', 'ShipCountry': 'Norway', 'Freight': 93.6300, 'Verified': true }, { 'OrderID': 10388, 'CustomerID': 'SEVES', 'OrderDate': new Date(850933800000), 'ShipName': 'Seven Seas Imports', 'ShipCity': 'London', 'ShipAddress': '90 Wadhurst Rd.', 'ShipRegion': null, 'ShipPostalCode': 'OX15 4NB', 'ShipCountry': 'UK', 'Freight': 34.8600, 'Verified': true }, { 'OrderID': 10389, 'CustomerID': 'BOTTM', 'OrderDate': new Date(851020200000), 'ShipName': 'Bottom-Dollar Markets', 'ShipCity': 'Tsawassen', 'ShipAddress': '23 Tsawassen Blvd.', 'ShipRegion': 'BC', 'ShipPostalCode': 'T2F 8M4', 'ShipCountry': 'Canada', 'Freight': 47.4200, 'Verified': true }, { 'OrderID': 10390, 'CustomerID': 'ERNSH', 'OrderDate': new Date(851279400000), 'ShipName': 'Ernst Handel', 'ShipCity': 'Graz', 'ShipAddress': 'Kirchgasse 6', 'ShipRegion': null, 'ShipPostalCode': '8010', 'ShipCountry': 'Austria', 'Freight': 126.3800, 'Verified': true }, { 'OrderID': 10391, 'CustomerID': 'DRACD', 'OrderDate': new Date(851279400000), 'ShipName': 'Drachenblut Delikatessen', 'ShipCity': 'Aachen', 'ShipAddress': 'Walserweg 21', 'ShipRegion': null, 'ShipPostalCode': '52066', 'ShipCountry': 'Germany', 'Freight': 5.4500, 'Verified': false }, { 'OrderID': 10392, 'CustomerID': 'PICCO', 'OrderDate': new Date(851365800000), 'ShipName': 'Piccolo und mehr', 'ShipCity': 'Salzburg', 'ShipAddress': 'Geislweg 14', 'ShipRegion': null, 'ShipPostalCode': '5020', 'ShipCountry': 'Austria', 'Freight': 122.4600, 'Verified': true }, { 'OrderID': 10393, 'CustomerID': 'SAVEA', 'OrderDate': new Date(851452200000), 'ShipName': 'Save-a-lot Markets', 'ShipCity': 'Boise', 'ShipAddress': '187 Suffolk Ln.', 'ShipRegion': 'ID', 'ShipPostalCode': '83720', 'ShipCountry': 'USA', 'Freight': 126.5600, 'Verified': true }, { 'OrderID': 10394, 'CustomerID': 'HUNGC', 'OrderDate': new Date(851452200000), 'ShipName': 'Hungry Coyote Import Store', 'ShipCity': 'Elgin', 'ShipAddress': 'City Center Plaza 516 Main St.', 'ShipRegion': 'OR', 'ShipPostalCode': '97827', 'ShipCountry': 'USA', 'Freight': 30.3400, 'Verified': true }, { 'OrderID': 10395, 'CustomerID': 'HILAA', 'OrderDate': new Date(851538600000), 'ShipName': 'HILARION-Abastos', 'ShipCity': 'San Cristóbal', 'ShipAddress': 'Carrera 22 con Ave. Carlos Soublette #8-35', 'ShipRegion': 'Táchira', 'ShipPostalCode': '5022', 'ShipCountry': 'Venezuela', 'Freight': 184.4100, 'Verified': true }, { 'OrderID': 10396, 'CustomerID': 'FRANK', 'OrderDate': new Date(851625000000), 'ShipName': 'Frankenversand', 'ShipCity': 'München', 'ShipAddress': 'Berliner Platz 43', 'ShipRegion': null, 'ShipPostalCode': '80805', 'ShipCountry': 'Germany', 'Freight': 135.3500, 'Verified': true }, { 'OrderID': 10397, 'CustomerID': 'PRINI', 'OrderDate': new Date(851625000000), 'ShipName': 'Princesa Isabel Vinhos', 'ShipCity': 'Lisboa', 'ShipAddress': 'Estrada da saúde n. 58', 'ShipRegion': null, 'ShipPostalCode': '1756', 'ShipCountry': 'Portugal', 'Freight': 60.2600, 'Verified': true }, { 'OrderID': 10398, 'CustomerID': 'SAVEA', 'OrderDate': new Date(851884200000), 'ShipName': 'Save-a-lot Markets', 'ShipCity': 'Boise', 'ShipAddress': '187 Suffolk Ln.', 'ShipRegion': 'ID', 'ShipPostalCode': '83720', 'ShipCountry': 'USA', 'Freight': 89.1600, 'Verified': true }, { 'OrderID': 10399, 'CustomerID': 'VAFFE', 'OrderDate': new Date(851970600000), 'ShipName': 'Vaffeljernet', 'ShipCity': 'Århus', 'ShipAddress': 'Smagsloget 45', 'ShipRegion': null, 'ShipPostalCode': '8200', 'ShipCountry': 'Denmark', 'Freight': 27.3600, 'Verified': false }, { 'OrderID': 10400, 'CustomerID': 'EASTC', 'OrderDate': new Date(852057000000), 'ShipName': 'Eastern Connection', 'ShipCity': 'London', 'ShipAddress': '35 King George', 'ShipRegion': null, 'ShipPostalCode': 'WX3 6FW', 'ShipCountry': 'UK', 'Freight': 83.9300, 'Verified': true }, { 'OrderID': 10401, 'CustomerID': 'RATTC', 'OrderDate': new Date(852057000000), 'ShipName': 'Rattlesnake Canyon Grocery', 'ShipCity': 'Albuquerque', 'ShipAddress': '2817 Milton Dr.', 'ShipRegion': 'NM', 'ShipPostalCode': '87110', 'ShipCountry': 'USA', 'Freight': 12.5100, 'Verified': false }, { 'OrderID': 10402, 'CustomerID': 'ERNSH', 'OrderDate': new Date(852143400000), 'ShipName': 'Ernst Handel', 'ShipCity': 'Graz', 'ShipAddress': 'Kirchgasse 6', 'ShipRegion': null, 'ShipPostalCode': '8010', 'ShipCountry': 'Austria', 'Freight': 67.8800, 'Verified': true }, { 'OrderID': 10403, 'CustomerID': 'ERNSH', 'OrderDate': new Date(852229800000), 'ShipName': 'Ernst Handel', 'ShipCity': 'Graz', 'ShipAddress': 'Kirchgasse 6', 'ShipRegion': null, 'ShipPostalCode': '8010', 'ShipCountry': 'Austria', 'Freight': 73.7900, 'Verified': true }, { 'OrderID': 10404, 'CustomerID': 'MAGAA', 'OrderDate': new Date(852229800000), 'ShipName': 'Magazzini Alimentari Riuniti', 'ShipCity': 'Bergamo', 'ShipAddress': 'Via Ludovico il Moro 22', 'ShipRegion': null, 'ShipPostalCode': '24100', 'ShipCountry': 'Italy', 'Freight': 155.9700, 'Verified': true }, { 'OrderID': 10405, 'CustomerID': 'LINOD', 'OrderDate': new Date(852489000000), 'ShipName': 'LINO-Delicateses', 'ShipCity': 'I. de Margarita', 'ShipAddress': 'Ave. 5 de Mayo Porlamar', 'ShipRegion': 'Nueva Esparta', 'ShipPostalCode': '4980', 'ShipCountry': 'Venezuela', 'Freight': 34.8200, 'Verified': true }, { 'OrderID': 10406, 'CustomerID': 'QUEEN', 'OrderDate': new Date(852575400000), 'ShipName': 'Queen Cozinha', 'ShipCity': 'Sao Paulo', 'ShipAddress': 'Alameda dos Canàrios, 891', 'ShipRegion': 'SP', 'ShipPostalCode': '05487-020', 'ShipCountry': 'Brazil', 'Freight': 108.0400, 'Verified': true }, { 'OrderID': 10407, 'CustomerID': 'OTTIK', 'OrderDate': new Date(852575400000), 'ShipName': 'Ottilies Käseladen', 'ShipCity': 'Köln', 'ShipAddress': 'Mehrheimerstr. 369', 'ShipRegion': null, 'ShipPostalCode': '50739', 'ShipCountry': 'Germany', 'Freight': 91.4800, 'Verified': true }, { 'OrderID': 10408, 'CustomerID': 'FOLIG', 'OrderDate': new Date(852661800000), 'ShipName': 'Folies gourmandes', 'ShipCity': 'Lille', 'ShipAddress': '184, chaussée de Tournai', 'ShipRegion': null, 'ShipPostalCode': '59000', 'ShipCountry': 'France', 'Freight': 11.2600, 'Verified': false }, { 'OrderID': 10409, 'CustomerID': 'OCEAN', 'OrderDate': new Date(852748200000), 'ShipName': 'Océano Atlántico Ltda.', 'ShipCity': 'Buenos Aires', 'ShipAddress': 'Ing. Gustavo Moncada 8585 Piso 20-A', 'ShipRegion': null, 'ShipPostalCode': '1010', 'ShipCountry': 'Argentina', 'Freight': 29.8300, 'Verified': false }, { 'OrderID': 10410, 'CustomerID': 'BOTTM', 'OrderDate': new Date(852834600000), 'ShipName': 'Bottom-Dollar Markets', 'ShipCity': 'Tsawassen', 'ShipAddress': '23 Tsawassen Blvd.', 'ShipRegion': 'BC', 'ShipPostalCode': 'T2F 8M4', 'ShipCountry': 'Canada', 'Freight': 2.4000, 'Verified': false }, { 'OrderID': 10411, 'CustomerID': 'BOTTM', 'OrderDate': new Date(852834600000), 'ShipName': 'Bottom-Dollar Markets', 'ShipCity': 'Tsawassen', 'ShipAddress': '23 Tsawassen Blvd.', 'ShipRegion': 'BC', 'ShipPostalCode': 'T2F 8M4', 'ShipCountry': 'Canada', 'Freight': 23.6500, 'Verified': false }, { 'OrderID': 10412, 'CustomerID': 'WARTH', 'OrderDate': new Date(853093800000), 'ShipName': 'Wartian Herkku', 'ShipCity': 'Oulu', 'ShipAddress': 'Torikatu 38', 'ShipRegion': null, 'ShipPostalCode': '90110', 'ShipCountry': 'Finland', 'Freight': 3.7700, 'Verified': false }, { 'OrderID': 10413, 'CustomerID': 'LAMAI', 'OrderDate': new Date(853180200000), 'ShipName': 'La maison d\u0027Asie', 'ShipCity': 'Toulouse', 'ShipAddress': '1 rue Alsace-Lorraine', 'ShipRegion': null, 'ShipPostalCode': '31000', 'ShipCountry': 'France', 'Freight': 95.6600, 'Verified': true }, { 'OrderID': 10414, 'CustomerID': 'FAMIA', 'OrderDate': new Date(853180200000), 'ShipName': 'Familia Arquibaldo', 'ShipCity': 'Sao Paulo', 'ShipAddress': 'Rua Orós, 92', 'ShipRegion': 'SP', 'ShipPostalCode': '05442-030', 'ShipCountry': 'Brazil', 'Freight': 21.4800, 'Verified': false }, { 'OrderID': 10415, 'CustomerID': 'HUNGC', 'OrderDate': new Date(853266600000), 'ShipName': 'Hungry Coyote Import Store', 'ShipCity': 'Elgin', 'ShipAddress': 'City Center Plaza 516 Main St.', 'ShipRegion': 'OR', 'ShipPostalCode': '97827', 'ShipCountry': 'USA', 'Freight': 0.2000, 'Verified': false }, { 'OrderID': 10416, 'CustomerID': 'WARTH', 'OrderDate': new Date(853353000000), 'ShipName': 'Wartian Herkku', 'ShipCity': 'Oulu', 'ShipAddress': 'Torikatu 38', 'ShipRegion': null, 'ShipPostalCode': '90110', 'ShipCountry': 'Finland', 'Freight': 22.7200, 'Verified': false }, { 'OrderID': 10417, 'CustomerID': 'SIMOB', 'OrderDate': new Date(853353000000), 'ShipName': 'Simons bistro', 'ShipCity': 'Kobenhavn', 'ShipAddress': 'Vinbæltet 34', 'ShipRegion': null, 'ShipPostalCode': '1734', 'ShipCountry': 'Denmark', 'Freight': 70.2900, 'Verified': true }, { 'OrderID': 10418, 'CustomerID': 'QUICK', 'OrderDate': new Date(853439400000), 'ShipName': 'QUICK-Stop', 'ShipCity': 'Cunewalde', 'ShipAddress': 'Taucherstraße 10', 'ShipRegion': null, 'ShipPostalCode': '01307', 'ShipCountry': 'Germany', 'Freight': 17.5500, 'Verified': false }, { 'OrderID': 10419, 'CustomerID': 'RICSU', 'OrderDate': new Date(853698600000), 'ShipName': 'Richter Supermarkt', 'ShipCity': 'Genève', 'ShipAddress': 'Starenweg 5', 'ShipRegion': null, 'ShipPostalCode': '1204', 'ShipCountry': 'Switzerland', 'Freight': 137.3500, 'Verified': true }, { 'OrderID': 10420, 'CustomerID': 'WELLI', 'OrderDate': new Date(853785000000), 'ShipName': 'Wellington Importadora', 'ShipCity': 'Resende', 'ShipAddress': 'Rua do Mercado, 12', 'ShipRegion': 'SP', 'ShipPostalCode': '08737-363', 'ShipCountry': 'Brazil', 'Freight': 44.1200, 'Verified': true }, { 'OrderID': 10421, 'CustomerID': 'QUEDE', 'OrderDate': new Date(853785000000), 'ShipName': 'Que Delícia', 'ShipCity': 'Rio de Janeiro', 'ShipAddress': 'Rua da Panificadora, 12', 'ShipRegion': 'RJ', 'ShipPostalCode': '02389-673', 'ShipCountry': 'Brazil', 'Freight': 99.2300, 'Verified': true }, { 'OrderID': 10422, 'CustomerID': 'FRANS', 'OrderDate': new Date(853871400000), 'ShipName': 'Franchi S.p.A.', 'ShipCity': 'Torino', 'ShipAddress': 'Via Monte Bianco 34', 'ShipRegion': null, 'ShipPostalCode': '10100', 'ShipCountry': 'Italy', 'Freight': 3.0200, 'Verified': false }, { 'OrderID': 10423, 'CustomerID': 'GOURL', 'OrderDate': new Date(853957800000), 'ShipName': 'Gourmet Lanchonetes', 'ShipCity': 'Campinas', 'ShipAddress': 'Av. Brasil, 442', 'ShipRegion': 'SP', 'ShipPostalCode': '04876-786', 'ShipCountry': 'Brazil', 'Freight': 24.5000, 'Verified': false }, { 'OrderID': 10424, 'CustomerID': 'MEREP', 'OrderDate': new Date(853957800000), 'ShipName': 'Mère Paillarde', 'ShipCity': 'Montréal', 'ShipAddress': '43 rue St. Laurent', 'ShipRegion': 'Québec', 'ShipPostalCode': 'H1J 1C3', 'ShipCountry': 'Canada', 'Freight': 370.6100, 'Verified': true }, { 'OrderID': 10425, 'CustomerID': 'LAMAI', 'OrderDate': new Date(854044200000), 'ShipName': 'La maison d\u0027Asie', 'ShipCity': 'Toulouse', 'ShipAddress': '1 rue Alsace-Lorraine', 'ShipRegion': null, 'ShipPostalCode': '31000', 'ShipCountry': 'France', 'Freight': 7.9300, 'Verified': false }, { 'OrderID': 10426, 'CustomerID': 'GALED', 'OrderDate': new Date(854303400000), 'ShipName': 'Galería del gastronómo', 'ShipCity': 'Barcelona', 'ShipAddress': 'Rambla de Cataluña, 23', 'ShipRegion': null, 'ShipPostalCode': '8022', 'ShipCountry': 'Spain', 'Freight': 18.6900, 'Verified': false }, { 'OrderID': 10427, 'CustomerID': 'PICCO', 'OrderDate': new Date(854303400000), 'ShipName': 'Piccolo und mehr', 'ShipCity': 'Salzburg', 'ShipAddress': 'Geislweg 14', 'ShipRegion': null, 'ShipPostalCode': '5020', 'ShipCountry': 'Austria', 'Freight': 31.2900, 'Verified': true }, { 'OrderID': 10428, 'CustomerID': 'REGGC', 'OrderDate': new Date(854389800000), 'ShipName': 'Reggiani Caseifici', 'ShipCity': 'Reggio Emilia', 'ShipAddress': 'Strada Provinciale 124', 'ShipRegion': null, 'ShipPostalCode': '42100', 'ShipCountry': 'Italy', 'Freight': 11.0900, 'Verified': false }, { 'OrderID': 10429, 'CustomerID': 'HUNGO', 'OrderDate': new Date(854476200000), 'ShipName': 'Hungry Owl All-Night Grocers', 'ShipCity': 'Cork', 'ShipAddress': '8 Johnstown Road', 'ShipRegion': 'Co. Cork', 'ShipPostalCode': null, 'ShipCountry': 'Ireland', 'Freight': 56.6300, 'Verified': true }, { 'OrderID': 10430, 'CustomerID': 'ERNSH', 'OrderDate': new Date(854562600000), 'ShipName': 'Ernst Handel', 'ShipCity': 'Graz', 'ShipAddress': 'Kirchgasse 6', 'ShipRegion': null, 'ShipPostalCode': '8010', 'ShipCountry': 'Austria', 'Freight': 458.7800, 'Verified': true }, { 'OrderID': 10431, 'CustomerID': 'BOTTM', 'OrderDate': new Date(854562600000), 'ShipName': 'Bottom-Dollar Markets', 'ShipCity': 'Tsawassen', 'ShipAddress': '23 Tsawassen Blvd.', 'ShipRegion': 'BC', 'ShipPostalCode': 'T2F 8M4', 'ShipCountry': 'Canada', 'Freight': 44.1700, 'Verified': true }, { 'OrderID': 10432, 'CustomerID': 'SPLIR', 'OrderDate': new Date(854649000000), 'ShipName': 'Split Rail Beer \u0026 Ale', 'ShipCity': 'Lander', 'ShipAddress': 'P.O. Box 555', 'ShipRegion': 'WY', 'ShipPostalCode': '82520', 'ShipCountry': 'USA', 'Freight': 4.3400, 'Verified': false }, { 'OrderID': 10433, 'CustomerID': 'PRINI', 'OrderDate': new Date(854908200000), 'ShipName': 'Princesa Isabel Vinhos', 'ShipCity': 'Lisboa', 'ShipAddress': 'Estrada da saúde n. 58', 'ShipRegion': null, 'ShipPostalCode': '1756', 'ShipCountry': 'Portugal', 'Freight': 73.8300, 'Verified': true }, { 'OrderID': 10434, 'CustomerID': 'FOLKO', 'OrderDate': new Date(854908200000), 'ShipName': 'Folk och fä HB', 'ShipCity': 'Bräcke', 'ShipAddress': 'Åkergatan 24', 'ShipRegion': null, 'ShipPostalCode': 'S-844 67', 'ShipCountry': 'Sweden', 'Freight': 17.9200, 'Verified': false }, { 'OrderID': 10435, 'CustomerID': 'CONSH', 'OrderDate': new Date(854994600000), 'ShipName': 'Consolidated Holdings', 'ShipCity': 'London', 'ShipAddress': 'Berkeley Gardens 12  Brewery', 'ShipRegion': null, 'ShipPostalCode': 'WX1 6LT', 'ShipCountry': 'UK', 'Freight': 9.2100, 'Verified': false }, { 'OrderID': 10436, 'CustomerID': 'BLONP', 'OrderDate': new Date(855081000000), 'ShipName': 'Blondel père et fils', 'ShipCity': 'Strasbourg', 'ShipAddress': '24, place Kléber', 'ShipRegion': null, 'ShipPostalCode': '67000', 'ShipCountry': 'France', 'Freight': 156.6600, 'Verified': true }, { 'OrderID': 10437, 'CustomerID': 'WARTH', 'OrderDate': new Date(855081000000), 'ShipName': 'Wartian Herkku', 'ShipCity': 'Oulu', 'ShipAddress': 'Torikatu 38', 'ShipRegion': null, 'ShipPostalCode': '90110', 'ShipCountry': 'Finland', 'Freight': 19.9700, 'Verified': false }, { 'OrderID': 10438, 'CustomerID': 'TOMSP', 'OrderDate': new Date(855167400000), 'ShipName': 'Toms Spezialitäten', 'ShipCity': 'Münster', 'ShipAddress': 'Luisenstr. 48', 'ShipRegion': null, 'ShipPostalCode': '44087', 'ShipCountry': 'Germany', 'Freight': 8.2400, 'Verified': false }, { 'OrderID': 10439, 'CustomerID': 'MEREP', 'OrderDate': new Date(855253800000), 'ShipName': 'Mère Paillarde', 'ShipCity': 'Montréal', 'ShipAddress': '43 rue St. Laurent', 'ShipRegion': 'Québec', 'ShipPostalCode': 'H1J 1C3', 'ShipCountry': 'Canada', 'Freight': 4.0700, 'Verified': false }, { 'OrderID': 10440, 'CustomerID': 'SAVEA', 'OrderDate': new Date(855513000000), 'ShipName': 'Save-a-lot Markets', 'ShipCity': 'Boise', 'ShipAddress': '187 Suffolk Ln.', 'ShipRegion': 'ID', 'ShipPostalCode': '83720', 'ShipCountry': 'USA', 'Freight': 86.5300, 'Verified': true }, { 'OrderID': 10441, 'CustomerID': 'OLDWO', 'OrderDate': new Date(855513000000), 'ShipName': 'Old World Delicatessen', 'ShipCity': 'Anchorage', 'ShipAddress': '2743 Bering St.', 'ShipRegion': 'AK', 'ShipPostalCode': '99508', 'ShipCountry': 'USA', 'Freight': 73.0200, 'Verified': true }, { 'OrderID': 10442, 'CustomerID': 'ERNSH', 'OrderDate': new Date(855599400000), 'ShipName': 'Ernst Handel', 'ShipCity': 'Graz', 'ShipAddress': 'Kirchgasse 6', 'ShipRegion': null, 'ShipPostalCode': '8010', 'ShipCountry': 'Austria', 'Freight': 47.9400, 'Verified': true }, { 'OrderID': 10443, 'CustomerID': 'REGGC', 'OrderDate': new Date(855685800000), 'ShipName': 'Reggiani Caseifici', 'ShipCity': 'Reggio Emilia', 'ShipAddress': 'Strada Provinciale 124', 'ShipRegion': null, 'ShipPostalCode': '42100', 'ShipCountry': 'Italy', 'Freight': 13.9500, 'Verified': false }, { 'OrderID': 10444, 'CustomerID': 'BERGS', 'OrderDate': new Date(855685800000), 'ShipName': 'Berglunds snabbköp', 'ShipCity': 'Luleå', 'ShipAddress': 'Berguvsvägen  8', 'ShipRegion': null, 'ShipPostalCode': 'S-958 22', 'ShipCountry': 'Sweden', 'Freight': 3.5000, 'Verified': false }, { 'OrderID': 10445, 'CustomerID': 'BERGS', 'OrderDate': new Date(855772200000), 'ShipName': 'Berglunds snabbköp', 'ShipCity': 'Luleå', 'ShipAddress': 'Berguvsvägen  8', 'ShipRegion': null, 'ShipPostalCode': 'S-958 22', 'ShipCountry': 'Sweden', 'Freight': 9.3000, 'Verified': false }, { 'OrderID': 10446, 'CustomerID': 'TOMSP', 'OrderDate': new Date(855858600000), 'ShipName': 'Toms Spezialitäten', 'ShipCity': 'Münster', 'ShipAddress': 'Luisenstr. 48', 'ShipRegion': null, 'ShipPostalCode': '44087', 'ShipCountry': 'Germany', 'Freight': 14.6800, 'Verified': false }, { 'OrderID': 10447, 'CustomerID': 'RICAR', 'OrderDate': new Date(855858600000), 'ShipName': 'Ricardo Adocicados', 'ShipCity': 'Rio de Janeiro', 'ShipAddress': 'Av. Copacabana, 267', 'ShipRegion': 'RJ', 'ShipPostalCode': '02389-890', 'ShipCountry': 'Brazil', 'Freight': 68.6600, 'Verified': true }]
 ...
 * Formula data source.
 */
export let formulaData: Object[] = [
    { 'Platform': 'JavaScript', val1: 10, val2: 100, 'Formula': 'SUM(B2,C2)', 'Result': { formula: '=SUM(B2,C2)' } },
    { 'Platform': 'Angular', val1: 20, val2: 200, 'Formula': 'PRODUCT(B3,C3)', 'Result': { formula: '=PRODUCT(B3,C3)' } },
    { 'Platform': 'React', val1: 30, val2: 300, 'Formula': 'COUNT(B1:B6)', 'Result': { formula: '=COUNT(B1:B6)' } },
 ...
 * Formula data source.
 */
export let formulaDataSource: Object[] = [
    {
...
/**
 * Movie list data source.
 */
export let movieListData: Object[] = [
    {
        'No': '1',
        'Released on': 1994,
        'Title': 'Forrest Gump',
