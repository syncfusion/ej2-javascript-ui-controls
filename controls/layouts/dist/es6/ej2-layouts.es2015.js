            ...
            for (let i = 0; i < paneCount; i++) {
                if (this.paneSettings[i].min !== null) {
                    ...
                    if (this.allPanes[i].offsetWidth < minValue) {
                        ...
                        let sizeDiff = minValue - this.allPanes[i].offsetWidth;
                        let isPercent = updatePane.style.flexBasis.indexOf('%') > -1;
...
let DashboardLayout = class DashboardLayout extends Component {
    ...
    downHandler(e) {
        ...
        let args = { event: e, element: el, isInteracted: true };
    ...
    removeAll() {
        ...
        this.oldRowCol = {};
        this.cloneObject = {};
        let clonedPanels = this.cloneModels(this.panels);
        this.setProperties({ panels: [] }, true);
        this.updatePanels();
        this.updateCloneArrayObject();
    ...
    resizePanel(id, sizeX, sizeY) {
        ...
        let ele = document.getElementById(id);
        let args = { event: null, element: ele, isInteracted: false };
        this.trigger('resizeStart', args);
