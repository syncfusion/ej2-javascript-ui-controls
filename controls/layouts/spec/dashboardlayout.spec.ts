...
describe('GridLayout', () => {
    ...
    describe('layout testing', () => {
        ...
        //     resizingElement.classList.add('e-item-hover');
        //     let movingElemnt: HTMLElement = resizingElement.querySelector('.e-south-west-expand');
        //     let targetElemnt: HTMLElement = document.getElementById('1');
        ...
        //     let resizingElement: HTMLElement = document.getElementById('1');
        //     resizingElement.classList.add('e-item-hover');
        //     let movingElemnt: HTMLElement = resizingElement.querySelector('.e-south-west-shrink');
        //     let targetElemnt: HTMLElement = document.getElementById('1');
        ...
        it('cellsize test case', () => {
            ...
            setCss(CellElements);
            expect(gridLayOut.element.classList.contains('e-dashboard-layout')).toBe(true);
            expect(gridLayOut.element.childElementCount == 6).toBe(true);
            expect((<HTMLElement>gridLayOut.element.querySelector('#one')).style.width).toBe('420px');
            expect((<HTMLElement>gridLayOut.element.querySelector('#one')).style.height).toBe('210px');
        });
        ...
        it('movepanel public method test case', () => {
            ...
            expect((<HTMLElement>gridLayOut.element.querySelector('#two')).getAttribute('data-col')).toBe('6');
    ...
    describe('layout testing', () => {
        ...
        it('layout pixel testing mediaQuery', function () {
            ...
            expect(gridLayOut.element.childElementCount == 6).toBe(true);
            expect((<HTMLElement>gridLayOut.element.querySelector('#one')).style.left == "0px").toBe(true);
            expect((<HTMLElement>gridLayOut.element.querySelector('#one')).style.top == "0px").toBe(true);
            expect((<HTMLElement>gridLayOut.element.querySelector('#two')).style.left == "0px").toBe(true);
            var height = ((<HTMLElement>gridLayOut.element.querySelector('#two')).offsetWidth / 1);
            expect((<HTMLElement>gridLayOut.element.querySelector('#two')).style.top == "" + (height + 5) + 'px').toBe(true);
            expect((<HTMLElement>gridLayOut.element.querySelector('#three')).style.left == "0px").toBe(true);
            expect((<HTMLElement>gridLayOut.element.querySelector('#three')).style.top == "" + (((height * 2) + 10)) + 'px').toBe(true);
            expect((<HTMLElement>gridLayOut.element.querySelector('#four')).style.left == "0px").toBe(true);
            expect((<HTMLElement>gridLayOut.element.querySelector('#four')).style.top == "" + (((height * 3) + 15)) + 'px').toBe(true);
            expect((<HTMLElement>gridLayOut.element.querySelector('#five')).style.left == "0px").toBe(true);
            expect((<HTMLElement>gridLayOut.element.querySelector('#five')).style.top == "" + (((height * 4) + 20)) + 'px').toBe(true);
            expect((<HTMLElement>gridLayOut.element.querySelector('#six')).style.left == "0px").toBe(true);
            expect((<HTMLElement>gridLayOut.element.querySelector('#six')).style.top == "" + (((height * 5) + 25)) + 'px').toBe(true);
        });
