...
var MultiLevelLabels = /** @class */ (function (_super) {
    ...
    __decorate$2([
        sf.base.Complex({ color: '#b5b5b5', width: 1, type: 'Rectangle' }, AxisLabelBorder)
...
var Axis = /** @class */ (function (_super) {
    ...
    Axis.prototype.calculateNumericAxisLabels = function (heatmap) {
        ...
        max = !sf.base.isNullOrUndefined(this.maximum) ? this.maximum :
    ...
    Axis.prototype.calculateDateTimeAxisLabel = function (heatmap) {
        ...
        if (minimum === null && maximum === null) {
            ...
            if (minimum !== null && maximum === null) {
                min = Date.parse(dateParser(dateFormatter(new Date(sf.data.DataUtil.parse.parseJson({ val: minimum }).val))));
                max = increaseDateTimeInterval(min, this.maxLength, this.intervalType, this.increment).getTime();
            }
            else if (minimum === null && maximum !== null) {
                max = Date.parse(dateParser(dateFormatter(new Date(sf.data.DataUtil.parse.parseJson({ val: maximum }).val))));
    ...
    __decorate$3([
        sf.base.Complex({ text: '', textStyle: Theme.axisTitleFont }, Title)
    ...
    __decorate$3([
        sf.base.Complex({ color: '#b5b5b5', width: 0, type: 'Rectangle' }, AxisLabelBorder)
...
var Series = /** @class */ (function () {
    ...
    Series.prototype.renderRectSeries = function () {
        ...
        for (var x = 0; x < (heatMap.xLength * heatMap.yLength); x++) {
            ...
            if (cellSetting.tileType === 'Rect') { // Rectangle/Tile Series
                ...
                else if (!sf.base.isNullOrUndefined(this.text) && (cellSetting.bubbleType === 'Size' || cellSetting.bubbleType === 'SizeAndColor')
    ...
    Series.prototype.isCellValueInRange = function (dataXIndex, dataYIndex) {
        ...
        for (var i = 0; i < this.heatMap.toggleValue.length; i++) {
            ...
            var bubbleText = !sf.base.isNullOrUndefined(clonedDataSource[dataXIndex][dataYIndex][1]) &&
    ...
    Series.prototype.setTextAndColor = function (dataXIndex, dataYIndex) {
        ...
        var clonedDataSource = this.heatMap.clonedDataSource;
        if (this.heatMap.bubbleSizeWithColor) {
            this.text = !sf.base.isNullOrUndefined(clonedDataSource[dataXIndex][dataYIndex][0]) &&
                clonedDataSource[dataXIndex][dataYIndex][0].toString() !== '' ? clonedDataSource[dataXIndex][dataYIndex][0] : '';
            this.color = !sf.base.isNullOrUndefined(clonedDataSource[dataXIndex][dataYIndex][1]) &&
            ...
            this.bubbleColorValue.push({
                ...
                bubbleData: !sf.base.isNullOrUndefined(clonedDataSource[dataXIndex][dataYIndex][1]) &&
                    clonedDataSource[dataXIndex][dataYIndex][1].toString() !== '' ? clonedDataSource[dataXIndex][dataYIndex][1] : '',
                valueType: 'Color'
            });
        }
    ...
    Series.prototype.calculateShapes = function (options, path, sectorContibution, curve) {
        ...
        switch (sectorContibution) {
            ...
            case 0:
                ...
                sf.base.merge(options, { 'd': pathString });
                break;
            default:
...
var TooltipSettings = /** @class */ (function (_super) {
    ...
    __decorate$5([
        sf.base.Complex({}, TooltipBorder)
    ], TooltipSettings.prototype, "border", void 0);
    __decorate$5([
        sf.base.Complex(Theme.tooltipFont, Font)
...
var Tooltip$1 = /** @class */ (function () {
    ...
    Tooltip$$1.prototype.renderTooltip = function (currentRect) {
        ...
        var showTooltip = this.heatMap.bubbleSizeWithColor ?
            !sf.base.isNullOrUndefined(currentRect.value) && !sf.base.isNullOrUndefined(currentRect.value[0].bubbleData)
                && currentRect.value[0].bubbleData.toString() !== '' ? true : false
            : sf.base.isNullOrUndefined(currentRect.value) || (!sf.base.isNullOrUndefined(currentRect.value) &&
...
var TwoDimensional = /** @class */ (function () {
    ...
    TwoDimensional.prototype.processDataSource = function (dataSource) {
        ...
        this.heatMap.minColorValue = sf.base.isNullOrUndefined(this.heatMap.minColorValue) ?
            this.heatMap.dataSourceMinValue : parseFloat(this.heatMap.minColorValue.toString());
        this.heatMap.maxColorValue = sf.base.isNullOrUndefined(this.heatMap.maxColorValue) ?
    ...
    TwoDimensional.prototype.processDataArray = function (tempCloneData, tempIndex, z, cloneDataIndex) {
        if (this.heatMap.bubbleSizeWithColor) {
            if (tempCloneData[tempIndex] && !sf.base.isNullOrUndefined(tempCloneData[tempIndex][z])
                ...
                if (!sf.base.isNullOrUndefined(tempCloneData[tempIndex]) && (tempCloneData[tempIndex][z] ||
...
var LegendSettings = /** @class */ (function (_super) {
    ...
    __decorate$6([
        sf.base.Complex({ text: '', textStyle: Theme.titleFont }, Title)
...
var Adaptor = /** @class */ (function () {
    ...
    Adaptor.prototype.constructDatasource = function (dataSource, dataSourceSettings) {
        if (dataSourceSettings.adaptorType === 'Cell') {
            ...
            if (((xAxis.valueType === 'Numeric' || xAxis.valueType === 'DateTime') &&
                (sf.base.isNullOrUndefined(xAxis.minimum) || sf.base.isNullOrUndefined(xAxis.maximum))) ||
                ((yAxis.valueType === 'Numeric' || yAxis.valueType === 'DateTime') &&
                    (sf.base.isNullOrUndefined(yAxis.minimum) || sf.base.isNullOrUndefined(yAxis.maximum)))) {
    ...
    Adaptor.prototype.getDateAxisCollection = function (min, max, intervalType, increment) {
        ...
        min = Date.parse(dateParser(dateFormatter(new Date(sf.data.DataUtil.parse.parseJson({ val: min }).val))));
        var tempInterval = min;
        var tempAxisColl = [];
        while (tempInterval <= max) {
    ...
    Adaptor.prototype.getMinMaxValue = function (dataSource, adapData, xAxis, yAxis) {
        ...
        if (data.length > 0) {
            this.adaptiveXMinMax.min = !sf.base.isNullOrUndefined(xAxis.minimum) ? xAxis.minimum : adapData.isJsonData ?
                // tslint:disable-next-line:no-any
                data[0][label[0]] : data[0][0];
            this.adaptiveYMinMax.min = !sf.base.isNullOrUndefined(yAxis.minimum) ? yAxis.minimum : adapData.isJsonData ?
                // tslint:disable-next-line:no-any
                data[0][label[1]] : data[0][1];
            this.adaptiveXMinMax.max = !sf.base.isNullOrUndefined(xAxis.maximum) ? xAxis.maximum : adapData.isJsonData ?
                // tslint:disable-next-line:no-any
                data[0][label[0]] : data[0][0];
            this.adaptiveYMinMax.max = !sf.base.isNullOrUndefined(yAxis.maximum) ? yAxis.maximum : adapData.isJsonData ?
                // tslint:disable-next-line:no-any
                data[0][label[1]] : data[0][1];
        }
            ...
            for (var xindex = 0; xindex < tempDataCollection.length; xindex++) {
                ...
                if (currentDataXIndex > -1) {
                    ...
                    if (currentDataYIndex !== -1) {
                        ...
                        this.reconstructData[currentDataXIndex][currentDataYIndex] = sf.base.isNullOrUndefined(tempDataCollection[xindex][2]) ?
    ...
    tempSplitDataCollection, adaptordata, labels, tempSplitData, valueType) {
        ...
        for (var splitIndex = 0; splitIndex < tempSplitData.length; splitIndex++) {
            value = !sf.base.isNullOrUndefined(labels) ? (!(valueType === 'DateTime') ?
            ...
            if (!sf.base.isNullOrUndefined(this.tempSplitDataCollection)) {
                this.tempSplitDataCollection = value !== -1 && !sf.base.isNullOrUndefined(labels) ?
        ...
        value = !sf.base.isNullOrUndefined(labels) ? value : sf.base.isNullOrUndefined(this.tempSplitDataCollection) ||
                ...
                if (currentDataXIndex !== -1) {
                    ...
                    for (var index = 0; index < Object.keys(this.tempSplitDataCollection).length; index++) {
                        ...
                        if (currentDataYIndex !== -1) {
                            ...
                            this.reconstructData[currentDataXIndex][currentDataYIndex] =
                                sf.base.isNullOrUndefined(this.tempSplitDataCollection[key]) ?
