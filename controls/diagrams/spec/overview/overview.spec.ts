...
describe('Overview', () => {
    ...
    describe('Overview Tests', () => {
        ...
        it('Click on the overview rect - Scale with resizer bottom right', (done: Function) => {
            let overviewelement: HTMLElement = document.getElementById(overview.element.id);
            let target: HTMLElement = document.getElementById('overview1_canvasbottomright');
            let mouseDown: string = 'mouseDown';
            let mouseup: string = 'mouseUp';
            let mouseMove: string = 'mouseMove';
            overview[mouseDown]({ target: target, type: mouseDown });
            ...
            expect(Number(diagram.scroller.currentZoom.toFixed(4)) >= 1.4 && Number(diagram.scroller.currentZoom.toFixed(4)) <= 1.6 ).toBe(true);
            done();
        });
    ...
    describe('HTML node get disappered after save and load the diagram', () => {
        ...
        it('Zoom-out diagram and doing interactions in diagram', (done: Function) => {
            ...
            let element = document.getElementById("overview10_htmlLayer");
    ...
    describe('863516-Overview is not synced with diagram content while zoom-out the diagram.', () => {
        ...
        it('Zoom-out diagram and checking the overview rect size', (done: Function) => {
            ...
            diagram.zoomTo(zoomOptions);
            let overviewRect = document.getElementById('overview13_canvasoverviewrect');
    ...
    describe('872140-Dragging HTML nodes in a diagram leaves shadows on the overview', () => {
        ...
        it('Drag the html node in diagram', (done: Function) => {
            ...
            let overview = (document.getElementById('overview14') as any).ej2_instances[0];
