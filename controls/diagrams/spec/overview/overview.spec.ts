...
// Safe DOM getter that supports both HTML and SVG elements
function getEl<T extends Element = HTMLElement>(id: string): T {
  const el = document.getElementById(id) as unknown as T | null;
  expect(el).toBeTruthy(); // avoid null deref later
  return el!;
}

// Tolerant numeric equals
function closeTo(actual: number, expected: number, tolerance: number = 2): void {
  expect(Math.abs(actual - expected)).toBeLessThanOrEqual(tolerance);
}

// Minimal event stubs
function asPointerEvent(obj: any): PointerEvent {
  return obj as unknown as PointerEvent;
}
function asTouchEvent(obj: any): TouchEvent {
  return obj as unknown as TouchEvent;
}
...
describe('Overview', () => {
    ...
    describe('Overview Tests1', () => {
        ...
        beforeAll((): void => {
            ...
            ove = createElement('div', { id: 'overview1' });
            ...
            options.width = '250px';
            options.sourceID = 'diagram1';
            overview = new Overview(options);
            overview.appendTo('#overview1');
        ...
        it('Click on the overview rect', (done: Function) => {
            ...
            let target: HTMLElement = document.getElementById('overview1_canvas_overviewsvg');
        ...
        it('Click on the overview rect - Pan with focused area', (done: Function) => {
            let overviewelement: HTMLElement = document.getElementById(overview.element.id);
            let target: HTMLElement = document.getElementById('overview1_canvasoverviewrect');
            let mouseDown: string = 'mouseDown';
            let mouseup: string = 'mouseUp';
            overview[mouseDown]({ target: target, type: mouseDown });
            ...
            expect(diagram.scroller.currentZoom).toBeCloseTo(1, 3);
            closeTo(diagram.scroller.horizontalOffset, -168, 3); // ±3 tolerance
            closeTo(diagram.scroller.verticalOffset, -33.6, 3);
            done();
        });
        it('Click on the overview rect - Scale with resizer bottom right', (done: Function) => {
            const overviewelement = getEl(overview.element.id);
            const target = getEl<HTMLElement>('overview1_canvasbottomright');
             let mouseDown: string = 'mouseDown';
             overview['mouseDown'](asPointerEvent({ target, type: mouseDown }));
            mouseEvents.mouseDownEvent(overviewelement, 1236, 170);
            mouseEvents.mouseMoveEvent(overviewelement, 1186, 160);
            overview['mouseUp'](asPointerEvent({ target, type: mouseDown }));
            const z = diagram.scroller.currentZoom;
        ...
        it('Click on the overview rect - Scale with resizer bottom right with y greater than X', (done: Function) => {
            ...
            expect(Number(diagram.scroller.currentZoom.toFixed(4)) >= 1.8 && Number(diagram.scroller.currentZoom.toFixed(4)) <= 2).toBe(true)
            done();
        });
        it('Click on the overview rect - Scale with resizer bottom', (done: Function) => {
            let overviewelement: HTMLElement = document.getElementById(overview.element.id);
            let target: HTMLElement = document.getElementById('overview1_canvasbottom');
            let mouseDown: string = 'mouseDown';
            let mouseup: string = 'mouseUp';
            overview[mouseDown]({ target: target, type: mouseDown });
            ...
            overview[mouseup]({ target: target, type: mouseDown });
            console.log('zoom '+ diagram.scroller.currentZoom.toFixed(4) + ' hOffset ' + Math.round(diagram.scroller.horizontalOffset) + ' vOffset ' + Math.round(diagram.scroller.verticalOffset) )
            expect(Number(diagram.scroller.currentZoom.toFixed(4)) >= 1.6 && Number(diagram.scroller.currentZoom.toFixed(4)) <= 1.8).toBe(true);
            done();
        });
        it('Click on the overview rect - Scale with resizer bottom Left', (done: Function) => {
            let overviewelement: HTMLElement = document.getElementById(overview.element.id);
            let target: HTMLElement = document.getElementById('overview1_canvasbottomleft');
            let mouseDown: string = 'mouseDown';
            let mouseup: string = 'mouseUp';
            overview[mouseDown]({ target: target, type: mouseDown });
            ...
            console.log('zoom '+ diagram.scroller.currentZoom.toFixed(4) + ' hOffset ' + Math.round(diagram.scroller.horizontalOffset) + ' vOffset ' + Math.round(diagram.scroller.verticalOffset) )
            expect(Number(diagram.scroller.currentZoom.toFixed(4)) >= 3.4 && Number(diagram.scroller.currentZoom.toFixed(4)) <= 3.6 ).toBe(true);
            done();
        });
        it('Click on the overview rect - Scale with resizer bottom Left with y greater than X', (done: Function) => {
            ...
            overview[mouseup]({ target: target, type: mouseDown });
            console.log('zoom '+ diagram.scroller.currentZoom.toFixed(4) + ' hOffset ' + Math.round(diagram.scroller.horizontalOffset) + ' vOffset ' + Math.round(diagram.scroller.verticalOffset) )
            expect(Number(diagram.scroller.currentZoom.toFixed(4)) >= 6.8 && Number(diagram.scroller.currentZoom.toFixed(4)) <= 8 ).toBe(true);
            done();
        });
        it('Click on the overview rect - Scale with resizer Left', (done: Function) => {
            let overviewelement: HTMLElement = document.getElementById(overview.element.id);
            let target: HTMLElement = document.getElementById('overview1_canvasleft');
            let mouseDown: string = 'mouseDown';
            let mouseup: string = 'mouseUp';
            overview[mouseDown]({ target: target, type: mouseDown });
            mouseEvents.mouseDownEvent(overviewelement, 1056, 160);
            mouseEvents.mouseMoveEvent(overviewelement, 1106, 170);
            overview[mouseup]({ target: target, type: mouseDown });   console.log('zoom '+ diagram.scroller.currentZoom.toFixed(4) + ' hOffset ' + Math.round(diagram.scroller.horizontalOffset) + ' vOffset ' + Math.round(diagram.scroller.verticalOffset) ); expect(Number(diagram.scroller.currentZoom.toFixed(4)) >= 6.8 && Number(diagram.scroller.currentZoom.toFixed(4)) <= 8 ).toBe(true);
            done();
        });
        it('Click on the overview rect - Scale with resizer Top left', (done: Function) => {
            let overviewelement: HTMLElement = document.getElementById(overview.element.id);
            let target: HTMLElement = document.getElementById('overview1_canvastopleft');
            let mouseDown: string = 'mouseDown';
            let mouseup: string = 'mouseUp';
            overview[mouseDown]({ target: target, type: mouseDown });
            mouseEvents.mouseDownEvent(overviewelement, 1106, 170);
            mouseEvents.mouseMoveEvent(overviewelement, 1056, 160);
            overview[mouseup]({ target: target, type: mouseDown });   console.log('zoom '+ diagram.scroller.currentZoom.toFixed(4) + ' hOffset ' + Math.round(diagram.scroller.horizontalOffset) + ' vOffset ' + Math.round(diagram.scroller.verticalOffset) ); expect(Number(diagram.scroller.currentZoom.toFixed(4)) >= 2.3 && Number(diagram.scroller.currentZoom.toFixed(4)) <= 2.5 ).toBe(true);
            done();
        });
        it('Click on the overview rect - Scale with resizer Top left Y greater than x', (done: Function) => {
            ...
            overview[mouseup]({ target: target, type: mouseDown });   console.log('zoom '+ diagram.scroller.currentZoom.toFixed(4) + ' hOffset ' + Math.round(diagram.scroller.horizontalOffset) + ' vOffset ' + Math.round(diagram.scroller.verticalOffset) ); expect(Number(diagram.scroller.currentZoom.toFixed(4)) >= 1.6 && Number(diagram.scroller.currentZoom.toFixed(4)) <= 1.8 ).toBe(true);
            done();
        });
        it('Click on the overview rect - Scale with resizer Top', (done: Function) => {
            let overviewelement: HTMLElement = document.getElementById(overview.element.id);
            let target: HTMLElement = document.getElementById('overview1_canvastop');
            let mouseDown: string = 'mouseDown';
            let mouseup: string = 'mouseUp';
            overview[mouseDown]({ target: target, type: mouseDown });
            mouseEvents.mouseDownEvent(overviewelement, 1056, 170);
            mouseEvents.mouseMoveEvent(overviewelement, 1156, 190);
            overview[mouseup]({ target: target, type: mouseDown });   console.log('zoom '+ diagram.scroller.currentZoom.toFixed(4) + ' hOffset ' + Math.round(diagram.scroller.horizontalOffset) + ' vOffset ' + Math.round(diagram.scroller.verticalOffset) ); 
            expect(Number(diagram.scroller.currentZoom.toFixed(4)) >= 2.1 && Number(diagram.scroller.currentZoom.toFixed(4)) <= 2.3).toBe(true);
            done();
        });
        it('Click on the overview rect - Scale with resizer Top right', (done: Function) => {
            let overviewelement: HTMLElement = document.getElementById(overview.element.id);
            let target: HTMLElement = document.getElementById('overview1_canvastopright');
            let mouseDown: string = 'mouseDown';
            let mouseup: string = 'mouseUp';
            overview[mouseDown]({ target: target, type: mouseDown });
            ...
            overview[mouseup]({ target: target, type: mouseDown });   console.log('zoom '+ diagram.scroller.currentZoom.toFixed(4) + ' hOffset ' + Math.round(diagram.scroller.horizontalOffset) + ' vOffset ' + Math.round(diagram.scroller.verticalOffset) ); 
            expect(Number(diagram.scroller.currentZoom.toFixed(4)) >= 1.7 && Number(diagram.scroller.currentZoom.toFixed(4)) <= 1.9 ).toBe(true);
            done();
        });
        it('Click on the overview rect - Scale with resizer Top right with Y greater than X', (done: Function) => {
            ...
            overview[mouseup]({ target: target, type: mouseDown });   console.log('zoom '+ diagram.scroller.currentZoom.toFixed(4) + ' hOffset ' + Math.round(diagram.scroller.horizontalOffset) + ' vOffset ' + Math.round(diagram.scroller.verticalOffset) ); expect(Number(diagram.scroller.currentZoom.toFixed(4)) >= 1.4 && Number(diagram.scroller.currentZoom.toFixed(4)) <= 1.6 ).toBe(true);
            done();
        });
        it('Click on the overview rect - Scale with resizer  Right', (done: Function) => {
            let overviewelement: HTMLElement = document.getElementById(overview.element.id);
            let target: HTMLElement = document.getElementById('overview1_canvasright');
            let mouseDown: string = 'mouseDown';
            let mouseup: string = 'mouseUp';
            overview[mouseDown]({ target: target, type: mouseDown });
            ...
            overview[mouseup]({ target: target, type: mouseDown });   console.log('zoom '+ diagram.scroller.currentZoom.toFixed(4) + ' hOffset ' + Math.round(diagram.scroller.horizontalOffset) + ' vOffset ' + Math.round(diagram.scroller.verticalOffset) ); expect(Number(diagram.scroller.currentZoom.toFixed(4)) >= 1 && Number(diagram.scroller.currentZoom.toFixed(4)) <= 1.2 ).toBe(true);
            done();
        });
        it('Click on the overview rect - Pan', (done: Function) => {
            ...
            overview[mouseDown]({ target: target, type: mouseDown });
            mouseEvents.mouseDownEvent(overviewelement, 100, 650);
            mouseEvents.mouseUpEvent(target, 100, 650);   console.log('zoom '+ diagram.scroller.currentZoom.toFixed(4) + ' hOffset ' + Math.round(diagram.scroller.horizontalOffset) + ' vOffset ' + Math.round(diagram.scroller.verticalOffset) ); expect(Number(diagram.scroller.currentZoom.toFixed(4)) >= 1 && Number(diagram.scroller.currentZoom.toFixed(4)) <= 1.2 ).toBe(true);
            done();
        });
        it('Click on the overview rect - Draw', (done: Function) => { 
            ...
            overview[mouseup]({ target: target, type: mouseDown });
            expect(diagram.scroller.currentZoom).toBeCloseTo(2.927, 2);
            done();
        });
        it('Click on the overview rect - Draw with current point lesser than start point', (done: Function) => { 
            ...
            mouseEvents.mouseUpEvent(target, 100, 550);
            overview[mouseup]({ target: target, type: mouseDown }); 
            expect(diagram.scroller.currentZoom).toBeCloseTo(3.501, 2);
            done();
        });
        it('Overview - Scrolled Event', (done: Function) => {
            ...
            overview['scrolled']({} as PointerEvent);
            expect(diagram.scroller.currentZoom).toBeCloseTo(3.501, 2);
            closeTo(Math.round(diagram.scroller.horizontalOffset), -20, 1);
            closeTo(Math.round(diagram.scroller.verticalOffset), -10, 1);
            done();
        });
        it('Click on the Resizer bottom right', (done: Function) => {
            let diagramCanvas: HTMLElement = document.getElementById('overview1_canvasbottomright');
            ...
            mouseEvents.mouseUpEvent(diagramCanvas, 178.57142857142858 + 10, 148.80952380952382 + 10);
            expect(diagram.scroller.currentZoom).toBeCloseTo(3.501, 2);
            closeTo(Math.round(diagram.scroller.horizontalOffset), -20, 1);
            closeTo(Math.round(diagram.scroller.verticalOffset), -10, 1);
            done();
        ...
        it('Click on the Resizer bottom left', (done: Function) => {
            let diagramCanvas: HTMLElement = document.getElementById('overview1_canvasbottomleft');
            mouseEvents.mouseDownEvent(diagramCanvas, 178.57142857142858, 148.80952380952382);
            mouseEvents.mouseMoveEvent(diagramCanvas, 178.57142857142858 + 10, 148.80952380952382 + 10);
            mouseEvents.mouseUpEvent(diagramCanvas, 178.57142857142858 + 10, 148.80952380952382 + 10);
            expect(diagram.scroller.currentZoom).toBeCloseTo(3.501, 2);
        ...
        it('Click on the Resizer top left', (done: Function) => {
            let diagramCanvas: HTMLElement = document.getElementById('overview1_canvastopleft');
            mouseEvents.mouseDownEvent(diagramCanvas, 178.57142857142858, 148.80952380952382);
            mouseEvents.mouseMoveEvent(diagramCanvas, 178.57142857142858 + 10, 148.80952380952382 + 10);
            mouseEvents.mouseUpEvent(diagramCanvas, 178.57142857142858 + 10, 148.80952380952382 + 10);
            expect(diagram.scroller.currentZoom).toBeCloseTo(3.501, 2);
        ...
        it('Click on the Resizer top right', (done: Function) => {
            let diagramCanvas: HTMLElement = document.getElementById('overview1_canvastopright');
            mouseEvents.mouseDownEvent(diagramCanvas, 178.57142857142858, 148.80952380952382);
            mouseEvents.mouseMoveEvent(diagramCanvas, 178.57142857142858 + 10, 148.80952380952382 + 10);
            mouseEvents.mouseUpEvent(diagramCanvas, 178.57142857142858 + 10, 148.80952380952382 + 10);
            expect(diagram.scroller.currentZoom).toBeCloseTo(3.501, 2);
        ...
        it('Click on the Resizer bottom', (done: Function) => {
            let diagramCanvas: HTMLElement = document.getElementById('overview1_canvasbottom');
            mouseEvents.mouseDownEvent(diagramCanvas, 178.57142857142858, 148.80952380952382);
            mouseEvents.mouseMoveEvent(diagramCanvas, 178.57142857142858 + 10, 148.80952380952382 + 10);
            mouseEvents.mouseUpEvent(diagramCanvas, 178.57142857142858 + 10, 148.80952380952382 + 10);
            expect(diagram.scroller.currentZoom).toBeCloseTo(3.501, 2);
        ...
        it('Click on the Resizer left', (done: Function) => {
            let diagramCanvas: HTMLElement = document.getElementById('overview1_canvasleft');
            mouseEvents.mouseDownEvent(diagramCanvas, 178.57142857142858, 148.80952380952382);
            mouseEvents.mouseMoveEvent(diagramCanvas, 178.57142857142858 + 10, 148.80952380952382 + 10);
            mouseEvents.mouseUpEvent(diagramCanvas, 178.57142857142858 + 10, 148.80952380952382 + 10);
            expect(diagram.scroller.currentZoom).toBeCloseTo(3.501, 2);
        ...
        it('Click on the Resizer top', (done: Function) => {
            let diagramCanvas: HTMLElement = document.getElementById('overview1_canvastop');
            mouseEvents.mouseDownEvent(diagramCanvas, 178.57142857142858, 148.80952380952382);
            mouseEvents.mouseMoveEvent(diagramCanvas, 178.57142857142858 + 10, 148.80952380952382 + 10);
            mouseEvents.mouseUpEvent(diagramCanvas, 178.57142857142858 + 10, 148.80952380952382 + 10);
            expect(diagram.scroller.currentZoom).toBeCloseTo(3.501, 2);
        ...
        it('Click on the Resizer right', (done: Function) => {
            let diagramCanvas: HTMLElement = document.getElementById('overview1_canvasright');
            mouseEvents.mouseDownEvent(diagramCanvas, 178.57142857142858, 148.80952380952382);
            mouseEvents.mouseMoveEvent(diagramCanvas, 178.57142857142858 + 10, 148.80952380952382 + 10);
            mouseEvents.mouseUpEvent(diagramCanvas, 178.57142857142858 + 10, 148.80952380952382 + 10);
            expect(diagram.scroller.currentZoom).toBeCloseTo(3.501, 2);
        ...
        it('Overview - Mouse wheel event', (done: Function) => {
            let scroller: HTMLElement = document.getElementById(diagram.element.id + 'content');
            mouseEvents.mouseWheelEvent(scroller, 250, 500, true); 
            console.log(diagram.scroller.horizontalOffset);
            console.log(diagram.scroller.verticalOffset);
            // expect((Math.round(diagram.scroller.horizontalOffset) == -15 || Math.floor(diagram.scroller.horizontalOffset) === 23) && (
            //     Math.round(diagram.scroller.verticalOffset) == -0 || (Math.floor(diagram.scroller.verticalOffset) >=73 && Math.floor(diagram.scroller.verticalOffset) <= 86))).toBe(true);
            done();
        });
        it('Overview - Document mouseup', (done: Function) => {
            ...
            // && ((Math.round(diagram.scroller.verticalOffset) === -0.16 || Math.round(diagram.scroller.verticalOffset) === 0 || (Math.floor(diagram.scroller.verticalOffset) >=73 && Math.floor(diagram.scroller.verticalOffset) <= 86)))).toBe(true);
            done();
        });
        ...
        it('Overview - Document mouseup with helper', (done: Function) => {
            ...
            console.log('diagram.scroller.verticalOffset ='+diagram.scroller.verticalOffset);
            // expect((diagram.scroller.currentZoom.toFixed(4) === '2.9178')).toBe(true);
            // expect((Math.round(diagram.scroller.horizontalOffset) === -14 || Math.floor(diagram.scroller.horizontalOffset) === 23) && (Math.round(diagram.scroller.verticalOffset) === 0 || (Math.floor(diagram.scroller.verticalOffset) >=73 && Math.floor(diagram.scroller.verticalOffset) <= 86))).toBe(true);
            done();
        });
        ...
        it('Overview - Mouse wheel event', (done: Function) => {
            ...
            console.log('diagram.scroller.verticalOffset ='+diagram.scroller.verticalOffset);
            // expect((diagram.scroller.currentZoom.toFixed(4) === '2.9178')).toBe(true);
            // expect((Math.round(diagram.scroller.horizontalOffset) === -14 || Math.floor(diagram.scroller.horizontalOffset) === 23) && (Math.round(diagram.scroller.verticalOffset) === 0 || (Math.floor(diagram.scroller.verticalOffset) >=63 && Math.floor(diagram.scroller.verticalOffset) <= 76))).toBe(true);
            done();
        });
    ...
    xdescribe('Overview Tests with multiple overview1', () => {
        let diagram: Diagram;
        ...
        beforeAll((): void => {
            ...
            document.body.appendChild(ele);
            diagramElement = createElement('div', { id: 'diagramNew' });
            document.body.appendChild(diagramElement);
            ove = createElement('div', { id: 'overview2', styles: 'display:none' });
            document.body.appendChild(ove);
            let connector: ConnectorModel = {
                id: 'connector1', sourcePoint: { x: 200, y: 100 }, targetPoint: { x: 400, y: 100 }
            };
            ...
            diagram2.appendTo('#diagramNew');
            let options: OverviewModel = {};
            options.height = '500';
            options.width = '250';
            options.sourceID = 'diagram2';
            overview = new Overview(options);
            overview.appendTo('#overview2');
        ...
        it('Multiple overview rect - Pan with focused area', (done: Function) => {
            ...
            let overviewelement: HTMLElement = document.getElementById(overview.element.id);
            let target: HTMLElement = document.getElementById('overview2_canvasoverviewrect');
            let mouseDown: string = 'mouseDown';
            let mouseup: string = 'mouseUp';
            overview[mouseDown]({ target: target, type: mouseDown });
            mouseEvents.mouseDownEvent(overviewelement, 1094, 82);
        ...
        it('Overview - Scale with in action as true', (done: Function) => {
            let overviewelement: HTMLElement = document.getElementById(overview.element.id);
            let target: HTMLElement = document.getElementById('overview2_canvasbottomright');
            let mouseDown: string = 'mouseDown';
            let mouseup: string = 'mouseUp';
            overview[mouseDown]({ target: target, type: mouseDown });
            mouseEvents.mouseDownEvent(overviewelement, 1236, 170);
    ...
    xdescribe('Overview Tests with multiple overview2', () => {
        let diagram: Diagram;
        let overview: Overview;
        let ele: HTMLElement;
        let ove: HTMLElement;
        ...
        beforeAll((): void => {
            ...
            document.body.appendChild(ele);
            ove = createElement('div', { id: 'overview3' });
            document.body.appendChild(ove);
            let connector: ConnectorModel = {
                id: 'connector1', sourcePoint: { x: 200, y: 100 }, targetPoint: { x: 400, y: 100 }
            };
            ...
            options.height = '500';
            options.width = '250';
            options.sourceID = 'diagram3';
            overview = new Overview(options);
            overview.appendTo('#overview3');
        ...
        it('Overview - For window resize', (done: Function) => {
            ...
            console.log('Before setTimeOut1 and window resize');
            overview[resize](<Event>{});
            console.log('Before setTimeOut1 after window resize');
            setTimeout(() => {
        ...
        it('Overview Visibility as Hidden- For window resize', (done: Function) => {
            ...
            let resize = 'windowResize';
            console.log('Before setTimeOut2 and window resize');
            overview[resize](<Event>{});
            console.log('Before setTimeOut2 after window resize');
            setTimeout(() => {
    ...
    describe('Overview Tests2', () => {
        ...
        beforeAll((): void => {
            parentelement = createElement('div', { id: 'overviewdiagram1', styles: "width: 100%;height: 500px;" });
            ...
            Diagramelement = createElement('div', { id: 'diagram4' });
            parentelement1.appendChild(Diagramelement);
            overViewElement = createElement('div', { id: 'overview4', styles: "width:25%;height:200px;float:left; border-color:lightgray;border-style:solid;" });
            ...
            newdiagram.appendTo('#diagram4');
            newdiagram.fitToPage()
            let options: OverviewModel = {};
            options.height = '150px';
            options.width = '100%';
            options.sourceID = 'diagram4';
            overview = new Overview(options);
            overview.appendTo('#overview4');
        ...
        it('Overview - For window resize', (done: Function) => {
            let htmlOverView = document.getElementById('overview4_htmlLayer');
    ...
    describe('Overview Not updated during zoom ', () => {
        ...
        beforeAll((): void => {
            ...
            parentelement = createElement('div', { id: 'overviewdiagram2', styles: "width: 100%;height: 500px;" });
            document.body.appendChild(parentelement)
            parentelement1 = createElement('div', { id: 'parentelement2', styles: "width:74%;height: 500px; float:left;" });
            parentelement.appendChild(parentelement1);
            Diagramelement = createElement('div', { id: 'diagram5' });
            parentelement1.appendChild(Diagramelement);
            overViewElement = createElement('div', { id: 'overview5', styles: "width:25%;height:200px;float:left; border-color:lightgray;border-style:solid;" });
            parentelement.appendChild(overViewElement);
            newdiagram = new Diagram({
                width: "100%",
                height: "500px",
            ...
            newdiagram.appendTo('#diagram5');
            newdiagram.fitToPage()
            let options: OverviewModel = {};
            options.height = '150px';
            options.width = '100%';
            options.sourceID = 'diagram5';
            overview = new Overview(options);
            overview.appendTo('#overview5');
        ...
        it('Overview Not updated during zoom check', (done: Function) => {
    ...
    describe('Overview Tests with Native node', () => {
        ...
        beforeAll((): void => {
            ...
            document.body.appendChild(ele);
            ove = createElement('div', { id: 'overview6' });
            document.body.appendChild(ove);
            let connector: ConnectorModel = {
            ...
            let node3: NodeModel = {
                id: 'node3', width: 100, height: 100, offsetX: 200, offsetY: 200,
                shape: {
                    type: 'HTML',
            ...
            diagram = new Diagram({
                width: '600px', height: '500px', nodes: [node, node2,node3], connectors: [connector],
            });
            ...
            options.height = '500';
            options.width = '250';
            options.sourceID = 'diagram6';
            overview = new Overview(options);
            overview.appendTo('#overview6');
        ...
        it('Overview check native element offsetx', (done: Function) => {
            ...
            const node: HTMLElement = document.getElementById('node1_content_groupElement');
        ...
        it('Overview check HTML element offsetx', (done: Function) => {
            let diagramCanvas: HTMLElement = document.getElementById(diagram.element.id + 'content');
            const node: HTMLElement = document.getElementById('node3_content_groupElement');
            const rect = node.getBoundingClientRect();
            const cx: number = rect.left + rect.width / 2;
            const cy: number = rect.top + rect.height / 2;
            mouseEvents.clickEvent(diagramCanvas, cx, cy);
            ...
            expect(diagram.selectedItems.nodes[0].wrapper.offsetX != 200).toBe(true);
            done();
        });
    });
    ...
    describe('Exception occurs while changing Overview id and window resize ', () => {
        ...
        beforeAll((): void => {
            ...
            document.body.appendChild(ele);
            ove = createElement('div', { id: 'over7' });
            document.body.appendChild(ove);
            ...
            options.height = '500';
            options.width = '250';
            options.sourceID = 'diagram7';
            overview = new Overview(options);
            overview.appendTo('#over7');
        ...
        afterAll((): void => {
            ...
            ele.remove();
            ove.remove();
            const domTable = (window as any)['domTable'];
            if (domTable) {
                delete (window as any)['domTable'];
            }
        });
        it('Checking overview html layer rendering with different id', (done: Function) => {
            const domTable = (window as any)['domTable'];
            expect(domTable).toBeTruthy();
            expect(domTable['overhtml_layer']).toBeUndefined();
            expect(domTable['overviewhtml_layer']).toBeUndefined();
            done();
        });
    });
    ...
    describe('Overview HTML layer not update properly issue', () => {
        ...
        beforeAll((): void => {
            ...
            document.body.appendChild(ele);
            ove = createElement('div', { id: 'over8' });
            document.body.appendChild(ove);
            ...
            options.height = '500';
            options.width = '250';
            options.sourceID = 'diagram8';
            overview = new Overview(options);
            overview.appendTo('#over8');
        ...
        it('Drag the HTML node and check the overview HTML layer', (done: Function) => {
            const node_element = getEl<HTMLElement>('node1_content_html_element');
            const position1 = parseInt(node_element.style.left || '0', 10) || 0;
            diagram.drag(diagram.nodes[0], 150, 0);
            const position2 = parseInt(node_element.style.left || '0', 10) || 0;
            // Expect delta ~ +150 (allow a pixel of tolerance)
            closeTo(position2 - position1, 150, 2);
            done();
        });
    });
    ...
    describe('Overview not updated properly while zoom out', () => {
        ...
        beforeAll((): void => {
            ...
            parentelement = createElement('div', { id: 'overviewdiagram3', styles: "width: 100%;height: 500px;" });
            document.body.appendChild(parentelement)
            parentelement1 = createElement('div', { id: 'parentelement3', styles: "width:74%;height: 500px; float:left;" });
            parentelement.appendChild(parentelement1);
            Diagramelement = createElement('div', { id: 'diagram9' });
            parentelement1.appendChild(Diagramelement);
            overViewElement = createElement('div', { id: 'overview9', styles: "width:25%;height:200px;float:left; border-color:lightgray;border-style:solid;" });
            parentelement.appendChild(overViewElement);
            ...
            newdiagram.appendTo('#diagram9');
            newdiagram.fitToPage()
            let options: OverviewModel = {};
            options.height = '250px';
            options.width = '70%';
            options.sourceID = 'diagram9';
            newoverview = new Overview(options);
            newoverview.appendTo('#overview9');
        ...
        it('Zoom-out diagram and doing interactions in diagram', (done: Function) => {
            ...
            let target:HTMLElement = document.getElementById('overview9_canvasoverviewrect');
            let mouseDown:string = 'mouseDown';
            let mouseup:string = 'mouseUp';
            ...
            expect(preZoom === newdiagram.scroller.currentZoom).toBe(true);
            done();
        });
    });
    ...
    describe('HTML node get disappered after save and load the diagram', () => {
        ...
        let ove: HTMLElement;
        beforeAll((): void => {
            ele = createElement('div', { id: 'diagram10', styles: "width:74%;height: 500px; float:left" });
            document.body.appendChild(ele);
            ove = createElement('div', { id: 'overview10', styles: "width:25%;height:200px;float:left; border-color:lightgray;border-style:solid;" });
            document.body.appendChild(ove);
        ...
        it('Zoom-out diagram and doing interactions in diagram', (done: Function) => {
            ...
            const element = getEl('overview10_htmlLayer');
            const child0 = element.childNodes.length > 0 ? element.childNodes[0] as HTMLElement : null;
            expect(child0).toBeTruthy();
            const length = child0.childNodes.length;
            // Expect at least the two HTML nodes visible in overview
    ...
    describe('830544-Support to add event to notify before rendering of diagram', () => {
        ...
        beforeAll((): void => {
            ele = createElement('div', { id: 'diagram11', styles: "width:74%;height: 500px; float:left" });
            document.body.appendChild(ele);
            ove = createElement('div', { id: 'overview11', styles: "width:25%;height:200px;float:left; border-color:lightgray;border-style:solid;" });
            document.body.appendChild(ove);
        ...
        function load(args: ILoadEventArgs){
            createSpinner({
                ...
                target: document.getElementById('diagram11')
            });
            showSpinner(document.getElementById('diagram11'));
            createEvent=true
        }
        function created(arg:object){
            hideSpinner(document.getElementById('diagram11'));
            createdEvent=true
        }
    });
    ...
    describe('849892-Overview not updated properly when we load the diagram', () => {
        ...
        let ove: HTMLElement;
        beforeAll((): void => {
            ele = createElement('div', { id: 'diagram12', styles: "width:74%;height: 500px; float:left" });
            document.body.appendChild(ele);
            ove = createElement('div', { id: 'overview12', styles: "width:25%;height:200px;float:left; border-color:lightgray;border-style:solid;" });
            document.body.appendChild(ove);
        ...
        it('Load customer JSON and check if the overview is updated properly', (done: Function) => {
            ...
            diagram.loadDiagram(savedata);
            let element = document.getElementById("overview12_canvasvisibleleft");
            let x = element.getAttribute("x");
            let y = element.getAttribute("y");
            console.log(x);
            console.log(y);
            expect(element && Number(x) === 7.586742238546293 || Number(y) === 131.57745493910681).toBe(true);
            done();
        });
    });
    ...
    describe('863516-Overview is not synced with diagram content while zoom-out the diagram.', () => {
        ...
        let ove: HTMLElement;
        beforeAll((): void => {
            ele = createElement('div', { id: 'diagram13', styles: "width:74%;height: 500px; float:left" });
            document.body.appendChild(ele);
            ove = createElement('div', { id: 'overview13', styles: "width:25%;height:200px;float:left; border-color:lightgray;border-style:solid;" });
            document.body.appendChild(ove);
        ...
        it('Zoom-out diagram and checking the overview rect size', (done: Function) => {
            ...
            diagram.zoomTo(zoomOptions);
            const overviewRect = getEl<SVGRectElement>('overview13_canvasoverviewrect');
            const preHeight = overviewRect.getAttribute('height');
            expect(preHeight).toBeTruthy();
            diagram.select([diagram.nodes[8]]);
            diagram.drag(diagram.selectedItems.nodes[0], 0, 300);
            const curHeight = overviewRect.getAttribute('height');
            expect(curHeight).toBeTruthy();
            expect(preHeight !== curHeight).toBe(true);
            done();
        });
    ...
    describe('872140-Dragging HTML nodes in a diagram leaves shadows on the overview', () => {
        ...
        let mouseEvents: MouseEvents = new MouseEvents();
        beforeAll((): void => {
            ele = createElement('div', { id: 'diagram14', styles: "width:74%;height: 500px; float:left" });
            document.body.appendChild(ele);
            ove = createElement('div', { id: 'overview14', styles: "width:25%;height:200px;float:left; border-color:lightgray;border-style:solid;" });
            document.body.appendChild(ove);
        ...
        it('Drag the html node in diagram', (done: Function) => {
            const html = (diagram as any).getObject('Node1') as NodeModel;
            const ovInst = (getEl('overview14') as any).ej2_instances[0];
            expect(ovInst).toBeTruthy();
            expect(ovInst.canvas).toBeTruthy();
            const overviewRect = getEl<SVGRectElement>(ovInst.canvas.id + 'overviewrect');
            const x = Number(overviewRect.getAttribute('x') || '0');
            const y = Number(overviewRect.getAttribute('y') || '0');
            const width = Number(overviewRect.getAttribute('width') || '0');
            const height = Number(overviewRect.getAttribute('height') || '0');
            diagram.select([html]);
            let diagramCanvas: HTMLElement = document.getElementById(diagram.element.id + 'content');
            ...
            const curX = Number(overviewRect.getAttribute('x') || '0');
            const curY = Number(overviewRect.getAttribute('y') || '0');
            const curWidth = Number(overviewRect.getAttribute('width') || '0');
            const curHeight = Number(overviewRect.getAttribute('height') || '0');
            expect(x).toBeCloseTo(curX, 0);
            expect(y).toBeCloseTo(curY, 0);
            expect(width).toBeCloseTo(curWidth, 0);
            expect(height).toBeCloseTo(curHeight, 0);
            done();
        });

    });

    describe('Render overview with 0 width and height', () => {
        let diagram: Diagram;
        let overview: Overview;
        let root: HTMLElement
        beforeAll((): void => {
            root = createElement('div', { id: 'diagramoverviewdiv', styles: 'width:100%;height:500px;' });
            document.body.appendChild(root);
            const leftPanel = createElement('div', { styles: 'width:74%;height:500px;float:left;' });
            root.appendChild(leftPanel);
            const diagramHost = createElement('div', { id: 'diagramwidth' });
            leftPanel.appendChild(diagramHost);
            const rightPanel = createElement('div', {
                styles: 'width:0%;height:0px;float:left;border:1px solid lightgray;'
            });
            root.appendChild(rightPanel);
            const overviewHost = createElement('div', { id: 'overviewwidth' });
            rightPanel.appendChild(overviewHost);
            ...
            diagram.appendTo('#diagramwidth');

            overview = new Overview({
                sourceID: 'diagramwidth',
            });
            overview.appendTo('#overviewwidth');
        });
        ...
        it('Check overview rendering', (done: Function) => {
            const overviewRect = getEl<SVGRectElement>('overviewwidth_canvas');
            expect(overviewRect).toBeTruthy();
            done();
        });
    });
});