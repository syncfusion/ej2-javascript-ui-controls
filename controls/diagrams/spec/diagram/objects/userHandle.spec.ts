...
describe('Diagram Control', () => {
    ...
    describe('Basic Shapes Without Size', () => {
        ...
        it('Checking user handle events with out action', (done: Function) => {
            ...
            const node = diagram.getObject('node') as NodeModel;
            const bounds: any = node.wrapper.bounds;
            const centerX = bounds.x + 15;
            const centerY = bounds.y + 15;
            mouseEvents.clickEvent(diagramCanvas, centerX, centerY);
    ...
    describe('UserHandle Events', () => {
        ...
        let mouseEvents: MouseEvents = new MouseEvents();
        afterAll((): void => {
            diagramuserhandle.clearSelection();
