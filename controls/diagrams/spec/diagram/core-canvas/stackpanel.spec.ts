...
import { Orientation, HorizontalAlignment } from '../../../src/diagram/enum/enum';
...
describe('Diagram Control', () => {
    describe('Simple Stack Panel without children', () => {
        ...
        beforeAll((): void => {
            ...
            diagram = new Diagram({
                mode: 'Canvas',
                width: '500px'
                , height: '500px', basicElements: [stackPanel]
    ...
    describe('Stack Panel with empty children collection', () => {
        ...
        beforeAll((): void => {
            ...
            stackPanel.children = [];
            stackPanel.style.fill = 'red';
            diagram = new Diagram({ mode: 'Canvas', width: '500px', height: '500px', basicElements: [stackPanel] });
    ...
    describe('Rotated vertical Stack Panel', () => {
        ...
        beforeAll((): void => {
            ...
            diagram = new Diagram({ mode: 'Canvas', width: '1000px', height: '500px', basicElements: [stackPanel] });
    ...
    describe('Rotated horizontal Stack Panel', () => {
        ...
        it('memory leak', () => {
            ...
            // modified to 50 to resolve CI failure
