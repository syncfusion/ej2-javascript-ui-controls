...
describe('Diagram Control', () => {
    ...
    describe('Diagram Element', () => {
        ...
        beforeAll((): void => {
            ...
            let node29: NodeModel = {
                id: 'node1', width: 90, height: 90, offsetX: 900, offsetY: 900,
                shape: { type: 'Flow', shape: 'StoredData', }
            };
            let shape30: PathModel = { type: 'Path', data: 'M 0,0 L 100,0 L100,100 L0,100 Z' };
            let node30: NodeModel = {
                id: 'node2', width: 100, height: 100, offsetX: 400, offsetY: 200,
                shape: shape30
            };
            let diagram1 = new Diagram({
                width: 1500, height: 1500, nodes: [node16, node30]
            });
            diagram.onPropertyChanged(diagram1, diagram);
