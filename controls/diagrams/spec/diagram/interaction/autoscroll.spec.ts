...
describe('Diagram Control', () => {
    ...
    describe('Virtualization in Canvas mode', () => {
        ...
        beforeAll(() => {
            ele = createElement('div', { id: 'diagramCanvasMode' });
            document.body.appendChild(ele);
            ...
            diagram.appendTo('#diagramCanvasMode');
        });
        afterAll(() => {
            diagram.destroy();
            ele.remove();
        ...
        it('checking initial rendering and zooming', (done: Function) => {
            let element = document.getElementById('diagramCanvasMode_diagram');
        ...
        it('Checking Autoscroll canvas diagram', (done: Function) => {
            ...
            mouseEvents.mouseMoveEvent(diagramCanvas, center.x + 50 + 25 + 10, center.y + 50 + 25 + 10);
            setTimeout(() => {
                mouseEvents.mouseUpEvent(diagramCanvas, center.x + 50 + 25 + 10 + 15, center.y + 50 + 25 + 10 + 15);
                let element = document.getElementById('diagramCanvasMode_diagram');
    ...
    describe('Virtualization in SVG mode', () => {
        ...
        beforeAll(() => {
            ele = createElement('div', { id: 'diagramSvgMode' });
            document.body.appendChild(ele);
            let shape: BasicShapeModel = { type: 'Basic', shape: 'Rectangle', cornerRadius: 10 };
            let node1: NodeModel = { id: 'node', offsetX: 100, offsetY: 100, width: 50, height: 50, shape: shape, borderColor: "red" };
            let shape2: BasicShapeModel = { type: 'Basic', shape: 'Ellipse' };
            ...
            diagram.appendTo('#diagramSvgMode');
        });
        afterAll(() => {
            diagram.destroy();
            ele.remove();
        ...
        it('checking initial rendering and zooming', (done: Function) => {
            let nodes = document.getElementById('diagramSvgMode_diagramLayer');
            expect(nodes.childNodes.length === 6).toBe(true);
            diagram.zoom(1.5);
            setTimeout(function () {
                let nodes1 = document.getElementById('diagramSvgMode_diagramLayer');
                console.log('checking initial rendering and zooming', nodes1.childNodes.length)
                expect(nodes1.childNodes.length === 4 || nodes1.childNodes.length === 6).toBe(true);
                done();
            }, 100);
            setTimeout(function () {
                diagram.zoom(.5);
        ...
        it('Checking Autoscroll right', (done: Function) => {
            ...
            setTimeout(function () {
                mouseEvents.mouseUpEvent(diagramCanvas, center.x + 50 + 25 + 10 + 10, center.y + 50 + 25 + 10 + 10);
                var element = document.getElementById('diagramSvgMode_diagramLayer');
    ...
    describe('AutoScroll Node resizing - Bottom', () => {
        ...
        it('Check node resizing at bottom', (done: Function) => {
            ...
            setTimeout(() => {
                console.log(`vertical offset is ${diagram.scroller.verticalOffset}`);
        ...
        it('Check node resizing at bottom', (done: Function) => {
            ...
            setTimeout(() => {
                console.log(`vertical offset is ${diagram.scroller.verticalOffset}`);
                expect(Math.ceil(diagram.scroller.verticalOffset) === 280 || Math.ceil(diagram.scroller.verticalOffset) === 270).toBe(true);
                done();
                mouseEvents.mouseUpEvent(diagramCanvas, center.x, center.y + 50 + 25 + 10 + 10);
            }, 110);
        });
    ...
    describe('AutoScroll Node resizing - Top', () => {
        ...
        it('Check node resizing at top', (done: Function) => {
            ...
            setTimeout(() => {
                console.log(`vertical offset is ${diagram.scroller.verticalOffset}`);
                expect(Math.ceil(diagram.scroller.verticalOffset) === 320 || Math.ceil(diagram.scroller.verticalOffset) === 330).toBe(true);
                done();
                mouseEvents.mouseUpEvent(diagramCanvas, center.x, center.y - 50 - 25 - 10 - 10);
            }, 110);
        });
