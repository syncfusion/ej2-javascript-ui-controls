...
describe('Diagram Control', () => {
    ...
    describe('Node  property change', () => {
        ...
        it('Changing path shape at run time', (done: Function) => {
            ...
            diagram.dataBind();
            let value: HTMLElement = document.getElementById('node1_content_groupElement');
            expect((value.childNodes[0] as HTMLElement).attributes[0].nodeValue === "M50,0 L60.72,38.15 L100,38.2 L67.35,59.59 L80.9,100 L50,72.84 L19.1,100 L32.65,59.59 L0,38.2 L39.28,38.15 L50,0 Z ").toBe(true);
            done();
        });
        ...
        it('Changing Flow shape at run time', (done: Function) => {
            ...
            diagram.dataBind();
            let value: HTMLElement = document.getElementById('node1_content_groupElement');
            expect((value.childNodes[0] as HTMLElement).attributes[0].nodeValue === "M0,50 C0,22.38,20.86,0,46.59,0 C72.31,0,93.17,22.38,93.17,50 C93.17,77.61,72.31,100,46.59,100 C20.86,100,0,77.61,0,50 Z M46.58,100 L100,100 ").toBe(true);
            done();
        });
    ...
    describe('Changing the pathnode shape at the run time issue fix', () => {
        ...
        it('Changing the pathnode shape at the run time ', (done: Function) => {
            ...
            (nodes.shape as PathModel).data = 'M145,29.99 C145,46.57,132.48,60,117.04,60 L27.96,60 C12.52,60,0,46.57,0,29.99 L0,29.99 C0,13.43,12.52,0,27.96,0 L117.05,0 C132.48,0,145,13.43,145,30 Z '
            diagram.dataBind();
