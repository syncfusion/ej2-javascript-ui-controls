...
//             expect((diagram.connectors[2] as Connector).intermediatePoints[0].x ==505&&(diagram.connectors[2] as Connector).intermediatePoints[0].y ==265&&(diagram.connectors[2] as Connector).intermediatePoints[1].x ==505&&(diagram.connectors[2] as Connector).intermediatePoints[1].y ==285&&(diagram.connectors[2] as Connector).intermediatePoints[2].x ==345&&(diagram.connectors[2] as Connector).intermediatePoints[2].y ==285&&(diagram.connectors[2] as Connector).intermediatePoints[3].x ==345&&(diagram.connectors[2] as Connector).intermediatePoints[3].y ==325).toBe(true);
...
//             expect((diagram.connectors[4] as Connector).intermediatePoints[0].x ==505&&(diagram.connectors[4] as Connector).intermediatePoints[0].y ==365&&(diagram.connectors[4] as Connector).intermediatePoints[1].x ==505&&(diagram.connectors[4] as Connector).intermediatePoints[1].y ==385&&(diagram.connectors[4] as Connector).intermediatePoints[2].x ==345&&(diagram.connectors[4] as Connector).intermediatePoints[2].y ==385&&(diagram.connectors[4] as Connector).intermediatePoints[3].x ==345&&(diagram.connectors[4] as Connector).intermediatePoints[3].y ==425).toBe(true);
...
//             expect((diagram.connectors[1] as Connector).intermediatePoints[0].x ==255&&(diagram.connectors[1] as Connector).intermediatePoints[0].y ==260&&(diagram.connectors[1] as Connector).intermediatePoints[1].x ==435&&(diagram.connectors[1] as Connector).intermediatePoints[1].y ==260&&(diagram.connectors[1] as Connector).intermediatePoints[2].x ==435&&(diagram.connectors[1] as Connector).intermediatePoints[2].y ==245&&(diagram.connectors[1] as Connector).intermediatePoints[3].x ==455&&(diagram.connectors[1] as Connector).intermediatePoints[3].y ==245).toBe(true);
//             expect((diagram.connectors[2] as Connector).intermediatePoints[0].x ==505&&(diagram.connectors[2] as Connector).intermediatePoints[0].y ==265&&(diagram.connectors[2] as Connector).intermediatePoints[1].x ==505&&(diagram.connectors[2] as Connector).intermediatePoints[1].y ==285&&(diagram.connectors[2] as Connector).intermediatePoints[2].x ==345&&(diagram.connectors[2] as Connector).intermediatePoints[2].y ==285&&(diagram.connectors[2] as Connector).intermediatePoints[3].x ==345&&(diagram.connectors[2] as Connector).intermediatePoints[3].y ==325).toBe(true);
//             expect((diagram.connectors[3] as Connector).intermediatePoints[0].x ==395&&(diagram.connectors[3] as Connector).intermediatePoints[0].y ==345&&(diagram.connectors[3] as Connector).intermediatePoints[1].x ==455&&(diagram.connectors[3] as Connector).intermediatePoints[1].y ==345).toBe(true);
//             expect((diagram.connectors[4] as Connector).intermediatePoints[0].x ==505&&(diagram.connectors[4] as Connector).intermediatePoints[0].y ==365&&(diagram.connectors[4] as Connector).intermediatePoints[1].x ==505&&(diagram.connectors[4] as Connector).intermediatePoints[1].y ==385&&(diagram.connectors[4] as Connector).intermediatePoints[2].x ==345&&(diagram.connectors[4] as Connector).intermediatePoints[2].y ==385&&(diagram.connectors[4] as Connector).intermediatePoints[3].x ==345&&(diagram.connectors[4] as Connector).intermediatePoints[3].y ==425).toBe(true);
//             expect((diagram.connectors[5] as Connector).intermediatePoints[0].x ==395&&(diagram.connectors[5] as Connector).intermediatePoints[0].y ==445&&(diagram.connectors[5] as Connector).intermediatePoints[1].x ==455&&(diagram.connectors[5] as Connector).intermediatePoints[1].y ==445).toBe(true);
...
//             expect((diagram.connectors[3] as Connector).intermediatePoints[0].x ==395&&(diagram.connectors[3] as Connector).intermediatePoints[0].y ==345&&(diagram.connectors[3] as Connector).intermediatePoints[1].x ==455&&(diagram.connectors[3] as Connector).intermediatePoints[1].y ==345).toBe(true);
//             expect((diagram.connectors[4] as Connector).intermediatePoints[0].x ==505&&(diagram.connectors[4] as Connector).intermediatePoints[0].y ==365&&(diagram.connectors[4] as Connector).intermediatePoints[1].x ==505&&(diagram.connectors[4] as Connector).intermediatePoints[1].y ==385&&(diagram.connectors[4] as Connector).intermediatePoints[2].x ==345&&(diagram.connectors[4] as Connector).intermediatePoints[2].y ==385&&(diagram.connectors[4] as Connector).intermediatePoints[3].x ==345&&(diagram.connectors[4] as Connector).intermediatePoints[3].y ==425).toBe(true);
//             expect((diagram.connectors[5] as Connector).intermediatePoints[0].x ==395&&(diagram.connectors[5] as Connector).intermediatePoints[0].y ==445&&(diagram.connectors[5] as Connector).intermediatePoints[1].x ==410&&(diagram.connectors[5] as Connector).intermediatePoints[1].y ==445&&(diagram.connectors[5] as Connector).intermediatePoints[2].x ==410&&(diagram.connectors[5] as Connector).intermediatePoints[2].y ==290&&(diagram.connectors[5] as Connector).intermediatePoints[3].x ==570&&(diagram.connectors[5] as Connector).intermediatePoints[3].y ==290&&(diagram.connectors[5] as Connector).intermediatePoints[4].x ==570&&(diagram.connectors[5] as Connector).intermediatePoints[4].y ==280&&(diagram.connectors[5] as Connector).intermediatePoints[5].x ==205&&(diagram.connectors[5] as Connector).intermediatePoints[5].y ==280&&(diagram.connectors[5] as Connector).intermediatePoints[6].x ==205&&(diagram.connectors[5] as Connector).intermediatePoints[6].y ==340).toBe(true);
...
//                 expect(diagram.nameTable["swimlanestackCanvas10"].rowIndex == 3 && diagram.nameTable["swimlanestackCanvas20"].rowIndex == 4 &&
//                     diagram.nameTable["swimlanestackCanvas30"].rowIndex == 5 && diagram.nameTable["swimlanestackCanvas40"].rowIndex == 2).toBe(true);
//                 console.log("seventh issues");
//                 // Connector Segments - Line Routing
//                 for (var i = 0; i < diagram.connectors.length; i++) { console.log(getIntermediatePoints((diagram.connectors[i] as Connector).intermediatePoints, '(diagram.connectors[' + i + '] as Connector)')); }
//                 expect((diagram.connectors[0] as Connector).intermediatePoints[0].x ==205&&(diagram.connectors[0] as Connector).intermediatePoints[0].y ==265&&(diagram.connectors[0] as Connector).intermediatePoints[1].x ==205&&(diagram.connectors[0] as Connector).intermediatePoints[1].y ==340).toBe(true);
//                 expect((diagram.connectors[1] as Connector).intermediatePoints[0].x ==255&&(diagram.connectors[1] as Connector).intermediatePoints[0].y ==360&&(diagram.connectors[1] as Connector).intermediatePoints[1].x ==435&&(diagram.connectors[1] as Connector).intermediatePoints[1].y ==360&&(diagram.connectors[1] as Connector).intermediatePoints[2].x ==435&&(diagram.connectors[1] as Connector).intermediatePoints[2].y ==345&&(diagram.connectors[1] as Connector).intermediatePoints[3].x ==455&&(diagram.connectors[1] as Connector).intermediatePoints[3].y ==345).toBe(true);
//                 expect((diagram.connectors[2] as Connector).intermediatePoints[0].x ==455&&(diagram.connectors[2] as Connector).intermediatePoints[0].y ==345&&(diagram.connectors[2] as Connector).intermediatePoints[1].x ==430&&(diagram.connectors[2] as Connector).intermediatePoints[1].y ==345&&(diagram.connectors[2] as Connector).intermediatePoints[2].x ==430&&(diagram.connectors[2] as Connector).intermediatePoints[2].y ==445&&(diagram.connectors[2] as Connector).intermediatePoints[3].x ==395&&(diagram.connectors[2] as Connector).intermediatePoints[3].y ==445).toBe(true);
//                 expect((diagram.connectors[3] as Connector).intermediatePoints[0].x ==395&&(diagram.connectors[3] as Connector).intermediatePoints[0].y ==445&&(diagram.connectors[3] as Connector).intermediatePoints[1].x ==455&&(diagram.connectors[3] as Connector).intermediatePoints[1].y ==445).toBe(true);
//                 expect((diagram.connectors[4] as Connector).intermediatePoints[0].x ==455&&(diagram.connectors[4] as Connector).intermediatePoints[0].y ==445&&(diagram.connectors[4] as Connector).intermediatePoints[1].x ==430&&(diagram.connectors[4] as Connector).intermediatePoints[1].y ==445&&(diagram.connectors[4] as Connector).intermediatePoints[2].x ==430&&(diagram.connectors[4] as Connector).intermediatePoints[2].y ==145&&(diagram.connectors[4] as Connector).intermediatePoints[3].x ==395&&(diagram.connectors[4] as Connector).intermediatePoints[3].y ==145).toBe(true);
...
// describe('Swimlane Save and Load', () => {
//     let diagram: Diagram;
//     let ele: HTMLElement;
//     beforeAll((): void => {
//         ele = createElement('div', { id: 'diagramSwimlane23' });
...
//     it('Checking With BPMN Nodes', (done: Function) => {
//         let data = diagram.saveDiagram();
//         expect(function () {
//             diagram.loadDiagram(data);
//         }).not.toThrow();
...
//     beforeAll((): void => {
//         ele = createElement('div', { id: 'diagram_swimlane_header' });
//         document.body.appendChild(ele);
//         let node: NodeModel[] = [{
//             shape: {
//                 type: 'SwimLane',
...
//         });
//         diagram.appendTo('#diagram_swimlane_header');
//     });
//     afterAll((): void => {
//         diagram.destroy();
//         ele.remove();
...
//     it(' header triggers Position change when clicked issue', (done: Function) => {
//         let mouseEvents: MouseEvents = new MouseEvents();
//         let diagramCanvas: Element = document.getElementById(diagram.element.id + 'content');
        
//         let positionChangeCheck: boolean = false;
//         diagram.positionChange = (args: IDraggingEventArgs) => {
//             positionChangeCheck = true;
//         };
...
//             positionChangeCheck = true;
//         };
//         mouseEvents.clickEvent(diagramCanvas, 600, 100, true)
//         mouseEvents.mouseDownEvent(diagramCanvas, 600, 100);
//         mouseEvents.mouseMoveEvent(diagramCanvas, 605, 100);
//         mouseEvents.mouseMoveEvent(diagramCanvas, 605, 110);
//         mouseEvents.mouseUpEvent(diagramCanvas, 605, 110);

//         expect(positionChangeCheck).toBe(true);
        
//         done();
//     });

//     it('connector Position change trigger', (done: Function) => {
//         let mouseEvents: MouseEvents = new MouseEvents();
//         let diagramCanvas: Element = document.getElementById(diagram.element.id + 'content');
...
//             positionChangeCheck = true;
//         };
//         mouseEvents.clickEvent(diagramCanvas, 750, 300, true)
//         mouseEvents.mouseDownEvent(diagramCanvas, 750, 300);
//         mouseEvents.mouseMoveEvent(diagramCanvas, 755, 300);
//         mouseEvents.mouseMoveEvent(diagramCanvas, 755, 305);
//         mouseEvents.mouseUpEvent(diagramCanvas, 755, 305);
//         expect(positionChangeCheck).toBe(true);
//         done();
...
//     });
// });
// describe('835465- child nodes not rendred while undo after deleting swimlane ', () => {
//     let diagram: Diagram;
//     let ele: HTMLElement;
//     let btn: HTMLButtonElement;
//     beforeAll((): void => {
...
//         ele.remove();
//     });
//     it('select swimlane -delete and Undo', (done: Function) => {
//         diagram.select([diagram.nameTable['swimlane']])
//         let count = diagram.nodes.length;
//         diagram.remove();
//         expect(diagram.nodes.length == 0).toBe(true);
//         diagram.undo();
//         let count_2 = diagram.nodes.length;
//         expect(count == count_2).toBe(true);        
//         done();
//     });
// });
...
//         expect((((diagram.nodes[0].shape) as SwimLaneModel).lanes.length) == 3).toBe(true);
//         done();
//     });
// });