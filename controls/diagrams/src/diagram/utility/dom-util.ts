...
import { compile, createElement, Browser, append } from '@syncfusion/ej2-base';
...
export function getContent(
    ...
    if ((typeof element.content === 'string' || typeof element.content === 'function') && (!(element as DiagramHtmlElement).isTemplate)) {
        ...
        if (compiledString) {
            ...
            if ((diagram as any).isVue || (diagram as any).isVue3) {
                compiledString = Array.prototype.slice.call(compiledString) as any;
                append(compiledString as any, div);
            } else {
