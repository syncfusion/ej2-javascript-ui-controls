...
import {
    Diagram, UndoRedo, NodeModel, AnnotationConstraints, Connector, ConnectorModel, PortVisibility,SnapSettings,SnapSettingsModel, PortShapes, Node, VerticalAlignment, Port, PointPort, PortModel, PointPortModel, PortConstraints,cloneObject,ConnectorConstraints, SnapConstraints, HierarchicalTree, DataBinding
} from '../../src/diagram/index';
import { TreeInfo } from '../animation/teamchart1';
...
let nodes: NodeModel[] = [
    {
        ...
        isExpanded:false,
        ports: [
        { id: 'port1', visibility: PortVisibility.Visible,  offset: { x: 0.5, y: 0 }, shape:'Circle',constraints:PortConstraints.Drag|PortConstraints.InConnect },
        { id: 'port2', visibility: PortVisibility.Visible,  offset: { x: 0, y: 0.5 }, shape:'Circle' },
        { id: 'port3', visibility: PortVisibility.Visible,  offset: { x: 1, y: 0.5 }, shape:'Circle',constraints:PortConstraints.Draw },
        { id: 'port4', visibility: PortVisibility.Visible,  offset: { x: 0.5, y: 1 }, shape:'Circle' },
        ],
        shape: {
            type: 'HTML',
            content: '<div style="height:100%;width:100%;"><button type="button" style="height:100%;width:100%;background:red;"> Button</button></div>'
            },
            expandIcon: {
    ...
    },
    {
        ...
        ports: [
        { id: 'port1', visibility: PortVisibility.Visible,  offset: { x: 0.5, y: 0 }, shape:'Circle',constraints:PortConstraints.Drag|PortConstraints.OutConnect}, 
        { id: 'port2', visibility: PortVisibility.Visible,  offset: { x: 0, y: 0.5 }, shape:'Circle' },
        { id: 'port3', visibility: PortVisibility.Connect,  offset: { x: 1, y: 0.5 }, shape:'Circle',constraints:PortConstraints.Draw },
        { id: 'port4', visibility: PortVisibility.Visible,  offset: { x: 0.5, y: 1 }, shape:'Circle' },
        ],
    },
    {
        id: 'node3', width: 100, height: 100, offsetX: 300, annotations: [{ id: 'text1', content: 'Child1' }],
        offsetY: 300,shape: {
            type: 'HTML',
            content: '<div style="height:100%;width:100%;"> <select name="components" id="components" style="height:100%;width:100%;background:#6BA5D7" ><option value="Diagram">Diagram</option><option value="Barcode">Barcode</option><option value="Chart">Chart</option><option value="Map">Map</option></select></div>'
            },
    }, {
        id: 'node4', width: 100, height: 100, offsetX: 700, annotations: [{ id: 'text1', content: 'Child2' }],
        offsetY: 300,
        shape: {
            type: 'Native',
...
let diagram: Diagram = new Diagram({
    width: '800px', height: '600px', nodes: nodes,connectors: connectors,snapSettings: snapSettings,
    layout: {
        enableAnimation: true,
        type: 'HierarchicalTree', margin: { top: 20 },
...
addport.onclick = function () {
    if (diagram.selectedItems.nodes.length > 0) {
        ...
        let port: PointPortModel[] =
            [{ id: 'port1', visibility: PortVisibility.Visible,  offset: { x: 0.5, y: 0 }, shape:'Circle',constraints:PortConstraints.Drag|PortConstraints.InConnect },
            { id: 'port2', visibility: PortVisibility.Hover,  offset: { x: 0, y: 0.5 }, shape:'Circle' },
            { id: 'port3', visibility: PortVisibility.Visible,  offset: { x: 1, y: 0.5 }, shape:'Circle',constraints:PortConstraints.Draw },
            ]
