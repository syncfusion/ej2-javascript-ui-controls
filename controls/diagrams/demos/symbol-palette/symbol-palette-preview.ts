...
let palettes: PaletteModel[] = [
    {
        id: 'flow', expanded: true, title: 'Flow Shapes', symbols: [
            {
                id: 'Terminator', width: 50, height: 60, previewSize:{height:200,width:200},dragSize:{height:200,width:200} ,
                shape: { type: 'Flow', shape: 'Terminator' }, style: { strokeWidth: 1 }, ports: [
            ...
            {
                id: 'Process', width: 50, height: 60, previewSize:{height:200,width:200},dragSize:{height:200,width:200} ,
                shape: { type: 'Flow', shape: 'Process' }, style: { strokeWidth: 1 }, ports: [
                    { offset: { x: 0, y: 0.5 }, visibility: PortVisibility.Connect | PortVisibility.Hover, constraints: PortConstraints.Draw },
                    { offset: { x: 0.5, y: 0 }, visibility: PortVisibility.Connect | PortVisibility.Hover, constraints: PortConstraints.Draw },
                    { offset: { x: 1, y: 0.5 }, visibility: PortVisibility.Connect | PortVisibility.Hover, constraints: PortConstraints.Draw },
                    { offset: { x: 0.5, y: 1 }, visibility: PortVisibility.Connect | PortVisibility.Hover, constraints: PortConstraints.Draw }
            ...
            {
                id: 'data', width: 50, height: 50, shape: { type: 'Flow', shape: 'Data' },previewSize:{height:200,width:200},dragSize:{height:200,width:200} ,
                ports: [
                    { offset: { x: 0, y: 0.5 }, visibility: PortVisibility.Connect | PortVisibility.Hover, constraints: PortConstraints.Draw },
                    { offset: { x: 0.5, y: 0 }, visibility: PortVisibility.Connect | PortVisibility.Hover, constraints: PortConstraints.Draw },
                    { offset: { x: 1, y: 0.5 }, visibility: PortVisibility.Connect | PortVisibility.Hover, constraints: PortConstraints.Draw },
        ...
        symbols: [
            {
                ...
                },previewSize:{height:200,width:200},dragSize:{height:200,width:200} ,
                height: 60,
                width: 140,
                offsetX: 70,
                offsetY: 30,
