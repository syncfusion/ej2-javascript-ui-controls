...
describe('Slash Command Module', () => {
    ...
    describe('Transform blocks using slash command', () => {
        ...
        //     const blockquoteElement = editorElement.querySelector('.e-quote-block').querySelector('blockquote') as HTMLElement;
    ...
    describe('Image in Table + Slash Command integrations', () => {
        ...
        it('Insert image via slash inside a cell, delete image → removed and focus moves to next block in same cell', (done) => {
                ...
                properties: {
                    ...
                    rows: [{
                        ...
                        cells: [{
                            columnId: 'c1',
                            blocks: [
                                { id: 'cell-p1', blockType: BlockType.Paragraph, content: [{ contentType: ContentType.Text, content: '' }] },
                                { id: 'cell-p2', blockType: BlockType.Paragraph, content: [{ contentType: ContentType.Text, content: 'Next paragraph' }] }
                            ]
                        }]
                    }]
                }
            ...
            setTimeout(() => {
                ...
                const imgEl = (cellBlocks[0] as HTMLElement).querySelector('.e-image-placeholder') as HTMLImageElement;
        ...
        it('Transform paragraph with content into Image via slash → adds new Image block after existing paragraph', (done) => {
            ...
            setTimeout(() => {
                ...
                expect((blocksDom[1] as HTMLElement).querySelector('.e-image-placeholder')).not.toBeNull();
        ...
        it('Undo/Redo for transforming paragraph with content into Image (addition after)', (done) => {
            ...
            setTimeout(() => {
                ...
                expect((domBlocks[1] as HTMLElement).querySelector('.e-image-placeholder')).not.toBeNull();
