import { Component, getUniqueID, INotifyPropertyChanged, NotifyPropertyChanges, Property, isNullOrUndefined as isNOU, formatUnit, Collection, EmitType, EventHandler, Complex, remove, Event, append, Observer, L10n, detach } from '@syncfusion/ej2-base';import { Mention, MentionChangeEventArgs, PopupEventArgs } from '@syncfusion/ej2-dropdowns';import { Popup, Tooltip } from '@syncfusion/ej2-popups';import { BeforeOpenCloseMenuEventArgs, ClickEventArgs, ContextMenu, ItemModel, MenuEventArgs, OpenCloseMenuEventArgs, Toolbar } from '@syncfusion/ej2-navigations';import { BlockModel, UserModel, CommandMenuSettingsModel, InlineToolbarSettingsModel, PasteSettingsModel, ToolbarItemModel, ContentModel, CommandItemModel, StyleModel, LabelItemModel, BlockActionMenuSettingsModel, ContextMenuSettingsModel, BlockActionItemModel, ContextMenuItemModel, LabelSettingsModel } from '../models/index';import { Block } from '../models/block/block';import { User } from '../models/common/user';import { CommandMenuSettings } from '../models/menus/command-menu-settings';import { InlineToolbarSettings } from '../models/menus/inline-toolbar-settings';import { ContextMenuSettings } from '../models/menus/context-menu-settings';import { BlockActionMenuSettings } from '../models/block/blockaction-menu-settings';import { PasteSettings } from '../models/common/paste-settings';import { LabelSettings } from '../models/common/label-settings';import { FocusEventArgs, BlurEventArgs, BlockAddedEventArgs, BlockRemovedEventArgs, BlockMovedEventArgs, ContentChangedEventArgs, SelectionChangedEventArgs, UndoRedoEventArgs, BlockDragEventArgs, BlockDropEventArgs, KeyActionExecutedEventArgs, BeforePasteEventArgs, AfterPasteEventArgs, CommandMenuOpenEventArgs, CommandMenuCloseEventArgs, CommandItemClickedEventArgs, CommandQueryFilteringEventArgs, ToolbarOpenEventArgs, ToolbarCloseEventArgs, BlockActionMenuOpenEventArgs, BlockActionMenuCloseEventArgs, BlockActionItemClickEventArgs, ContextMenuBeforeOpenEventArgs, ContextMenuBeforeCloseEventArgs, ContextMenuOpenEventArgs, ContextMenuItemClickEventArgs, ContextMenuCloseEventArgs } from './eventargs';import { PopupRenderer, MentionRenderer, MenuBarRenderer, TooltipRenderer } from '../renderer/index';import { BlockAction, FormattingAction, ListBlockAction, DragAndDropAction, BlockEditorMethods, UndoRedoAction, ClipboardAction } from '../actions/index';import { cleanCheckmarkElement, getAdjacentBlock, getBlockContentElement, getBlockIndexById, getBlockModelById, getClosestContentElementInDocument, getParentBlock, isAtEndOfBlock, isAtStartOfBlock, isListTypeBlock, isNonContentEditableBlock, isChildrenTypeBlock, getContentElementBasedOnId } from '../utils/block';import { setCursorPosition, getSelectionRange, captureSelectionState, getPathFromBlock, getTextOffset } from '../utils/selection';import { sanitizeBlock, sanitizeContent, sanitizeLabelItems, sanitizeStyles, transformIntoToolbarItem } from '../utils/transform';import { IInlineContentInsertionArgs, IMentionRenderOptions, IPopupRenderOptions, ISplitContent, RangePath, IAddBlockArgs, IUndoRedoState, IUndoRedoSelection, ITransformBlockArgs } from './interface';import { deepClone, focusLastNbsp, generateUniqueId, getAbsoluteOffset, getAutoAvatarColor, getNormalizedKey, getTemplateFunction, getUserInitials, isNodeAroundSpecialElements } from '../utils/common';import { getBlockActionsMenuItems, getCommandMenuItems, getContextMenuItems, getInlineToolbarItems, getLabelMentionDisplayTemplate, getLabelMenuItems, getUserMentionDisplayTemplate } from '../utils/data';import { BlockType, BuiltInToolbar, ContentType, DeletionType } from './enums';import { InlineContentInsertionModule, NodeSelection, SlashCommandModule, ContextMenuModule, BlockActionMenuModule, InlineToolbarModule, LinkModule, ClipboardCleanupModule } from '../plugins/index';import { clearBreakTags, createFormattingElement, findClosestParent, getElementRect, isElementEmpty, wrapNodeWithTag } from '../utils/dom';import { decode, encode, sanitizeHelper } from '../utils/security';import { events } from './constant';import { getBlockDataAsHTML } from '../utils/html-parser';
