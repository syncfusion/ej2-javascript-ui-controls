...
describe('ImageEditor', () => {
   ...
   describe('Rotate With Annotations', () => {
       ...
       it('90 Degree Combination', (done) => {
           ...
           setTimeout(() => {
               ...
               expect(imageEditor.objColl[0].activePoint.startX).toEqual(395.53999999999996);
               expect(imageEditor.objColl[0].activePoint.startY).toEqual(216.99999999999994);
               expect(imageEditor.objColl[0].activePoint.endX).toEqual(452.53999999999996);
               expect(imageEditor.objColl[0].activePoint.endY).toEqual(292.99999999999994);
               expect(imageEditor.objColl[1].shape).toEqual('text');
               expect(imageEditor.objColl[1].activePoint.startX).toEqual(284.73199999999997);
               expect(imageEditor.objColl[1].activePoint.startY).toEqual(24.43203124999995);
               expect(imageEditor.objColl[1].activePoint.endX).toEqual(338.53999999999996);
       ...
       it('180 Degree Combination', (done) => {
           ...
           setTimeout(() => {
               ...
               expect(imageEditor.transform.degree).toEqual(180);
               expect(imageEditor.objColl[0].shape).toEqual('rectangle');
               expect(imageEditor.objColl[0].activePoint.startX).toEqual(190.60526315789474);
               expect(imageEditor.objColl[0].activePoint.startY).toEqual(182.99999999999994);
               expect(imageEditor.objColl[0].activePoint.endX).toEqual(290.60526315789474);
               expect(imageEditor.objColl[0].activePoint.endY).toEqual(257.99999999999994);
               expect(imageEditor.objColl[1].shape).toEqual('text');
               expect(imageEditor.objColl[1].activePoint.startX).toEqual(190.60526315789474);
               expect(imageEditor.objColl[1].activePoint.startY).toEqual(37.199999999999946);
               expect(imageEditor.objColl[1].activePoint.endX).toEqual(543.9841694078948);
       ...
       it('270 Degree Combination', (done) => {
           ...
           setTimeout(() => {
               ...
               expect(imageEditor.transform.degree).toEqual(270);
               expect(imageEditor.objColl[0].shape).toEqual('rectangle');
               expect(imageEditor.objColl[0].activePoint.startX).toEqual(294.46000000000004);
               expect(imageEditor.objColl[0].activePoint.startY).toEqual(15);
               expect(imageEditor.objColl[0].activePoint.endX).toEqual(351.46000000000004);
               expect(imageEditor.objColl[0].activePoint.endY).toEqual(91);
               expect(imageEditor.objColl[1].shape).toEqual('text');
               expect(imageEditor.objColl[1].activePoint.startX).toEqual(408.46000000000004);
               expect(imageEditor.objColl[1].activePoint.startY).toEqual(15);
               expect(imageEditor.objColl[1].activePoint.endX).toEqual(462.26800000000003);
       ...
       it('360 or 0 Degree Combination', (done) => {
           ...
           setTimeout(() => {
               ...
               expect(imageEditor.transform.degree).toEqual(0);
               expect(imageEditor.objColl[0].shape).toEqual('rectangle');
               expect(imageEditor.objColl[0].activePoint.startX).toEqual(456.3947368421052);
               expect(imageEditor.objColl[0].activePoint.startY).toEqual(50.00000000000003);
               expect(imageEditor.objColl[0].activePoint.endX).toEqual(556.3947368421052);
               expect(imageEditor.objColl[0].activePoint.endY).toEqual(125.00000000000003);
               expect(imageEditor.objColl[1].shape).toEqual('text');
               expect(imageEditor.objColl[1].activePoint.startX).toEqual(203.0158305921052);
               expect(imageEditor.objColl[1].activePoint.startY).toEqual(200.00000000000003);
               expect(imageEditor.objColl[1].activePoint.endX).toEqual(556.3947368421052);
   ...
   describe('Rotate With Zoom', () => {
       ...
       it('90 Degree Rotate With Zoom', (done) => {
           ...
           setTimeout(() => {
               ...
               imageEditor.rotate(90);
               expect(imageEditor.transform.degree).toEqual(90);
               expect(imageEditor.img.destLeft).toEqual(267.86);
               ...
               imageEditor.zoom(2);
               expect(imageEditor.transform.zoomFactor).toEqual(0.1);
               expect(imageEditor.img.destLeft).toEqual(257.296);
               ...
               expect(imageEditor.img.destLeft).toEqual(246.732);
       ...
       it('180 Degree Rotate With Zoom', (done) => {
           ...
           setTimeout(() => {
               ...
               imageEditor.rotate(90);
               expect(imageEditor.transform.degree).toEqual(180);
               expect(imageEditor.img.destLeft).toEqual(190.60526315789474);
               expect(imageEditor.img.destTop).toEqual(15);
               ...
               imageEditor.zoom(2);
               expect(imageEditor.transform.zoomFactor).toEqual(0.1);
               expect(imageEditor.img.destLeft).toEqual(172.31578947368422);
               expect(imageEditor.img.destTop).toEqual(1.0999999999999943);
               ...
               imageEditor.zoom(3);
               expect(imageEditor.transform.zoomFactor).toEqual(0.2);
               expect(imageEditor.img.destLeft).toEqual(154.0263157894737);
               expect(imageEditor.img.destTop).toEqual(-12.800000000000011);
   ...
   describe('Rotate With Crop', () => {
       ...
       it('90 Degree Rotate With Crop', (done) => {
           ...
           setTimeout(() => {
               ...
               expect(imageEditor.activeObj.shape).toEqual('crop-square');
               imageEditor.crop();
               expect(imageEditor.img.destLeft).toEqual(234.50000000000006);
               expect(imageEditor.img.destTop).toEqual(15);
               expect(imageEditor.img.destWidth).toEqual(277.9999999999999);
               expect(imageEditor.img.destHeight).toEqual(278);
               expect(imageEditor.objColl[0].activePoint.startX).toEqual(404.7162217240677);
               expect(imageEditor.objColl[0].activePoint.startY).toEqual(243.22967189728956);
               expect(imageEditor.objColl[0].activePoint.endX).toEqual(485.4478296311392);
               expect(imageEditor.objColl[0].activePoint.endY).toEqual(350.8718157733849);
               done();
           }, 100);
       });
       it('180 Degree Rotate With Crop', (done) => {
           ...
           setTimeout(() => {
               ...
               expect(imageEditor.activeObj.shape).toEqual('crop-square');
               imageEditor.crop();
               expect(imageEditor.img.destLeft).toEqual(234.50000000000009);
               expect(imageEditor.img.destTop).toEqual(15);
               expect(imageEditor.img.destWidth).toEqual(277.99999999999983);
               expect(imageEditor.img.destHeight).toEqual(278);
               expect(imageEditor.objColl[0].activePoint.startX).toEqual(180.17400440264157);
               expect(imageEditor.objColl[0].activePoint.startY).toEqual(184.65399239543729);
               expect(Math.round(imageEditor.objColl[0].activePoint.endX)).toEqual(286);
       ...
       it('270 Degree Rotate With Crop', (done) => {
           ...
           setTimeout(() => {
               ...
               expect(imageEditor.activeObj.shape).toEqual('crop-square');
               imageEditor.crop();
               expect(imageEditor.img.destLeft).toEqual(234.50000000000014);
               expect(imageEditor.img.destTop).toEqual(15);
               expect(imageEditor.img.destWidth).toEqual(277.9999999999997);
               expect(imageEditor.img.destHeight).toEqual(278);
               expect(imageEditor.objColl[0].activePoint.startX).toEqual(261.55217036886086);
               expect(imageEditor.objColl[0].activePoint.startY).toEqual(-42.871815773384895);
               expect(imageEditor.objColl[0].activePoint.endX).toEqual(342.2837782759324);
               expect(imageEditor.objColl[0].activePoint.endY).toEqual(64.77032810271041);
               done();
           }, 100);
       });
       it('360 or 0 Degree Rotate With Crop', (done) => {
           ...
           setTimeout(() => {
               ...
               expect(imageEditor.activeObj.shape).toEqual('crop-square');
               imageEditor.crop();
               expect(imageEditor.img.destLeft).toEqual(234.5);
               expect(imageEditor.img.destTop).toEqual(15);
               expect(imageEditor.img.destWidth).toEqual(278);
               expect(imageEditor.img.destHeight).toEqual(278);
               expect(imageEditor.objColl[0].activePoint.startX).toEqual(461.12257354412645);
               expect(imageEditor.objColl[0].activePoint.startY).toEqual(44.06844106463881);
               expect(imageEditor.objColl[0].activePoint.endX).toEqual(566.8259955973583);
   ...
   describe('Rotate With Flip', () => {
       ...
       it('360 or 0 Degree Rotate With Horizontal and Vertical Flip', (done) => {
           ...
           setTimeout(() => {
               ...
               expect(imageEditor.objColl[0].activePoint.startX).toEqual(190.6052631578949);
               expect(imageEditor.objColl[0].activePoint.startY).toEqual(50.00000000000003);
               expect(imageEditor.objColl[0].activePoint.endX).toEqual(290.6052631578949);
               expect(imageEditor.objColl[0].activePoint.endY).toEqual(125.00000000000003);
               imageEditor.flip('Vertical');
               expect(imageEditor.rotateFlipColl[0]).toEqual('horizontal');
               expect(imageEditor.rotateFlipColl[1]).toEqual('vertical');
   ...
   describe('Flip With Zoom', () => {
       ...
       it('Horizontal and Vertical Flip With Zoom', (done) => {
           ...
           setTimeout(() => {
               ...
               expect(imageEditor.transform.currFlipState).toEqual('horizontal');
               expect(imageEditor.objColl[0].shape).toEqual('rectangle');
               expect(Math.round(imageEditor.objColl[0].activePoint.startX)).toEqual(191);
               ...
               expect(Math.round(imageEditor.objColl[0].activePoint.startX)).toEqual(172);
               expect(Math.round(imageEditor.objColl[0].activePoint.startY)).toEqual(40);
               expect(Math.round(imageEditor.objColl[0].activePoint.endX)).toEqual(282);
               expect(Math.round(imageEditor.objColl[0].activePoint.endY)).toEqual(122);
               imageEditor.zoom(3);
               expect(imageEditor.transform.zoomFactor).toEqual(.2);
               expect(Math.round(imageEditor.objColl[0].activePoint.startX)).toEqual(154);
               expect(Math.round(imageEditor.objColl[0].activePoint.startY)).toEqual(29);
               expect(Math.round(imageEditor.objColl[0].activePoint.endX)).toEqual(274);
               ...
               expect(Math.round(imageEditor.objColl[0].activePoint.startX)).toEqual(191);
               expect(Math.round(imageEditor.objColl[0].activePoint.startY)).toEqual(50);
               expect(Math.round(imageEditor.objColl[0].activePoint.endX)).toEqual(291);
       ...
       it('Vertical and Horizontal Flip With Zoom', (done) => {
           ...
           setTimeout(() => {
               ...
               imageEditor.zoom(2);
               expect(imageEditor.transform.zoomFactor).toEqual(.1);
               expect(imageEditor.objColl[0].activePoint.startX).toEqual(464.6842105263157);
               expect(Math.round(imageEditor.objColl[0].activePoint.startY)).toEqual(186);
               expect(imageEditor.objColl[0].activePoint.endX).toEqual(574.6842105263157);
               expect(imageEditor.objColl[0].activePoint.endY).toEqual(268.4);
               imageEditor.zoom(3);
               expect(imageEditor.transform.zoomFactor).toEqual(.2);
               expect(imageEditor.objColl[0].activePoint.startX).toEqual(472.97368421052624);
               expect(imageEditor.objColl[0].activePoint.startY).toEqual(188.8);
               expect(imageEditor.objColl[0].activePoint.endX).toEqual(592.9736842105262);
   ...
   describe('Flip With Crop', () => {
       ...
       it('Horizontal Flip With Crop', (done) => {
           ...
           setTimeout(() => {
               ...
               expect(imageEditor.img.destWidth).toEqual(278);
               expect(imageEditor.img.destHeight).toEqual(278);
               expect(imageEditor.objColl[0].activePoint.startX).toEqual(180.1740044026419);
   ...
   describe('Flip With Rotate', () => {
       ...
       it('Horizontal Flip With Rotate', (done) => {
           ...
           setTimeout(() => {
               ...
               expect(imageEditor.img.destWidth).toEqual(365.7894736842105);
               expect(imageEditor.img.destHeight).toEqual(278);
               expect(imageEditor.objColl[0].activePoint.startX).toEqual(456.3947368421051);
               expect(imageEditor.objColl[0].activePoint.startY).toEqual(182.99999999999994);
               expect(imageEditor.objColl[0].activePoint.endX).toEqual(556.3947368421051);
               expect(imageEditor.objColl[0].activePoint.endY).toEqual(257.99999999999994);
               imageEditor.rotate(90);
               expect(imageEditor.transform.degree).toEqual(270);
               expect(imageEditor.img.destLeft).toEqual(267.86);
               ...
               expect(imageEditor.img.destWidth).toEqual(365.7894736842105);
               expect(imageEditor.img.destHeight).toEqual(278);
               expect(imageEditor.objColl[0].activePoint.startX).toEqual(190.60526315789485);
               expect(imageEditor.objColl[0].activePoint.startY).toEqual(50.00000000000003);
               expect(imageEditor.objColl[0].activePoint.endX).toEqual(290.60526315789485);
               expect(imageEditor.objColl[0].activePoint.endY).toEqual(125.00000000000003);
               done();
           }, 100);
       });
       it('Vertical Flip With Rotate', (done) => {
           ...
           setTimeout(() => {
               ...
               expect(imageEditor.img.destWidth).toEqual(211.28);
               expect(imageEditor.img.destHeight).toEqual(278);
               expect(imageEditor.objColl[0].activePoint.startX).toEqual(294.46);
               expect(imageEditor.objColl[0].activePoint.startY).toEqual(216.99999999999994);
               expect(imageEditor.objColl[0].activePoint.endX).toEqual(351.46);
               expect(imageEditor.objColl[0].activePoint.endY).toEqual(292.99999999999994);
               imageEditor.rotate(90);
               expect(imageEditor.transform.degree).toEqual(180);
               expect(imageEditor.img.destLeft).toEqual(190.60526315789474);
               ...
               expect(imageEditor.img.destWidth).toEqual(211.28);
               expect(imageEditor.img.destHeight).toEqual(278);
               expect(imageEditor.objColl[0].activePoint.startX).toEqual(395.54);
               expect(imageEditor.objColl[0].activePoint.startY).toEqual(15);
               expect(imageEditor.objColl[0].activePoint.endX).toEqual(452.54);
               expect(imageEditor.objColl[0].activePoint.endY).toEqual(91);
               imageEditor.rotate(90);
               expect(imageEditor.transform.degree).toEqual(0);
               expect(imageEditor.img.destLeft).toEqual(190.60526315789474);
   ...
   describe('Combination testing', () => {
       ...
       it('Text size improper', (done) => {
           ...
           setTimeout(() => {
                ...
                imageEditor.rotate(-90);
                expect(imageEditor.transform.degree).toEqual(-180);
                expect(imageEditor.objColl[imageEditor.objColl.length - 1].textSettings.fontSize).toEqual(21.00000000000001);
                done();
           }, 100);
       });
       ...
       it('Freehanddraw and flip combination', (done) => {
           ...
           setTimeout(() => {
               ...
               //  expect(imageEditor.currSelectionPoint.shape).toEqual('crop-4:3');
                ...
                imageEditor.zoom(2);
                expect(imageEditor.transform.zoomFactor).toEqual(.1);
                expect(imageEditor.pointColl[0].points[0].x).toEqual(3.290627695280847);
               //  imageEditor.select('square');
               //  imageEditor.crop();
                done();
           }, 100);
       ...
       it('Coverage improvement for new features', (done) => {
        ...
        it('Addtional Selection with Crop', (done) => {
            ...
            setTimeout(() => {
                ...
                imageEditor.crop();
                expect(imageEditor.img.destLeft).toEqual(240);
                expect(imageEditor.img.destTop).toEqual(15);
                expect(imageEditor.img.destWidth).toEqual(251.99999999999997);
                ...
                imageEditor.crop();
                expect(imageEditor.img.destLeft).toEqual(224.25);
                expect(imageEditor.img.destTop).toEqual(15);
                ...
                imageEditor.crop();
                expect(imageEditor.img.destLeft).toEqual(214.80000000000004);
                expect(imageEditor.img.destTop).toEqual(15);
                ...
                imageEditor.crop();
                expect(imageEditor.img.destLeft).toEqual(231);
                expect(imageEditor.img.destTop).toEqual(15);
                ...
                imageEditor.crop();
                expect(imageEditor.img.destLeft).toEqual(259.6875);
                expect(imageEditor.img.destTop).toEqual(15);
        ...
        it('Coverage improvement - random combinations 2', (done) => {
            ...
            setTimeout(() => {
                imageEditor.drawRectangle(350, 200, 650, 400, 15, 'red', 'green');
                    ...
                    imageEditor.crop();
                    expect(imageEditor.img.destLeft).toEqual(65.99999999999994);
                    ...
                    imageEditor.crop();
                    expect(imageEditor.img.destLeft).toEqual(66.00000000000006);
                    ...
                    imageEditor.crop();
                    expect(imageEditor.img.destLeft).toEqual(318.75);
                    expect(imageEditor.img.destTop).toEqual(15);
                    ...
                    imageEditor.crop();
                    expect(imageEditor.img.destLeft).toEqual(258);
                    expect(imageEditor.img.destTop).toEqual(15);
  ...
  describe('Opening images with specific width and height', () => {
        ...
        it('Opening images with specific width and height without maintaining aspect ratio - 3', (done) => {
            ...
            setTimeout(() => {
                let dimension: any = imageEditor.getImageDimension();
                // expect(Math.round(dimension.width)).toEqual(896);
                // expect(Math.round(dimension.height)).toEqual(398);
                done();
            }, 100);
        });
