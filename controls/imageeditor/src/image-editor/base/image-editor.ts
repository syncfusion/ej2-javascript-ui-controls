...
export class ImageEditor extends Component<HTMLDivElement> implements INotifyPropertyChanged {
    ...
    public destroy(): void {
        ...
        if (!isBlazor()) {this.notify('toolbar', { 
    ...
    public reset(): void {
        ...
        if (!this.disabled && !obj['isErrorImage']) {
            ...
            if (!isNullOrUndefined(obj['initialZoomValue'])) {
    ...
    private moveToSelectionRange(type: string, activeObj: SelectionPoint): void {
        if (!isNullOrUndefined(this.activeObj.shape)) {
            if (type === 'rotateleft' || type === 'rotateright') {
                let zoomFactor: number = this.transform.zoomFactor;
                this.objColl.push(this.activeObj);
                this.notify('shape', { prop: 'refreshActiveObj', onPropertyChange: false});
                if (this.transform.degree % 90 === 0 && this.transform.degree % 180 !== 0) {
                    if (this.objColl[this.objColl.length - 1].activePoint.width < activeObj.activePoint.height) {
                        for (let i: number = 2; i < this.zoomSettings.maxZoomFactor; i++) {
                            if (this.objColl[this.objColl.length - 1].activePoint.width >= activeObj.activePoint.height ||
                ...
                const panX: number = (this.lowerCanvas.clientWidth / 2) - (this.objColl[this.objColl.length - 1].activePoint.startX +
                    (this.objColl[this.objColl.length - 1].activePoint.width / 2));
                const panY: number = (this.lowerCanvas.clientHeight / 2) - (this.objColl[this.objColl.length - 1].activePoint.startY +
                ...
                this.notify('transform', { prop: 'setTempPanMove', onPropertyChange: false,
                    value: {point: null }});
                this.activeObj = extend({}, this.objColl[this.objColl.length - 1]) as SelectionPoint;
                this.objColl.pop();
                this.notify('draw', { prop: 'drawObject', onPropertyChange: false, value: {canvas: 'duplicate', obj: this.activeObj }});
            }
        }
     ...
     */
    public getSquarePointForRotatedShape(obj: SelectionPoint, object?: Object): ActivePoint {
