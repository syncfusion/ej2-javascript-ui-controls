    ...
    ContentRender.prototype.refreshContentRows = function (args) {
        ...
        for (var i = startIndex, len = modelData.length; i < len; i++) {
            ...
            if (!gObj.rowTemplate) {
                ...
                var elements = gObj.getRowTemplate()(sf.base.extend({ index: i }, dataSource[i]), gObj, 'rowTemplate', rowTemplateID);
...
var Selection = /** @class */ (function () {
    ...
    Selection.prototype.updatePersistCollection = function (selectedRow, chkState) {
        var _this = this;
        if (this.parent.isPersistSelection && !sf.base.isNullOrUndefined(selectedRow)) {
...
function toogleCheckbox(elem) {
    ...
    span.classList.contains('e-check') ? sf.base.classList(span, ['e-uncheck'], ['e-check']) :
...
sfBlazor.modules["pager"] = "grids.Pager";
sfBlazor.loadDependencies(sfBlazor.dependencyJson.pager, () => {
