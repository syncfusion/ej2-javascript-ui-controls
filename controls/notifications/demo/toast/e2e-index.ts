...
document.getElementById('showToast').onclick = (e: Event) => {
  ...
  toast.position.X = (<HTMLInputElement>document.getElementById('positionX')).value;
  toast.position.Y = (<HTMLInputElement>document.getElementById('positionY')).value;
