import { Message, Severity } from "../../src/index";
...
describe("Null or undefined value testing", () => {
    ...
    it("cssClass", () => {
        ...
        expect(msgObj.cssClass).toBe(null);
        msgObj.destroy();
        msgObj = new Message({ cssClass: undefined });
        msgObj.appendTo('#msg');
        expect(msgObj.cssClass).toBe('');
        msgObj.destroy();
    });
    it('RTL', () => {
        msgObj = new Message({ enableRtl: null });
        msgObj.appendTo('#msg');
        expect(msgObj.enableRtl).toBe(false);
        msgObj.destroy();
        msgObj = new Message({ enableRtl: undefined });
        msgObj.appendTo('#msg');
        expect(msgObj.enableRtl).toBe(false);
        msgObj.destroy();
    })
    it('severity', () => {
        msgObj = new Message({ severity: null });
        msgObj.appendTo('#msg');
        expect(msgObj.severity).toBe(null);
        msgObj.destroy();
        msgObj = new Message({ severity: undefined });
        msgObj.appendTo('#msg');
        expect(msgObj.severity).toBe('Normal');
        msgObj.destroy();
    })
    it('variant', () => {
        msgObj = new Message({ variant: null });
        msgObj.appendTo('#msg');
        expect(msgObj.variant).toBe(null);
        msgObj.destroy();
        msgObj = new Message({ variant: undefined });
        msgObj.appendTo('#msg');
        expect(msgObj.variant).toBe('Text');
        msgObj.destroy();
    })
    it('show icon', () => {
        msgObj = new Message({ showIcon: null });
        msgObj.appendTo('#msg');
        expect(msgObj.showIcon).toBe(null);
        msgObj.destroy();
        msgObj = new Message({ showIcon: undefined });
        msgObj.appendTo('#msg');
        expect(msgObj.showIcon).toBe(true);
        msgObj.destroy();
    })
    it('show close icon', () => {
        msgObj = new Message({ showCloseIcon: null });
        msgObj.appendTo('#msg');
        expect(msgObj.showCloseIcon).toBe(null);
        msgObj.destroy();
        msgObj = new Message({ showCloseIcon: undefined });
        msgObj.appendTo('#msg');
        expect(msgObj.showCloseIcon).toBe(false);
        msgObj.destroy();
    })
    it('visible', () => {
        msgObj = new Message({ visible: null });
        msgObj.appendTo('#msg');
        expect(msgObj.visible).toBe(null);
        msgObj.destroy();
        msgObj = new Message({ visible: undefined });
        msgObj.appendTo('#msg');
        expect(msgObj.visible).toBe(true);
        msgObj.destroy();
    })
    it('content', () => {
        msgObj = new Message({ content: null });
        msgObj.appendTo('#msg');
        expect(msgObj.content).toBe(null);
        msgObj.destroy();
        msgObj = new Message({ content: undefined });
        msgObj.appendTo('#msg');
        expect(msgObj.content).toBe(null);
        msgObj.destroy();
    })
