...
var ListView = /** @class */ (function (_super) {
    ...
    ListView.prototype.selectEventData = function (li, e) {
        ...
        if (e) {
            sf.base.merge(eventArgs, { isInteracted: true, event: e, index: Array.prototype.indexOf.call(this.curUL.children, li) });
        }
        return eventArgs;
    };
    ...
    ListView.prototype.renderList = function (data) {
        ...
        if (sf.base.isBlazor() && this.isServerRendered && !this.enableVirtualization && this.itemReRender) {
            // tslint:disable
...
var Virtualization = /** @class */ (function () {
    ...
    Virtualization.prototype.createUIItem = function (args) {
        ...
        if (this.listViewInstance.showCheckBox) {
            ...
            if (!sf.base.isNullOrUndefined(this.listViewInstance.virtualCheckBox.outerHTML)) {
