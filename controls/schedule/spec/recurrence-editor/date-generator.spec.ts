...
describe('Recurrence Date Generator Specs', () => {
    ...
    describe('Schedule - recurrence Freq- Daily (without EndDate)', () => {
        ...
        it('Default - ByDay with Start time', () => {
            expect(JSON.stringify(generate(new Date(2022, 1, 1, 10),
                'FREQ=DAILY;BYDAY=MO,TU,WE,TH,FR;INTERVAL=1;COUNT=5', null, 0)))
                .toBe(JSON.stringify([
    ...
    describe('Schedule - recurrence Freq- Weekly (without EndDate)', () => {
        ...
        it('Default - Having BYMONTH with start time', () => {
            expect(
                JSON.stringify(generate(new Date(2022, 1, 1, 10), 'FREQ=WEEKLY;BYDAY=SU;BYMONTH=12;INTERVAL=1;COUNT=5', null, 0)))
                .toBe(
                    JSON.stringify([
        ...
        it('Default - BYDAY with start time', () => {
            expect(
                JSON.stringify(generate(new Date(2022, 1, 1, 10), 'FREQ=WEEKLY;INTERVAL=2;COUNT=4;BYDAY=TU,SU;', null, 0)))
                .toBe(
                    JSON.stringify([
    ...
    describe('Schedule - recurrence Freq- MONTHLY (without EndDate)', () => {
        ...
        it('Default - BYMONTHDAY With BYSETPOS', () => {
            expect(
                JSON.stringify(generate(startDate,
                    'FREQ=MONTHLY;BYMONTHDAY=23,27,31;INTERVAL=1;BYSETPOS=2;COUNT=5', null, 0)))
                .toBe(JSON.stringify([
        ...
        it('Default - BYMONTHDAY Without BYSETPOS', () => {
            expect(
                JSON.stringify(generate(startDate,
                    'FREQ=MONTHLY;BYMONTHDAY=23,27,31;COUNT=5', null, 0)))
                .toBe(JSON.stringify([
        ...
        it('Default - BYMONTHDAY With multiple BYMONTH', () => {
            expect(
                JSON.stringify(generate(new Date('Sun Jun 01 2014 '),
                    'FREQ=MONTHLY;BYMONTHDAY=23,27,31;BYMONTH=3,4;COUNT=5', null, 0)))
                .toBe(JSON.stringify([
        ...
        it('Default - Having BYMONTH with start time', () => {
            expect(
                JSON.stringify(generate(new Date(2022, 1, 1, 10), 'FREQ=MONTHLY;BYDAY=SU;BYMONTH=12;INTERVAL=1;COUNT=5', null, 0)))
                .toBe(
                    JSON.stringify([
                        new Date(2022, 11, 4, 10).getTime(), new Date(2022, 11, 11, 10).getTime(),
                        new Date(2022, 11, 18, 10).getTime(), new Date(2022, 11, 25, 10).getTime(),
        ...
        it('Default - Having BYMONTH with multiple BYDAY with start time', () => {
            expect(
                JSON.stringify(generate(new Date(2022, 1, 1, 10), 'FREQ=MONTHLY;BYDAY=SU,MO;INTERVAL=1;COUNT=5', null, 0)))
                .toBe(
                    JSON.stringify([
        ...
        it('Default - BYDAY with start time', () => {
            expect(
                JSON.stringify(generate(new Date(2022, 1, 1, 10), 'FREQ=MONTHLY;INTERVAL=2;COUNT=4;BYDAY=SU,2TU;', null, 0)))
                .toBe(
                    JSON.stringify([
    ...
    describe('Schedule - recurrence Freq- YEARLY', () => {
        ...
        it('Default - BYMONTHDAY without BYMONTH property', () => {
            expect(
                JSON.stringify(generate(startDate,
                    'FREQ=YEARLY;BYMONTHDAY=20,25,28;BYSETPOS=2;COUNT=5', null, 0)))
                .toBe(
                    JSON.stringify([
        ...
        it('Default - BYMONTHDAY without BYMONTH and BYSETPOS', () => {
            expect(
                JSON.stringify(generate(startDate,
                    'FREQ=YEARLY;BYMONTHDAY=12,13;COUNT=5', null, 0)))
                .toBe(
                    JSON.stringify([
                        new Date('Mon May 12 2014 ').getTime(), new Date('Tue May 13 2014 ').getTime(),
                        new Date('Thu Jun 12 2014 ').getTime(), new Date('Fri Jun 13 2014 ').getTime(),
        ...
        it('Default - BYMONTHDAY for Multiple months', () => {
            expect(
                JSON.stringify(generate(startDate,
                    'FREQ=YEARLY;BYMONTHDAY=12,13;BYMONTH=6,7;INTERVAL=1;UNTIL=20140729T000000Z', null, 0)))
                .toBe(
                    JSON.stringify([
                        new Date('Thu Jun 12 2014 ').getTime(), new Date('Fri Jun 13 2014 ').getTime(),
        ...
        it('Default - YearDay With BYSETPOS', () => {
            expect(
                JSON.stringify(generate(startDate,
                    'FREQ=YEARLY;BYYEARDAY=20,28,-45;BYSETPOS=2;COUNT=5', null, 0)))
                .toBe(
                    JSON.stringify([
        ...
        it('Default - YearDay With BYDAY', () => {
            expect(
                JSON.stringify(generate(startDate,
                    'FREQ=YEARLY;INTERVAL=3;COUNT=5;BYYEARDAY=1,100,200;BYDAY=MO', null, 0)))
                .toBe(
                    JSON.stringify([
        ...
        it('Default - WeekNo without day and with BYSETPOS', () => {
            expect(
                JSON.stringify(generate(startDate,
                    'FREQ=YEARLY;BYWEEKNO=20;BYSETPOS=2;COUNT=5', null, 0)))
                .toBe(
                    JSON.stringify([
                        new Date('Mon May 12 2014 ').getTime(), new Date('Mon May 11 2015 ').getTime(),
                        new Date('Mon May 09 2016 ').getTime(), new Date('Mon May 08 2017 ').getTime(),
        ...
        it('Default - WeekNo with day and with BYSETPOS', () => {
            expect(
                JSON.stringify(generate(startDate,
                    'FREQ=YEARLY;BYWEEKNO=-20;BYDAY=MO,TU,WE;BYSETPOS=2;COUNT=5', null, 0)))
                .toBe(
                    JSON.stringify([
    ...
    describe('Schedule - recurrence Freq- YEARLY (Having functionalities)', () => {
        ...
        it('Default - Having BYMONTH and BYSETPOS with start time', () => {
            expect(
                JSON.stringify(generate(new Date(2022, 1, 1, 10), 'FREQ=YEARLY;BYDAY=SU;BYSETPOS=1;BYMONTH=12;INTERVAL=1;COUNT=5', null, 0)))
                .toBe(
                    JSON.stringify([
        ...
        it('Default - BYDAY with start time', () => {
            expect(
                JSON.stringify(generate(new Date(2022, 1, 1, 10), 'FREQ=YEARLY;BYDAY=SU;INTERVAL=1;COUNT=5', null, 0)))
                .toBe(
                    JSON.stringify([
        ...
        it('Default - BYDAY with Mulitple values with start time', () => {
            expect(
                JSON.stringify(generate(new Date(2022, 1, 1, 10), 'FREQ=YEARLY;BYDAY=1SU,-1MO;INTERVAL=1;COUNT=5', null, 0)))
                .toBe(
                    JSON.stringify([
        ...
        it('Default - BYMONTHDAY with multipe value and start time', () => {
            expect(
                JSON.stringify(generate(new Date(2022, 1, 1, 10), 'FREQ=YEARLY;BYMONTHDAY=12,18,23;COUNT=5', null, 0)))
                .toBe(
                    JSON.stringify([
        ...
        it('Default - BYMONTHDAY with start time', () => {
            expect(
                JSON.stringify(generate(new Date(2022, 1, 1, 10), 'FREQ=YEARLY;BYMONTHDAY=13;BYMONTH=12;COUNT=5', null, 0)))
                .toBe(
                    JSON.stringify([
