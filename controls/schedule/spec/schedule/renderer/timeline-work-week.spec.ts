...
import {
    Schedule, CellClickEventArgs, ScheduleModel, TimelineViews, EJ2Instance, TimelineMonth
...
import { triggerMouseEvent, disableScheduleAnimation, createSchedule, createGroupSchedule, destroy } from '../util.spec';
...
describe('Schedule timeline work week view', () => {
    ...
    describe('Start and end hour', () => {
        ...
        it('Checking elements', () => {
            ...
            expect(schObj.element.querySelectorAll('.e-header-row td')[5].innerHTML).
    ...
    describe('Dependent properties', () => {
        ...
        it('width and height', () => {
            schObj = new Schedule({ height: '600px', width: '500px', currentView: 'TimelineWorkWeek', views: ['TimelineDay', 'TimelineWeek', 'TimelineWorkWeek'], selectedDate: new Date(2017, 9, 4) });
            schObj.appendTo('#Schedule');
    ...
    describe('Multi level resource rendering with expanded property', () => {
        ...
        it('More event element checking', () => {
            let moreIndicatorList: Element[] = [].slice.call(schObj.element.querySelectorAll('.e-more-indicator'));
            expect(moreIndicatorList.length).toEqual(11);
            let element: HTMLElement = moreIndicatorList[0] as HTMLElement;
            element.click();
            let morePopup: HTMLElement = schObj.element.querySelector('.e-more-popup-wrapper') as HTMLElement;
            let moreEventList: Element[] = [].slice.call(morePopup.querySelectorAll('.e-more-appointment-wrapper .e-appointment'));
    ...
    describe('Custom work days of Resources in group', () => {
        ...
        it('work hours count', () => {
            ...
            expect((<Element>schObj.element.querySelectorAll('.e-content-table tr')[1].childNodes[15]).classList.contains('e-work-hours')).toEqual(false);
            expect((<Element>schObj.element.querySelectorAll('.e-content-table tr')[1].childNodes[16]).classList.contains('e-work-hours')).toEqual(true);
        });
    });
    ...
    describe('Year, Month, Week, Day, Hour header rows', () => {
        ...
        it('check day rows', () => {
            ...
            expect(headTrs[3].children[0].innerHTML).
                toEqual('<span class="e-header-date e-navigate">Apr 30, Monday</span>');
        ...
        it('navigate next date', (done: Function) => {
            ...
            let dataBound: (args: Object) => void = (args: Object) => {
                ...
                expect(headTrs[3].children[0].getAttribute('colSpan')).toEqual('48');
                expect(headTrs[3].children[0].innerHTML).
                    toEqual('<span class="e-header-date e-navigate">May 7, Monday</span>');
