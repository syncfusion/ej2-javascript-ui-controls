...
describe('EJ2-38768-Expand Collapse with Frozen Columns less than TreeColumnIndex', () => {
  let gridObj: TreeGrid; 
  beforeAll((done: Function) => {
  ...
  it('check expand collapse for Frozen Columns less than TreeColumnIndex', () => {     
      gridObj.collapseRow(gridObj.grid.getMovableRows()[11] as HTMLTableRowElement, gridObj.grid.currentViewData[11]);      
      expect((gridObj.getMovableRows()[12] as HTMLTableRowElement).style.display).toBe('none');
      expect((gridObj.getMovableRows()[13] as HTMLTableRowElement).style.display).toBe('none');
      expect((gridObj.getMovableRows()[14] as HTMLTableRowElement).style.display).toBe('none');
      expect((gridObj.getMovableRows()[20] as HTMLTableRowElement).style.display).toBe('none');
      expect((gridObj.getMovableRows()[21] as HTMLTableRowElement).style.display).toBe('none');
      expect((gridObj.getMovableRows()[22] as HTMLTableRowElement).style.display).toBe('none');
      expect((gridObj.getMovableRows()[28] as HTMLTableRowElement).style.display).toBe('none');
      expect((gridObj.getMovableRows()[29] as HTMLTableRowElement).style.display).toBe('none');
      expect((gridObj.getMovableRows()[30] as HTMLTableRowElement).style.display).toBe('none');
      expect((gridObj.getRows()[12] as HTMLTableRowElement).style.display).toBe('none');
      expect((gridObj.getRows()[13] as HTMLTableRowElement).style.display).toBe('none');
      expect((gridObj.getRows()[14] as HTMLTableRowElement).style.display).toBe('none');
      expect((gridObj.getRows()[20] as HTMLTableRowElement).style.display).toBe('none');
      expect((gridObj.getRows()[21] as HTMLTableRowElement).style.display).toBe('none');
      expect((gridObj.getRows()[22] as HTMLTableRowElement).style.display).toBe('none');
      expect((gridObj.getRows()[28] as HTMLTableRowElement).style.display).toBe('none');
      expect((gridObj.getRows()[29] as HTMLTableRowElement).style.display).toBe('none');
      expect((gridObj.getRows()[30] as HTMLTableRowElement).style.display).toBe('none');
      gridObj.expandRow(gridObj.grid.getMovableRows()[11] as HTMLTableRowElement, gridObj.grid.currentViewData[11]);
      expect((gridObj.getMovableRows()[12] as HTMLTableRowElement).style.display).toBe('table-row');
      expect((gridObj.getMovableRows()[13] as HTMLTableRowElement).style.display).toBe('table-row');
      expect((gridObj.getMovableRows()[14] as HTMLTableRowElement).style.display).toBe('table-row');
      expect((gridObj.getMovableRows()[20] as HTMLTableRowElement).style.display).toBe('table-row');
      expect((gridObj.getMovableRows()[21] as HTMLTableRowElement).style.display).toBe('table-row');
      expect((gridObj.getMovableRows()[22] as HTMLTableRowElement).style.display).toBe('table-row');
      expect((gridObj.getMovableRows()[28] as HTMLTableRowElement).style.display).toBe('table-row');
      expect((gridObj.getMovableRows()[29] as HTMLTableRowElement).style.display).toBe('table-row');
      expect((gridObj.getMovableRows()[30] as HTMLTableRowElement).style.display).toBe('table-row');
      expect((gridObj.getRows()[12] as HTMLTableRowElement).style.display).toBe('table-row');
      expect((gridObj.getRows()[13] as HTMLTableRowElement).style.display).toBe('table-row');
      expect((gridObj.getRows()[14] as HTMLTableRowElement).style.display).toBe('table-row');
      expect((gridObj.getRows()[20] as HTMLTableRowElement).style.display).toBe('table-row');
      expect((gridObj.getRows()[21] as HTMLTableRowElement).style.display).toBe('table-row');
      expect((gridObj.getRows()[22] as HTMLTableRowElement).style.display).toBe('table-row');
      expect((gridObj.getRows()[28] as HTMLTableRowElement).style.display).toBe('table-row');
      expect((gridObj.getRows()[29] as HTMLTableRowElement).style.display).toBe('table-row');
      expect((gridObj.getRows()[30] as HTMLTableRowElement).style.display).toBe('table-row');
   });
      afterAll(() => {
      destroy(gridObj);
    });
