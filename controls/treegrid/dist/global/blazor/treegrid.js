        ...
        for (var i = 0; i < column.length; i++) {
            ...
            if (typeof this.columns[i] === 'string') {
                ...
                for (var _i = 0, _a = Object.keys(column[i]); _i < _a.length; _i++) {
                    var prop = _a[_i];
                    if (i === this.treeColumnIndex && prop === 'template' && !sf.base.isBlazor()) {
...
var RowDD$1 = /** @class */ (function () {
    ...
    RowDD$$1.prototype.rowsAdded = function (e) {
        ...
        if (sf.base.isNullOrUndefined(this.parent.dataSource) || !this.parent.dataSource.length) {
            ...
            for (var i = dragLength - 1; i > -1; i--) {
                ...
                if (!sf.base.isNullOrUndefined(draggedRecord_1.taskData) &&
    ...
    RowDD$$1.prototype.dragDropGrid = function (args) {
        ...
        if (dropElement && dropElement.id === this.parent.rowDropSettings.targetID && !isRemoteData(this.parent)
            ...
            if (this.parent.idMapping != null && (sf.base.isNullOrUndefined(this.dropPosition) || this.dropPosition === 'bottomSegment')) {
                var actualData = [];
                for (var i = 0; i < records.length; i++) {
            ...
            for (var i = 0; i < dragLength; i++) {
                ...
                if (this.dropPosition !== 'Invalid') {
                    ...
                    if (this.dropPosition === 'bottomSegment') {
                        ...
                        if (draggedRecord.hasChildRecords && sf.base.isNullOrUndefined(this.parent.idMapping)) {
                            var level = 1;
...
var PdfExport$1 = /** @class */ (function () {
    ...
    isMultipleExport, pdfDoc, isBlob) {
        ...
        return new Promise(function (resolve, reject) {
            var dm = isLocal && !(dtSrc instanceof sf.data.DataManager) ? new sf.data.DataManager(dtSrc) : _this.parent.dataSource;
            var query = new sf.data.Query();
            if (!isLocal) {
                query = _this.generateQuery(query);
    ...
    Aggregate$$1.prototype.calculateSummaryValue = function (summaryQuery, filteredData, isSort) {
        ...
        if (this.parent.aggregates.filter(function (x) { return x.showChildSummary; }).length) {
            ...
            for (var columnIndex = 0, length_1 = columnLength; columnIndex < length_1; columnIndex++) {
                var fields = sf.base.isNullOrUndefined(sf.grids.getObject('field', this.parent.columns[columnIndex])) ?
                    this.parent.columns[columnIndex] : sf.grids.getObject('field', this.parent.columns[columnIndex]);
                items[fields] = null;
            }
