...
/** @hidden */
export const expanding: string = 'expanding';
/** @hidden */
export const collapsed: string = 'collapsed';
/** @hidden */
export const collapsing: string = 'collapsing';
/** @hidden */
export const remoteExpand: string = 'remoteExpand';
/** @hidden */
export const localPagedExpandCollapse: string = 'localPagedExpandCollapse';
/** @hidden */
export const pagingActions: string = 'pagingActions';
/** @hidden */
...
/** @hidden */
export const beginAdd: string = 'beginAdd';
/** @hidden */
...
/** @hidden */
export const batchSave: string = 'batchSave';
/** @hidden */
