...
describe('DropDownButton', () => {
    ...
    describe('DOM', () => {
        ...
        it('Add items & Remove items testing', () => {
            ...
            drpButton.addItems([{ text: 'Insert' }, { text: 'Attach' }], 'Attach');
        });
    ...
    describe('Property', () => {
        ...
        it('popupWidth', () => {
            drpButton = new DropDownButton({ popupWidth: '40px' });
            drpButton.appendTo('#drp-button');
    ...
    describe('Dropdown Button Template testing', () => {
        afterEach(() => {
            drpButton.destroy();
        });
        ...
        it('DropDownButton with items', () => {
            ...
            drpButton = new DropDownButton({items: items, itemTemplate:  "<span class='ename'>${text}</span>", animationSettings: { duration: 1000, easing: 'ease', effect: 'SlideDown' },  beforeItemRender: (args: MenuEventArgs) => {
