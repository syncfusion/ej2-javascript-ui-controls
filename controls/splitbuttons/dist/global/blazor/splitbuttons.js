window.sf = window.sf || {};
window.sf.splitbuttons = (function (exports) {
'use strict';
...
var dropDownButtonObserver = new sf.base.Observer();
var classNames = {
    DISABLED: 'e-disabled',
    FOCUS: 'e-focused',
    ICON: 'e-menu-icon',
...
var DropDownButton = /** @class */ (function (_super) {
    ...
    DropDownButton.prototype.render = function () {
        if (sf.base.isBlazor() && this.isServerRendered) {
            sf.buttons.buttonObserver.on('component-rendered', this.buttonRendered, this, this.element.id);
            this.createPopup();
    ...
    DropDownButton.prototype.buttonRendered = function (args) {
        if (this.element.id === args.instance.element.id) {
            ...
            sf.buttons.buttonObserver.off('component-rendered', this.buttonRendered, this.element.id);
        }
    };
    /**
    ...
    DropDownButton.prototype.upDownKeyHandler = function (e) {
        ...
        if (liIdx !== -1) {
            sf.base.addClass([ul.children[liIdx]], classNames.FOCUS);
...
var SplitButton = /** @class */ (function (_super) {
    ...
    SplitButton.prototype.render = function () {
        if (sf.base.isBlazor() && this.isServerRendered) {
            sf.buttons.buttonObserver.on('component-rendered', this.buttonInstance, this, this.element.id);
    ...
    SplitButton.prototype.buttonInstance = function (args) {
        if (this.element.id === args.instance.element.id) {
            ...
            sf.buttons.buttonObserver.off('component-rendered', this.buttonInstance, this.element.id);
        }
    };
...
function createButtonGroup(selector, options, createElement$$1) {
    ...
    var nextChild;
    var btnModel;
    if (sf.base.isNullOrUndefined(createElement$$1)) {
        createElement$$1 = sf.base.createElement;
    }
    var wrapper = document.querySelector(selector);
    sf.base.addClass([wrapper], ['e-btn-group', 'e-css']);
    ...
    for (var i = 0, j = 0; j < childs.length; i++, j++) {
        ...
        if (btnModel !== null) {
            ...
            new sf.buttons.Button(btnModel || {}, btnElem);
        }
    }
    return wrapper;
}
...
exports.Item = Item;
exports.dropDownButtonObserver = dropDownButtonObserver;
...
sfBlazor.loadDependencies(sfBlazor.dependencyJson.splitbuttons, () => {
    sf.splitbuttons = sf.splitbuttons({});
});
