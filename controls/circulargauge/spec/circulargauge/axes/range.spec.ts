    ...
    describe('Gauge axis Range with tick and labels', () => {
        ...
        it('Checking major tick lines range color', (done: Function) => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                ...
                svg = document.getElementById('container_Axis_Major_TickLine_0_8');
        ...
        it('Checking minor tick lines range color', (done: Function) => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                ...
                expect(svg.getAttribute('stroke') == 'red');
                expect(svg.getAttribute('fill') == 'red');
                svg = document.getElementById('container_Axis_Minor_TickLine_0_8');
                expect(svg.getAttribute('stroke') == 'green');
                expect(svg.getAttribute('fill') == 'green');
                done();
            };
        ...
        it('Checking major tick lines range color within the range', (done: Function) => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                ...
                expect(svg.getAttribute('stroke') == 'green');
                expect(svg.getAttribute('fill') == 'green');
                svg = document.getElementById('container_Axis_Major_TickLine_0_9');
                expect(svg.getAttribute('stroke') == '#b5b5b5');
                expect(svg.getAttribute('fill') == '#b5b5b5');
                done();
            };
        ...
        it('Checking minor tick lines range color  within the range', (done: Function) => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                ...
                expect(svg.getAttribute('stroke') == 'red');
                expect(svg.getAttribute('fill') == 'red');
                svg = document.getElementById('container_Axis_Minor_TickLine_0_7');
                expect(svg.getAttribute('stroke') == 'green');
                expect(svg.getAttribute('fill') == 'green');
                svg = document.getElementById('container_Axis_Minor_TickLine_0_9');
                expect(svg.getAttribute('stroke') == '#b5b5b5');
                expect(svg.getAttribute('fill') == '#b5b5b5');
                done();
            };
    ...
    describe('Checking range position with position property', () => {
        ...
        it('Checking with default axis range radius', (done: Function) => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Range_0');
                value = svg.getAttribute('d').split(' ');
                expect(value[1] == '311.3076893283069' || value[1] == '301.3076893283069' || value[1] == '305.8076893283069' || value[1] == '292.3076893283069').toBe(true);
                expect(value[5]).toBe('214');
                expect(value[9] == '271.0972774540941' || value[9] == '261.0972774540941' || value[9] == '265.5972774540941' || value[9] == '252.09727745409413').toBe(true);
                done();
            };
            gauge.refresh();
        });
        ...
        it('Checking range position of inside', (done: Function) => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                ...
                expect(value[9] == '271.62719671832735' || value[9] == '261.62719671832735' || value[9] == '266.12719671832735' || value[9] == '252.62719671832733').toBe(true);
                done();
            };
        ...
        it('Checking range position of outside', (done: Function) => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Range_0');
                value = svg.getAttribute('d').split(' ');
                expect(value[1] == '310.9656691849812' || value[1] == '300.9656691849812' || value[1] == '305.4656691849812' || value[1] == '291.9656691849812').toBe(true);
                expect(value[5]).toBe('215');
                expect(value[9] == '270.5673581898609' || value[9] == '260.5673581898609' || value[9] == '265.0673581898609' || value[9] == '251.56735818986093').toBe(true);
                done();
            };
        ...
        it('Checking range position of Cross', (done: Function) => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Range_0');
                value = svg.getAttribute('d').split(' ');
                expect(value[1] == '309.59758861167853' || value[1] == '299.59758861167853' || value[1] == '304.09758861167853' || value[1] == '290.59758861167853').toBe(true);
                expect(value[5]).toBe('224');
                expect(value[9] == '263.14848849059604' || value[9] == '253.14848849059604' || value[9] == '257.64848849059604' || value[9] == '244.14848849059604').toBe(true);
                done();
            };
        ...
        it('Checking range position of cross with offset in percentage', (done: Function) => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Range_0');
                value = svg.getAttribute('d').split(' ');
                expect(value[1] == '324.23605074601716' || value[1] == '314.23605074601716' || value[1] == '318.73605074601716' || value[1] == '305.23605074601716').toBe(true);
                expect(value[5]).toBe('181.2');
                expect(value[9] == '285.8290329997772' || value[9] == '275.8290329997772' || value[9] == '280.3290329997772' || value[9] == '266.8290329997772').toBe(true);
                done();
            };
            gauge.axes[0].ranges[0].position = 'Cross';
        ...
        it('Checking range position of cross with offset as number', (done: Function) => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Range_0');
                value = svg.getAttribute('d').split(' ');
                expect(value[1] == '304.1252663184679' || value[1] == '294.1252663184679' || value[1] == '298.6252663184679' || value[1] == '285.1252663184679').toBe(true);
                expect(value[5]).toBe('235');
                expect(value[9] == '259.96897290519684' || value[9] == '249.96897290519684' || value[9] == '254.46897290519684' || value[9] == '240.96897290519684').toBe(true);
                done();
            };
            gauge.axes[0].ranges[0].position = 'Outside';
            gauge.axes[0].ranges[0].offset = 20;
        ...
        it('Checking range position of cross with offset in pixel', (done: Function) => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Range_0');
                value = svg.getAttribute('d').split(' ');
                expect(value[1] == '318.49011233814593' || value[1] == '308.49011233814593' || value[1] == '312.99011233814593' || value[1] == '299.49011233814593').toBe(true);
                expect(value[5]).toBe('193');
                expect(value[9] == '282.2255820029914' || value[9] == '272.2255820029914' || value[9] == '276.7255820029914' || value[9] == '263.2255820029914').toBe(true);
                done();
            };
            gauge.axes[0].ranges[0].position = 'Inside';
    ...
    describe('Checking the behaviour of range in the presence of range bar pointer', () => {
        ...
        it('Checking startwidth and endwidth are different for different angles', (done: Function) => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                ...
                value === 'M 378.99999999999994 21.5 A 203.5 203.5 0 1 1 216.47767370537588 102.53064278855823 L 240.43673900679465 120.58509348311966 A 163.5 163.5 0 1 0 378.99999999999994 61.5 Z' ||
                value === 'M 374.49999999999994 21.5 A 203.5 203.5 0 1 1 211.97767370537588 102.53064278855823 L 235.93673900679465 120.58509348311966 A 163.5 163.5 0 1 0 374.49999999999994 61.5 Z' ||
                value === 'M 365.49999999999994 21.5 A 203.5 203.5 0 1 1 202.97767370537588 102.53064278855823 L 226.93673900679465 120.58509348311966 A 163.5 163.5 0 1 0 365.49999999999994 61.5 Z').toBe(true);
                done();
            };
        ...
        it('Checking startwidth and endwidth are same for different angles', (done: Function) => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                ...
                || value === 'M 378.99999999999994 21.5 A 203.5 203.5 0 1 1 378.9996448254972 21.500000000309967 L 378.99969718537477 51.500000000264265 A 173.5 173.5 0 1 0 378.99999999999994 51.5 Z'
                || value === 'M 374.49999999999994 21.5 A 203.5 203.5 0 1 1 374.4996448254972 21.500000000309967 L 374.49969718537477 51.500000000264265 A 173.5 173.5 0 1 0 374.49999999999994 51.5 Z'
                || value === 'M 365.49999999999994 21.5 A 203.5 203.5 0 1 1 365.4996448254972 21.500000000309967 L 365.49969718537477 51.500000000264265 A 173.5 173.5 0 1 0 365.49999999999994 51.5 Z').toBe(true);
                done();
            };
            gauge.axes[0].startAngle = 0;
        ...
        it('Checking startwidth and endwidth are different for different angles with AntiClockWise Direction', (done: Function) => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                ...
                || value === 'M 378.99999999999994 21.5 A 203.5 203.5 0 1 1 202.76383032986675 123.24999999999997 L 237.40484648124428 143.25 A 163.5 163.5 0 1 0 378.99999999999994 51.5 Z'
                || value === 'M 374.49999999999994 21.5 A 203.5 203.5 0 1 1 198.26383032986675 123.24999999999997 L 232.90484648124428 143.25 A 163.5 163.5 0 1 0 374.49999999999994 51.5 Z'
                || value === 'M 365.49999999999994 21.5 A 203.5 203.5 0 1 1 189.26383032986675 123.24999999999997 L 223.90484648124428 143.25 A 163.5 163.5 0 1 0 365.49999999999994 51.5 Z').toBe(true);
                done();
            };
            gauge.axes[0].startAngle = 0;
        ...
        it('Checking startwidth and endwidth are different for different angles with Range Position as Outside', (done: Function) => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                ...
                value === 'M 378.99999999999994 21.5 A 203.5 203.5 0 1 1 202.76383032986675 123.24999999999997 L 176.7830682163336 103.24999999999997 A 278.5 278.5 0 1 0 378.99999999999994 -18.5 Z' ||
                value === 'M 374.49999999999994 21.5 A 203.5 203.5 0 1 1 198.26383032986675 123.24999999999997 L 172.2830682163336 103.24999999999997 A 278.5 278.5 0 1 0 374.49999999999994 -18.5 Z' ||
                value === 'M 365.49999999999994 21.5 A 203.5 203.5 0 1 1 189.26383032986675 123.24999999999997 L 163.2830682163336 103.24999999999997 A 278.5 278.5 0 1 0 365.49999999999994 -18.5 Z').toBe(true);
                done();
            };
            gauge.axes[0].startAngle = 0;
            gauge.axes[0].endAngle = 300;
        ...
        it('Checking startwidth and endwidth are different for different angles with Range Position as Outside in AntiCLockWise direction', (done: Function) => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                ...
                value === 'M 378.99999999999994 21.5 A 203.5 203.5 0 1 1 202.76383032986675 123.24999999999997 L 168.1228141784892 123.24999999999997 A 278.5 278.5 0 1 0 378.99999999999994 -8.5 Z' ||
                value === 'M 374.49999999999994 21.5 A 203.5 203.5 0 1 1 198.26383032986675 123.24999999999997 L 163.6228141784892 123.24999999999997 A 278.5 278.5 0 1 0 374.49999999999994 -8.5 Z' ||
                value === 'M 365.49999999999994 21.5 A 203.5 203.5 0 1 1 189.26383032986675 123.24999999999997 L 154.6228141784892 123.24999999999997 A 278.5 278.5 0 1 0 365.49999999999994 -8.5 Z').toBe(true);
                done();
            };
            gauge.axes[0].startAngle = 0;
            gauge.axes[0].endAngle = 300;
        ...
        it('Checking startwidth and endwidth are different for different angles with Range Position as Cross', (done: Function) => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                ...
                || value === 'M 374.49999999999994 21.5 A 201 201 0 1 1 202.59395734878893 125.74999999999997 L 228.5747194623221 140.75 A 153.5 163.5 0 1 0 374.49999999999994 61.5 Z'
                || value === 'M 374.49999999999994 21.5 A 203.5 203.5 0 1 1 198.26383032986675 123.24999999999997 L 163.6228141784892 123.24999999999997 A 278.5 278.5 0 1 0 374.49999999999994 -8.5 Z'
                || value === 'M 365.49999999999994 21.5 A 201 201 0 1 1 193.59395734878893 125.74999999999997 L 219.5747194623221 140.75 A 153.5 163.5 0 1 0 365.49999999999994 61.5 Z').toBe(true);
                done();
            };
        ...
        it('Checking startwidth and endwidth are different for different angles with Range Position as Cross in AntiCLockWise Direction', (done: Function) => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                ...
                || value === 'M 378.99999999999994 26.5 A 201 201 0 1 1 202.76383032986675 123.24999999999997 L 237.40484648124428 143.25 A 156 166 0 1 0 378.99999999999994 56.5 Z'
                || value === 'M 374.49999999999994 26.5 A 201 201 0 1 1 198.26383032986675 123.24999999999997 L 232.90484648124428 143.25 A 156 166 0 1 0 374.49999999999994 56.5 Z'
                || value === 'M 365.49999999999994 26.5 A 201 201 0 1 1 189.26383032986675 123.24999999999997 L 223.90484648124428 143.25 A 156 166 0 1 0 365.49999999999994 56.5 Z').toBe(true);
                done();
            };
            gauge.axes[0].startAngle = 0;
            gauge.axes[0].endAngle = 300;
