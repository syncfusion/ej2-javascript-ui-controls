...
describe('Circular-Gauge Control', () => {
    ...
    describe('Checking the theme in', () => {
        ...
        it('Major tick Fluent2 color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_Major_TickLine_0_0');
                expect(svg.getAttribute('stroke')).toBe('#C8C6C4');
            };
            gauge.refresh();
        });
        it('Minor Fluent2 color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_Minor_TickLine_0_1');
                expect(svg.getAttribute('stroke')).toBe('#C8C6C4');
            };
        ...
        it('AxisLine Fluent2 color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_AxisLine_0');
                expect(svg.getAttribute('stroke')).toBe('#EDEBE9');
            };
            gauge.refresh();
        });
        it('Axis label Fluent2 color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Label_0');
                expect(svg.getAttribute('fill')).toBe('#242424');
            };
            gauge.refresh();
        });
        it('Axis label font family Fluent2 color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Label_0');
                expect(svg.style.fontFamily).toBe('"Segoe UI"');
            };
            gauge.refresh();
        });
        it('Background Fluent2 color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_CircularGaugeBorder');
        ...
        it('Title font size Fluent2 color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_CircularGaugeTitle');
        ...
        it('Needle cap Fluent2 color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Pointer_NeedleCap_0');
                expect(svg.getAttribute('fill')).toBe('#A19F9D');
            };
            gauge.refresh();
        });
        it('Needle Fluent2 color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Pointer_Needle_0');
                expect(svg.getAttribute('fill')).toBe('#A19F9D');
            };
        ...
        it('Needle Fluent2 default color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Pointer_NeedleTail_0');
                expect(svg.getAttribute('fill')).toBe('#A19F9D');
            };
        ...
        it('tooltip Fluent2 color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Pointer_NeedleRect_0');
                debugger;
                trigger.mousemoveEvent(svg, 202.125, 233, 151.875, 7);
                let tooltip: Element = document.getElementById('container_CircularGauge_Tooltip_text')
                expect(tooltip.getAttribute('font-family')).toBe('Segoe UI');
            };
            gauge.refresh();
        });
        it('tooltip text color Fluent2 color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Pointer_NeedleRect_0');
                debugger;
                trigger.mousemoveEvent(svg, 202.125, 233, 151.875, 7);
                let tooltip: Element = document.getElementById('container_CircularGauge_Tooltip_text')
                expect(tooltip.querySelector('tspan').getAttribute('fill')).toBe('#242424');
            };
            gauge.refresh();
        });
        it('tooltip fill  Fluent2 color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Pointer_NeedleRect_0');
                debugger;
                trigger.mousemoveEvent(svg, 202.125, 233, 151.875, 7);
        ...
        it('tooltip opacity  Fluent2 color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Pointer_NeedleRect_0');
                debugger;
                trigger.mousemoveEvent(svg, 202.125, 233, 151.875, 7);
    ...
    describe('Checking the theme in', () => {
        ...
        it('Major tick Fluent2Dark color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_Major_TickLine_0_0');
                expect(svg.getAttribute('stroke')).toBe('#484644');
            };
            gauge.refresh();
        });
        it('Minor Fluent2Dark color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_Minor_TickLine_0_1');
                expect(svg.getAttribute('stroke')).toBe('#484644');
            };
        ...
        it('AxisLine Fluent2Dark color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_AxisLine_0');
                expect(svg.getAttribute('stroke')).toBe('#292827');
            };
            gauge.refresh();
        });
        it('Axis label Fluent2Dark color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Label_0');
                expect(svg.getAttribute('fill')).toBe('#FFFFFF');
            };
        ...
        it('Axis label font family Fluent2Dark color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Label_0');
                expect(svg.style.fontFamily).toBe('"Segoe UI"');
            };
        ...
        it('Background Fluent2Dark color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_CircularGaugeBorder');
                expect(svg.getAttribute('fill')).toBe('transparent');
            };
        ...
        it('Title Fluent2Dark color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_CircularGaugeTitle');
                expect(svg.getAttribute('fill')).toBe('#FFFFFF');
            };
        ...
        it('Title font size Fluent2Dark color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_CircularGaugeTitle');
                expect(svg.style.fontSize).toBe('14px');
            };
        ...
        it('Needle cap Fluent2Dark color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Pointer_NeedleCap_0');
                expect(svg.getAttribute('fill')).toBe('#8A8886');
            };
            gauge.refresh();
        });
        it('Needle Fluent2Dark color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Pointer_Needle_0');
                expect(svg.getAttribute('fill')).toBe('#8A8886');
            };
        ...
        it('Needle Fluent2Dark default color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Pointer_NeedleTail_0');
                expect(svg.getAttribute('fill')).toBe('#8A8886');
            };
        ...
        it('tooltip Fluent2Dark color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Pointer_NeedleRect_0');
                debugger;
                trigger.mousemoveEvent(svg, 202.125, 233, 151.875, 7);
        ...
        it('tooltip text color Fluent2Dark color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Pointer_NeedleRect_0');
                debugger;
                trigger.mousemoveEvent(svg, 202.125, 233, 151.875, 7);
        ...
        it('tooltip fill  Fluent2Dark color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Pointer_NeedleRect_0');
                debugger;
                trigger.mousemoveEvent(svg, 202.125, 233, 151.875, 7);
                let tooltip: Element = document.getElementById('container_CircularGauge_Tooltip_path')
                expect(tooltip.getAttribute('fill')).toBe('#292929');
            };
            gauge.refresh();
        });
        it('tooltip opacity  Fluent2Dark color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Pointer_NeedleRect_0');
                debugger;
                trigger.mousemoveEvent(svg, 202.125, 233, 151.875, 7);
        ...
        it('pointer Fluent2Dark color', (): void => {
            gauge.loaded = (args: ILoadedEventArgs): void => {
                svg = document.getElementById('container_Axis_0_Pointer_RangeBar_0');
                expect(svg.getAttribute('fill')).toBe('#8A8886');
            };
