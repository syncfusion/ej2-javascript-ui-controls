...
document.getElementById('labelOffset').onpointermove = document.getElementById('labelOffset').ontouchmove =
    ...
    document.getElementById('showlastlabel').onchange = () => {
        let lastlabel = <HTMLInputElement>document.getElementById('showlastlabel');
        circulargauge.axes[0].showLastLabel = lastlabel.checked;
        circulargauge.refresh();
    };