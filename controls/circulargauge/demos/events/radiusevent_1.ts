import { CircularGauge, Annotations, Legend, Alignment, GaugeShape, LegendPosition ,IRadiusCalculateEventArgs} from '../../src/index';
...
let circulargauge: CircularGauge = new CircularGauge({
    ...
    radiusCalculate: function (args: IRadiusCalculateEventArgs) {
        args.currentRadius = 80;
