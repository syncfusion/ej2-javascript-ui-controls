import { CircularGauge, Annotations, Legend, Alignment, GaugeShape, LegendPosition ,IMouseEventArgs} from '../../src/index';
...
let circulargauge: CircularGauge = new CircularGauge({
    ...
    gaugeMouseMove: function (args: IMouseEventArgs) {
       args.x = 90;
       args.y = 30;
    }
});
