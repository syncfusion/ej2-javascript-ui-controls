    ...
    let circulargauge: CircularGauge = new CircularGauge({
        ...
        axes: [{
            ...
            labelStyle: {
                ...
                font: { size: '18px', color: 'blue', fontFamily: 'Roboto', fontStyle: 'Regular' }
            ...
            ranges: [{ start: 0, end: 40, color: 'teal' }, { start: 40, end: 80, color: 'purple' },
            { start: 80, end: 120, color: 'orange' }],
            pointers: [{
