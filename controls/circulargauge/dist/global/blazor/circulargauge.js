window.sf = window.sf || {};
window.sf.circulargauge = (function (exports) {
'use strict';
        ...
        if (type === 'SVG') {
            ...
            image_1.onload = (function () {
                ...
                if (type === 'PDF') {
                    ...
                    document_1.pages.add().graphics.drawImage(new sf.pdfexport.PdfBitmap(imageString), 0, 0, _this.control.availableSize.width, _this.control.availableSize.height);
                    if (isDownload) {
...
CircularGauge.Inject(GaugeTooltip, Annotations, Legend);
...
sfBlazor.loadDependencies(sfBlazor.dependencyJson.circulargauge, () => {
    sf.circulargauge = sf.circulargauge({});
});
