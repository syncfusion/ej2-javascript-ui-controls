window.sf = window.sf || {};
var sfcirculargauge = (function (exports) {
'use strict';
...
function measureText(text, font) {
    ...
    if (htmlObject === null) {
        htmlObject = sf.base.createElement('text', { id: 'gauge-measuretext' });
...
function getPathArc(center, start, end, radius, startWidth, endWidth, range, axis) {
    ...
    var startRadius = !sf.base.isNullOrUndefined(range) ? (range.position === 'Outside' ? radius + startWidth : range.position === 'Cross'
        && axis.direction === 'AntiClockWise' ? radius - (endWidth + startWidth) / 2 : radius - startWidth) : radius - startWidth;
    var endRadius = !sf.base.isNullOrUndefined(range) ? (range.position === 'Outside' ? radius + endWidth : range.position === 'Cross' &&
        axis.direction === 'ClockWise' ? radius - (endWidth + startWidth) / 2 : radius - endWidth) : radius - endWidth;
    var arcRadius = !sf.base.isNullOrUndefined(range) ? (range.position === 'Outside' ? radius + ((startWidth + endWidth) / 2) :
    ...
    var insideArcRadius = !sf.base.isNullOrUndefined(range) && range.position === 'Cross' ?
        radius + ((startWidth + endWidth) / 4) - (axis.direction === 'ClockWise' ? startWidth : endWidth) / 2 : radius;
    var insideEndRadius = !sf.base.isNullOrUndefined(range) && range.position === 'Cross' && axis.direction === 'ClockWise' ?
        radius - ((startWidth - endWidth) / 2) : radius;
    var insideStartRadius = !sf.base.isNullOrUndefined(range) && range.position === 'Cross' && axis.direction === 'AntiClockWise' ?
        radius + ((startWidth - endWidth) / 2) : radius;
...
var TooltipSettings = /** @class */ (function (_super) {
    ...
    __decorate$1([
        sf.base.Complex({}, RangeTooltip)
    ], TooltipSettings.prototype, "rangeSettings", void 0);
    __decorate$1([
        sf.base.Complex({}, AnnotationTooltip)
...
var Cap = /** @class */ (function (_super) {
    ...
    __decorate$2([
        sf.base.Complex({ color: null, width: 8 }, Border)
...
var Annotation = /** @class */ (function (_super) {
    ...
    __decorate$2([
        sf.base.Complex({ size: '12px', color: '#686868' }, Font)
...
var AxisRenderer = /** @class */ (function () {
    ...
    AxisRenderer.prototype.calculateRangeRadiusWithPosition = function (axis, range, startWidth) {
        var actualRadius;
        actualRadius = !sf.base.isNullOrUndefined(range.position) && range.position !== 'Auto' && sf.base.isNullOrUndefined(range.radius) ?
...
var PointerRenderer = /** @class */ (function () {
    ...
    PointerRenderer.prototype.calculatePointerRadius = function (axis, pointer) {
        var padding = 5;
        pointer.currentRadius = !sf.base.isNullOrUndefined(pointer.radius) ?
    ...
    PointerRenderer.prototype.drawMarkerPointer = function (axis, axisIndex, index, parentElement, gauge) {
        ...
        if (sf.base.isNullOrUndefined(pointer.radius) && !sf.base.isNullOrUndefined(pointer.position) && (pointer.markerShape === 'InvertedTriangle' ||
    ...
    AxisLayoutPanel.prototype.calculateAxesRadius = function () {
        ...
        var _loop_1 = function (axis) {
            ...
            if (this_1.gauge.moveToCenter && this_1.gauge.axes.length === 1 &&
                sf.base.isNullOrUndefined(this_1.gauge.centerX) && sf.base.isNullOrUndefined(this_1.gauge.centerY)) {
                ...
                if (startAngle > endAngle ? Math.abs(startAngle - endAngle) > 90 ? true : false : true) {
                    ...
                    if ((!sf.base.isNullOrUndefined(startXDiff) && !sf.base.isNullOrUndefined(endXDiff) && !sf.base.isNullOrUndefined(startYDiff) &&
                        !sf.base.isNullOrUndefined(endYDiff)) && ((startXDiff > 0 || endXDiff > 0) && (startYDiff > 0 || endYDiff > 0))) {
        ...
        var promise = new Promise(function (resolve, reject) {
            ...
            image.onload = (function () {
                ...
                document.pages.add().graphics.
                    drawImage(new sf.pdfexport.PdfBitmap(imageString), 0, 0, _this.control.availableSize.width, _this.control.availableSize.height);
                if (allowDownload) {
...
var LinearGradient = /** @class */ (function (_super) {
    ...
    __decorate$4([
        sf.base.Collection([{ color: '#000000', opacity: 1, offset: '0%', style: '' }], ColorStop)
...
var RadialGradient = /** @class */ (function (_super) {
    ...
    __decorate$4([
        sf.base.Complex({ x: '0%', y: '0%' }, GradientPosition)
...
var CircularGauge = /** @class */ (function (_super) {
    ...
    CircularGauge.prototype.calculateBounds = function () {
        ...
        if (this.moveToCenter && this.axes.length === 1 &&
            sf.base.isNullOrUndefined(this.centerX) && sf.base.isNullOrUndefined(this.centerY)) {
    ...
    CircularGauge.prototype.onPropertyChanged = function (newProp, oldProp) {
        ...
        var isPointerValueSame = (Object.keys(newProp).length === 1 && newProp instanceof Object &&
            !sf.base.isNullOrUndefined(this.activePointer));
...
sfBlazor.loadDependencies(sfBlazor.dependencyJson.circulargauge, () => {
