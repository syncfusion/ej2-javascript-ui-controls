...
export const CARD_CONTAINER_CLASS: string = 'e-card-container';
...
export const MULTI_CARD_CONTAINER_CLASS: string = 'e-multi-card-container';

export const LIMITS_CLASS: string = 'e-limits';

export const SHOW_ADD_FOCUS: string = 'e-show-add-focus';

export const POPUP_CONTAINER_CLASS: string = 'e-mobile-popup-container';
