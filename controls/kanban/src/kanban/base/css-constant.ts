 ...
 */
/** @hidden */
export const ROOT_CLASS: string = 'e-kanban';
/** @hidden */
export const RTL_CLASS: string = 'e-rtl';
/** @hidden */
export const DEVICE_CLASS: string = 'e-device';
/** @hidden */
export const ICON_CLASS: string = 'e-icons';
/** @hidden */
export const TEMPLATE_CLASS: string = 'e-template';
/** @hidden */
export const SWIMLANE_CLASS: string = 'e-swimlane';
/** @hidden */
export const TABLE_CLASS: string = 'e-kanban-table';
/** @hidden */
export const HEADER_CLASS: string = 'e-kanban-header';
/** @hidden */
export const HEADER_TABLE_CLASS: string = 'e-header-table';
/** @hidden */
...
/** @hidden */
export const CONTENT_CLASS: string = 'e-kanban-content';
/** @hidden */
export const CONTENT_TABLE_CLASS: string = 'e-content-table';
/** @hidden */
export const HEADER_ROW_TOGGLE_CLASS: string = 'e-toggle-header';
/** @hidden */
export const HEADER_ROW_CLASS: string = 'e-header-row';
/** @hidden */
export const CONTENT_ROW_CLASS: string = 'e-content-row';
/** @hidden */
...
/** @hidden */
export const FORM_WRAPPER_CLASS: string = 'e-kanban-form-wrapper';
/** @hidden */
export const ERROR_VALIDATION_CLASS: string = 'e-kanban-error';
/** @hidden */
