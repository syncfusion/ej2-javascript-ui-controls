...
var SortSettings = /** @class */ (function (_super) {
    ...
    __decorate$6([
        sf.base.Property('DataSourceOrder')
...
var Action = /** @class */ (function () {
    ...
    Action.prototype.addButtonClick = function (target) {
        ...
        if (this.parent.kanbanData.length !== 0 && this.parent.swimlaneSettings.keyField &&
            sf.base.closest(target, '.' + CONTENT_ROW_CLASS).previousElementSibling) {
...
var DragAndDrop = /** @class */ (function () {
    ...
    DragAndDrop.prototype.multiCloneCreate = function (keys, contentCell) {
        ...
        for (var _i = 0, keys_1 = keys; _i < keys_1.length; _i++) {
            var key = keys_1[_i];
            var colKey = sf.base.createElement('div', { className: MULTI_COLUMN_KEY_CLASS, attrs: { 'data-key': key.trim() } });
    ...
    DragAndDrop.prototype.dragStop = function (e) {
        ...
        this.parent.trigger(dragStop, dragArgs, function (dragEventArgs) {
            ...
            dragMultiClone.forEach(function (clone) { sf.base.remove(clone); });
...
var LayoutRender = /** @class */ (function (_super) {
            ...
            for (var _i = 0, _a = this_2.parent.columns; _i < _a.length; _i++) {
                ...
                if (this_2.isColumnVisible(column)) {
                    ...
                    if (column.allowToggle && !column.isExpanded || index !== -1) {
                        ...
                        td.appendChild(sf.base.createElement('div', { className: COLLAPSE_HEADER_TEXT_CLASS, innerHTML: text }));
                        td.setAttribute('aria-expanded', 'false');
                    }
                    if (column.showAddButton) {
                        var button = sf.base.createElement('div', { className: SHOW_ADD_BUTTON, attrs: { 'tabindex': '-1' } });
    ...
    LayoutRender.prototype.renderCard = function (data) {
        ...
        if (this.parent.cardSettings.template) {
            ...
            if (this.parent.cardSettings.tagsField && data[this.parent.cardSettings.tagsField]) {
                var cardTags = sf.base.createElement('div', { className: CARD_TAGS_CLASS });
            ...
            if (this.parent.cardSettings.footerCssField) {
                var cardFields = sf.base.createElement('div', { className: CARD_FOOTER_CLASS });
    ...
    LayoutRender.prototype.refreshValidation = function () {
        ...
        validations.forEach(function (node) { sf.base.remove(node); });
    ...
    LayoutRender.prototype.unWireEvents = function () {
        ...
        var cardWrapper = [].slice.call(this.parent.element.querySelectorAll('.' + CARD_WRAPPER_CLASS));
        cardWrapper.forEach(function (wrapper) { sf.base.EventHandler.remove(wrapper, 'scroll', _this.onColumnScroll); });
        if (this.parent.isAdaptive) {
...
var Kanban = /** @class */ (function (_super) {
    ...
    Kanban.prototype.destroy = function () {
        this.destroyModules();
        [].slice.call(this.element.childNodes).forEach(function (node) { sf.base.detach(node); });
