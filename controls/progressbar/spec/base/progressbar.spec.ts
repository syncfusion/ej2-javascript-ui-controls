...
describe('ProgressBar Control', () => {
    ...
    describe('ProgressBar Tailwind3 theme checking', () => {
        let progress: ProgressBar;
        let element: HTMLElement;
        let path: Element;
        let stroke: string;
        ...
        it('checking default Tailwind3 theme checking', () => {
            loaded = (args: ILoadedEventArgs): void => {
                expect(true).toBe(true);
            };
            progress.isActive = true;
    ...
    describe('ProgressBar Tailwind3Dark theme checking', () => {
        let progress: ProgressBar;
        let element: HTMLElement;
        let path: Element;
        let stroke: string;
        ...
        it('checking default Tailwind3Dark theme checking', () => {
            loaded = (args: ILoadedEventArgs): void => {
                expect(true).toBe(true);
            };
            progress.isActive = true;
