...
- `#I789321` - Now the issue with seconds not being displayed properly on the message timestamp in Chat UI has been resolved.

- `#I790449` - Now the issue with localization not working for `view in chat` and `unpin` chat UI options has been resolved.
