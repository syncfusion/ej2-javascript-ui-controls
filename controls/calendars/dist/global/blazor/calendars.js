window.sf = window.sf || {};
window.sf.calendars = (function (exports) {
'use strict';
...
var DatePicker = /** @class */ (function (_super) {
        ...
        if ((sf.base.isNullOrUndefined(this.value)) && (!sf.base.isNullOrUndefined(this.previousDate)) ||
            ...
            if (this.popupObj) {
                if (this.popupObj.element.querySelectorAll('.' + SELECTED$2).length > 0) {
                    sf.base.removeClass(this.popupObj.element.querySelectorAll('.' + SELECTED$2), [SELECTED$2]);
                }
            }
            ...
            this.trigger('open', eventArgs, function (eventArgs) {
                ...
                if (!sf.base.isNullOrUndefined(_this.inputElement) && _this.inputElement.value === '') {
                    if (!sf.base.isNullOrUndefined(_this.tableBodyElement) && _this.tableBodyElement.querySelectorAll('td.e-selected').length > 0) {
                        sf.base.addClass([_this.tableBodyElement.querySelector('td.e-selected')], FOCUSEDDATE$2);
                        sf.base.removeClass(_this.tableBodyElement.querySelectorAll('td.e-selected'), SELECTED$2);
                    }
                }
    ...
    DatePicker.prototype.preRender = function () {
        ...
        sf.base.removeClass([this.inputElementCopy], [ROOT$1, CONTROL, LIBRARY]);
...
var DateRangePicker = /** @class */ (function (_super) {
    ...
    DateRangePicker.prototype.preRender = function () {
        ...
        sf.base.removeClass([this.cloneElement], [ROOT$2, CONTROL$1, LIBRARY$1]);
        this.updateHtmlAttributeToElement();
        if (this.element.getAttribute('id')) {
    ...
    DateRangePicker.prototype.rangeIconHandler = function (e) {
        ...
        if (this.isPopupOpen() && document.body.contains(this.popupObj.element)) {
            ...
            sf.base.addClass([this.inputWrapper.container], [INPUTFOCUS$1]);
        }
    };
    ...
    DateRangePicker.prototype.createPopup = function () {
        ...
        this.popupWrapper = sf.base.createElement('div', { id: this.element.id + '_popup', className: ROOT$2 + ' ' + POPUP$1 });
    ...
    DateRangePicker.prototype.updateDeviceCalendar = function (calendar) {
        if (calendar) {
            ...
            this.tableBodyElement = sf.base.select('.' + CONTENT$1 + ' tbody', calendar);
    ...
    DateRangePicker.prototype.errorClass = function () {
        ...
        if (((sf.base.isNullOrUndefined(this.endValue) && sf.base.isNullOrUndefined(this.startValue) && inputStr !== '') ||
            ...
            sf.base.addClass([this.inputWrapper.container], ERROR$1);
            sf.base.attributes(this.inputElement, { 'aria-invalid': 'true' });
        }
        else {
            if (this.inputWrapper) {
                sf.base.removeClass([this.inputWrapper.container], ERROR$1);
                sf.base.attributes(this.inputElement, { 'aria-invalid': 'false' });
            }
        }
    };
        ...
        switch (e.action) {
            ...
            case 'select':
                if (levelRestrict) {
                    ...
                    if (!sf.base.isNullOrUndefined(element) && !element.classList.contains(DISABLED$2)) {
                    ...
                    if (!ele.classList.contains(WEEKNUMBER$2) && !ele.classList.contains(DISABLED$2)) {
                        ...
                        if (!ele.classList.contains(OTHERMONTH$2)) {
                            ...
                            if (this.currentView() === this.depth &&
                                ...
                                && !(this.isDateDisabled(this.startValue) || this.isDateDisabled(this.endValue))) {
                                sf.base.addClass([ele], [STARTDATE, SELECTED$3]);
                            ...
                            if (this.currentView() === this.depth &&
                                ...
                                && !this.inputWrapper.container.classList.contains('e-error')
                                && !(this.isDateDisabled(this.startValue) || this.isDateDisabled(this.endValue))) {
                                sf.base.addClass([ele], [ENDDATE, SELECTED$3]);
    ...
    DateRangePicker.prototype.otherMonthSelect = function (ele, isStartDate, sameDate) {
        ...
        if (!sf.base.isNullOrUndefined(tdCell)) {
            if (isStartDate) {
                sf.base.addClass([tdCell], [STARTDATE, SELECTED$3]);
                this.addSelectedAttributes(tdCell, this.startValue, true);
            }
            else {
                sf.base.addClass([tdCell], [ENDDATE, SELECTED$3]);
    ...
    DateRangePicker.prototype.selectRange = function (event, element) {
        ...
        if (sf.base.isNullOrUndefined(this.startValue)) {
            ...
            if (+date === +this.startValue || +date > +this.startValue) {
                ...
                if (this.isMobile) {
                    ...
                    for (var _i = 0, endEle_1 = endEle; _i < endEle_1.length; _i++) {
                        ...
                        if (!ele_1.classList.contains(STARTDATE)) {
                            ...
                            sf.base.removeClass([ele_1], [ENDDATE, SELECTED$3]);
                        }
                        else {
                ...
                sf.base.removeClass(this.popupObj.element.querySelectorAll('.' + STARTDATE), [STARTDATE, SELECTED$3]);
                sf.base.addClass([ele], STARTDATE);
                this.addSelectedAttributes(ele, this.startValue, true);
                if (ele.classList.contains(OTHERMONTH$2)) {
                    this.otherMonthSelect(ele, true);
        ...
        sf.base.addClass([ele], SELECTED$3);
        this.updateHeader();
        this.removeFocusedDate();
    };
            ...
            if (this.currentView() === this.depth) {
                    ...
                    if (!ele.classList.contains(STARTDATE) && !ele.classList.contains(WEEKNUMBER$2)) {
                        if (!ele.classList.contains(DISABLED$2)) {
                            ...
                            if (+eleDate < +this.startValue) {
                                sf.base.addClass([ele], [DATEDISABLED, DISABLED$2, OVERLAY$2]);
                ...
                if (isStartDate) {
                    if (!this.previousIcon.classList.contains(DISABLED$2)) {
                        sf.base.addClass([this.previousIcon], [ICONDISABLED, DISABLED$2, OVERLAY$2]);
                    }
                }
            }
            else {
                for (var _a = 0, tdCells_5 = tdCells; _a < tdCells_5.length; _a++) {
                    ...
                    if (!this.startButton.element.classList.contains(ACTIVE$1) && ((this.currentView() === 'Year' &&
                        ...
                        sf.base.addClass([ele], [DISABLED$2]);
                    }
                    else {
                        break;
                    }
        ...
        if ((!sf.base.isNullOrUndefined(this.startValue) && sf.base.isNullOrUndefined(this.endValue)) ||
            ...
            if ((!sf.base.isNullOrUndefined(this.minDays) && this.minDays > 0) || (!sf.base.isNullOrUndefined(this.maxDays) && this.maxDays > 0)) {
                ...
                for (var _i = 0, tdCells_6 = tdCells; _i < tdCells_6.length; _i++) {
                    ...
                    if (!ele.classList.contains(STARTDATE) && !ele.classList.contains(WEEKNUMBER$2)) {
                        var eleDate = this.getIdValue(null, ele);
                        if (!sf.base.isNullOrUndefined(minDate) && +eleDate === +minDate && ele.classList.contains(DISABLED$2)) {
                        ...
                        if (!ele.classList.contains(DISABLED$2)) {
                            ...
                            if (!sf.base.isNullOrUndefined(maxDate) && +eleDate > +maxDate) {
                                ...
                                sf.base.EventHandler.clearEvents(ele);
                                if (sf.base.isNullOrUndefined(maxEle) && !ele.classList.contains(OTHERMONTH$2)) {
                                    maxEle = ele;
                                }
                            }
                        }
                ...
                if (!sf.base.isNullOrUndefined(maxEle)) {
                    if (this.isMobile) {
                        if (!this.nextIcon.classList.contains(DISABLED$2)) {
                            sf.base.addClass([this.nextIcon], [ICONDISABLED, DISABLED$2, OVERLAY$2]);
                        }
                    }
                    else {
                        ...
                        if (!isLeftCalendar) {
                            if (!this.rightCalNextIcon.classList.contains(DISABLED$2)) {
                                sf.base.addClass([this.rightCalNextIcon], [ICONDISABLED, DISABLED$2, OVERLAY$2]);
                            }
                        }
                        else {
                            if (!this.rightCalNextIcon.classList.contains(DISABLED$2)) {
                            ...
                            if (!this.leftCalNextIcon.classList.contains(DISABLED$2)) {
                                sf.base.addClass([this.leftCalNextIcon], [ICONDISABLED, DISABLED$2, OVERLAY$2]);
                            }
                            if (!this.rightCalPrevIcon.classList.contains(DISABLED$2)) {
                                sf.base.addClass([this.rightCalPrevIcon], [ICONDISABLED, DISABLED$2, OVERLAY$2]);
                            }
                        }
                    }
                }
    ...
    DateRangePicker.prototype.removeClassDisabled = function () {
        ...
        for (var _i = 0, tdCells_7 = tdCells; _i < tdCells_7.length; _i++) {
            ...
            if (ele.classList.contains(DATEDISABLED)) {
                sf.base.removeClass([ele], [DATEDISABLED, DISABLED$2, OVERLAY$2]);
        ...
        if (this.isMobile) {
            if (this.nextIcon.classList.contains(ICONDISABLED)) {
                sf.base.removeClass([this.nextIcon], [ICONDISABLED, DISABLED$2, OVERLAY$2]);
            }
            if (this.previousIcon.classList.contains(ICONDISABLED)) {
                sf.base.removeClass([this.previousIcon], [ICONDISABLED, DISABLED$2, OVERLAY$2]);
            }
        }
        else {
            if (this.rightCalNextIcon.classList.contains(ICONDISABLED)) {
                sf.base.removeClass([this.rightCalNextIcon], [ICONDISABLED, DISABLED$2, OVERLAY$2]);
            }
            if (this.rightCalPrevIcon.classList.contains(ICONDISABLED)) {
                sf.base.removeClass([this.rightCalPrevIcon], [ICONDISABLED, DISABLED$2, OVERLAY$2]);
            }
            if (this.leftCalNextIcon.classList.contains(ICONDISABLED)) {
                sf.base.removeClass([this.leftCalNextIcon], [ICONDISABLED, DISABLED$2, OVERLAY$2]);
            }
        }
    };
    ...
    DateRangePicker.prototype.removeSelection = function () {
        ...
        if (this.popupObj) {
            if (this.popupObj.element.querySelectorAll('.' + SELECTED$3).length > 0) {
                sf.base.removeClass(this.popupObj.element.querySelectorAll('.' + SELECTED$3), [STARTDATE, ENDDATE, SELECTED$3]);
            }
    ...
    DateRangePicker.prototype.isPopupOpen = function () {
        if (!sf.base.isNullOrUndefined(this.popupObj) && this.popupObj.element.classList.contains(POPUP$1)) {
            return true;
        }
        return false;
    };
    ...
    DateRangePicker.prototype.createCalendar = function () {
        ...
        if (!this.isMobile) {
            ...
            sf.base.remove(this.calendarElement.querySelector('.' + LEFTCALENDER + ' .' + ICONCONTAINER$1));
            ...
            sf.base.prepend([this.leftCalPrevIcon], this.calendarElement.querySelector('.' + LEFTCALENDER + ' .' + HEADER$1));
            ...
            sf.base.remove(this.calendarElement.querySelector('.' + RIGHTCALENDER + ' .' + ICONCONTAINER$1));
            ...
            sf.base.prepend([this.rightCalPrevIcon], this.calendarElement.querySelector('.' + RIGHTCALENDER + ' .' + HEADER$1));
            ...
            sf.base.remove(this.calendarElement.querySelector('.' + CALENDAR + ' .' + ICONCONTAINER$1));
            ...
            sf.base.prepend([prevIcon], this.calendarElement.querySelector('.' + CALENDAR + ' .' + HEADER$1));
    ...
    DateRangePicker.prototype.createControl = function () {
        ...
        sf.base.addClass([applyBtn], [APPLY, FLAT$1, PRIMARY$1, CSS$1]);
    ...
    DateRangePicker.prototype.applyFunction = function (eve) {
        ...
        if (!(sf.base.closest(eve.target, '.' + INPUTCONTAINER$1))
            && (!isValueChanged)) {
            this.focusOut();
        }
        if (!this.isMobile) {
    ...
    DateRangePicker.prototype.removeListSelection = function () {
        ...
        if (!sf.base.isNullOrUndefined(item)) {
            sf.base.removeClass([item], ACTIVE$1);
    ...
    DateRangePicker.prototype.createPresets = function () {
        if (!sf.base.isUndefined(this.presets[0].start && this.presets[0].end && this.presets[0].label)) {
            ...
            if (!sf.base.isNullOrUndefined(this.activeIndex) && this.activeIndex > -1) {
                sf.base.addClass([this.liCollections[this.activeIndex]], ACTIVE$1);
            }
        }
    };
    ...
    DateRangePicker.prototype.renderPopup = function () {
        ...
        this.popupObj = new sf.popups.Popup(this.popupWrapper, {
            ...
            open: function () {
                ...
                sf.base.addClass([_this.inputWrapper.buttons[0]], ACTIVE$1);
                if (!_this.isMobile) {
            ...
            close: function () {
                ...
                sf.base.removeClass([_this.inputWrapper.buttons[0]], ACTIVE$1);
                if (_this.isRangeIconClicked) {
        ...
        if (this.isMobile && this.isCustomWindow) {
            sf.base.addClass([this.modal], [DEVICE$1, ROOT$2, 'e-range-modal']);
    ...
    DateRangePicker.prototype.documentHandler = function (e) {
        ...
        if ((sf.base.isNullOrUndefined(this.targetElement) ||
            ...
            && !(sf.base.closest(target, '.' + INPUTCONTAINER$1) === this.inputWrapper.container)
    ...
    DateRangePicker.prototype.adjustLongHeaderWidth = function () {
        if (this.dayHeaderFormat === 'Wide') {
            sf.base.addClass([this.popupWrapper], DAYHEADERLONG$1);
        }
    };
    ...
    DateRangePicker.prototype.focusOut = function () {
        ...
        if (document.activeElement === this.inputElement) {
            sf.base.removeClass([this.inputWrapper.container], [INPUTFOCUS$1]);
            this.preventBlur = false;
            this.inputElement.blur();
    ...
    DateRangePicker.prototype.destroy = function () {
        ...
        if (this.inputElement) {
            sf.base.removeClass([this.inputElement], [ROOT$2]);
            sf.base.EventHandler.remove(this.inputElement, 'blur', this.inputBlurHandler);
            sf.inputs.Input.removeAttributes(ariaAttrs, this.inputElement);
                    ...
                    if (!_this.closeEventArgs.cancel) {
                        ...
                        if (_this.popupObj) {
                            ...
                            if (_this.preventBlur) {
                                ...
                                sf.base.addClass([_this.inputWrapper.container], [INPUTFOCUS$1]);
                            }
                        }
                        if (!_this.isMobile) {
                        ...
                        sf.base.removeClass([document.body], OVERFLOW$1);
...
var TimePicker = /** @class */ (function (_super) {
    ...
    TimePicker.prototype.preRender = function () {
        ...
        this.cloneElement = this.element.cloneNode(true);
        sf.base.removeClass([this.cloneElement], [ROOT$3, CONTROL$2, LIBRARY$2]);
        this.inputElement = this.element;
        this.angularTag = null;
        this.formElement = sf.base.closest(this.element, 'form');
    ...
    TimePicker.prototype.renderPopup = function () {
        ...
        this.popupObj = new sf.popups.Popup(this.popupWrapper, {
            ...
            open: function () {
                ...
                sf.base.addClass([_this.inputWrapper.buttons[0]], SELECTED$4);
            }, close: function () {
                sf.base.removeClass([_this.inputWrapper.buttons[0]], SELECTED$4);
                _this.unWireListEvents();
    ...
    TimePicker.prototype.removeErrorClass = function () {
        sf.base.removeClass([this.inputWrapper.container], ERROR$2);
        sf.base.attributes(this.inputElement, { 'aria-invalid': 'false' });
    };
    TimePicker.prototype.checkErrorState = function (val) {
        ...
        if (this.validateState(value) && !this.invalidValueString) {
            ...
            sf.base.addClass([this.inputWrapper.container], ERROR$2);
            sf.base.attributes(this.inputElement, { 'aria-invalid': 'true' });
        }
    };
    ...
    TimePicker.prototype.disableElement = function (element) {
        sf.base.addClass(element, DISABLED$3);
    };
    TimePicker.prototype.enableElement = function (element) {
        sf.base.removeClass(element, DISABLED$3);
    };
        ...
        if (!this.readonly && this.enabled) {
            ...
            switch (event.action) {
                ...
                case 'enter':
                    ...
                    this.hide();
                    sf.base.addClass([this.inputWrapper.container], FOCUS);
    ...
    TimePicker.prototype.onMouseClick = function (event) {
        ...
        var li = this.selectedElement = sf.base.closest(target, '.' + LISTCLASS$1);
    ...
    TimePicker.prototype.closePopup = function (delay, e) {
        ...
        if (this.isPopupOpen() && this.popupWrapper) {
            ...
            sf.base.removeClass([document.body], OVERFLOW$2);
    ...
    TimePicker.prototype.onMouseOver = function (event) {
        var currentLi = sf.base.closest(event.target, '.' + LISTCLASS$1);
    ...
    TimePicker.prototype.setSelection = function (li, event) {
        if (this.isValidLI(li) && !li.classList.contains(SELECTED$4)) {
            if (!this.isBlazorServer) {
                ...
                this.activeIndex = Array.prototype.slice.call(this.liCollections).indexOf(li);
                this.valueWithMinutes = new Date(this.timeCollections[this.activeIndex]);
                sf.base.addClass([this.selectedElement], SELECTED$4);
    ...
    TimePicker.prototype.keyHandler = function (event) {
        if (sf.base.isNullOrUndefined(this.step) || this.step <= 0 || this.inputWrapper.buttons[0].classList.contains(DISABLED$3)) {
            return;
        }
    ...
    TimePicker.prototype.removeSelection = function () {
        ...
        if (!sf.base.isNullOrUndefined(this.popupWrapper)) {
            ...
            if (items.length) {
                sf.base.removeClass(items, SELECTED$4);
    ...
    TimePicker.prototype.setEnable = function () {
        ...
        if (this.enabled) {
            sf.base.removeClass([this.inputWrapper.container], DISABLED$3);
            sf.base.attributes(this.inputElement, { 'aria-disabled': 'false' });
            this.inputElement.setAttribute('tabindex', this.tabIndex);
        }
        else {
            this.hide();
            sf.base.addClass([this.inputWrapper.container], DISABLED$3);
...
var DateTimePicker = /** @class */ (function (_super) {
    ...
    DateTimePicker.prototype.focusHandler = function () {
        sf.base.addClass([this.inputWrapper.container], INPUTFOCUS$2);
    };
    /**
     * Sets the focus to widget for interaction.
     * @returns void
    ...
    DateTimePicker.prototype.focusOut = function () {
        if (document.activeElement === this.inputElement) {
            this.inputElement.blur();
            sf.base.removeClass([this.inputWrapper.container], [INPUTFOCUS$2]);
        }
    };
    ...
    DateTimePicker.prototype.checkErrorState = function () {
        if (this.isValidState) {
            sf.base.removeClass([this.inputWrapper.container], ERROR$3);
        }
        else {
            sf.base.addClass([this.inputWrapper.container], ERROR$3);
        }
    ...
    DateTimePicker.prototype.disablePopupButton = function (isDisable) {
        if (isDisable) {
            sf.base.addClass([this.inputWrapper.buttons[0], this.timeIcon], DISABLED$4);
            this.hide();
        }
        else {
            sf.base.removeClass([this.inputWrapper.buttons[0], this.timeIcon], DISABLED$4);
        }
    };
    ...
    DateTimePicker.prototype.createInputElement = function () {
        ...
        sf.base.removeClass([this.inputWrapper.container], DATEWRAPPER$1);
        sf.base.addClass([this.inputWrapper.container], DATETIMEWRAPPER);
        sf.base.addClass([this.inputElement], ROOT$4);
        this.renderTimeIcon();
    };
    DateTimePicker.prototype.renderTimeIcon = function () {
        this.timeIcon = sf.inputs.Input.appendSpan(INPUTWRAPPER$1 + ' ' + TIMEICON$1 + ' ' + ICONS$1, this.inputWrapper.container);
    };
    ...
    DateTimePicker.prototype.listCreation = function () {
        ...
        this.listWrapper = sf.base.createElement('div', { className: CONTENT$3, attrs: { 'tabindex': '0' } });
        var min = this.startTime(value);
        var max = this.endTime(value);
        var listDetails = exports.TimePickerBase.createListItems(this.createElement, min, max, this.globalize, this.cldrTimeFormat(), this.step);
    ...
    DateTimePicker.prototype.openPopup = function (e) {
        ...
        this.trigger('open', eventArgs, function (eventArgs) {
            ...
            if (!_this.preventArgs.cancel && !_this.readonly) {
                ...
                sf.base.addClass([_this.inputWrapper.container], [ICONANIMATION$1]);
                sf.base.attributes(_this.inputElement, { 'aria-expanded': 'true' });
                sf.base.EventHandler.add(document, 'mousedown touchstart', _this.documentClickHandler, _this);
            }
        });
    ...
    DateTimePicker.prototype.renderPopup = function () {
        ...
        this.popupObject = new sf.popups.Popup(this.dateTimeWrapper, {
            ...
            open: function () {
                ...
                sf.base.addClass([_this.timeIcon], ACTIVE$2);
                if (!sf.base.Browser.isDevice) {
                ...
                sf.base.removeClass([_this.timeIcon], ACTIVE$2);
    ...
    DateTimePicker.prototype.onMouseOver = function (event) {
        var currentLi = sf.base.closest(event.target, '.' + LISTCLASS$2);
    ...
    DateTimePicker.prototype.onMouseClick = function (event) {
        var target = event.target;
        var li = this.selectedElement = sf.base.closest(target, '.' + LISTCLASS$2);
    ...
    DateTimePicker.prototype.setSelection = function (li, event) {
        if (this.isValidLI(li) && !li.classList.contains(ACTIVE$2)) {
            ...
            this.activeIndex = index;
            this.valueWithMinutes = new Date(this.timeCollections[this.activeIndex]);
            sf.base.addClass([this.selectedElement], ACTIVE$2);
            this.selectedElement.setAttribute('aria-selected', 'true');
    ...
    DateTimePicker.prototype.removeTimeSelection = function () {
        ...
        if (!sf.base.isNullOrUndefined(this.dateTimeWrapper)) {
            ...
            if (items.length) {
                sf.base.removeClass(items, ACTIVE$2);
                items[0].removeAttribute('aria-selected');
            }
        }
    };
    ...
    DateTimePicker.prototype.dateTimeCloseEventCallback = function (e, eventArgs) {
        ...
        if (!this.preventArgs.cancel) {
            if (this.isDatePopupOpen()) {
                ...
                this.closePopup(e);
                sf.base.removeClass([document.body], OVERFLOW$3);
    ...
    DateTimePicker.prototype.preRender = function () {
        ...
        this.dateTimeFormat = this.cldrDateTimeFormat();
        _super.prototype.preRender.call(this);
        sf.base.removeClass([this.inputElementCopy], [ROOT$4]);
    };
...
sfBlazor.loadDependencies(sfBlazor.dependencyJson.calendars, () => {
    sf.calendars = sf.calendars({});
});
