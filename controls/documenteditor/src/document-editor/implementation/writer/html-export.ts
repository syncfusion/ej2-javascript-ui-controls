...
export class HtmlExport {
    ...
    private serializeImageContainer(image: any): string {
        ...
        if (image[alternativeTextProperty[this.keywordIndex]] !== "") {
            tagAttributes.push('alt="' + image[alternativeTextProperty[this.keywordIndex]] + '"');
        }
