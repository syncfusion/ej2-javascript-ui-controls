...
describe("Copied the document contains section break validation",()=>{
    ...
    it("Copied the document contains section break validation",()=>{
        ...
        editor.editorModule.copiedData = JSON.stringify(documentContent);
        let html: string = editor.selection.htmlWriter.writeHtml(documentContent);
        let expectHtml: any = '<p style="font-weight:normal;font-style:normal;color:#000000;font-size:11pt;font-family:Calibri;text-align:left;margin-top:0pt; margin-right:0pt; margin-bottom:8pt; margin-left:0pt; line-height:1.1;white-space:pre"><span style="font-weight:normal;font-style:normal;">Syncfusion</span></p><p style="font-weight:normal;font-style:normal;color:#000000;font-size:11pt;font-family:Calibri;text-align:left;margin-top:0pt; margin-right:0pt; margin-bottom:8pt; margin-left:0pt; line-height:1.1;white-space:pre"><span style="font-weight:normal;font-style:normal;">Software</span></p><p style="font-weight:normal;font-style:normal;color:#000000;font-size:11pt;font-family:Calibri;text-align:left;margin-top:0pt; margin-right:0pt; margin-bottom:8pt; margin-left:0pt; line-height:1.1;white-space:pre"><span style="font-weight:normal;font-style:normal;">Technology</span></p>';
