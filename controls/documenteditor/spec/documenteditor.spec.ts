...
import {
    ...
    TableCellWidget, BodyWidget, ParagraphWidget, LineWidget, DocumentHelper, TextFormFieldInfo, CheckBoxFormFieldInfo, DropDownFormFieldInfo, FormFieldData, CollaborativeEditing
} from '../src/index';
...
describe('Open protected document in lock and edit mode', () => {
    let editor: DocumentEditor;
    beforeAll((): void => {
        let ele: HTMLElement = createElement('div', { id: 'container' });
        document.body.appendChild(ele);
        DocumentEditor.Inject(CollaborativeEditing)
        editor = new DocumentEditor({ isReadOnly: false, enableComment: true, enableLockAndEdit: true });
