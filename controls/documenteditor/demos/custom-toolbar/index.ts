import { DocumentEditorContainer, CustomToolbarItemModel } from '../../src/index';
...
let toolItem: CustomToolbarItemModel = {
    prefixIcon: 'e-de-ctnr-pagenumber', tooltipText: 'Custom toolbar item',
    text: 'Custom toolbar item', id: 'Custom', cssClass: 'e-de-toolbar-btn'
};

let container: DocumentEditorContainer = new DocumentEditorContainer({
    toolbarItems: ['Open', 'New', 'Separator', toolItem, 'Separator', 'TableOfContents', 'Image', 'Break', 'Bookmark', {
        prefixIcon: 'e-de-ctnr-pagenumber', tooltipText: 'Custom toolbar item2',
        text: 'Custom toolbar item2', id: 'Custom2', cssClass: 'e-de-toolbar-btn'
    }, 'Separator', 'Hyperlink', 'RestrictEditing']
});
...
function onToolbarClick(args: ClickEventArgs) {
    switch (args.item.id) {
        case 'Custom':
            //User action.
            container.toolbarModule.enableItems(1, false);
            break;
        case 'Custom2':
            //User action.
            container.toolbarModule.enableItems(6, false);
            break;
    }
}
