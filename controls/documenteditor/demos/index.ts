 ...
 */
import { createElement, Browser, isNullOrUndefined, L10n } from '@syncfusion/ej2-base';
...
let baseUrl: string = 'https://ej2services.syncfusion.com/production/web-services/' + controller;
