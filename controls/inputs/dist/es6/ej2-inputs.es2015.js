...
let Slider = class Slider extends Component {
    ...
    renderTooltip() {
        ...
        let tooltipPointer = this.isBootstrap ? true : false;
    ...
    tickesAlignment(orien, tickWidth) {
...
let Uploader = class Uploader extends Component {
    ...
    getCurrentMetaData(fileInfo, e) {
        ...
        if (isNullOrUndefined(fileInfo)) {
            let target = this.uploadWrapper.querySelector('.' + ICON_FOCUSED).parentElement;
    ...
    setTabFocus(e) {
        ...
        if (target === this.clearButton) {
            ...
            this.browseButton.blur();
            let iconElement = this.listParent.querySelectorAll('span.e-icons')[0];
            iconElement.focus();
    ...
    createFileList(fileData) {
        ...
        if (this.template !== '' && !isNullOrUndefined(this.template)) {
            ...
            for (let listItem of fileData) {
                ...
                let iconElement = this.createElement('span', { className: ' e-icons', attrs: { 'tabindex': '-1' } });
                /* istanbul ignore next */
