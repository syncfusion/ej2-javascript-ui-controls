...
describe('ColorPicker', () => {
    ...
    describe('ColorPicker – change event on same-value selection', function () {
        let colorPicker: any;
        ...
        it('should NOT trigger change event when the same colour is selected again', function (done) {
            // Spy on the change handler – we expect it to be called **once** (initial set)
            ...
            // Open the picker
            colorPicker.toggle();
            colorPicker.container.querySelectorAll('.e-row')[0].children[3].click();
            // Applying the newly selected tile color.
            colorPicker.container.querySelector('.e-apply').click();
            // Wait for the first change to be processed
            setTimeout(function () {
                expect(changeSpy).toHaveBeenCalledTimes(1); // only the first apply
                // Reset spy for the second part
                ...
                // Applying the newly selected tile color.
                colorPicker.container.querySelector('.e-apply').click();
                // Give the UI a tick to potentially fire the event
                setTimeout(function () {
