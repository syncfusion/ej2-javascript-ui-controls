window.sf = window.sf || {};
window.sf.popups = (function (exports) {
'use strict';
...
var Dialog = /** @class */ (function (_super) {
    ...
    Dialog.prototype.setButton = function () {
        ...
        var footerBtn = !sf.base.isNullOrUndefined(footerEle) &&
    ...
    __decorate$1([
        sf.base.Complex({ X: 'center', Y: 'center' }, PositionData)
...
var Tooltip = /** @class */ (function (_super) {
    ...
    Tooltip.prototype.initialize = function () {
        ...
        if (!(this.isServerRender())) {
            sf.base.addClass([this.element], ROOT$1);
        }
    };
    ...
    Tooltip.prototype.beforeRenderBlazor = function (target, ctrlObj) {
        if (target) {
            if (sf.base.Browser.isDevice) {
                sf.base.addClass([ctrlObj.tooltipEle], DEVICE$1);
            }
    ...
    Tooltip.prototype.onMouseOut = function (e) {
        ...
        if (enteredElement && !this.mouseTrail) {
            var checkForTooltipElement = sf.base.closest(enteredElement, "." + TOOLTIP_WRAP + "." + POPUP_LIB + "." + POPUP_ROOT$1);
    ...
    Tooltip.prototype.touchEnd = function (e) {
        if (this.tooltipEle && sf.base.closest(e.target, '.' + ROOT$1) === null) {
            this.close();
        }
    };
    Tooltip.prototype.scrollHandler = function (e) {
        if (this.tooltipEle) {
            if (!(sf.base.closest(e.target, "." + TOOLTIP_WRAP + "." + POPUP_LIB + "." + POPUP_ROOT$1))) {
                this.close();
            }
        }
    };
        ...
        for (var _i = 0, _a = Object.keys(newProp); _i < _a.length; _i++) {
            ...
            switch (prop) {
                ...
                case 'enableRtl':
                    if (this.tooltipEle) {
                        if (this.enableRtl) {
                            sf.base.addClass([this.tooltipEle], RTL$1);
                        }
                        else {
                            sf.base.removeClass([this.tooltipEle], RTL$1);
                        }
                    }
                    break;
            }
    ...
    Tooltip.prototype.destroy = function () {
        ...
        sf.base.removeClass([this.element], ROOT$1);
...
exports.blazorSpinner = blazorSpinner;
...
sfBlazor.loadDependencies(sfBlazor.dependencyJson.popups, () => {
    sf.popups = sf.popups({});
});
