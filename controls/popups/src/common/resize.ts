...
function resizeSouth(e: any): void {
    ...
    let borderValue: number = isNullOrUndefined(containerElement) ? 0 : containerElement.offsetHeight - containerElement.clientHeight;
    ...
    if (calculateValue) {
        ...
        let calculatedTop: number = (isNullOrUndefined(containerElement)) ? targetTop : topWithoutborder;
...
function resizeWest(e: any): void {
    ...
    let targetRectValues: ClientRect = getClientRectValues(targetElement);
    let borderValue: number = isNullOrUndefined(containerElement) ? 0 : containerElement.offsetWidth - containerElement.clientWidth;
    let left: number = isNullOrUndefined(containerElement) ? 0 : rectValues.left;
    let containerWidth: number = isNullOrUndefined(containerElement) ? 0 : rectValues.width;
