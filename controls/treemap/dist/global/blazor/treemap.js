window.sf = window.sf || {};
var sftreemap = (function (exports) {
'use strict';
...
var SubTitleSettings = /** @class */ (function (_super) {
    ...
    __decorate$1([
        sf.base.Complex({ size: '14px' }, Font)
...
var TitleSettings = /** @class */ (function (_super) {
    ...
    __decorate$1([
        sf.base.Complex({ size: '15px' }, Font)
    ], TitleSettings.prototype, "textStyle", void 0);
    __decorate$1([
        sf.base.Property('Center')
    ], TitleSettings.prototype, "alignment", void 0);
    __decorate$1([
        sf.base.Complex({}, SubTitleSettings)
...
var LegendSettings = /** @class */ (function (_super) {
    ...
    __decorate$1([
        sf.base.Complex({ size: '13px' }, Font)
    ...
    __decorate$1([
        sf.base.Complex({ color: '#000000', width: 0 }, Border)
    ], LegendSettings.prototype, "border", void 0);
    __decorate$1([
        sf.base.Complex({ color: '#000000', width: 0 }, Border)
    ], LegendSettings.prototype, "shapeBorder", void 0);
    __decorate$1([
        sf.base.Complex({}, CommonTitleSettings)
...
var LeafItemSettings = /** @class */ (function (_super) {
    ...
    __decorate$1([
        sf.base.Complex({ color: null, size: '12px' }, Font)
    ...
    __decorate$1([
        sf.base.Collection([], ColorMapping)
...
var TooltipSettings = /** @class */ (function (_super) {
    ...
    __decorate$1([
        sf.base.Complex({ fontFamily: defaultFont, size: '13px' }, Font)
...
var SelectionSettings = /** @class */ (function (_super) {
    ...
    __decorate$1([
        sf.base.Property('0.5')
    ], SelectionSettings.prototype, "opacity", void 0);
    __decorate$1([
        sf.base.Complex({}, Border)
    ], SelectionSettings.prototype, "border", void 0);
    __decorate$1([
        sf.base.Property('Item')
...
var LevelSettings = /** @class */ (function (_super) {
    ...
    __decorate$1([
        sf.base.Property('Near')
    ], LevelSettings.prototype, "headerAlignment", void 0);
    __decorate$1([
        sf.base.Complex({ color: null, size: '13px' }, Font)
...
function measureText(text, font) {
    ...
    if (measureObject === null) {
        measureObject = sf.base.createElement('text', { id: 'treeMapMeasureText' });
...
function renderTextElement(options, font, color, parent, isMinus) {
    ...
    var height;
    var htmlObject;
    var breadCrumbText = !sf.base.isNullOrUndefined(text) && !sf.base.isNullOrUndefined(options.connectorText) ?
    ...
    if (breadCrumbText) {
        ...
        for (var z = 0; z < drillLevelText.length; z++) {
            var drillText = (drillLevelText[z].search(options.connectorText) !== -1 && !sf.base.isNullOrUndefined(options.connectorText)) ?
...
function colorMap(colorMapping, equalValue, value, weightValuePath) {
    ...
    var paths = [];
    var opacity;
    if (sf.base.isNullOrUndefined(equalValue) && (sf.base.isNullOrUndefined(value) && isNaN(value))) {
        return null;
    }
    for (var i = 0; i < colorMapping.length; i++) {
        var isEqualColor = false;
        var dataValue = value;
        if (!sf.base.isNullOrUndefined(colorMapping[i].from) && !sf.base.isNullOrUndefined(colorMapping[i].to)
            && !sf.base.isNullOrUndefined(colorMapping[i].value)) {
        ...
        else if ((!sf.base.isNullOrUndefined(colorMapping[i].from) && !sf.base.isNullOrUndefined(colorMapping[i].to))
            || !sf.base.isNullOrUndefined((colorMapping[i].value))) {
            if ((value >= colorMapping[i].from && colorMapping[i].to >= value) || (colorMapping[i].value === equalValue)) {
        ...
        if (((value >= colorMapping[i].from && value <= colorMapping[i].to) || (colorMapping[i].value === equalValue))
            && !sf.base.isNullOrUndefined(colorMapping[i].minOpacity) && !sf.base.isNullOrUndefined(colorMapping[i].maxOpacity) && fill) {
            opacity = deSaturationColor(weightValuePath, colorMapping[i], fill, value);
        }
        if ((fill === '' || sf.base.isNullOrUndefined(fill))
            && sf.base.isNullOrUndefined(colorMapping[i].from) && sf.base.isNullOrUndefined(colorMapping[i].to)
            && sf.base.isNullOrUndefined(colorMapping[i].minOpacity) && sf.base.isNullOrUndefined(colorMapping[i].maxOpacity)
            && sf.base.isNullOrUndefined(colorMapping[i].value)) {
            fill = (Object.prototype.toString.call(colorMapping[i].color) === '[object Array]') ?
                colorMapping[i].color[0] : colorMapping[i].color;
        }
        opacity = !sf.base.isNullOrUndefined(opacity) ? opacity : '1';
        paths.push(fill);
    }
...
function drawSymbol(location, shape, size, url, options, label) {
    var svgRenderer = new sf.svgbase.SvgRenderer('');
...
function renderLegendShape(location, size, shape, options, url) {
    ...
    switch (shape) {
        ...
        case 'Bubble':
            ...
            sf.base.merge(options, { 'rx': shapeWidth / 2, 'ry': shapeHeight / 2, 'cx': shapeX, 'cy': shapeY });
            break;
        case 'VerticalLine':
            renderPath = 'M' + ' ' + shapeX + ' ' + (shapeY + (shapeHeight / 2)) + ' ' + 'L' + ' ' + shapeX + ' '
                + (shapeY + (-shapeHeight / 2));
            sf.base.merge(options, { 'd': renderPath });
            break;
        case 'Diamond':
        ...
        case 'Image':
            functionName = 'Image';
            sf.base.merge(options, { 'href': url, 'height': shapeHeight, 'width': shapeWidth, x: x, y: y });
            break;
    }
...
var LayoutPanel = /** @class */ (function () {
    ...
    LayoutPanel.prototype.processLayoutPanel = function () {
        ...
        if (LevelsData.levelsData && LevelsData.levelsData.length > 0) {
            data = (!sf.base.isNullOrUndefined(this.treemap.initialDrillDown.groupIndex) &&
                !sf.base.isNullOrUndefined(this.treemap.initialDrillDown.groupName)) &&
                (sf.base.isNullOrUndefined(this.treemap.drilledItems) ? sf.base.isNullOrUndefined(this.treemap.drilledItems)
                    : this.treemap.drilledItems.length === 0) ?
                this.getDrilldownData(LevelsData.levelsData[0], [])[0] : LevelsData.levelsData[0];
            totalRect = sf.base.extend({}, this.treemap.areaRect, totalRect, false);
            if (!sf.base.isNullOrUndefined(this.treemap.treeMapLegendModule) && !sf.base.isNullOrUndefined(this.treemap.totalRect)) {
                if (this.treemap.legendSettings.position !== 'Float') {
                    totalRect = this.treemap.totalRect;
                }
            }
            if (!sf.base.isNullOrUndefined(this.treemap.currentLevel) &&
                (sf.base.isNullOrUndefined(this.treemap.drilledItems) ? !sf.base.isNullOrUndefined(this.treemap.drilledItems)
                    : this.treemap.drilledItems.length !== 0)) {
                ...
                if (!sf.base.isNullOrUndefined(this.treemap.initialDrillDown.groupIndex) && !this.treemap.enableBreadcrumb) {
                ...
                if (!sf.base.isNullOrUndefined(this.treemap.initialDrillDown.groupIndex) &&
                    (sf.base.isNullOrUndefined(this.treemap.drilledItems) ? sf.base.isNullOrUndefined(this.treemap.drilledItems)
                        : this.treemap.drilledItems.length === 0)) {
    ...
    LayoutPanel.prototype.calculateLayoutItems = function (data, rect) {
        this.renderItems = [];
        this.parentData = [];
        if (!sf.base.isNullOrUndefined(this.treemap.weightValuePath)) {
    ...
    LayoutPanel.prototype.sliceAndDiceProcess = function (processData, rect) {
        ...
        for (var i = 0; i < processData.length; i++) {
            ...
            item['isLeafItem'] = (levels.length === 0) || ((this.treemap.isHierarchicalData ||
                sf.base.isNullOrUndefined(this.treemap.leafItemSettings.labelPath)) ?
    ...
    LayoutPanel.prototype.getCoordinates = function (row, rect) {
        ...
        for (var i = 0; i < rowLength; i += 1) {
            ...
            item['isLeafItem'] = (levels.length === 0) || (this.treemap.isHierarchicalData ? index === levels.length :
                sf.base.isNullOrUndefined(leaf.labelPath) ? false : index === levels.length);
    ...
    LayoutPanel.prototype.onDemandProcess = function (childItems) {
        ...
        if (sf.base.isNullOrUndefined(parentItem['groupName'])) {
    ...
    LayoutPanel.prototype.renderLayoutItems = function (renderData) {
        ...
        var template;
        var border;
        var templateGroup = sf.base.createElement('div', {
        ...
        var _loop_1 = function (i) {
            ...
            index = item['groupIndex'];
            if (this_1.treemap.drillDownView && sf.base.isNullOrUndefined(this_1.treemap.currentLevel)
        ...
        if (templateGroup.childNodes.length > 0) {
            ...
            sf.base.updateBlazorTemplate(this.treemap.element.id + '_HeaderTemplate', 'HeaderTemplate', levels[levels.length - 1]);
            sf.base.updateBlazorTemplate(this.treemap.element.id + '_LabelTemplate', 'LabelTemplate', leaf);
        }
    ...
    LayoutPanel.prototype.renderItemText = function (text, parentElement, textStyle, rect, interSectAction, groupId, fill, position, connectorText) {
        ...
        if (!sf.base.isNullOrUndefined(textCollection)) {
            var collection = [];
            var texts = null;
            var maxNumber = [];
    ...
    LayoutPanel.prototype.getItemColor = function (isLeafItem, item) {
        ...
        if (!sf.base.isNullOrUndefined(LevelsData.defaultLevelsData)) {
        ...
        if (colorMapping.length > 0) {
            ...
            itemFill = !sf.base.isNullOrUndefined(option['fill']) ? option['fill'] : treemap.leafItemSettings.fill;
            itemOpacity = option['opacity'];
        }
        else {
            for (var i = 0; i < parentData.length; i++) {
                if (parentData[i]['levelOrderName'] === item['levelOrderName'].split('#')[0]) {
                    itemFill = !sf.base.isNullOrUndefined(itemFill) ? itemFill : !sf.base.isNullOrUndefined(treemap.colorValuePath) ?
    ...
    LayoutPanel.prototype.renderTemplate = function (secondaryEle, groupId, rect, position, template, item, isLeafItem) {
        ...
        if (sf.base.isNullOrUndefined(template['prototype'])) {
...
var TreeMap = /** @class */ (function (_super) {
    ...
    TreeMap.prototype.render = function () {
        ...
        if (!sf.base.isNullOrUndefined(LevelsData.levelsData)) {
    ...
    TreeMap.prototype.processDataManager = function () {
        ...
        if (this.dataSource instanceof sf.data.DataManager) {
            ...
            queryModule = this.query instanceof sf.data.Query ? this.query : new sf.data.Query();
            ...
            ajaxModule = new sf.base.Ajax(localAjax.dataOptions, localAjax.type, localAjax.async, localAjax.contentType);
    ...
    TreeMap.prototype.createSvg = function () {
        ...
        if (this.leafItemSettings.labelTemplate) {
            sf.base.resetBlazorTemplate(this.element.id + '_LabelTemplate', 'LabelTemplate');
        }
        for (var i = 0; i < this.levels.length; i++) {
            if (this.levels[i].headerTemplate) {
                sf.base.resetBlazorTemplate(this.element.id + '_HeaderTemplate', 'HeaderTemplate');
            }
        }
    ...
    TreeMap.prototype.renderBorder = function () {
        ...
        if ((this.border.width > 0 || (this.background || this.themeStyle.backgroundColor)) && sf.base.isNullOrUndefined(borderElement)) {
    ...
    TreeMap.prototype.renderTitle = function (title, type, bounds, groupEle) {
        ...
        if (title.text) {
            if (sf.base.isNullOrUndefined(groupEle)) {
                groupEle = this.renderer.createGroup({ id: this.element.id + '_Title_Group' });
            }
            var trimmedTitle = textTrim(width, title.text, style);
            var elementSize = measureText(trimmedTitle, style);
            var rect = (sf.base.isNullOrUndefined(bounds)) ? new Rect(this.margin.left, this.margin.top, this.availableSize.width, this.availableSize.height) : bounds;
    ...
    TreeMap.prototype.processingData = function () {
        ...
        if (!sf.base.isNullOrUndefined(this.dataSource) && this.dataSource.length > 0 && this.weightValuePath) {
            ...
            if (this.levels.length === 0) {
                ...
                if (this.isHierarchicalData) {
                    ...
                    LevelsData.hierarchyData = sf.base.extend([], this.dataSource, LevelsData.hierarchyData, true);
    ...
    TreeMap.prototype.processHierarchicalData = function (data, dataCount) {
        ...
        if (childData && childData.length > 0) {
            ...
            for (var j = 0; j < childData.length; j++) {
                ...
                childData[j]['groupIndex'] = sf.base.isNullOrUndefined(levelIndex) ? childLevel === this.levels.length
    ...
    TreeMap.prototype.reOrderLevelData = function (start) {
        ...
        for (var i = 0; i < currentData.length; i++) {
            ...
            for (var j = 0; j < previousData.length; j++) {
                previousData[j][currentPath] = sf.base.isNullOrUndefined(previousData[j][currentPath]) ? [] : previousData[j][currentPath];
                if (currentName.indexOf(previousData[j]['levelOrderName']) !== -1) {
                    if (sf.base.isNullOrUndefined(currentData[i]['parent'])) {
    ...
    TreeMap.prototype.unWireEVents = function () {
        sf.base.EventHandler.remove(this.element, 'click', this.clickOnTreeMap);
        sf.base.EventHandler.remove(this.element, 'dblclick', this.doubleClickOnTreeMap);
        sf.base.EventHandler.remove(this.element, 'contextmenu', this.rightClickOnTreeMap);
        sf.base.EventHandler.remove(this.element, sf.base.Browser.touchStartEvent, this.mouseDownOnTreeMap);
        sf.base.EventHandler.remove(this.element, sf.base.Browser.touchMoveEvent, this.mouseMoveOnTreeMap);
        sf.base.EventHandler.remove(this.element, sf.base.Browser.touchEndEvent, this.mouseEndOnTreeMap);
        sf.base.EventHandler.remove(this.element, 'pointerleave mouseleave', this.mouseLeaveOnTreeMap);
    ...
    TreeMap.prototype.wireEVents = function () {
        sf.base.EventHandler.add(this.element, 'click', this.clickOnTreeMap, this);
        sf.base.EventHandler.add(this.element, 'dblclick', this.doubleClickOnTreeMap, this);
        sf.base.EventHandler.add(this.element, 'contextmenu', this.rightClickOnTreeMap, this);
        sf.base.EventHandler.add(this.element, sf.base.Browser.touchStartEvent, this.mouseDownOnTreeMap, this);
        sf.base.EventHandler.add(this.element, sf.base.Browser.touchMoveEvent, this.mouseMoveOnTreeMap, this);
        sf.base.EventHandler.add(this.element, sf.base.Browser.touchEndEvent, this.mouseEndOnTreeMap, this);
        sf.base.EventHandler.add(this.element, 'pointerleave mouseleave', this.mouseLeaveOnTreeMap, this);
    ...
    TreeMap.prototype.clickOnTreeMap = function (e) {
        ...
        if (targetId.indexOf('_Item_Index') > -1) {
            ...
            this.trigger(itemClick, eventArgs, function (observedArgs) {
                if (observedArgs.text !== labelText || observedArgs.contentItemTemplate !== labelText) {
                    if (sf.base.isNullOrUndefined(_this.leafItemSettings.labelTemplate)) {
                        ...
                        if (!sf.base.isNullOrUndefined(itemTemplate)) {
                            if (_this.isBlazor) {
                                var templateElement = sf.base.createElement('div');
        ...
        var doubleTapTimer1;
        if (!sf.base.isNullOrUndefined(this.doubleClick)) {
            if (!sf.base.isNullOrUndefined(doubleTapTimer1) && end - doubleTapTimer1 < 500) {
    ...
    TreeMap.prototype.calculatePreviousLevelChildItems = function (labelText, drillLevelValues, item, directLevel) {
        ...
        for (var _i = 0, _a = Object['values'](this.layout.renderItems); _i < _a.length; _i++) {
            ...
            if (drillLevelText[0] === drillLevelValues['levelText'][0]) {
                text = p === 0 ? sf.base.isNullOrUndefined(text1) ? text1 : drillLevelValues['levelText'][p] :
            ...
            if (this.levels.length !== 0 && !item['isLeafItem'] && findChildren(item)['values'] &&
                ...
                if (this.drilledItems.length > 0) {
                    ...
                    for (var i = 0; i < this.drilledItems.length; i++) {
                        if (!sf.base.isNullOrUndefined(drillLevel)) { //Compare the selected text level with drilled items
                        ...
                        if (item['levelOrderName'] === this.drilledItems[i]['name'] && !directLevel && sf.base.isNullOrUndefined(drillLevel)) {
                        ...
                        else if (i === this.drilledItems.length - 1 && sf.base.isNullOrUndefined(drillLevel)) {
                ...
                startEvent = {
                    ...
                    element: targetEle, groupIndex: this.enableBreadcrumb &&
                        this.drilledItems.length !== 0 && !sf.base.isNullOrUndefined(drillLevel) ?
                        this.drilledItems[this.drilledItems.length - 1]['data']['groupIndex'] : item['groupIndex'],
                    groupName: this.enableBreadcrumb && this.drilledItems.length !== 0 && !sf.base.isNullOrUndefined(drillLevel) ?
                ...
                this.trigger(drillStart, startEvent, function (observedArgs) {
                    _this.currentLevel = item['isDrilled'] && sf.base.isNullOrUndefined(drillLevel) ? item['groupIndex'] :
                        (!sf.base.isNullOrUndefined(drillLevel) && _this.enableBreadcrumb && item['isDrilled']) ? drillLevel : null;
                    if (!observedArgs.cancel) {
                        if (document.getElementById(layoutID)) {
                            var layerElementId = document.getElementById(layoutID);
                            layerElementId.parentNode.removeChild(layerElementId);
                        }
                        totalRect = sf.base.extend({}, _this.areaRect, totalRect, true);
                        if (_this.legendSettings.visible && !sf.base.isNullOrUndefined(_this.treeMapLegendModule)) {
                            if (!sf.base.isNullOrUndefined(newDrillItem)) {
                                ...
                                if (_this.enableBreadcrumb && !sf.base.isNullOrUndefined(drillLevel)) {
                            ...
                            totalRect = !sf.base.isNullOrUndefined(_this.totalRect) ? _this.totalRect : totalRect;
                        }
                        if (document.getElementById(templateID)) {
                            var drillElementId = document.getElementById(templateID);
                            drillElementId.parentNode.removeChild(drillElementId);
                        }
                        if (!sf.base.isNullOrUndefined(observedArgs.childItems) && !observedArgs.cancel) {
                ...
                if (process) {
                    if (!directLevel && sf.base.isNullOrUndefined(drillLevel)) {
    ...
    TreeMap.prototype.selectItem = function (levelOrder, isSelected) {
        if (sf.base.isNullOrUndefined(isSelected)) {
            isSelected = true;
        }
        var levelOrderName = '';
    ...
    __decorate([
        sf.base.Complex({}, TitleSettings)
    ], TreeMap.prototype, "titleSettings", void 0);
    __decorate([
        sf.base.Property('Squarified')
    ...
    __decorate([
        sf.base.Property('TopLeftBottomRight')
    ...
    __decorate([
        sf.base.Complex({}, InitialDrillSettings)
    ], TreeMap.prototype, "initialDrillDown", void 0);
    __decorate([
        sf.base.Complex({}, LeafItemSettings)
    ], TreeMap.prototype, "leafItemSettings", void 0);
    __decorate([
        sf.base.Collection([], LevelSettings)
    ], TreeMap.prototype, "levels", void 0);
    __decorate([
        sf.base.Complex({}, HighlightSettings)
...
var TreeMapLegend = /** @class */ (function () {
    ...
    TreeMapLegend.prototype.calculateLegendBounds = function () {
        ...
        if ((this.treemap.palette.length > 0 || !sf.base.isNullOrUndefined(this.treemap.colorValuePath))
        ...
        if (this.legendCollections.length > 0) {
            ...
            if (legendMode === 'Default') {
                legendWidth = (sf.base.isNullOrUndefined(legendWidth)) ? treemap.areaRect.width : legendWidth;
                legendHeight = (sf.base.isNullOrUndefined(legendHeight)) ? treemap.areaRect.height : legendHeight;
                var j = 0;
                for (var i = 0; i < this.legendCollections.length; i++) {
                    var legendItem = this.legendCollections[i];
                    if (sf.base.isNullOrUndefined(this.totalPages[this.page])) {
                ...
                rectWidth_1 = (orientation_1 === 'Horizontal') ? (sf.base.isNullOrUndefined(legendWidth)) ? (treemap.areaRect.width / legendLength_1) :
                    (legendWidth / legendLength_1) : (sf.base.isNullOrUndefined(legendWidth)) ? defaultSize : legendWidth;
                rectHeight_1 = (orientation_1 === 'Horizontal') ? (sf.base.isNullOrUndefined(legendHeight)) ? defaultSize : legendHeight :
                    (sf.base.isNullOrUndefined(legendHeight)) ? (treemap.areaRect.height / legendLength_1) : (legendHeight / legendLength_1);
                startX_1 = 0;
    ...
    TreeMapLegend.prototype.findPaletteLegendItems = function (data, type) {
        var child;
        var legendFillColor;
        if (!sf.base.isNullOrUndefined(this.treemap.drilledItems)) {
            if (this.treemap.drilledItems.length === 0 && !sf.base.isNullOrUndefined(this.treemap.initialDrillDown.groupName)
                && sf.base.isNullOrUndefined(this.treemap.drilledLegendItems)) {
        ...
        if (this.treemap.enableDrillDown && !sf.base.isNullOrUndefined(this.treemap.drilledLegendItems)) {
        ...
        if (child && child.length > 0) {
            for (var i = 0; i < child.length; i++) {
                if (sf.base.isNullOrUndefined(child[i]['data'][this.treemap.legendSettings.showLegendPath]) ||
                    ...
                    if (!isDuplicate) {
                        this.legendCollections.push({
                            ...
                            legendFill: this.treemap.palette.length > 0 ? !sf.base.isNullOrUndefined(this.treemap.currentLevel)
            ...
            if (this.treemap.palette.length > 0) {
                for (var j = 0; j < this.legendCollections.length; j++) {
                    this.legendCollections[j]['legendFill'] = !sf.base.isNullOrUndefined(this.treemap.currentLevel)
    ...
    TreeMapLegend.prototype.calculateLegendItems = function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            for (var _i = 0, colorMapping_1 = colorMapping; _i < colorMapping_1.length; _i++) {
                ...
                colorMap$$1.value = !sf.base.isNullOrUndefined(colorMap$$1.value) ? colorMap$$1.value.toString() : colorMap$$1.value;
                if (!sf.base.isNullOrUndefined(colorMap$$1.from) && !sf.base.isNullOrUndefined(colorMap$$1.to) &&
                    rangeValue >= colorMap$$1.from && rangeValue <= colorMap$$1.to && colorMap$$1.showLegend) {
                    colorMapProcess = true;
                    isRange = true;
                    actualValue = colorMap$$1.from + ' - ' + colorMap$$1.to;
                    legendText = !sf.base.isNullOrUndefined(colorMap$$1.label) ? colorMap$$1.label : colorMap$$1.from + ' - ' + colorMap$$1.to;
                    fill = sf.base.isNullOrUndefined(colorMap$$1.color) ? fill : colorMap$$1.color;
                    isAddData = this.isAddNewLegendData(actualValue);
                }
                else if (!sf.base.isNullOrUndefined(colorMap$$1.value) && equalValue === colorMap$$1.value && colorMap$$1.showLegend) {
                    colorMapProcess = true;
                    isEqualColor = true;
                    actualValue = colorMap$$1.value.toString();
                    legendText = !sf.base.isNullOrUndefined(colorMap$$1.label) ? colorMap$$1.label : colorMap$$1.value.toString();
                    fill = sf.base.isNullOrUndefined(colorMap$$1.color) ? fill :
                        Object.prototype.toString.call(colorMap$$1.color) === '[object Array]' ? colorMap$$1.color[0] : colorMap$$1.color;
                    isAddData = this.isAddNewLegendData(actualValue);
                }
                if (colorMapProcess && sf.base.isNullOrUndefined(colorMap$$1.value) && colorMap$$1.maxOpacity && colorMap$$1.minOpacity
                ...
                if (isAddData && isAddData['process'] && colorMapProcess && !isDuplicate) {
                    ...
                    fill = ((Object.prototype.toString.call(colorMap$$1.color) === '[object Array]')) && sf.base.isNullOrUndefined(gradientElement)
                        && sf.base.isNullOrUndefined(colorMap$$1.value) ? this.legendGradientColor(colorMap$$1, legendIndex) : fill;
                    this.legendCollections.push({
                        actualValue: actualValue,
                        legendName: legendText, legendFill: fill, legendData: [],
                        gradientElement: !sf.base.isNullOrUndefined(gradientElement) ? gradientElement : sf.base.isNullOrUndefined(colorMap$$1.value)
                ...
                if (!isRange && !isDesaturation && !isEqualColor) {
                    if (sf.base.isNullOrUndefined(colorMap$$1.from) && sf.base.isNullOrUndefined(colorMap$$1.to)
                        && sf.base.isNullOrUndefined(colorMap$$1.minOpacity) &&
                        sf.base.isNullOrUndefined(colorMap$$1.maxOpacity) && sf.base.isNullOrUndefined(colorMap$$1.value) &&
                        !sf.base.isNullOrUndefined(colorMap$$1.color)) {
                        outfill = ((Object.prototype.toString.call(colorMap$$1.color) === '[object Array]'))
                            ? colorMap$$1.color[0] : colorMap$$1.color;
                        labelLegend = !sf.base.isNullOrUndefined(colorMap$$1.label) ? colorMap$$1.label : 'Others';
                        if (sf.base.isNullOrUndefined(this.outOfRangeLegend)) {
                            this.legendCollections.push({
    ...
    TreeMapLegend.prototype.drawLegendItem = function (page) {
        ...
        if (page >= 0 && page < this.totalPages.length) {
            ...
            var strokeColor_1 = isLineShape_1 ? sf.base.isNullOrUndefined(legend.fill) ? '#000000' : legend.fill : shapeBorder.color;
    ...
    TreeMapLegend.prototype.renderInteractivePointer = function (e) {
        ...
        if (target.id.indexOf('_Item_Index') > -1 && legend.visible && this.legendRenderingCollections.length > 0) {
            ...
            for (var i = 0; i < this.legendCollections.length; i++) {
                ...
                if (!sf.base.isNullOrUndefined(currentData['legendData'])) {
    ...
    TreeMapLegend.prototype.getLegendAlignment = function (treemap, width, height, legend) {
        ...
        var spacing = 10;
        var totalRect;
        totalRect = sf.base.extend({}, treemap.areaRect, totalRect, true);
    ...
    TreeMapLegend.prototype.wireEvents = function (element) {
        sf.base.EventHandler.add(element, sf.base.Browser.touchStartEvent, this.changeNextPage, this);
    };
    /**
    ...
    TreeMapLegend.prototype.addEventListener = function () {
        ...
        this.treemap.on(sf.base.Browser.touchMoveEvent, this.renderInteractivePointer, this);
        this.treemap.on(sf.base.Browser.touchEndEvent, this.mouseUpHandler, this);
    };
    /**
    ...
    TreeMapLegend.prototype.removeEventListener = function () {
        ...
        this.treemap.off(sf.base.Browser.touchMoveEvent, this.renderInteractivePointer);
        this.treemap.off(sf.base.Browser.touchEndEvent, this.mouseUpHandler);
    };
    /**
     * Get module name.
     */
    ...
    TreeMapLegend.prototype.legendGradientColor = function (colorMap$$1, legendIndex) {
        ...
        if (!sf.base.isNullOrUndefined(colorMap$$1.color) && Object.prototype.toString.call(colorMap$$1.color) === '[object Array]') {
...
var TreeMapHighlight = /** @class */ (function () {
    ...
    TreeMapHighlight.prototype.addEventListener = function () {
        ...
        this.treemap.on(sf.base.Browser.touchMoveEvent, this.mouseMove, this);
    };
    /**
    ...
    TreeMapHighlight.prototype.removeEventListener = function () {
        ...
        this.treemap.off(sf.base.Browser.touchMoveEvent, this.mouseMove);
    };
    /**
     * Get module name.
     */
...
var TreeMapSelection = /** @class */ (function () {
                ...
                for (var k = 0; k < selectionElements.length; k++) {
                    ...
                    treemap.trigger(itemSelected, treemap.isBlazor ? eventBlazorArgs : eventArgs, function (observedArgs) {
                        if (observedArgs.contentItemTemplate !== labelText) {
                            ...
                            if (!sf.base.isNullOrUndefined(itemTemplate)) {
                                if (treemap.isBlazor) {
                                    var templateCreated = sf.base.createElement('div');
    ...
    TreeMapSelection.prototype.addEventListener = function () {
        ...
        this.treemap.on(sf.base.Browser.touchStartEvent, this.mouseDown, this);
    };
    /**
    ...
    TreeMapSelection.prototype.removeEventListener = function () {
        ...
        this.treemap.off(sf.base.Browser.touchStartEvent, this.mouseDown);
    };
    /**
     * Get module name.
     */
...
var TreeMapTooltip = /** @class */ (function () {
        ...
        if (targetId.indexOf('_Item_Index') > -1) {
            ...
            if (!sf.base.isNullOrUndefined(item)) {
                ...
                if (document.getElementById(this.tooltipId)) {
                    ...
                    tooltipEle = sf.base.createElement('div', {
    ...
    TreeMapTooltip.prototype.addTooltip = function (tootipArgs, markerFill, tooltipEle, eventArgs) {
        var cancel;
        var args;
        if (!sf.base.isNullOrUndefined(tootipArgs)) {
    ...
    TreeMapTooltip.prototype.addEventListener = function () {
        ...
        this.treemap.on(sf.base.Browser.touchMoveEvent, this.renderTooltip, this);
        this.treemap.on(sf.base.Browser.touchEndEvent, this.mouseUpHandler, this);
    };
    /**
    ...
    TreeMapTooltip.prototype.removeEventListener = function () {
        ...
        this.treemap.off(sf.base.Browser.touchMoveEvent, this.renderTooltip);
        this.treemap.off(sf.base.Browser.touchEndEvent, this.mouseUpHandler);
    };
    /**
     * Get module name.
...
exports.Font = Font;
exports.CommonTitleSettings = CommonTitleSettings;
exports.SubTitleSettings = SubTitleSettings;
exports.TitleSettings = TitleSettings;
exports.ColorMapping = ColorMapping;
exports.LegendSettings = LegendSettings;
exports.InitialDrillSettings = InitialDrillSettings;
exports.LeafItemSettings = LeafItemSettings;
...
exports.itemRendering = itemRendering;
exports.drillStart = drillStart;
exports.drillEnd = drillEnd;
exports.itemSelected = itemSelected;
exports.itemHighlight = itemHighlight;
exports.tooltipRendering = tooltipRendering;
...
exports.legendItemRendering = legendItemRendering;
exports.legendRendering = legendRendering;
...
exports.itemsToOrder = itemsToOrder;
exports.isContainsData = isContainsData;
exports.findChildren = findChildren;
exports.findHightLightItems = findHightLightItems;
exports.getTemplateFunction = getTemplateFunction;
exports.convertElement = convertElement;
exports.findLabelLocation = findLabelLocation;
exports.measureElement = measureElement;
exports.getArea = getArea;
exports.getShortestEdge = getShortestEdge;
exports.convertToContainer = convertToContainer;
exports.convertToRect = convertToRect;
exports.getMousePosition = getMousePosition;
exports.colorMap = colorMap;
exports.deSaturationColor = deSaturationColor;
exports.colorCollections = colorCollections;
...
exports.legendMaintain = legendMaintain;
...
exports.renderLegendShape = renderLegendShape;
exports.isParentItem = isParentItem;
exports.TreeMapAjax = TreeMapAjax;
...
sfBlazor.modules["treemap"] = "treemap.TreeMap";
sfBlazor.loadDependencies(sfBlazor.dependencyJson.treemap, () => {
    sf.treemap = sf.base.extend({}, sf.treemap, sftreemap({}));
});