...
describe('TreeMap Component Base Spec', () => {
    ...
    describe('TreeMap testing spec', () => {
        ...
        it('Checking with background without refresh method ', () => {
            treemap.loaded = (args: ILoadedEventArgs) => {
                let element: Element = document.getElementById(args.treemap.element.id + '_TreeMap_Border');
                expect(element.getAttribute('fill')).toBe('yellow');
            };
            treemap.background = 'yellow';
        });
